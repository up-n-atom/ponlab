...
Remove lan4 from LAN bridge and add it to the Guest bridge:
  ...
  > ubus-cli Bridging.Bridge.guest.Port.+{Name="LAN4", Alias="LAN4", LowerLayers="Device.Ethernet.Interface.6."}\n
  > sleep 1\n
...
Remove lan4 from the Guest bridge and add it back to the LAN bridge:
  ...
  > ubus-cli Bridging.Bridge.lan.Port.+{Name="lan4", Alias="LAN4", LowerLayers="Device.Ethernet.Interface.6."}\n
  > sleep 1\n
