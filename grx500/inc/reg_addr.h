 ...
 */
/* CGU */
#define CGU_FPI_BASE	(0x00000000)
/* ACA SPRAM */
...
#define DSL_FW_FREQ_INC			PPE_REG_ADDR(0x0DCE)
...
/* DSL_FRAMER_REQ bit */
#define DSL_FRAMER_REQ_START_INDC 	BIT(0)
#define DSL_FRAMER_REQ_START_DYN_FREQ	BIT(1)
#define DSL_FRAMER_REQ_START_ERB_RESET	BIT(2)
...
/*CGU REG BIT */
#define CGU_REG(X)			(CGU_FPI_BASE + (X))
#define PLL_CFG				CGU_REG(0x060)
#define PLL_CFG_PLL_EN		BIT(0)
#define PLL_CFG_PLL_RST		BIT(1)
#define PLL_CFG_PLLL		BIT(4)
#define PLL_CFG_PLLN		(16)
#define PLL_CFG_PLLN_MASK	(0xFF)
#define PLL_CFG_PLL_BP		BIT(30)

#define PMU_POWER_DOWN_ALL	(PMU_ADMA | PMU_CDMA | PMU_SPI | PMU_DSL |\
		PMU_PPE_QSB | PMU_PPE_SLL01 | \
