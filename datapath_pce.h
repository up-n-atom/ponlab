...
/* Max default RMON counter index */
#define PCE_RMON_SIZE_MAX	256
...
struct dp_pce_rule {
	...
	DECLARE_BITMAP(_rmon_used, PCE_RMON_SIZE_MAX); /* Used counters */
...
struct dp_subblk_entry {
	...
	struct list_head rules_list; /* Rules list */
};
