...
#define	REG_PAC_EXTRAPOLATOR_DBG_INFO_MIN_RSSI                 (PAC_EXTRAPOLATOR_BASE_ADDRESS + 0xCC)
#define	REG_PAC_EXTRAPOLATOR_DBG_INFO_AF_FETCH_PREP            (PAC_EXTRAPOLATOR_BASE_ADDRESS + 0xD0)
/*---------------------------------------------------------------------------------
...
/*REG_PAC_EXTRAPOLATOR_DBG_INFO_MIN_RSSI 0xCC */
typedef union
{
	uint32 val;
	struct
...
/*REG_PAC_EXTRAPOLATOR_DBG_INFO_AF_FETCH_PREP 0xD0 */
typedef union
{
	uint32 val;
	struct
