...
typedef union
{
	...
	struct
	{
		uint32 suPage : 1; //su_page, reset value: 0x0, access type: RW
		uint32 muPage : 1; //mu_page, reset value: 0x0, access type: RW
		uint32 chPage : 2; //ch_page, reset value: 0x0, access type: RW
		uint32 reserved0 : 28;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		...
		uint32 streamerRate : 1; //0=640M , 1=320M, reset value: 0x0, access type: RW
		uint32 reserved0 : 28;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 sphereReduceWafaTones : 6; //reduce numbter of cycles for sphere operation for WAFA plans , reset value: 0x14, access type: RW
		uint32 reserved0 : 26;
	} bitFields;
