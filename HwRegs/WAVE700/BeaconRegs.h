...
Module:				beacon
SOC Revision:		latest
Generated at:       2022-05-04 10:58:58
Purpose:
...
#define	REG_BEACON_VAP16_BEACON_RO_COUNTERS     (BEACON_BASE_ADDRESS + 0x224)
#define	REG_BEACON_VAP17_BEACON_RO_COUNTERS     (BEACON_BASE_ADDRESS + 0x228)
#define	REG_BEACON_VAP18_BEACON_RO_COUNTERS     (BEACON_BASE_ADDRESS + 0x22C)
#define	REG_BEACON_VAP19_BEACON_RO_COUNTERS     (BEACON_BASE_ADDRESS + 0x230)
#define	REG_BEACON_VAP20_BEACON_RO_COUNTERS     (BEACON_BASE_ADDRESS + 0x234)
#define	REG_BEACON_VAP21_BEACON_RO_COUNTERS     (BEACON_BASE_ADDRESS + 0x238)
#define	REG_BEACON_VAP22_BEACON_RO_COUNTERS     (BEACON_BASE_ADDRESS + 0x23C)
#define	REG_BEACON_VAP23_BEACON_RO_COUNTERS     (BEACON_BASE_ADDRESS + 0x240)
#define	REG_BEACON_VAP24_BEACON_RO_COUNTERS     (BEACON_BASE_ADDRESS + 0x244)
#define	REG_BEACON_VAP25_BEACON_RO_COUNTERS     (BEACON_BASE_ADDRESS + 0x248)
#define	REG_BEACON_VAP26_BEACON_RO_COUNTERS     (BEACON_BASE_ADDRESS + 0x24C)
#define	REG_BEACON_VAP27_BEACON_RO_COUNTERS     (BEACON_BASE_ADDRESS + 0x250)
#define	REG_BEACON_VAP28_BEACON_RO_COUNTERS     (BEACON_BASE_ADDRESS + 0x254)
#define	REG_BEACON_VAP29_BEACON_RO_COUNTERS     (BEACON_BASE_ADDRESS + 0x258)
#define	REG_BEACON_VAP30_BEACON_RO_COUNTERS     (BEACON_BASE_ADDRESS + 0x25C)
#define	REG_BEACON_VAP31_BEACON_RO_COUNTERS     (BEACON_BASE_ADDRESS + 0x260)
...
/*REG_BEACON_VAP16_BEACON_RO_COUNTERS 0x224 */
typedef union
{
	uint32 val;
	struct
...
} RegBeaconVap16BeaconRoCounters_u;

/*REG_BEACON_VAP17_BEACON_RO_COUNTERS 0x228 */
typedef union
{
	uint32 val;
	struct
...
} RegBeaconVap17BeaconRoCounters_u;

/*REG_BEACON_VAP18_BEACON_RO_COUNTERS 0x22C */
typedef union
{
	uint32 val;
	struct
...
} RegBeaconVap18BeaconRoCounters_u;

/*REG_BEACON_VAP19_BEACON_RO_COUNTERS 0x230 */
typedef union
{
	uint32 val;
	struct
...
} RegBeaconVap19BeaconRoCounters_u;

/*REG_BEACON_VAP20_BEACON_RO_COUNTERS 0x234 */
typedef union
{
	uint32 val;
	struct
...
} RegBeaconVap20BeaconRoCounters_u;

/*REG_BEACON_VAP21_BEACON_RO_COUNTERS 0x238 */
typedef union
{
	uint32 val;
	struct
...
} RegBeaconVap21BeaconRoCounters_u;

/*REG_BEACON_VAP22_BEACON_RO_COUNTERS 0x23C */
typedef union
{
	uint32 val;
	struct
...
} RegBeaconVap22BeaconRoCounters_u;

/*REG_BEACON_VAP23_BEACON_RO_COUNTERS 0x240 */
typedef union
{
	uint32 val;
	struct
...
} RegBeaconVap23BeaconRoCounters_u;

/*REG_BEACON_VAP24_BEACON_RO_COUNTERS 0x244 */
typedef union
{
	uint32 val;
	struct
...
} RegBeaconVap24BeaconRoCounters_u;

/*REG_BEACON_VAP25_BEACON_RO_COUNTERS 0x248 */
typedef union
{
	uint32 val;
	struct
...
} RegBeaconVap25BeaconRoCounters_u;

/*REG_BEACON_VAP26_BEACON_RO_COUNTERS 0x24C */
typedef union
{
	uint32 val;
	struct
...
} RegBeaconVap26BeaconRoCounters_u;

/*REG_BEACON_VAP27_BEACON_RO_COUNTERS 0x250 */
typedef union
{
	uint32 val;
	struct
...
} RegBeaconVap27BeaconRoCounters_u;

/*REG_BEACON_VAP28_BEACON_RO_COUNTERS 0x254 */
typedef union
{
	uint32 val;
	struct
...
} RegBeaconVap28BeaconRoCounters_u;

/*REG_BEACON_VAP29_BEACON_RO_COUNTERS 0x258 */
typedef union
{
	uint32 val;
	struct
...
} RegBeaconVap29BeaconRoCounters_u;

/*REG_BEACON_VAP30_BEACON_RO_COUNTERS 0x25C */
typedef union
{
	uint32 val;
	struct
...
} RegBeaconVap30BeaconRoCounters_u;

/*REG_BEACON_VAP31_BEACON_RO_COUNTERS 0x260 */
typedef union
{
	uint32 val;
	struct
...
} RegBeaconVap31BeaconRoCounters_u;
