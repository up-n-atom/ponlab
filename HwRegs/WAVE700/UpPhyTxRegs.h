...
#define	REG_UP_PHY_TX_TD_SYMBOL_DELAY_LENGTH_22                        (UP_PHY_TX_BASE_ADDRESS + 0x238)
#define	REG_UP_PHY_TX_TD_SYMBOL_DELAY_LENGTH_23                        (UP_PHY_TX_BASE_ADDRESS + 0x23C)
...
} RegUpPhyTxTdSymbolDelayLength2_3_u;
...
/*REG_UP_PHY_TX_TD_SYMBOL_DELAY_LENGTH_22 0x238 */
typedef union
{
	uint32 val;
	struct
...
} RegUpPhyTxTdSymbolDelayLength22_u;

/*REG_UP_PHY_TX_TD_SYMBOL_DELAY_LENGTH_23 0x23C */
typedef union
{
	uint32 val;
	struct
