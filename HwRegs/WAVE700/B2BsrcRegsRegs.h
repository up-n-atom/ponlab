...
/***********************************************************************************
File:				B2BsrcRegsRegs.h
Module:				b2BsrcRegs
SOC Revision:		latest
Generated at:       2022-05-04 10:58:03
Purpose:
Description:		This File was auto generated using SOC Online

************************************************************************************/
#ifndef _B2_BSRC_REGS_REGS_H_
#define _B2_BSRC_REGS_REGS_H_
...
#define B2_BSRC_REGS_BASE_ADDRESS                             MEMORY_MAP_UNIT_20016_BASE_ADDRESS
#define	REG_B2_BSRC_REGS_GLOBAL_REG                             (B2_BSRC_REGS_BASE_ADDRESS + 0x0)
#define	REG_B2_BSRC_REGS_SENDER_INT_STATUS                      (B2_BSRC_REGS_BASE_ADDRESS + 0x4)
#define	REG_B2_BSRC_REGS_SENDER_INT_EN                          (B2_BSRC_REGS_BASE_ADDRESS + 0x8)
#define	REG_B2_BSRC_REGS_SENDER_CLEAR_INT                       (B2_BSRC_REGS_BASE_ADDRESS + 0xC)
#define	REG_B2_BSRC_REGS_INT_STATUS                             (B2_BSRC_REGS_BASE_ADDRESS + 0x10)
#define	REG_B2_BSRC_REGS_INT_EN                                 (B2_BSRC_REGS_BASE_ADDRESS + 0x14)
#define	REG_B2_BSRC_REGS_CLEAR_INT                              (B2_BSRC_REGS_BASE_ADDRESS + 0x18)
#define	REG_B2_BSRC_REGS_INT_ERROR_STATUS                       (B2_BSRC_REGS_BASE_ADDRESS + 0x1C)
#define	REG_B2_BSRC_REGS_INT_ERROR_EN                           (B2_BSRC_REGS_BASE_ADDRESS + 0x20)
#define	REG_B2_BSRC_REGS_CLEAR_INT_ERROR                        (B2_BSRC_REGS_BASE_ADDRESS + 0x24)
#define	REG_B2_BSRC_REGS_AGER_CFG                               (B2_BSRC_REGS_BASE_ADDRESS + 0x28)
#define	REG_B2_BSRC_REGS_SENDER_INDIRECT_ACCESS                 (B2_BSRC_REGS_BASE_ADDRESS + 0x2C)
#define	REG_B2_BSRC_REGS_SENDER_AGER_PERIOD                     (B2_BSRC_REGS_BASE_ADDRESS + 0x30)
#define	REG_B2_BSRC_REGS_SENDER_BUF_STS_CNT_1_0                 (B2_BSRC_REGS_BASE_ADDRESS + 0x34)
#define	REG_B2_BSRC_REGS_SENDER_BUF_STS_CNT_3_2                 (B2_BSRC_REGS_BASE_ADDRESS + 0x38)
#define	REG_B2_BSRC_REGS_SENDER_BUF_STS_CNT_5_4                 (B2_BSRC_REGS_BASE_ADDRESS + 0x3C)
#define	REG_B2_BSRC_REGS_SENDER_BUF_STS_CNT_7_6                 (B2_BSRC_REGS_BASE_ADDRESS + 0x40)
#define	REG_B2_BSRC_REGS_FW_INDIRECT_ACCESS                     (B2_BSRC_REGS_BASE_ADDRESS + 0x44)
#define	REG_B2_BSRC_REGS_FW_AGER_PERIOD                         (B2_BSRC_REGS_BASE_ADDRESS + 0x48)
#define	REG_B2_BSRC_REGS_FW_BUF_STS_CNT_1_0                     (B2_BSRC_REGS_BASE_ADDRESS + 0x4C)
#define	REG_B2_BSRC_REGS_FW_BUF_STS_CNT_3_2                     (B2_BSRC_REGS_BASE_ADDRESS + 0x50)
#define	REG_B2_BSRC_REGS_FW_BUF_STS_CNT_5_4                     (B2_BSRC_REGS_BASE_ADDRESS + 0x54)
#define	REG_B2_BSRC_REGS_FW_BUF_STS_CNT_7_6                     (B2_BSRC_REGS_BASE_ADDRESS + 0x58)
#define	REG_B2_BSRC_REGS_NDPFB_CFG0                             (B2_BSRC_REGS_BASE_ADDRESS + 0x5C)
#define	REG_B2_BSRC_REGS_NDPFB_CFG1                             (B2_BSRC_REGS_BASE_ADDRESS + 0x60)
#define	REG_B2_BSRC_REGS_NDPFB_CFG2                             (B2_BSRC_REGS_BASE_ADDRESS + 0x64)
#define	REG_B2_BSRC_REGS_NDPFB_REPORT_FIFO_BASE_ADDR            (B2_BSRC_REGS_BASE_ADDRESS + 0x68)
#define	REG_B2_BSRC_REGS_NDPFB_REPORT_FIFO_DEPTH_MINUS_ONE      (B2_BSRC_REGS_BASE_ADDRESS + 0x6C)
#define	REG_B2_BSRC_REGS_NDPFB_REPORT_FIFO_CLEAR_STRB           (B2_BSRC_REGS_BASE_ADDRESS + 0x70)
#define	REG_B2_BSRC_REGS_NDPFB_REPORT_FIFO_RD_ENTRIES_NUM       (B2_BSRC_REGS_BASE_ADDRESS + 0x74)
#define	REG_B2_BSRC_REGS_NDPFB_REPORT_FIFO_NUM_ENTRIES_COUNT    (B2_BSRC_REGS_BASE_ADDRESS + 0x78)
#define	REG_B2_BSRC_REGS_NDPFB_REPORT_FIFO_DEBUG                (B2_BSRC_REGS_BASE_ADDRESS + 0x7C)
#define	REG_B2_BSRC_REGS_LOGGER_REG                             (B2_BSRC_REGS_BASE_ADDRESS + 0x80)
#define	REG_B2_BSRC_REGS_LOGGER_FILTER                          (B2_BSRC_REGS_BASE_ADDRESS + 0x84)
#define	REG_B2_BSRC_REGS_FIFO_STATUS0                           (B2_BSRC_REGS_BASE_ADDRESS + 0x88)
#define	REG_B2_BSRC_REGS_FIFO_STATUS1                           (B2_BSRC_REGS_BASE_ADDRESS + 0x8C)
#define	REG_B2_BSRC_REGS_FSM_STATUS                             (B2_BSRC_REGS_BASE_ADDRESS + 0x90)
#define	REG_B2_BSRC_REGS_SPARE_REG                              (B2_BSRC_REGS_BASE_ADDRESS + 0xA0)
/*---------------------------------------------------------------------------------
/						Data Type Definition										
/----------------------------------------------------------------------------------*/
/*REG_B2_BSRC_REGS_GLOBAL_REG 0x0 */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsGlobalReg_u;

/*REG_B2_BSRC_REGS_SENDER_INT_STATUS 0x4 */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsSenderIntStatus_u;

/*REG_B2_BSRC_REGS_SENDER_INT_EN 0x8 */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsSenderIntEn_u;

/*REG_B2_BSRC_REGS_SENDER_CLEAR_INT 0xC */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsSenderClearInt_u;

/*REG_B2_BSRC_REGS_INT_STATUS 0x10 */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsIntStatus_u;

/*REG_B2_BSRC_REGS_INT_EN 0x14 */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsIntEn_u;

/*REG_B2_BSRC_REGS_CLEAR_INT 0x18 */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsClearInt_u;

/*REG_B2_BSRC_REGS_INT_ERROR_STATUS 0x1C */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsIntErrorStatus_u;

/*REG_B2_BSRC_REGS_INT_ERROR_EN 0x20 */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsIntErrorEn_u;

/*REG_B2_BSRC_REGS_CLEAR_INT_ERROR 0x24 */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsClearIntError_u;

/*REG_B2_BSRC_REGS_AGER_CFG 0x28 */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsAgerCfg_u;

/*REG_B2_BSRC_REGS_SENDER_INDIRECT_ACCESS 0x2C */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsSenderIndirectAccess_u;

/*REG_B2_BSRC_REGS_SENDER_AGER_PERIOD 0x30 */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsSenderAgerPeriod_u;

/*REG_B2_BSRC_REGS_SENDER_BUF_STS_CNT_1_0 0x34 */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsSenderBufStsCnt10_u;

/*REG_B2_BSRC_REGS_SENDER_BUF_STS_CNT_3_2 0x38 */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsSenderBufStsCnt32_u;

/*REG_B2_BSRC_REGS_SENDER_BUF_STS_CNT_5_4 0x3C */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsSenderBufStsCnt54_u;

/*REG_B2_BSRC_REGS_SENDER_BUF_STS_CNT_7_6 0x40 */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsSenderBufStsCnt76_u;

/*REG_B2_BSRC_REGS_FW_INDIRECT_ACCESS 0x44 */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsFwIndirectAccess_u;

/*REG_B2_BSRC_REGS_FW_AGER_PERIOD 0x48 */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsFwAgerPeriod_u;

/*REG_B2_BSRC_REGS_FW_BUF_STS_CNT_1_0 0x4C */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsFwBufStsCnt10_u;

/*REG_B2_BSRC_REGS_FW_BUF_STS_CNT_3_2 0x50 */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsFwBufStsCnt32_u;

/*REG_B2_BSRC_REGS_FW_BUF_STS_CNT_5_4 0x54 */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsFwBufStsCnt54_u;

/*REG_B2_BSRC_REGS_FW_BUF_STS_CNT_7_6 0x58 */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsFwBufStsCnt76_u;

/*REG_B2_BSRC_REGS_NDPFB_CFG0 0x5C */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsNdpfbCfg0_u;

/*REG_B2_BSRC_REGS_NDPFB_CFG1 0x60 */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsNdpfbCfg1_u;

/*REG_B2_BSRC_REGS_NDPFB_CFG2 0x64 */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsNdpfbCfg2_u;

/*REG_B2_BSRC_REGS_NDPFB_REPORT_FIFO_BASE_ADDR 0x68 */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsNdpfbReportFifoBaseAddr_u;

/*REG_B2_BSRC_REGS_NDPFB_REPORT_FIFO_DEPTH_MINUS_ONE 0x6C */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsNdpfbReportFifoDepthMinusOne_u;

/*REG_B2_BSRC_REGS_NDPFB_REPORT_FIFO_CLEAR_STRB 0x70 */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsNdpfbReportFifoClearStrb_u;

/*REG_B2_BSRC_REGS_NDPFB_REPORT_FIFO_RD_ENTRIES_NUM 0x74 */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsNdpfbReportFifoRdEntriesNum_u;

/*REG_B2_BSRC_REGS_NDPFB_REPORT_FIFO_NUM_ENTRIES_COUNT 0x78 */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsNdpfbReportFifoNumEntriesCount_u;

/*REG_B2_BSRC_REGS_NDPFB_REPORT_FIFO_DEBUG 0x7C */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsNdpfbReportFifoDebug_u;

/*REG_B2_BSRC_REGS_LOGGER_REG 0x80 */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsLoggerReg_u;

/*REG_B2_BSRC_REGS_LOGGER_FILTER 0x84 */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsLoggerFilter_u;

/*REG_B2_BSRC_REGS_FIFO_STATUS0 0x88 */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsFifoStatus0_u;

/*REG_B2_BSRC_REGS_FIFO_STATUS1 0x8C */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsFifoStatus1_u;

/*REG_B2_BSRC_REGS_FSM_STATUS 0x90 */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsFsmStatus_u;

/*REG_B2_BSRC_REGS_SPARE_REG 0xA0 */
typedef union
{
	uint32 val;
	struct
...
} RegB2BsrcRegsSpareReg_u;



#endif // _B2_BSRC_REGS_REGS_H_
