...
/***********************************************************************************
File:				B01QManagerTx1Regs.h
Module:				b01QManagerTx1
SOC Revision:		latest
...
************************************************************************************/
#ifndef _B01_Q_MANAGER_TX1_REGS_H_
#define _B01_Q_MANAGER_TX1_REGS_H_
...
#define B01_Q_MANAGER_TX1_BASE_ADDRESS                             MEMORY_MAP_UNIT_30_BASE_ADDRESS
#define	REG_B01_Q_MANAGER_TX1_CTL                 (B01_Q_MANAGER_TX1_BASE_ADDRESS + 0x0)
#define	REG_B01_Q_MANAGER_TX1_PUSH_ADDR_TOP       (B01_Q_MANAGER_TX1_BASE_ADDRESS + 0x4)
#define	REG_B01_Q_MANAGER_TX1_PUSH_ADDR_BOTTOM    (B01_Q_MANAGER_TX1_BASE_ADDRESS + 0x8)
#define	REG_B01_Q_MANAGER_TX1_POP_ADDR_TOP        (B01_Q_MANAGER_TX1_BASE_ADDRESS + 0xC)
#define	REG_B01_Q_MANAGER_TX1_POP_ADDR_BOTTOM     (B01_Q_MANAGER_TX1_BASE_ADDRESS + 0x10)
#define	REG_B01_Q_MANAGER_TX1_FIFO_STATUS         (B01_Q_MANAGER_TX1_BASE_ADDRESS + 0x18)
#define	REG_B01_Q_MANAGER_TX1_CLEAN_FIFO          (B01_Q_MANAGER_TX1_BASE_ADDRESS + 0x1C)
#define	REG_B01_Q_MANAGER_TX1_FIFO_EN             (B01_Q_MANAGER_TX1_BASE_ADDRESS + 0x20)
/*---------------------------------------------------------------------------------
/						Data Type Definition										
/----------------------------------------------------------------------------------*/
/*REG_B01_Q_MANAGER_TX1_CTL 0x0 */
typedef union
{
	uint32 val;
	struct
...
} RegB01QManagerTx1Ctl_u;

/*REG_B01_Q_MANAGER_TX1_PUSH_ADDR_TOP 0x4 */
typedef union
{
	uint32 val;
	struct
...
} RegB01QManagerTx1PushAddrTop_u;

/*REG_B01_Q_MANAGER_TX1_PUSH_ADDR_BOTTOM 0x8 */
typedef union
{
	uint32 val;
	struct
...
} RegB01QManagerTx1PushAddrBottom_u;

/*REG_B01_Q_MANAGER_TX1_POP_ADDR_TOP 0xC */
typedef union
{
	uint32 val;
	struct
...
} RegB01QManagerTx1PopAddrTop_u;

/*REG_B01_Q_MANAGER_TX1_POP_ADDR_BOTTOM 0x10 */
typedef union
{
	uint32 val;
	struct
...
} RegB01QManagerTx1PopAddrBottom_u;

/*REG_B01_Q_MANAGER_TX1_FIFO_STATUS 0x18 */
typedef union
{
	uint32 val;
	struct
...
} RegB01QManagerTx1FifoStatus_u;

/*REG_B01_Q_MANAGER_TX1_CLEAN_FIFO 0x1C */
typedef union
{
	uint32 val;
	struct
...
} RegB01QManagerTx1CleanFifo_u;

/*REG_B01_Q_MANAGER_TX1_FIFO_EN 0x20 */
typedef union
{
	uint32 val;
	struct
...
} RegB01QManagerTx1FifoEn_u;



#endif // _B01_Q_MANAGER_TX1_REGS_H_
