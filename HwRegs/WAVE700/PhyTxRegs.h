...
Module:				phyTx
SOC Revision:		latest
Generated at:       2022-05-04 10:59:15
Purpose:
...
#define	REG_PHY_TX_TD_SYMBOL_DELAY_LENGTH_22                        (PHY_TX_BASE_ADDRESS + 0x238)
#define	REG_PHY_TX_TD_SYMBOL_DELAY_LENGTH_23                        (PHY_TX_BASE_ADDRESS + 0x23C)
...
} RegPhyTxTdSymbolDelayLength2_3_u;
...
/*REG_PHY_TX_TD_SYMBOL_DELAY_LENGTH_22 0x238 */
typedef union
{
	uint32 val;
	struct
...
/*REG_PHY_TX_TD_SYMBOL_DELAY_LENGTH_23 0x23C */
typedef union
{
	uint32 val;
	struct
