...
#define	REG_B1_PAC_DUR_TSF_FIELD_TIME6P               (B1_PAC_DUR_BASE_ADDRESS + 0x60)
#define	REG_B1_PAC_DUR_TSF_FIELD_TIME6M               (B1_PAC_DUR_BASE_ADDRESS + 0x64)
...
/*REG_B1_PAC_DUR_TSF_FIELD_TIME6P 0x60 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PacDurTsfFieldTime6P_u;

/*REG_B1_PAC_DUR_TSF_FIELD_TIME6M 0x64 */
typedef union
{
	uint32 val;
	struct
...
#define B1_PAC_DUR_MISC_FIELD_POWER_MGMT_MASK                                                                     0x00000001
//========================================
/* REG_PAC_DUR_TSF_FIELD_TIME 0x1C */
#define B1_PAC_DUR_TSF_FIELD_TIME_FIELD_TSF_FIELD_TIME_MASK                                                       0x000001FF
//========================================
/* REG_PAC_DUR_TXOP_JUMP_TABLE_BASE 0x50 */
#define B1_PAC_DUR_TXOP_JUMP_TABLE_BASE_FIELD_TXOP_JUMP_TABLE_BASE_MASK                                           0x00FFFFC0
//========================================
/* REG_PAC_DUR_TX_MPDU_DUR_FIELD 0x54 */
#define B1_PAC_DUR_TX_MPDU_DUR_FIELD_FIELD_TX_MPDU_DUR_FIELD_MASK                                                 0x0000FFFF
//========================================
/* REG_PAC_DUR_TX_NAV_TIMER_AT_TX_EN_RISE 0x58 */
#define B1_PAC_DUR_TX_NAV_TIMER_AT_TX_EN_RISE_FIELD_TX_NAV_TIMER_AT_TX_EN_RISE_MASK                               0x0003FFFF
//========================================
/* REG_PAC_DUR_TSF_FIELD_TIME6P 0x60 */
#define B1_PAC_DUR_TSF_FIELD_TIME6P_FIELD_TSF_FIELD_TIME6P_MASK                                                   0x0FFFFFFF
//========================================
/* REG_PAC_DUR_TSF_FIELD_TIME6M 0x64 */
#define B1_PAC_DUR_TSF_FIELD_TIME6M_FIELD_TSF_FIELD_TIME6M_MASK                                                   0x0FFFFFFF
//========================================
/* REG_PAC_DUR_TSF_FIELD_TIME1 0x84 */
#define B1_PAC_DUR_TSF_FIELD_TIME1_FIELD_TSF_FIELD_TIME1_MASK                                                     0x01FFFFFF
//========================================
/* REG_PAC_DUR_TSF_FIELD_TIME2 0x88 */
#define B1_PAC_DUR_TSF_FIELD_TIME2_FIELD_TSF_FIELD_TIME2_MASK                                                     0x01FFFFFF
//========================================
/* REG_PAC_DUR_TSF_FIELD_TIME3 0x8C */
#define B1_PAC_DUR_TSF_FIELD_TIME3_FIELD_TSF_FIELD_TIME3_MASK                                                     0x01FFFFFF
//========================================
/* REG_PAC_DUR_PHY_PAC_TX_AIR_TIME_RESULT 0x94 */
#define B1_PAC_DUR_PHY_PAC_TX_AIR_TIME_RESULT_FIELD_PHY_PAC_TX_AIR_TIME_RESULT_MASK                               0x0001FFFF
//========================================
/* REG_PAC_DUR_DURATION_CALCULATION_RESULT 0x9C */
#define B1_PAC_DUR_DURATION_CALCULATION_RESULT_FIELD_AUTO_REPLY_DUR_MASK                                          0x0000FFFF
#define B1_PAC_DUR_DURATION_CALCULATION_RESULT_FIELD_AUTO_REPLY_BF_REPORT_DUR_MASK                                0xFFFF0000
//========================================
/* REG_PAC_DUR_TSF_ADJUST_DATA_IN 0xA0 */
#define B1_PAC_DUR_TSF_ADJUST_DATA_IN_FIELD_TSF_ADJUST_DATA_IN_MASK                                               0x00FFFFFF
//========================================
/* REG_PAC_DUR_TX_AIR_TIME_CTR_WR_VALUE 0xA4 */
#define B1_PAC_DUR_TX_AIR_TIME_CTR_WR_VALUE_FIELD_TX_AIR_TIME_CTR_WR_VALUE_MASK                                   0x0FFFFFFF
//========================================
/* REG_PAC_DUR_TX_AIR_TIME_CTR 0xA8 */
#define B1_PAC_DUR_TX_AIR_TIME_CTR_FIELD_TX_AIR_TIME_CTR_MASK                                                     0x0FFFFFFF
//========================================
/* REG_PAC_DUR_TSF_OFFSET_INDEX 0xF4 */
#define B1_PAC_DUR_TSF_OFFSET_INDEX_FIELD_TSF_OFFSET_INDEX_MASK                                                   0x0000001F
//========================================
/* REG_PAC_DUR_DUR_TIMER_COMPENSATION 0xF8 */
#define B1_PAC_DUR_DUR_TIMER_COMPENSATION_FIELD_DUR_TIMER_RXRDY_COMPENSATION_MASK                                 0x0000001F
#define B1_PAC_DUR_DUR_TIMER_COMPENSATION_FIELD_DUR_TIMER_TXEN_COMPENSATION_MASK                                  0x00001F00
//========================================
/* REG_PAC_DUR_TX_FRAME_ADDR3_SELECT_VAP 0xFC */
#define B1_PAC_DUR_TX_FRAME_ADDR3_SELECT_VAP_FIELD_TX_FRAME_ADDR3_SELECT_VAP_MASK                                 0xFFFFFFFF
