...
typedef union
{
	...
	struct
	{
		uint32 gpioOpenDrain : 20; //gpio open drain enable : bit 0, 1, --- to 15 are for GPIO0, GPIO1, ---, GPIO15, respectively. Bit 16 is for SPI DI. Bit 17 is for SPI DO. Bit 118 is for SPI CLK. Bit 19 is for SPI CS. , 0 - GPIO[0--19] pads open drain disable/push pull enable , 1 - GPIO[0--19] pads open drain enable/push pull  disable, reset value: 0x4040, access type: RW
		uint32 reserved0 : 12;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		...
		uint32 pcie0AppXferPendingWlan : 1; //no description, reset value: 0x0, access type: RW
		uint32 reserved0 : 27;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		...
		uint32 pcie0SmlhLinkUp : 1; //PHY Link up/down indicator:   , ------------      1: Link is up  , ------------      0: Link is down, reset value: 0x0, access type: RO
...
typedef union
{
	...
	struct
	{
		uint32 efusePd : 1; //Power down power switch, when accessing efuse for read/write the pd should be de-activated. Default value of bit is ------------0------------., reset value: 0x0, access type: RW
		uint32 reserved0 : 31;
	} bitFields;
} RegSocRegsEfusePd_u;
...
typedef union
{
	...
	struct
	{
		uint32 pcie0PtmContextValid : 1; //PTM Context Valid , This bit is not working in L1 mode based on pre-silicon test. Other mode is not yet tested. It is not recommended to use this bit. Alternatively, PCIe controller register PTM_REQ_STATUS_OFF  bit 0 (ptm_req_context_valid) can be used., reset value: 0x0, access type: RO
		uint32 reserved0 : 31;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		...
		uint32 reserved1 : 7;
		uint32 vid : 1; //Enable GPIO12 and GPIO15 for use as vid0/1 from SW/FW ,   0 : Disable. GPIO12 and GPIO15  as GPIO or VID0/1 from WLAN IP. VID0/1 out from WLAN IP as default ,   1 : Enable. GPIO12 as vid0 and GPIO15 as vid1 Output from vid0_out  and vid1_out of pcie_gpio_mux_control, reset value: 0x1, access type: RW
		uint32 reserved2 : 3;
		uint32 vid0Out : 1; //VID0_OUT: GPIO12 out data if VID=1. FW read VID0 efuse bit and write to this VID0_OUT as output to GPIO12. , reset value: 0x0, access type: RW
		uint32 vid1Out : 1; //VID1_OUT: GPIO15 out data if VID=1. FW read VID1 efuse bit and write to this VID1_OUT as output to GPIO12. , reset value: 0x0, access type: RW
		uint32 reserved3 : 11;
		uint32 pcieL1 : 1; //Enable GPIO29 for pcie L1 state observation ,   0 : GPIO29 is used as GPIO ,   1 : GPIO29 is used for PCIe L1 state observation. GPIO29 is 0 if PCIe is not in L1 state. GPIO29 is 1 if PCIe is in L1 state, reset value: 0x0, access type: RW
		uint32 reserved4 : 2;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		...
		uint32 reserved0 : 3;
		uint32 pcieSpHsSramRm : 4; //RM configuration for PCIE SP HS memories, reset value: 0x2, access type: RW
		uint32 pcieSpHsSramRme : 1; //RME configuration for PCIE SP HS memories, reset value: 0x0, access type: RW
		uint32 reserved1 : 19;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		...
		uint32 msiXTablePbaSel : 1; //PCIe MSI-X table and PBA select. 0 - MSI-X Table. 1 - MSI-X PBA., reset value: 0x0, access type: RW
		uint32 reserved0 : 15;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		...
		uint32 reserved2 : 3;
		uint32 pcieClk : 1; //PCIE_CLK_OUT: Enable PCIe clock  to GPIO30 out for observation.  ,   0 : Disable. GPIO30 as GPIO ,   1 : Enable. GPIO30 as PCIE Clock Out, reset value: 0x0, access type: RW
...
typedef union
{
	...
	struct
	{
		...
		uint32 reserved0 : 3;
		uint32 chipType : 8; //WAV7712 Chip Type: MXL31712: 0x72, MXL31713: 0x73, MXL31714: 0x74, MXL31715: 0x75, MXL31716: 0x76, reset value: 0x0, access type: RO
...
typedef union
{
	...
	struct
	{
		uint32 gpioPullup1 : 16; //gpio pull up enable 1 : bit 0, 1, --- to 15 are for GPIO16, GPIO17, ---, GPIO31, respectively.  , 0 - GPIO[16--31] pads pull up disable , 1 - GPIO16--31] pads pull up enable, reset value: 0xEFFF, access type: RW
		uint32 reserved0 : 16;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 gpioPulldn1 : 16; //gpio pull down enable 1 : bit 0, 1, --- to 15 are for GPIO16, GPIO17, ---, GPIO31, respectively.  , 0 - GPIO16--31] pads pull down disable , 1 - GPIO16--31] pads pull down enable, reset value: 0x1000, access type: RW
		uint32 reserved0 : 16;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 socSpare0 : 32; //SoC Spare register 0 , Bit 0 is used for LDO_EN_MASK, reset value: 0x0, access type: RW
	} bitFields;
...
//========================================
/* REG_SOC_REGS_RESERVE_LOC0 0x0 */
#define SOC_REGS_RESERVE_LOC0_FIELD_RESERVE_LOC0_MASK                                                             0x0000FFFF
//========================================
/* REG_SOC_REGS_SOFT_RESET 0x4 */
#define SOC_REGS_SOFT_RESET_FIELD_SW_WLAN_RSTN_MASK                                                               0x00000001
#define SOC_REGS_SOFT_RESET_FIELD_SW_CPHY_RSTN_MASK                                                               0x00000002
#define SOC_REGS_SOFT_RESET_FIELD_SW_PHY_RSTN_MASK                                                                0x00000004
#define SOC_REGS_SOFT_RESET_FIELD_SW_PCS_RSTN_MASK                                                                0x00000008
#define SOC_REGS_SOFT_RESET_FIELD_SW_APB_PRESETN_MASK                                                             0x00000010
#define SOC_REGS_SOFT_RESET_FIELD_SW_PCIE0_RSTN_MASK                                                              0x00000040
#define SOC_REGS_SOFT_RESET_FIELD_SW_CHIP_RSTN_MASK                                                               0x00010000
//========================================
/* REG_SOC_REGS_SOFT_RESET_STROBE_ENABLE 0x8 */
#define SOC_REGS_SOFT_RESET_STROBE_ENABLE_FIELD_SW_WLAN_RSTN_EN_MASK                                              0x00000001
#define SOC_REGS_SOFT_RESET_STROBE_ENABLE_FIELD_SW_CPHY_RSTN_EN_MASK                                              0x00000002
#define SOC_REGS_SOFT_RESET_STROBE_ENABLE_FIELD_SW_PHY_RSTN_EN_MASK                                               0x00000004
#define SOC_REGS_SOFT_RESET_STROBE_ENABLE_FIELD_SW_PCS_RSTN_EN_MASK                                               0x00000008
#define SOC_REGS_SOFT_RESET_STROBE_ENABLE_FIELD_SW_APB_PRESETN_EN_MASK                                            0x00000010
#define SOC_REGS_SOFT_RESET_STROBE_ENABLE_FIELD_SW_PCIE0_RSTN_EN_MASK                                             0x00000040
#define SOC_REGS_SOFT_RESET_STROBE_ENABLE_FIELD_SW_CHIP_RSTN_EN_MASK                                              0x00010000
//========================================
/* REG_SOC_REGS_RCU_BOOT 0xC */
#define SOC_REGS_RCU_BOOT_FIELD_RESET_FSM_STATE_MASK                                                              0x00000007
#define SOC_REGS_RCU_BOOT_FIELD_EFUSE_PCIE_OVR_MASK                                                               0x00000020
#define SOC_REGS_RCU_BOOT_FIELD_MSPS_STATUS_MASK                                                                  0x00000100
#define SOC_REGS_RCU_BOOT_FIELD_FUN_STRAP_REG_MASK                                                                0x00003E00
//========================================
/* REG_SOC_REGS_GPIO_PULLUP 0x10 */
#define SOC_REGS_GPIO_PULLUP_FIELD_GPIO_PULLUP_MASK                                                               0x000FFFFF
//========================================
/* REG_SOC_REGS_GPIO_PULLDN 0x14 */
#define SOC_REGS_GPIO_PULLDN_FIELD_GPIO_PULLDN_MASK                                                               0x000FFFFF
//========================================
/* REG_SOC_REGS_GPIO_SLEW_CTRL 0x18 */
#define SOC_REGS_GPIO_SLEW_CTRL_FIELD_GPIO_SLEW_CTRL_MASK                                                         0x000FFFFF
//========================================
/* REG_SOC_REGS_GPIO_DRIVE_CTRL0 0x1C */
#define SOC_REGS_GPIO_DRIVE_CTRL0_FIELD_GPIO_DRIVE_CTRL0_MASK                                                     0x000FFFFF
//========================================
/* REG_SOC_REGS_GPIO_DRIVE_CTRL1 0x20 */
#define SOC_REGS_GPIO_DRIVE_CTRL1_FIELD_GPIO_DRIVE_CTRL1_MASK                                                     0x000FFFFF
//========================================
/* REG_SOC_REGS_GPIO_OPEN_DRAIN 0x24 */
#define SOC_REGS_GPIO_OPEN_DRAIN_FIELD_GPIO_OPEN_DRAIN_MASK                                                       0x000FFFFF
//========================================
/* REG_SOC_REGS_EEPROM_SW_ACCESS 0x28 */
#define SOC_REGS_EEPROM_SW_ACCESS_FIELD_EEPROM_OVERRIDE_MASK                                                      0x00000001
#define SOC_REGS_EEPROM_SW_ACCESS_FIELD_EE_RESV1_MASK                                                             0x0000000E
#define SOC_REGS_EEPROM_SW_ACCESS_FIELD_EE_SCL_IN_MASK                                                            0x00000010
#define SOC_REGS_EEPROM_SW_ACCESS_FIELD_EE_SCL_OUT_MASK                                                           0x00000020
#define SOC_REGS_EEPROM_SW_ACCESS_FIELD_EE_SCL_OE_MASK                                                            0x00000040
#define SOC_REGS_EEPROM_SW_ACCESS_FIELD_EE_SDA_IN_MASK                                                            0x00000100
#define SOC_REGS_EEPROM_SW_ACCESS_FIELD_EE_SDA_OUT_MASK                                                           0x00000200
#define SOC_REGS_EEPROM_SW_ACCESS_FIELD_EE_SDA_OE_MASK                                                            0x00000400
#define SOC_REGS_EEPROM_SW_ACCESS_FIELD_EE_RESV2_MASK                                                             0xFFFFF800
//========================================
/* REG_SOC_REGS_PCIE_EP_CHIP_RST_ENA 0x2C */
#define SOC_REGS_PCIE_EP_CHIP_RST_ENA_FIELD_PCIE0_EP_CHIP_RST_ENA_MASK                                            0x00000001
//========================================
/* REG_SOC_REGS_PCIE_INTR_VEC 0x48 */
#define SOC_REGS_PCIE_INTR_VEC_FIELD_PCIE_INTR_VEC_MASK                                                           0x000000FF
//========================================
/* REG_SOC_REGS_PCIE_MSI_ENABLE 0x4C */
#define SOC_REGS_PCIE_MSI_ENABLE_FIELD_MSI_MSIX_INTR_MODE_MASK                                                    0x00000100
#define SOC_REGS_PCIE_MSI_ENABLE_FIELD_MSIX_TC_MASK                                                               0x00007000
//========================================
/* REG_SOC_REGS_PCIE_LEGACY_INT_ENA 0x50 */
#define SOC_REGS_PCIE_LEGACY_INT_ENA_FIELD_PCIE_LEGACY_INT_ENA_MASK                                               0x00000001
//========================================
/* REG_SOC_REGS_PCIE_DIAG_CTRL_BUS 0x54 */
#define SOC_REGS_PCIE_DIAG_CTRL_BUS_FIELD_PCIE0_DIAG_CTRL_BUS_MASK                                                0x00000007
//========================================
/* REG_SOC_REGS_PCIE_APPS_PM_WAKEUP 0x60 */
#define SOC_REGS_PCIE_APPS_PM_WAKEUP_FIELD_PCIE0_OUTBAND_PWRUP_CMD_MASK                                           0x00000001
#define SOC_REGS_PCIE_APPS_PM_WAKEUP_FIELD_PCIE0_APPS_PM_XMT_PME_MASK                                             0x00000002
#define SOC_REGS_PCIE_APPS_PM_WAKEUP_FIELD_PCIE0_APP_REQ_EXIT_L1_MASK                                             0x00000004
#define SOC_REGS_PCIE_APPS_PM_WAKEUP_FIELD_PCIE0_APP_XFER_PENDING_MASK                                            0x00000008
#define SOC_REGS_PCIE_APPS_PM_WAKEUP_FIELD_PCIE0_APP_XFER_PENDING_WLAN_MASK                                       0x00000010
//========================================
/* REG_SOC_REGS_PCIE0_RADM_STATUS 0x64 */
#define SOC_REGS_PCIE0_RADM_STATUS_FIELD_PCIE0_RADM_CPL_TIMEOUT_MASK                                              0x00000002
#define SOC_REGS_PCIE0_RADM_STATUS_FIELD_PCIE0_RADM_TIMEOUT_FUNC_NUM_MASK                                         0x0000001C
#define SOC_REGS_PCIE0_RADM_STATUS_FIELD_PCIE0_RADM_TIMEOUT_CPL_TC_MASK                                           0x000000E0
#define SOC_REGS_PCIE0_RADM_STATUS_FIELD_PCIE0_RADM_TIMEOUT_CPL_ATTR_MASK                                         0x00000300
#define SOC_REGS_PCIE0_RADM_STATUS_FIELD_PCIE0_RADM_TIMEOUT_CPL_LEN_MASK                                          0x003FFC00
#define SOC_REGS_PCIE0_RADM_STATUS_FIELD_PCIE0_RADM_TIMEOUT_CPL_TAG_MASK                                          0xFFC00000
//========================================
/* REG_SOC_REGS_PCIE_LINK_STATUS 0x68 */
#define SOC_REGS_PCIE_LINK_STATUS_FIELD_PCIE0_RDLH_LINK_UP_MASK                                                   0x00000001
#define SOC_REGS_PCIE_LINK_STATUS_FIELD_PCIE0_PM_CURNT_STATE_MASK                                                 0x0000000E
#define SOC_REGS_PCIE_LINK_STATUS_FIELD_PCIE0_SMLH_LTSSM_STATE_MASK                                               0x000003F0
#define SOC_REGS_PCIE_LINK_STATUS_FIELD_PCIE0_SMLH_LINK_UP_MASK                                                   0x00000400
#define SOC_REGS_PCIE_LINK_STATUS_FIELD_PCIE0_LINK_REQ_RST_NOT_MASK                                               0x00000800
#define SOC_REGS_PCIE_LINK_STATUS_FIELD_PIPE_LANE0_PHYSTATUS_MASK                                                 0x00002000
#define SOC_REGS_PCIE_LINK_STATUS_FIELD_PIPE_LANE1_PHYSTATUS_MASK                                                 0x20000000
//========================================
/* REG_SOC_REGS_EFUSE_DATA 0x70 */
#define SOC_REGS_EFUSE_DATA_FIELD_EFUSE_DATA_MASK                                                                 0xFFFFFFFF
//========================================
/* REG_SOC_REGS_EFUSE_ADDRESS 0x74 */
#define SOC_REGS_EFUSE_ADDRESS_FIELD_EFUSE_ADDR_MASK                                                              0x00001FFF
//========================================
/* REG_SOC_REGS_EFUSE_CONTROL 0x78 */
#define SOC_REGS_EFUSE_CONTROL_FIELD_EFUSE_WR_RDN_MASK                                                            0x00000001
//========================================
/* REG_SOC_REGS_EFUSE_STATUS 0x7C */
#define SOC_REGS_EFUSE_STATUS_FIELD_EFUSE_BUSY_MASK                                                               0x00000001
#define SOC_REGS_EFUSE_STATUS_FIELD_EFUSE_INIT_DONE_MASK                                                          0x00000002
#define SOC_REGS_EFUSE_STATUS_FIELD_EFUSE_FSM_STATE_MASK                                                          0x0000001C
//========================================
/* REG_SOC_REGS_EFUSE_TIMER_CONFIG1 0x80 */
#define SOC_REGS_EFUSE_TIMER_CONFIG1_FIELD_EFUSE_TPGM_MASK                                                        0x0000FFFF
#define SOC_REGS_EFUSE_TIMER_CONFIG1_FIELD_EFUSE_TSU_CS_STROBE_MASK                                               0xFFFF0000
//========================================
/* REG_SOC_REGS_EFUSE_TIMER_CONFIG2 0x84 */
#define SOC_REGS_EFUSE_TIMER_CONFIG2_FIELD_EFUSE_TRD_MASK                                                         0x0000FFFF
#define SOC_REGS_EFUSE_TIMER_CONFIG2_FIELD_EFUSE_TSU_PS_CSB_MASK                                                  0xFFFF0000
//========================================
/* REG_SOC_REGS_EFUSE_PCIE_FSM_OVR 0x88 */
#define SOC_REGS_EFUSE_PCIE_FSM_OVR_FIELD_EFUSE_PCIE_FSM_OVR_MASK                                                 0x00000001
//========================================
/* REG_SOC_REGS_EFUSE_PD 0x8C */
#define SOC_REGS_EFUSE_PD_FIELD_EFUSE_PD_MASK                                                                     0x00000001
//========================================
/* REG_SOC_REGS_WATCHDOG_ENABLE 0x90 */
#define SOC_REGS_WATCHDOG_ENABLE_FIELD_WATCHDOG_ENABLE_MASK                                                       0x00000001
//========================================
/* REG_SOC_REGS_WATCHDOG_RESET 0x94 */
#define SOC_REGS_WATCHDOG_RESET_FIELD_WATCHDOG_RESET_MASK                                                         0x00000001
//========================================
/* REG_SOC_REGS_WATCHDOG_CMP_VALUE 0x98 */
#define SOC_REGS_WATCHDOG_CMP_VALUE_FIELD_WATCHDOG_CMP_VALUE_MASK                                                 0xFFFFFFFF
//========================================
/* REG_SOC_REGS_WATCHDOG_COUNT 0x9C */
#define SOC_REGS_WATCHDOG_COUNT_FIELD_WATCHDOG_COUNT_MASK                                                         0xFFFFFFFF
//========================================
/* REG_SOC_REGS_UART_ENABLE 0xA4 */
#define SOC_REGS_UART_ENABLE_FIELD_UART_ENABLE_MASK                                                               0x00000001
//========================================
/* REG_SOC_REGS_PCIE_MSI_INTR_MODE 0xAC */
#define SOC_REGS_PCIE_MSI_INTR_MODE_FIELD_PCIE_MSI_INTR_MODE_MASK                                                 0x00000003
//========================================
/* REG_SOC_REGS_CHIP_ID 0xB0 */
#define SOC_REGS_CHIP_ID_FIELD_CHIP_ID_MASK                                                                       0xFFFFFFFF
//========================================
/* REG_SOC_REGS_EFUSE_INIT_VECTOR_0 0xB4 */
#define SOC_REGS_EFUSE_INIT_VECTOR_0_FIELD_EFUSE_INIT_VECTOR_0_MASK                                               0xFFFFFFFF
//========================================
/* REG_SOC_REGS_EFUSE_INIT_VECTOR_24 0xB8 */
#define SOC_REGS_EFUSE_INIT_VECTOR_24_FIELD_EFUSE_INIT_VECTOR_24_MASK                                             0xFFFFFFFF
//========================================
/* REG_SOC_REGS_EFUSE_DWORD_ENABLE 0xC0 */
#define SOC_REGS_EFUSE_DWORD_ENABLE_FIELD_EFUSE_DWORD_ENABLE_MASK                                                 0x00000001
//========================================
/* REG_SOC_REGS_EFUSE_DWORD_WR_MAP 0xC4 */
#define SOC_REGS_EFUSE_DWORD_WR_MAP_FIELD_EFUSE_DWORD_WR_MAP_MASK                                                 0xFFFFFFFF
//========================================
/* REG_SOC_REGS_EFUSE_DWORD_RD_DATA 0xC8 */
#define SOC_REGS_EFUSE_DWORD_RD_DATA_FIELD_EFUSE_DWORD_RD_DATA_MASK                                               0xFFFFFFFF
//========================================
/* REG_SOC_REGS_EFUSE_DWORD_CONTROL 0xCC */
#define SOC_REGS_EFUSE_DWORD_CONTROL_FIELD_EFUSE_DWORD_ADDRESS_MASK                                               0x000000FF
#define SOC_REGS_EFUSE_DWORD_CONTROL_FIELD_EFUSE_DWORD_WR_RD_MASK                                                 0x80000000
//========================================
/* REG_SOC_REGS_EFUSE_DWORD_DONE 0xD0 */
#define SOC_REGS_EFUSE_DWORD_DONE_FIELD_EFUSE_DWORD_DONE_MASK                                                     0x00000001
//========================================
/* REG_SOC_REGS_EFUSE_BRIDGE_SOFT_RESET 0xD8 */
#define SOC_REGS_EFUSE_BRIDGE_SOFT_RESET_FIELD_SW_EFUSE_RSTN_MASK                                                 0x00000100
//========================================
/* REG_SOC_REGS_PCIE_APPS_NS_CTRL 0xE8 */
#define SOC_REGS_PCIE_APPS_NS_CTRL_FIELD_PCIE0_RD_TLP_NO_SNOOP_MASK                                               0x00000001
#define SOC_REGS_PCIE_APPS_NS_CTRL_FIELD_PCIE0_WR_TLP_NO_SNOOP_MASK                                               0x00000100
//========================================
/* REG_SOC_REGS_PCIE0_PTM_MANUAL_UPDATE 0xF0 */
#define SOC_REGS_PCIE0_PTM_MANUAL_UPDATE_FIELD_PCIE0_PTM_MAN_UPDATE_MASK                                          0x00000001
//========================================
/* REG_SOC_REGS_PCIE0_PTM_AUTO_UPDATE_SIGNAL 0xF4 */
#define SOC_REGS_PCIE0_PTM_AUTO_UPDATE_SIGNAL_FIELD_PCIE0_PTM_AUTO_UPDATE_SIGNAL_MASK                             0x00010000
//========================================
/* REG_SOC_REGS_PCIE0_PTM_CONTEXT_VALID 0xF8 */
#define SOC_REGS_PCIE0_PTM_CONTEXT_VALID_FIELD_PCIE0_PTM_CONTEXT_VALID_MASK                                       0x00000001
//========================================
/* REG_SOC_REGS_PCIE0_PTM_CLOCK_UPDATED 0xFC */
#define SOC_REGS_PCIE0_PTM_CLOCK_UPDATED_FIELD_PCIE0_PTM_CLOCK_UPDATED_MASK                                       0x00000001
//========================================
/* REG_SOC_REGS_PCIE0_PTM_LOCAL_CLOCK_L 0x110 */
#define SOC_REGS_PCIE0_PTM_LOCAL_CLOCK_L_FIELD_PCIE0_PTM_LOCAL_CLOCK_L_MASK                                       0xFFFFFFFF
//========================================
/* REG_SOC_REGS_PCIE0_PTM_LOCAL_CLOCK_U 0x114 */
#define SOC_REGS_PCIE0_PTM_LOCAL_CLOCK_U_FIELD_PCIE0_PTM_LOCAL_CLOCK_U_MASK                                       0xFFFFFFFF
//========================================
/* REG_SOC_REGS_PCIE0_PTM_CLOCK_CORRECTION_L 0x118 */
#define SOC_REGS_PCIE0_PTM_CLOCK_CORRECTION_L_FIELD_PCIE0_PTM_CLOCK_CORRECTION_L_MASK                             0xFFFFFFFF
//========================================
/* REG_SOC_REGS_PCIE0_PTM_CLOCK_CORRECTION_U 0x11C */
#define SOC_REGS_PCIE0_PTM_CLOCK_CORRECTION_U_FIELD_PCIE0_PTM_CLOCK_CORRECTION_U_MASK                             0xFFFFFFFF
//========================================
/* REG_SOC_REGS_PCIE_GPIO_MUX_CONTROL 0x140 */
#define SOC_REGS_PCIE_GPIO_MUX_CONTROL_FIELD_PCIE_CLKREQ_EN_MASK                                                  0x00000001
#define SOC_REGS_PCIE_GPIO_MUX_CONTROL_FIELD_PCIE_WAKE_EN_MASK                                                    0x00000010
#define SOC_REGS_PCIE_GPIO_MUX_CONTROL_FIELD_VID_MASK                                                             0x00001000
#define SOC_REGS_PCIE_GPIO_MUX_CONTROL_FIELD_VID0_OUT_MASK                                                        0x00010000
#define SOC_REGS_PCIE_GPIO_MUX_CONTROL_FIELD_VID1_OUT_MASK                                                        0x00020000
#define SOC_REGS_PCIE_GPIO_MUX_CONTROL_FIELD_PCIE_L1_MASK                                                         0x20000000
//========================================
/* REG_SOC_REGS_PCIE_PHY_CR_PARA_SEL 0x144 */
#define SOC_REGS_PCIE_PHY_CR_PARA_SEL_FIELD_PCIE_PHY_CR_PARA_SEL_MASK                                             0x00000001
//========================================
/* REG_SOC_REGS_PCIE_MEM_CTRL_SP 0x148 */
#define SOC_REGS_PCIE_MEM_CTRL_SP_FIELD_PCIE_SP_HD_RF_RM_MASK                                                     0x0000000F
#define SOC_REGS_PCIE_MEM_CTRL_SP_FIELD_PCIE_SP_HD_RF_RME_MASK                                                    0x00000010
#define SOC_REGS_PCIE_MEM_CTRL_SP_FIELD_PCIE_SP_HS_SRAM_RM_MASK                                                   0x00000F00
#define SOC_REGS_PCIE_MEM_CTRL_SP_FIELD_PCIE_SP_HS_SRAM_RME_MASK                                                  0x00001000
//========================================
/* REG_SOC_REGS_PCIE_MEM_CTRL_DP 0x14C */
#define SOC_REGS_PCIE_MEM_CTRL_DP_FIELD_PCIE_DP_HD_SRAM_RMA_MASK                                                  0x0000000F
#define SOC_REGS_PCIE_MEM_CTRL_DP_FIELD_PCIE_DP_HD_SRAM_RMEA_MASK                                                 0x00000010
#define SOC_REGS_PCIE_MEM_CTRL_DP_FIELD_PCIE_DP_HD_SRAM_RMB_MASK                                                  0x00000F00
#define SOC_REGS_PCIE_MEM_CTRL_DP_FIELD_PCIE_DP_HD_SRAM_RMEB_MASK                                                 0x00001000
//========================================
/* REG_SOC_REGS_PCIE_MEM_CTRL_TP 0x150 */
#define SOC_REGS_PCIE_MEM_CTRL_TP_FIELD_PCIE_TP_HD_RF_RMA_MASK                                                    0x0000000F
#define SOC_REGS_PCIE_MEM_CTRL_TP_FIELD_PCIE_TP_HD_RF_RMEA_MASK                                                   0x00000010
#define SOC_REGS_PCIE_MEM_CTRL_TP_FIELD_PCIE_TP_HD_RF_RMB_MASK                                                    0x00000F00
#define SOC_REGS_PCIE_MEM_CTRL_TP_FIELD_PCIE_TP_HD_RF_RMEB_MASK                                                   0x00001000
//========================================
/* REG_SOC_REGS_PCIE0_IATU_SEL 0x154 */
#define SOC_REGS_PCIE0_IATU_SEL_FIELD_PCIE0_IATU_SEL_MASK                                                         0x0000FFFF
#define SOC_REGS_PCIE0_IATU_SEL_FIELD_MSI_X_TABLE_PBA_SEL_MASK                                                    0x00010000
//========================================
/* REG_SOC_REGS_DEBUG_OBS_CONTROL 0x180 */
#define SOC_REGS_DEBUG_OBS_CONTROL_FIELD_GPIO_CLK_DIV_VAL_MASK                                                    0x0000FFFF
#define SOC_REGS_DEBUG_OBS_CONTROL_FIELD_GPIO_CLK_SEL_MASK                                                        0x000F0000
#define SOC_REGS_DEBUG_OBS_CONTROL_FIELD_CLK_OBS_EN_MASK                                                          0x01000000
#define SOC_REGS_DEBUG_OBS_CONTROL_FIELD_PHY_DEBUG_EN_MASK                                                        0x04000000
#define SOC_REGS_DEBUG_OBS_CONTROL_FIELD_PCIE_CLK_MASK                                                            0x40000000
#define SOC_REGS_DEBUG_OBS_CONTROL_FIELD_PCIE_RESET_MASK                                                          0x80000000
//========================================
/* REG_SOC_REGS_EFUSE_WLAN 0x190 */
#define SOC_REGS_EFUSE_WLAN_FIELD_FIREWALL_ON_MASK                                                                0x00000001
#define SOC_REGS_EFUSE_WLAN_FIELD_SPI_DISABLE_MASK                                                                0x00000002
#define SOC_REGS_EFUSE_WLAN_FIELD_JTAG_DISABLE_MASK                                                               0x00000004
#define SOC_REGS_EFUSE_WLAN_FIELD_SECURITY_BOOT_ON_MASK                                                           0x00000008
#define SOC_REGS_EFUSE_WLAN_FIELD_SKIP_PLL_INIT_MASK                                                              0x00000010
#define SOC_REGS_EFUSE_WLAN_FIELD_CHIP_TYPE_MASK                                                                  0x0000FF00
#define SOC_REGS_EFUSE_WLAN_FIELD_HW_TYPE_MASK                                                                    0x00FF0000
#define SOC_REGS_EFUSE_WLAN_FIELD_HW_REVISION_MASK                                                                0xFF000000
//========================================
/* REG_SOC_REGS_EFUSE_VID 0x194 */
#define SOC_REGS_EFUSE_VID_FIELD_VID0_MASK                                                                        0x00000001
#define SOC_REGS_EFUSE_VID_FIELD_VID1_MASK                                                                        0x00000002
//========================================
/* REG_SOC_REGS_GPIO_PULLUP1 0x200 */
#define SOC_REGS_GPIO_PULLUP1_FIELD_GPIO_PULLUP1_MASK                                                             0x0000FFFF
//========================================
/* REG_SOC_REGS_GPIO_PULLDN1 0x204 */
#define SOC_REGS_GPIO_PULLDN1_FIELD_GPIO_PULLDN1_MASK                                                             0x0000FFFF
//========================================
/* REG_SOC_REGS_GPIO_SLEW_CTRL1 0x208 */
#define SOC_REGS_GPIO_SLEW_CTRL1_FIELD_GPIO_SLEW_CTRL1_MASK                                                       0x0000FFFF
//========================================
/* REG_SOC_REGS_GPIO_DRIVE1_CTRL0 0x20C */
#define SOC_REGS_GPIO_DRIVE1_CTRL0_FIELD_GPIO_DRIVE1_CTRL0_MASK                                                   0x0000FFFF
//========================================
/* REG_SOC_REGS_GPIO_DRIVE1_CTRL1 0x210 */
#define SOC_REGS_GPIO_DRIVE1_CTRL1_FIELD_GPIO_DRIVE1_CTRL1_MASK                                                   0x0000FFFF
//========================================
/* REG_SOC_REGS_GPIO_OPEN_DRAIN1 0x214 */
#define SOC_REGS_GPIO_OPEN_DRAIN1_FIELD_GPIO_OPEN_DRAIN1_MASK                                                     0x0000FFFF
//========================================
/* REG_SOC_REGS_BME_RESET_MASK 0x220 */
#define SOC_REGS_BME_RESET_MASK_FIELD_BME_MASK_MASK                                                               0x00000001
//========================================
/* REG_SOC_REGS_PCIE_PHY_SRAM 0x224 */
#define SOC_REGS_PCIE_PHY_SRAM_FIELD_SRAM_UPDATE_MASK                                                             0x00000001
#define SOC_REGS_PCIE_PHY_SRAM_FIELD_LTSSM_MASK                                                                   0x00000010
#define SOC_REGS_PCIE_PHY_SRAM_FIELD_LTSSM_EN_MUX_SEL_MASK                                                        0x00001000
//========================================
/* REG_SOC_REGS_SOC_SPARE_REG0 0x230 */
#define SOC_REGS_SOC_SPARE_REG0_FIELD_SOC_SPARE0_MASK                                                             0xFFFFFFFF
//========================================
/* REG_SOC_REGS_SOC_SPARE_REG1 0x234 */
#define SOC_REGS_SOC_SPARE_REG1_FIELD_SOC_SPARE1_MASK                                                             0xFFFFFFFF
//========================================
/* REG_SOC_REGS_SOC_SPARE_REG2 0x238 */
#define SOC_REGS_SOC_SPARE_REG2_FIELD_SOC_SPARE2_MASK                                                             0xFFFFFFFF
//========================================
/* REG_SOC_REGS_SOC_SPARE_REG3 0x23C */
#define SOC_REGS_SOC_SPARE_REG3_FIELD_SOC_SPARE3_MASK                                                             0xFFFFFFFF
//========================================
/* REG_SOC_REGS_SOC_PCIE_DEBUG_REG0 0x240 */
#define SOC_REGS_SOC_PCIE_DEBUG_REG0_FIELD_PCIE0_PHY_RST_N_MASK                                                   0x00000001
#define SOC_REGS_SOC_PCIE_DEBUG_REG0_FIELD_PCIE0_PHY_RESET_MASK                                                   0x00000002
#define SOC_REGS_SOC_PCIE_DEBUG_REG0_FIELD_PCIE0_PWR_RST_N_MASK                                                   0x00000004
#define SOC_REGS_SOC_PCIE_DEBUG_REG0_FIELD_PCIE0_AUXCLK_POWER_UP_RST_N_MASK                                       0x00000008
#define SOC_REGS_SOC_PCIE_DEBUG_REG0_FIELD_PCIE0_SYNC_POWER_UP_RST_N_MASK                                         0x00000010
#define SOC_REGS_SOC_PCIE_DEBUG_REG0_FIELD_PCIE0_SYNC_SOFT_WARM_RST_N_MASK                                        0x00000020
#define SOC_REGS_SOC_PCIE_DEBUG_REG0_FIELD_PCIE0_SYNC_BUTTON_RST_N_MASK                                           0x00000040
#define SOC_REGS_SOC_PCIE_DEBUG_REG0_FIELD_PCIE0_PLCLK_LINK_DOWN_RST_N_MASK                                       0x00000080
#define SOC_REGS_SOC_PCIE_DEBUG_REG0_FIELD_PCIE0_AUXCLK_LINK_DOWN_RST_N_MASK                                      0x00000200
#define SOC_REGS_SOC_PCIE_DEBUG_REG0_FIELD_PCIE0_PM_REQ_PHY_RST_MASK                                              0x00000400
#define SOC_REGS_SOC_PCIE_DEBUG_REG0_FIELD_PCIE0_PM_REQ_CORE_RST_MASK                                             0x00000800
#define SOC_REGS_SOC_PCIE_DEBUG_REG0_FIELD_PCIE0_PM_SEL_AUXCLK_MASK                                               0x00001000
#define SOC_REGS_SOC_PCIE_DEBUG_REG0_FIELD_PCIE0_AUXCLK_SEL_REG_MASK                                              0x00002000
#define SOC_REGS_SOC_PCIE_DEBUG_REG0_FIELD_PCIE0_AUXCLK_SEL_CORECLK_MASK                                          0x00004000
#define SOC_REGS_SOC_PCIE_DEBUG_REG0_FIELD_PCIE0_AUXCLK_EN_MASK                                                   0x00008000
#define SOC_REGS_SOC_PCIE_DEBUG_REG0_FIELD_PCIE0_CORECLK_ACTIVE_MASK                                              0x00010000
#define SOC_REGS_SOC_PCIE_DEBUG_REG0_FIELD_PCIE0_PM_EN_CORE_CLK_MASK                                              0x00020000
#define SOC_REGS_SOC_PCIE_DEBUG_REG0_FIELD_CLOCK_SELECT_MASK                                                      0x00700000
#define SOC_REGS_SOC_PCIE_DEBUG_REG0_FIELD_RESET_SELECT_MASK                                                      0x1F000000
//========================================
/* REG_SOC_REGS_SOC_PCIE_DEBUG_REG1 0x244 */
#define SOC_REGS_SOC_PCIE_DEBUG_REG1_FIELD_DEBUG_CONTROL_MASK                                                     0x0000FFFF
