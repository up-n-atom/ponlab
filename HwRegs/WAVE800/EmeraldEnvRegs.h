...
#define	REG_EMERALD_ENV_HW_EVENTS3A_INTERRUPTS           (EMERALD_ENV_BASE_ADDRESS + 0x2C0)
#define	REG_EMERALD_ENV_HW_EVENTS3B_INTERRUPTS           (EMERALD_ENV_BASE_ADDRESS + 0x2C4)
#define	REG_EMERALD_ENV_HW_ERRORS3_INTERRUPTS            (EMERALD_ENV_BASE_ADDRESS + 0x2C8)
#define	REG_EMERALD_ENV_HW_EVENTS3A_INT_EN               (EMERALD_ENV_BASE_ADDRESS + 0x2CC)
#define	REG_EMERALD_ENV_HW_EVENTS3B_INT_EN               (EMERALD_ENV_BASE_ADDRESS + 0x2D0)
#define	REG_EMERALD_ENV_HW_ERRORS3_INT_EN                (EMERALD_ENV_BASE_ADDRESS + 0x2D4)
#define	REG_EMERALD_ENV_HW_EVENTS3A_MASKED_INTERRUPTS    (EMERALD_ENV_BASE_ADDRESS + 0x2D8)
#define	REG_EMERALD_ENV_HW_EVENTS3B_MASKED_INTERRUPTS    (EMERALD_ENV_BASE_ADDRESS + 0x2DC)
#define	REG_EMERALD_ENV_HW_ERRORS3_MASKED_INTERRUPTS     (EMERALD_ENV_BASE_ADDRESS + 0x2E0)
/*---------------------------------------------------------------------------------
...
typedef union
{
	...
	struct
	{
		uint32 chipId : 16; //Chip ID, reset value: 0xA00, access type: RO
...
typedef union
{
	...
	struct
	{
		uint32 gpioOutputEnable : 32; //GPIO Output enable, reset value: 0x0, access type: RW
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 gpioData : 32; //GPIO Data, reset value: 0x0, access type: RW
	} bitFields;
...
typedef union
{
	...
	struct
	{
		...
		uint32 timer0SleepCntMode : 1; //Set '1' to count clock cycles of CPU sleep state. Prescaler is bypassed. Count value is 32 bits wide, single clock resolution., reset value: 0x0, access type: RW
		uint32 timer1SleepCntMode : 1; //Set '1' to count clock cycles of CPU sleep state. Prescaler is bypassed. Count value is 32 bits wide, single clock resolution., reset value: 0x0, access type: RW
		uint32 timer2SleepCntMode : 1; //Set '1' to count clock cycles of CPU sleep state. Prescaler is bypassed. Count value is 32 bits wide, single clock resolution., reset value: 0x0, access type: RW
		uint32 timer3SleepCntMode : 1; //Set '1' to count clock cycles of CPU sleep state. Prescaler is bypassed. Count value is 32 bits wide, single clock resolution., reset value: 0x0, access type: RW
		uint32 reserved0 : 24;
	} bitFields;
...
/*REG_EMERALD_ENV_HW_EVENTS3A_INTERRUPTS 0x2C0 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 hwEvents3AInterrupts : 32; //no description, reset value: 0x0, access type: RO
	} bitFields;
} RegEmeraldEnvHwEvents3AInterrupts_u;

/*REG_EMERALD_ENV_HW_EVENTS3B_INTERRUPTS 0x2C4 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 hwEvents3BInterrupts : 32; //no description, reset value: 0x0, access type: RO
	} bitFields;
} RegEmeraldEnvHwEvents3BInterrupts_u;

/*REG_EMERALD_ENV_HW_ERRORS3_INTERRUPTS 0x2C8 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 hwErrors3Interrupts : 32; //no description, reset value: 0x0, access type: RO
	} bitFields;
} RegEmeraldEnvHwErrors3Interrupts_u;

/*REG_EMERALD_ENV_HW_EVENTS3A_INT_EN 0x2CC */
typedef union
{
	uint32 val;
	struct
	{
		uint32 hwEvents3AIntEn : 32; //no description, reset value: 0x0, access type: RW
	} bitFields;
} RegEmeraldEnvHwEvents3AIntEn_u;

/*REG_EMERALD_ENV_HW_EVENTS3B_INT_EN 0x2D0 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 hwEvents3BIntEn : 32; //no description, reset value: 0x0, access type: RW
	} bitFields;
} RegEmeraldEnvHwEvents3BIntEn_u;

/*REG_EMERALD_ENV_HW_ERRORS3_INT_EN 0x2D4 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 hwErrors3IntEn : 32; //no description, reset value: 0x0, access type: RW
	} bitFields;
} RegEmeraldEnvHwErrors3IntEn_u;

/*REG_EMERALD_ENV_HW_EVENTS3A_MASKED_INTERRUPTS 0x2D8 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 hwEvents3AMaskedInterrupts : 32; //no description, reset value: 0x0, access type: RO
	} bitFields;
} RegEmeraldEnvHwEvents3AMaskedInterrupts_u;

/*REG_EMERALD_ENV_HW_EVENTS3B_MASKED_INTERRUPTS 0x2DC */
typedef union
{
	uint32 val;
	struct
	{
		uint32 hwEvents3BMaskedInterrupts : 32; //no description, reset value: 0x0, access type: RO
	} bitFields;
} RegEmeraldEnvHwEvents3BMaskedInterrupts_u;

/*REG_EMERALD_ENV_HW_ERRORS3_MASKED_INTERRUPTS 0x2E0 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 hwErrors3MaskedInterrupts : 32; //no description, reset value: 0x0, access type: RO
	} bitFields;
} RegEmeraldEnvHwErrors3MaskedInterrupts_u;

//========================================
/* REG_EMERALD_ENV_SYS_IF_GCLK 0x0 */
#define EMERALD_ENV_SYS_IF_GCLK_FIELD_UART_RX_GCLK_MASK                                                           0x00000001
#define EMERALD_ENV_SYS_IF_GCLK_FIELD_UART_RX_FIFO_GCLK_MASK                                                      0x00000002
#define EMERALD_ENV_SYS_IF_GCLK_FIELD_UART_TX_GCLK_MASK                                                           0x00000004
#define EMERALD_ENV_SYS_IF_GCLK_FIELD_UART_TX_FIFO_GCLK_MASK                                                      0x00000008
#define EMERALD_ENV_SYS_IF_GCLK_FIELD_UART_CDIV_GCLK_MASK                                                         0x00000010
#define EMERALD_ENV_SYS_IF_GCLK_FIELD_CACHE_CTRS_GCLK_MASK                                                        0x00000020
#define EMERALD_ENV_SYS_IF_GCLK_FIELD_TIMERS_GCLK_MASK                                                            0x00000040
#define EMERALD_ENV_SYS_IF_GCLK_FIELD_TEST_BUS_FIFO_GCLK_MASK                                                     0x00000080
//========================================
/* REG_EMERALD_ENV_SYS_IF_SW_RESET 0x4 */
#define EMERALD_ENV_SYS_IF_SW_RESET_FIELD_UART_RX_SW_RESET_MASK                                                   0x00000001
#define EMERALD_ENV_SYS_IF_SW_RESET_FIELD_UART_RX_FIFO_SW_RESET_MASK                                              0x00000002
#define EMERALD_ENV_SYS_IF_SW_RESET_FIELD_UART_TX_SW_RESET_MASK                                                   0x00000004
#define EMERALD_ENV_SYS_IF_SW_RESET_FIELD_UART_TX_FIFO_SW_RESET_MASK                                              0x00000008
#define EMERALD_ENV_SYS_IF_SW_RESET_FIELD_UART_CDIV_SW_RESET_MASK                                                 0x00000010
#define EMERALD_ENV_SYS_IF_SW_RESET_FIELD_CACHE_CTRS_SW_RESET_MASK                                                0x00000020
#define EMERALD_ENV_SYS_IF_SW_RESET_FIELD_TIMERS_GCLK_SW_RESET_MASK                                               0x00000040
#define EMERALD_ENV_SYS_IF_SW_RESET_FIELD_TEST_BUS_FIFO_SW_RESET_MASK                                             0x00000080
//========================================
/* REG_EMERALD_ENV_UART_WR 0xC */
#define EMERALD_ENV_UART_WR_FIELD_UART_WRITE_DATA_MASK                                                            0x000000FF
//========================================
/* REG_EMERALD_ENV_UART_RD 0x10 */
#define EMERALD_ENV_UART_RD_FIELD_UART_READ_DATA_MASK                                                             0x000000FF
#define EMERALD_ENV_UART_RD_FIELD_UART_READ_PARITY_ERROR_BIT_MASK                                                 0x00000100
//========================================
/* REG_EMERALD_ENV_UART_DIVR 0x14 */
#define EMERALD_ENV_UART_DIVR_FIELD_UART_CLOCK_DIVISION_RATIO_MASK                                                0x00003FFF
//========================================
/* REG_EMERALD_ENV_UART_FWL_REG 0x18 */
#define EMERALD_ENV_UART_FWL_REG_FIELD_UART_RX_FIFO_WATER_LEVEL_MASK                                              0x0000001F
#define EMERALD_ENV_UART_FWL_REG_FIELD_UART_TX_FIFO_WATER_LEVEL_MASK                                              0x000003E0
//========================================
/* REG_EMERALD_ENV_UART_INT_REG 0x1C */
#define EMERALD_ENV_UART_INT_REG_FIELD_UART_OVERRUN_IRQ_ENABLE_MASK                                               0x00000001
#define EMERALD_ENV_UART_INT_REG_FIELD_UART_FRAMING_ERROR_IRQ_ENABLE_MASK                                         0x00000002
#define EMERALD_ENV_UART_INT_REG_FIELD_UART_PARITY_ERROR_IRQ_ENABLE_MASK                                          0x00000004
#define EMERALD_ENV_UART_INT_REG_FIELD_UART_READ_COLLAPSE_BUFFER_IRQ_ENABLE_MASK                                  0x00000008
#define EMERALD_ENV_UART_INT_REG_FIELD_UART_WRITE_COLLAPSE_BUFFER_IRQ_ENABLE_MASK                                 0x00000010
#define EMERALD_ENV_UART_INT_REG_FIELD_UART_READ_FIFO_WATER_LEVEL_IRQ_ENABLE_MASK                                 0x00000020
#define EMERALD_ENV_UART_INT_REG_FIELD_UART_WRITE_FIFO_WATER_LEVEL_IRQ_ENABLE_MASK                                0x00000040
#define EMERALD_ENV_UART_INT_REG_FIELD_UART_IDLE_IRQ_ENABLE_MASK                                                  0x00000080
#define EMERALD_ENV_UART_INT_REG_FIELD_UART_OVERRUN_IRQ_MASK                                                      0x00000100
#define EMERALD_ENV_UART_INT_REG_FIELD_UART_FRAMING_ERROR_IRQ_MASK                                                0x00000200
#define EMERALD_ENV_UART_INT_REG_FIELD_UART_PARITY_ERROR_IRQ_MASK                                                 0x00000400
#define EMERALD_ENV_UART_INT_REG_FIELD_UART_READ_COLLAPSE_BUFFER_IRQ_MASK                                         0x00000800
#define EMERALD_ENV_UART_INT_REG_FIELD_UART_WRITE_COLLAPSE_BUFFER_IRQ_MASK                                        0x00001000
#define EMERALD_ENV_UART_INT_REG_FIELD_UART_READ_FIFO_WATER_LEVEL_IRQ_MASK                                        0x00002000
#define EMERALD_ENV_UART_INT_REG_FIELD_UART_WRITE_FIFO_WATER_LEVEL_IRQ_MASK                                       0x00004000
#define EMERALD_ENV_UART_INT_REG_FIELD_UART_IDLE_IRQ_MASK                                                         0x00008000
//========================================
/* REG_EMERALD_ENV_UART_CONTROL_REG 0x20 */
#define EMERALD_ENV_UART_CONTROL_REG_FIELD_UART_TX_OUTPUT_ENABLE_MASK                                             0x00000001
#define EMERALD_ENV_UART_CONTROL_REG_FIELD_UART_RX_PARITY_MODE_MASK                                               0x00000006
#define EMERALD_ENV_UART_CONTROL_REG_FIELD_UART_TX_PARITY_MODE_MASK                                               0x00000018
#define EMERALD_ENV_UART_CONTROL_REG_FIELD_UART_RX_STOP_MASK                                                      0x00000020
#define EMERALD_ENV_UART_CONTROL_REG_FIELD_UART_TX_STOP_MASK                                                      0x00000040
#define EMERALD_ENV_UART_CONTROL_REG_FIELD_UART_LOOPBACK_MODE_MASK                                                0x00000080
//========================================
/* REG_EMERALD_ENV_UART_NOISE_COUNT 0x24 */
#define EMERALD_ENV_UART_NOISE_COUNT_FIELD_UART_NOISE_COUNTER_CLEAR_MASK                                          0x00000001
#define EMERALD_ENV_UART_NOISE_COUNT_FIELD_UART_NOISE_COUNTER_MASK                                                0x000001FE
//========================================
/* REG_EMERALD_ENV_UART_IDLE_CNT_MAX 0x28 */
#define EMERALD_ENV_UART_IDLE_CNT_MAX_FIELD_UART_RX_IDLE_COUNTER_MASK                                             0x000000FF
//========================================
/* REG_EMERALD_ENV_UART_COUNT_FIF 0x2C */
#define EMERALD_ENV_UART_COUNT_FIF_FIELD_UART_BYTES_IN_RX_FIFO_MASK                                               0x0000001F
#define EMERALD_ENV_UART_COUNT_FIF_FIELD_UART_BYTES_IN_TX_FIFO_MASK                                               0x000003E0
//========================================
/* REG_EMERALD_ENV_UART_INT_MODE 0x30 */
#define EMERALD_ENV_UART_INT_MODE_FIELD_UART_TX_INTERRUPT_MODE_MASK                                               0x00000001
//========================================
/* REG_EMERALD_ENV_PLL_DIV 0x40 */
#define EMERALD_ENV_PLL_DIV_FIELD_TEST_CLK_DIV_D2A_MASK                                                           0x00000003
#define EMERALD_ENV_PLL_DIV_FIELD_WLAN_CLK_DIV_D2A_MASK                                                           0x0000000C
#define EMERALD_ENV_PLL_DIV_FIELD_ADC_CLK_DIV_D2A_MASK                                                            0x00000030
#define EMERALD_ENV_PLL_DIV_FIELD_DAC_CLK_DIV_D2A_MASK                                                            0x000000C0
#define EMERALD_ENV_PLL_DIV_FIELD_SSI_CLK_DIV_D2A_MASK                                                            0x00000300
#define EMERALD_ENV_PLL_DIV_FIELD_LCPLL_DIVIDER_INT_D2A_MASK                                                      0x00FF0000
//========================================
/* REG_EMERALD_ENV_PLL_EN 0x44 */
#define EMERALD_ENV_PLL_EN_FIELD_TEST_CLK_PDN_D2A_MASK                                                            0x00000001
#define EMERALD_ENV_PLL_EN_FIELD_WLAN_CLK_PDN_D2A_MASK                                                            0x00000002
#define EMERALD_ENV_PLL_EN_FIELD_ADC_CLK_PDN_D2A_MASK                                                             0x00000004
#define EMERALD_ENV_PLL_EN_FIELD_DAC_CLK_PDN_D2A_MASK                                                             0x00000008
#define EMERALD_ENV_PLL_EN_FIELD_SSI_CLK_PDN_D2A_MASK                                                             0x00000010
//========================================
/* REG_EMERALD_ENV_PLL_CTL 0x48 */
#define EMERALD_ENV_PLL_CTL_FIELD_LCPLL_PUP_D2A_MASK                                                              0x00000080
#define EMERALD_ENV_PLL_CTL_FIELD_LCPLL_RESETN_D2A_MASK                                                           0x00000100
#define EMERALD_ENV_PLL_CTL_FIELD_LCPLL_BYPASS_D2A_MASK                                                           0x00000200
#define EMERALD_ENV_PLL_CTL_FIELD_FCSI_LDO_PD_D2A_MASK                                                            0x00002000
#define EMERALD_ENV_PLL_CTL_FIELD_USB_SPND_WUP_D2A_MASK                                                           0x00004000
//========================================
/* REG_EMERALD_ENV_PLL_LOCK 0x50 */
#define EMERALD_ENV_PLL_LOCK_FIELD_PLL_LOCK_MASK                                                                  0x00000001
//========================================
/* REG_EMERALD_ENV_CPU_ENABLE 0x54 */
#define EMERALD_ENV_CPU_ENABLE_FIELD_CPU_ENABLE_MASK                                                              0x00000001
//========================================
/* REG_EMERALD_ENV_CLOCK_SELECT 0x58 */
#define EMERALD_ENV_CLOCK_SELECT_FIELD_CPU_CLOCK_SELECT_MASK                                                      0x00000003
//========================================
/* REG_EMERALD_ENV_SYSTEM_INFO 0x60 */
#define EMERALD_ENV_SYSTEM_INFO_FIELD_CHIP_ID_MASK                                                                0x0000FFFF
#define EMERALD_ENV_SYSTEM_INFO_FIELD_BOOT_MODE_MASK                                                              0x00030000
#define EMERALD_ENV_SYSTEM_INFO_FIELD_CPU_ID_MASK                                                                 0x000C0000
//========================================
/* REG_EMERALD_ENV_SECURE_WRITE 0x68 */
#define EMERALD_ENV_SECURE_WRITE_FIELD_SECURE_WRITE_MASK                                                          0x0000FFFF
//========================================
/* REG_EMERALD_ENV_GPIO_SEL 0x70 */
#define EMERALD_ENV_GPIO_SEL_FIELD_CLKGEN_CLK_ON_GPIO_MASK                                                        0x00000008
#define EMERALD_ENV_GPIO_SEL_FIELD_GENRISC_GPO_SELECTED_MASK                                                      0x00000010
#define EMERALD_ENV_GPIO_SEL_FIELD_SELECT_PHY_SIGNALS_MASK                                                        0x00000020
#define EMERALD_ENV_GPIO_SEL_FIELD_GPIO_DIV_BYPASS_MASK                                                           0x00000040
//========================================
/* REG_EMERALD_ENV_MIPS_CTL 0x74 */
#define EMERALD_ENV_MIPS_CTL_FIELD_BOOT_MODE_REQ_MASK                                                             0x00000003
#define EMERALD_ENV_MIPS_CTL_FIELD_MIPS_SW_RESET_N_REG_MASK                                                       0x00000010
//========================================
/* REG_EMERALD_ENV_TOP_MUX 0x78 */
#define EMERALD_ENV_TOP_MUX_FIELD_LVDS_XO_SEL_MASK                                                                0x00000001
#define EMERALD_ENV_TOP_MUX_FIELD_MODEM_XO_SEL_MASK                                                               0x00000002
#define EMERALD_ENV_TOP_MUX_FIELD_MODEM_PRE_DIV_MASK                                                              0x00000004
#define EMERALD_ENV_TOP_MUX_FIELD_CPU_PHY_DIV_MASK                                                                0x00000018
#define EMERALD_ENV_TOP_MUX_FIELD_CPU_PHY_DIV_ENABLE_MASK                                                         0x00000020
//========================================
/* REG_EMERALD_ENV_BB_OPMODE_STATUS 0x7C */
#define EMERALD_ENV_BB_OPMODE_STATUS_FIELD_BB_OPMODE_STATUS_MASK                                                  0x0000FFFF
//========================================
/* REG_EMERALD_ENV_GPIO_OEN 0x80 */
#define EMERALD_ENV_GPIO_OEN_FIELD_GPIO_OUTPUT_ENABLE_MASK                                                        0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_GPIO_DAT 0x84 */
#define EMERALD_ENV_GPIO_DAT_FIELD_GPIO_DATA_MASK                                                                 0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_GPIO_STB_LEN 0x88 */
#define EMERALD_ENV_GPIO_STB_LEN_FIELD_GPIO_STROBE_LENGTH_MASK                                                    0x0000001F
//========================================
/* REG_EMERALD_ENV_GPO_REG 0x8C */
#define EMERALD_ENV_GPO_REG_FIELD_GPO_REGISTER_MASK                                                               0x0000FFFF
//========================================
/* REG_EMERALD_ENV_GPIO_ACTIVE 0x90 */
#define EMERALD_ENV_GPIO_ACTIVE_FIELD_GPIO_ACTIVE_MASK                                                            0x00000001
//========================================
/* REG_EMERALD_ENV_LS_MODE 0xB0 */
#define EMERALD_ENV_LS_MODE_FIELD_LS_FORCE_DISABLE_MASK                                                           0x00000001
#define EMERALD_ENV_LS_MODE_FIELD_LS_FORCE_ENABLE_MASK                                                            0x00000002
#define EMERALD_ENV_LS_MODE_FIELD_LS_DYNAMIC_MASK                                                                 0x00000004
//========================================
/* REG_EMERALD_ENV_CPU_SPARE_GC_CONTROL 0xB8 */
#define EMERALD_ENV_CPU_SPARE_GC_CONTROL_FIELD_CPU_SPARE_GC_BYPASS_MASK                                           0x0000000F
#define EMERALD_ENV_CPU_SPARE_GC_CONTROL_FIELD_CPU_SPARE_GC_ENABLE_MASK                                           0x000000F0
//========================================
/* REG_EMERALD_ENV_CPU_GPR 0xC0 */
#define EMERALD_ENV_CPU_GPR_FIELD_CPU_GPR_MASK                                                                    0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_CPU_GPO 0xC4 */
#define EMERALD_ENV_CPU_GPO_FIELD_CPU_GPO_MASK                                                                    0x0000FFFF
//========================================
/* REG_EMERALD_ENV_CPU_GPI1 0xC8 */
#define EMERALD_ENV_CPU_GPI1_FIELD_CPU_GPI1_MASK                                                                  0x0000FFFF
//========================================
/* REG_EMERALD_ENV_CPU_GPI2 0xCC */
#define EMERALD_ENV_CPU_GPI2_FIELD_CPU_GPI2_MASK                                                                  0x0000FFFF
//========================================
/* REG_EMERALD_ENV_RAM_CTL_ADDR 0xD0 */
#define EMERALD_ENV_RAM_CTL_ADDR_FIELD_RAM_TEST_RNM_MASK                                                          0x00000001
#define EMERALD_ENV_RAM_CTL_ADDR_FIELD_RAM_TEST_MODE_MASK                                                         0x00000002
#define EMERALD_ENV_RAM_CTL_ADDR_FIELD_MEM_GLOBAL_RM_MASK                                                         0x0000000C
//========================================
/* REG_EMERALD_ENV_M4K_RAMS_RM 0xD4 */
#define EMERALD_ENV_M4K_RAMS_RM_FIELD_M4K_RAMS_RM_MASK                                                            0x03FFFFFF
//========================================
/* REG_EMERALD_ENV_IRAM_RM 0xD8 */
#define EMERALD_ENV_IRAM_RM_FIELD_IRAM_RM_MASK                                                                    0x3FFFFFFF
//========================================
/* REG_EMERALD_ENV_ERAM_RM 0xDC */
#define EMERALD_ENV_ERAM_RM_FIELD_ERAM_RM_MASK                                                                    0x003FFFFF
//========================================
/* REG_EMERALD_ENV_CPU_GPR1 0xE0 */
#define EMERALD_ENV_CPU_GPR1_FIELD_CPU_GPR1_MASK                                                                  0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_CPU_GPR2 0xE4 */
#define EMERALD_ENV_CPU_GPR2_FIELD_CPU_GPR2_MASK                                                                  0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_CPU_GPR3 0xE8 */
#define EMERALD_ENV_CPU_GPR3_FIELD_CPU_GPR3_MASK                                                                  0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_SPARE_CONFIG_MAC_IN 0xF0 */
#define EMERALD_ENV_SPARE_CONFIG_MAC_IN_FIELD_SPARE_CONFIG_MAC_IN_MASK                                            0x0000FFFF
//========================================
/* REG_EMERALD_ENV_SPARE_CONFIG_MAC_OUT 0xF4 */
#define EMERALD_ENV_SPARE_CONFIG_MAC_OUT_FIELD_SPARE_CONFIG_MAC_OUT_MASK                                          0x0000FFFF
//========================================
/* REG_EMERALD_ENV_SWDOG_BOOT_CNT 0x100 */
#define EMERALD_ENV_SWDOG_BOOT_CNT_FIELD_SW_WATCHDOG_COUNT_VALUE_FOR_NMI_MASK                                     0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_SWDOG_INT_CNT 0x104 */
#define EMERALD_ENV_SWDOG_INT_CNT_FIELD_SW_WATCHDOG_COUNT_VALUE_FOR_IRQ_MASK                                      0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_SWDOG_MASK 0x108 */
#define EMERALD_ENV_SWDOG_MASK_FIELD_SW_WATCHDOG_MASK_MASK                                                        0x00000001
//========================================
/* REG_EMERALD_ENV_SWDOG_BOOT_CTR 0x10C */
#define EMERALD_ENV_SWDOG_BOOT_CTR_FIELD_SW_WATCHDOG_COUNTER_VALUE_FOR_NMI_MASK                                   0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_SWDOG_INT_CTR 0x110 */
#define EMERALD_ENV_SWDOG_INT_CTR_FIELD_SW_WATCHDOG_COUNTER_VALUE_FOR_IRQ_MASK                                    0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_IRQ_MASK 0x140 */
#define EMERALD_ENV_IRQ_MASK_FIELD_IRQ_MASK_MASK                                                                  0xFFFFFFFE
//========================================
/* REG_EMERALD_ENV_IRQ_MAP_00 0x148 */
#define EMERALD_ENV_IRQ_MAP_00_FIELD_IRQ_SOURCE_01_MAPPING_MASK                                                   0x0000001F
#define EMERALD_ENV_IRQ_MAP_00_FIELD_IRQ_SOURCE_02_MAPPING_MASK                                                   0x000003E0
#define EMERALD_ENV_IRQ_MAP_00_FIELD_IRQ_SOURCE_03_MAPPING_MASK                                                   0x00007C00
#define EMERALD_ENV_IRQ_MAP_00_FIELD_IRQ_SOURCE_04_MAPPING_MASK                                                   0x000F8000
#define EMERALD_ENV_IRQ_MAP_00_FIELD_IRQ_SOURCE_05_MAPPING_MASK                                                   0x01F00000
#define EMERALD_ENV_IRQ_MAP_00_FIELD_IRQ_SOURCE_06_MAPPING_MASK                                                   0x3E000000
//========================================
/* REG_EMERALD_ENV_IRQ_MAP_01 0x14C */
#define EMERALD_ENV_IRQ_MAP_01_FIELD_IRQ_SOURCE_07_MAPPING_MASK                                                   0x0000001F
#define EMERALD_ENV_IRQ_MAP_01_FIELD_IRQ_SOURCE_08_MAPPING_MASK                                                   0x000003E0
#define EMERALD_ENV_IRQ_MAP_01_FIELD_IRQ_SOURCE_09_MAPPING_MASK                                                   0x00007C00
#define EMERALD_ENV_IRQ_MAP_01_FIELD_IRQ_SOURCE_10_MAPPING_MASK                                                   0x000F8000
#define EMERALD_ENV_IRQ_MAP_01_FIELD_IRQ_SOURCE_11_MAPPING_MASK                                                   0x01F00000
#define EMERALD_ENV_IRQ_MAP_01_FIELD_IRQ_SOURCE_12_MAPPING_MASK                                                   0x3E000000
//========================================
/* REG_EMERALD_ENV_IRQ_MAP_02 0x150 */
#define EMERALD_ENV_IRQ_MAP_02_FIELD_IRQ_SOURCE_13_MAPPING_MASK                                                   0x0000001F
#define EMERALD_ENV_IRQ_MAP_02_FIELD_IRQ_SOURCE_14_MAPPING_MASK                                                   0x000003E0
#define EMERALD_ENV_IRQ_MAP_02_FIELD_IRQ_SOURCE_15_MAPPING_MASK                                                   0x00007C00
#define EMERALD_ENV_IRQ_MAP_02_FIELD_IRQ_SOURCE_16_MAPPING_MASK                                                   0x000F8000
#define EMERALD_ENV_IRQ_MAP_02_FIELD_IRQ_SOURCE_17_MAPPING_MASK                                                   0x01F00000
#define EMERALD_ENV_IRQ_MAP_02_FIELD_IRQ_SOURCE_18_MAPPING_MASK                                                   0x3E000000
//========================================
/* REG_EMERALD_ENV_IRQ_MAP_03 0x154 */
#define EMERALD_ENV_IRQ_MAP_03_FIELD_IRQ_SOURCE_19_MAPPING_MASK                                                   0x0000001F
#define EMERALD_ENV_IRQ_MAP_03_FIELD_IRQ_SOURCE_20_MAPPING_MASK                                                   0x000003E0
#define EMERALD_ENV_IRQ_MAP_03_FIELD_IRQ_SOURCE_21_MAPPING_MASK                                                   0x00007C00
#define EMERALD_ENV_IRQ_MAP_03_FIELD_IRQ_SOURCE_22_MAPPING_MASK                                                   0x000F8000
#define EMERALD_ENV_IRQ_MAP_03_FIELD_IRQ_SOURCE_23_MAPPING_MASK                                                   0x01F00000
#define EMERALD_ENV_IRQ_MAP_03_FIELD_IRQ_SOURCE_24_MAPPING_MASK                                                   0x3E000000
//========================================
/* REG_EMERALD_ENV_IRQ_MAP_04 0x158 */
#define EMERALD_ENV_IRQ_MAP_04_FIELD_IRQ_SOURCE_25_MAPPING_MASK                                                   0x0000001F
#define EMERALD_ENV_IRQ_MAP_04_FIELD_IRQ_SOURCE_26_MAPPING_MASK                                                   0x000003E0
#define EMERALD_ENV_IRQ_MAP_04_FIELD_IRQ_SOURCE_27_MAPPING_MASK                                                   0x00007C00
#define EMERALD_ENV_IRQ_MAP_04_FIELD_IRQ_SOURCE_28_MAPPING_MASK                                                   0x000F8000
#define EMERALD_ENV_IRQ_MAP_04_FIELD_IRQ_SOURCE_29_MAPPING_MASK                                                   0x01F00000
#define EMERALD_ENV_IRQ_MAP_04_FIELD_IRQ_SOURCE_30_MAPPING_MASK                                                   0x3E000000
//========================================
/* REG_EMERALD_ENV_IRQ_MAP_05 0x15C */
#define EMERALD_ENV_IRQ_MAP_05_FIELD_IRQ_SOURCE_31_MAPPING_MASK                                                   0x0000001F
//========================================
/* REG_EMERALD_ENV_IRQ_MAPPED 0x160 */
#define EMERALD_ENV_IRQ_MAPPED_FIELD_MAPPED_IRQS_FROM_MAPPER_MASK                                                 0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_IRQ_UNMAPPED 0x164 */
#define EMERALD_ENV_IRQ_UNMAPPED_FIELD_UNMAPPED_IRQS_TO_MAPPER_MASK                                               0x7FFFFFFF
//========================================
/* REG_EMERALD_ENV_TIMERS_IRQ_EN 0x174 */
#define EMERALD_ENV_TIMERS_IRQ_EN_FIELD_TIMER0_IRQ_EN_MASK                                                        0x00000001
#define EMERALD_ENV_TIMERS_IRQ_EN_FIELD_TIMER1_IRQ_EN_MASK                                                        0x00000002
#define EMERALD_ENV_TIMERS_IRQ_EN_FIELD_TIMER2_IRQ_EN_MASK                                                        0x00000004
#define EMERALD_ENV_TIMERS_IRQ_EN_FIELD_TIMER3_IRQ_EN_MASK                                                        0x00000008
//========================================
/* REG_EMERALD_ENV_TIMER0_PRESCALER 0x178 */
#define EMERALD_ENV_TIMER0_PRESCALER_FIELD_TIMER0_PRESCALER_MASK                                                  0x00000FFF
//========================================
/* REG_EMERALD_ENV_TIMER1_PRESCALER 0x17C */
#define EMERALD_ENV_TIMER1_PRESCALER_FIELD_TIMER1_PRESCALER_MASK                                                  0x00000FFF
//========================================
/* REG_EMERALD_ENV_TIMER0_MAX_COUNT 0x180 */
#define EMERALD_ENV_TIMER0_MAX_COUNT_FIELD_TIMER_0_MAX_COUNT_MASK                                                 0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_TIMER1_MAX_COUNT 0x184 */
#define EMERALD_ENV_TIMER1_MAX_COUNT_FIELD_TIMER_1_MAX_COUNT_MASK                                                 0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_TIMER2_MAX_COUNT 0x188 */
#define EMERALD_ENV_TIMER2_MAX_COUNT_FIELD_TIMER_2_MAX_COUNT_MASK                                                 0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_TIMER3_MAX_COUNT 0x18C */
#define EMERALD_ENV_TIMER3_MAX_COUNT_FIELD_TIMER_3_MAX_COUNT_MASK                                                 0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_TIMER0_CTR 0x190 */
#define EMERALD_ENV_TIMER0_CTR_FIELD_TIMER_0_COUNT_VALUE_MASK                                                     0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_TIMER1_CTR 0x194 */
#define EMERALD_ENV_TIMER1_CTR_FIELD_TIMER_1_COUNT_VALUE_MASK                                                     0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_TIMER2_CTR 0x198 */
#define EMERALD_ENV_TIMER2_CTR_FIELD_TIMER_2_COUNT_VALUE_MASK                                                     0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_TIMER3_CTR 0x19C */
#define EMERALD_ENV_TIMER3_CTR_FIELD_TIMER_3_COUNT_VALUE_MASK                                                     0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_TIMERS_EXPIRATION_STATUS 0x1A0 */
#define EMERALD_ENV_TIMERS_EXPIRATION_STATUS_FIELD_TIMER0_EXPIRED_MASK                                            0x00000001
#define EMERALD_ENV_TIMERS_EXPIRATION_STATUS_FIELD_TIMER1_EXPIRED_MASK                                            0x00000002
#define EMERALD_ENV_TIMERS_EXPIRATION_STATUS_FIELD_TIMER2_EXPIRED_MASK                                            0x00000004
#define EMERALD_ENV_TIMERS_EXPIRATION_STATUS_FIELD_TIMER3_EXPIRED_MASK                                            0x00000008
//========================================
/* REG_EMERALD_ENV_TIMERS_CONFIG 0x1A4 */
#define EMERALD_ENV_TIMERS_CONFIG_FIELD_TIMER_0_ONESHOT_MODE_MASK                                                 0x00000001
#define EMERALD_ENV_TIMERS_CONFIG_FIELD_TIMER_1_ONESHOT_MODE_MASK                                                 0x00000002
#define EMERALD_ENV_TIMERS_CONFIG_FIELD_TIMER_2_ONESHOT_MODE_MASK                                                 0x00000004
#define EMERALD_ENV_TIMERS_CONFIG_FIELD_TIMER_3_ONESHOT_MODE_MASK                                                 0x00000008
#define EMERALD_ENV_TIMERS_CONFIG_FIELD_TIMER_0_SLEEP_CNT_MODE_MASK                                               0x00000010
#define EMERALD_ENV_TIMERS_CONFIG_FIELD_TIMER_1_SLEEP_CNT_MODE_MASK                                               0x00000020
#define EMERALD_ENV_TIMERS_CONFIG_FIELD_TIMER_2_SLEEP_CNT_MODE_MASK                                               0x00000040
#define EMERALD_ENV_TIMERS_CONFIG_FIELD_TIMER_3_SLEEP_CNT_MODE_MASK                                               0x00000080
//========================================
/* REG_EMERALD_ENV_TIMER2_PRESCALER 0x1A8 */
#define EMERALD_ENV_TIMER2_PRESCALER_FIELD_TIMER2_PRESCALER_MASK                                                  0x00000FFF
//========================================
/* REG_EMERALD_ENV_TIMER3_PRESCALER 0x1AC */
#define EMERALD_ENV_TIMER3_PRESCALER_FIELD_TIMER3_PRESCALER_MASK                                                  0x00000FFF
//========================================
/* REG_EMERALD_ENV_TIMERS_CONTROL 0x1B0 */
#define EMERALD_ENV_TIMERS_CONTROL_FIELD_TIMER0_ENABLE_MASK                                                       0x00000001
#define EMERALD_ENV_TIMERS_CONTROL_FIELD_TIMER1_ENABLE_MASK                                                       0x00000002
#define EMERALD_ENV_TIMERS_CONTROL_FIELD_TIMER2_ENABLE_MASK                                                       0x00000004
#define EMERALD_ENV_TIMERS_CONTROL_FIELD_TIMER3_ENABLE_MASK                                                       0x00000008
#define EMERALD_ENV_TIMERS_CONTROL_FIELD_TIMER0_DISABLE_MASK                                                      0x00000010
#define EMERALD_ENV_TIMERS_CONTROL_FIELD_TIMER1_DISABLE_MASK                                                      0x00000020
#define EMERALD_ENV_TIMERS_CONTROL_FIELD_TIMER2_DISABLE_MASK                                                      0x00000040
#define EMERALD_ENV_TIMERS_CONTROL_FIELD_TIMER3_DISABLE_MASK                                                      0x00000080
//========================================
/* REG_EMERALD_ENV_TIMERS_STATUS 0x1B4 */
#define EMERALD_ENV_TIMERS_STATUS_FIELD_TIMER0_ACTIVE_MASK                                                        0x00000001
#define EMERALD_ENV_TIMERS_STATUS_FIELD_TIMER1_ACTIVE_MASK                                                        0x00000002
#define EMERALD_ENV_TIMERS_STATUS_FIELD_TIMER2_ACTIVE_MASK                                                        0x00000004
#define EMERALD_ENV_TIMERS_STATUS_FIELD_TIMER3_ACTIVE_MASK                                                        0x00000008
//========================================
/* REG_EMERALD_ENV_CPU_GPI3 0x1F0 */
#define EMERALD_ENV_CPU_GPI3_FIELD_FPGA_VERSION_MASK                                                              0x000000FF
#define EMERALD_ENV_CPU_GPI3_FIELD_WLAN_IP_VER_MASK                                                               0x0000FF00
#define EMERALD_ENV_CPU_GPI3_FIELD_PROTO_TYPE_MASK                                                                0x000F0000
#define EMERALD_ENV_CPU_GPI3_FIELD_RELEASE_NUM_MASK                                                               0x0FF00000
#define EMERALD_ENV_CPU_GPI3_FIELD_RELEASE_TYPE_MASK                                                              0x10000000
#define EMERALD_ENV_CPU_GPI3_FIELD_RESERVED_MASK                                                                  0xE0000000
//========================================
/* REG_EMERALD_ENV_HW_EVENTS0A_INTERRUPTS 0x200 */
#define EMERALD_ENV_HW_EVENTS0A_INTERRUPTS_FIELD_HW_EVENTS0A_INTERRUPTS_MASK                                      0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_EVENTS0B_INTERRUPTS 0x204 */
#define EMERALD_ENV_HW_EVENTS0B_INTERRUPTS_FIELD_HW_EVENTS0B_INTERRUPTS_MASK                                      0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_EVENTS1A_INTERRUPTS 0x208 */
#define EMERALD_ENV_HW_EVENTS1A_INTERRUPTS_FIELD_HW_EVENTS1A_INTERRUPTS_MASK                                      0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_EVENTS1B_INTERRUPTS 0x20C */
#define EMERALD_ENV_HW_EVENTS1B_INTERRUPTS_FIELD_HW_EVENTS1B_INTERRUPTS_MASK                                      0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_EVENTS2A_INTERRUPTS 0x210 */
#define EMERALD_ENV_HW_EVENTS2A_INTERRUPTS_FIELD_HW_EVENTS2A_INTERRUPTS_MASK                                      0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_EVENTS2B_INTERRUPTS 0x214 */
#define EMERALD_ENV_HW_EVENTS2B_INTERRUPTS_FIELD_HW_EVENTS2B_INTERRUPTS_MASK                                      0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_ERRORS0_INTERRUPTS 0x218 */
#define EMERALD_ENV_HW_ERRORS0_INTERRUPTS_FIELD_HW_ERRORS0_INTERRUPTS_MASK                                        0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_ERRORS1_INTERRUPTS 0x21C */
#define EMERALD_ENV_HW_ERRORS1_INTERRUPTS_FIELD_HW_ERRORS1_INTERRUPTS_MASK                                        0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_ERRORS2_INTERRUPTS 0x220 */
#define EMERALD_ENV_HW_ERRORS2_INTERRUPTS_FIELD_HW_ERRORS2_INTERRUPTS_MASK                                        0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_EVENTS0A_INT_EN 0x240 */
#define EMERALD_ENV_HW_EVENTS0A_INT_EN_FIELD_HW_EVENTS0A_INT_EN_MASK                                              0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_EVENTS0B_INT_EN 0x244 */
#define EMERALD_ENV_HW_EVENTS0B_INT_EN_FIELD_HW_EVENTS0B_INT_EN_MASK                                              0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_EVENTS1A_INT_EN 0x248 */
#define EMERALD_ENV_HW_EVENTS1A_INT_EN_FIELD_HW_EVENTS1A_INT_EN_MASK                                              0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_EVENTS1B_INT_EN 0x24C */
#define EMERALD_ENV_HW_EVENTS1B_INT_EN_FIELD_HW_EVENTS1B_INT_EN_MASK                                              0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_EVENTS2A_INT_EN 0x250 */
#define EMERALD_ENV_HW_EVENTS2A_INT_EN_FIELD_HW_EVENTS2A_INT_EN_MASK                                              0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_EVENTS2B_INT_EN 0x254 */
#define EMERALD_ENV_HW_EVENTS2B_INT_EN_FIELD_HW_EVENTS2B_INT_EN_MASK                                              0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_ERRORS0_INT_EN 0x258 */
#define EMERALD_ENV_HW_ERRORS0_INT_EN_FIELD_HW_ERRORS0_INT_EN_MASK                                                0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_ERRORS1_INT_EN 0x25C */
#define EMERALD_ENV_HW_ERRORS1_INT_EN_FIELD_HW_ERRORS1_INT_EN_MASK                                                0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_ERRORS2_INT_EN 0x260 */
#define EMERALD_ENV_HW_ERRORS2_INT_EN_FIELD_HW_ERRORS2_INT_EN_MASK                                                0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_EVENTS0A_MASKED_INTERRUPTS 0x280 */
#define EMERALD_ENV_HW_EVENTS0A_MASKED_INTERRUPTS_FIELD_HW_EVENTS0A_MASKED_INTERRUPTS_MASK                        0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_EVENTS0B_MASKED_INTERRUPTS 0x284 */
#define EMERALD_ENV_HW_EVENTS0B_MASKED_INTERRUPTS_FIELD_HW_EVENTS0B_MASKED_INTERRUPTS_MASK                        0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_EVENTS1A_MASKED_INTERRUPTS 0x288 */
#define EMERALD_ENV_HW_EVENTS1A_MASKED_INTERRUPTS_FIELD_HW_EVENTS1A_MASKED_INTERRUPTS_MASK                        0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_EVENTS1B_MASKED_INTERRUPTS 0x28C */
#define EMERALD_ENV_HW_EVENTS1B_MASKED_INTERRUPTS_FIELD_HW_EVENTS1B_MASKED_INTERRUPTS_MASK                        0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_EVENTS2A_MASKED_INTERRUPTS 0x290 */
#define EMERALD_ENV_HW_EVENTS2A_MASKED_INTERRUPTS_FIELD_HW_EVENTS2A_MASKED_INTERRUPTS_MASK                        0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_EVENTS2B_MASKED_INTERRUPTS 0x294 */
#define EMERALD_ENV_HW_EVENTS2B_MASKED_INTERRUPTS_FIELD_HW_EVENTS2B_MASKED_INTERRUPTS_MASK                        0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_ERRORS0_MASKED_INTERRUPTS 0x298 */
#define EMERALD_ENV_HW_ERRORS0_MASKED_INTERRUPTS_FIELD_HW_ERRORS0_MASKED_INTERRUPTS_MASK                          0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_ERRORS1_MASKED_INTERRUPTS 0x29C */
#define EMERALD_ENV_HW_ERRORS1_MASKED_INTERRUPTS_FIELD_HW_ERRORS1_MASKED_INTERRUPTS_MASK                          0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_ERRORS2_MASKED_INTERRUPTS 0x2A0 */
#define EMERALD_ENV_HW_ERRORS2_MASKED_INTERRUPTS_FIELD_HW_ERRORS2_MASKED_INTERRUPTS_MASK                          0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_EVENTS3A_INTERRUPTS 0x2C0 */
#define EMERALD_ENV_HW_EVENTS3A_INTERRUPTS_FIELD_HW_EVENTS3A_INTERRUPTS_MASK                                      0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_EVENTS3B_INTERRUPTS 0x2C4 */
#define EMERALD_ENV_HW_EVENTS3B_INTERRUPTS_FIELD_HW_EVENTS3B_INTERRUPTS_MASK                                      0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_ERRORS3_INTERRUPTS 0x2C8 */
#define EMERALD_ENV_HW_ERRORS3_INTERRUPTS_FIELD_HW_ERRORS3_INTERRUPTS_MASK                                        0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_EVENTS3A_INT_EN 0x2CC */
#define EMERALD_ENV_HW_EVENTS3A_INT_EN_FIELD_HW_EVENTS3A_INT_EN_MASK                                              0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_EVENTS3B_INT_EN 0x2D0 */
#define EMERALD_ENV_HW_EVENTS3B_INT_EN_FIELD_HW_EVENTS3B_INT_EN_MASK                                              0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_ERRORS3_INT_EN 0x2D4 */
#define EMERALD_ENV_HW_ERRORS3_INT_EN_FIELD_HW_ERRORS3_INT_EN_MASK                                                0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_EVENTS3A_MASKED_INTERRUPTS 0x2D8 */
#define EMERALD_ENV_HW_EVENTS3A_MASKED_INTERRUPTS_FIELD_HW_EVENTS3A_MASKED_INTERRUPTS_MASK                        0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_EVENTS3B_MASKED_INTERRUPTS 0x2DC */
#define EMERALD_ENV_HW_EVENTS3B_MASKED_INTERRUPTS_FIELD_HW_EVENTS3B_MASKED_INTERRUPTS_MASK                        0xFFFFFFFF
//========================================
/* REG_EMERALD_ENV_HW_ERRORS3_MASKED_INTERRUPTS 0x2E0 */
#define EMERALD_ENV_HW_ERRORS3_MASKED_INTERRUPTS_FIELD_HW_ERRORS3_MASKED_INTERRUPTS_MASK                          0xFFFFFFFF
