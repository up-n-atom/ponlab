...
#define PHY_RX_BE_IF_BASE_ADDRESS             MEMORY_MAP_UNIT_201_BASE_ADDRESS
...
#define	REG_PHY_RX_BE_IF_PHY_RXBE_IF189          (PHY_RX_BE_IF_BASE_ADDRESS + 0x1620)
...
#define	REG_PHY_RX_BE_IF_PHY_RXBE_IF18F          (PHY_RX_BE_IF_BASE_ADDRESS + 0x163C)
...
#define	REG_PHY_RX_BE_IF_PHY_RXBE_IF196          (PHY_RX_BE_IF_BASE_ADDRESS + 0x1658)
...
#define	REG_PHY_RX_BE_IF_PHY_RXBE_IF1EF          (PHY_RX_BE_IF_BASE_ADDRESS + 0x17BC)
#define	REG_PHY_RX_BE_IF_PHY_RXBE_IF1F0          (PHY_RX_BE_IF_BASE_ADDRESS + 0x17C0)
#define	REG_PHY_RX_BE_IF_PHY_RXBE_IF1F4          (PHY_RX_BE_IF_BASE_ADDRESS + 0x17C4)
#define	REG_PHY_RX_BE_IF_PHY_RXBE_IF1F8          (PHY_RX_BE_IF_BASE_ADDRESS + 0x17C8)
#define	REG_PHY_RX_BE_IF_PHY_RXBE_IF1FC          (PHY_RX_BE_IF_BASE_ADDRESS + 0x17CC)
#define	REG_PHY_RX_BE_IF_PAC_PHY_PACKET_TYPE     (PHY_RX_BE_IF_BASE_ADDRESS + 0x17D0)
/*---------------------------------------------------------------------------------
...
} RegPhyRxBeIfPacPhyPacketType_u;
