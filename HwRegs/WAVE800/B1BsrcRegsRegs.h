...
************************************************************************************/
#ifndef _B1_BSRC_REGS_REGS_H_
#define _B1_BSRC_REGS_REGS_H_
...
#define B1_BSRC_REGS_BASE_ADDRESS                             MEMORY_MAP_UNIT_10016_BASE_ADDRESS
#define	REG_B1_BSRC_REGS_GLOBAL_REG                             (B1_BSRC_REGS_BASE_ADDRESS + 0x0)
#define	REG_B1_BSRC_REGS_SENDER_INT_STATUS                      (B1_BSRC_REGS_BASE_ADDRESS + 0x4)
#define	REG_B1_BSRC_REGS_SENDER_INT_EN                          (B1_BSRC_REGS_BASE_ADDRESS + 0x8)
#define	REG_B1_BSRC_REGS_SENDER_CLEAR_INT                       (B1_BSRC_REGS_BASE_ADDRESS + 0xC)
#define	REG_B1_BSRC_REGS_INT_STATUS                             (B1_BSRC_REGS_BASE_ADDRESS + 0x10)
#define	REG_B1_BSRC_REGS_INT_EN                                 (B1_BSRC_REGS_BASE_ADDRESS + 0x14)
#define	REG_B1_BSRC_REGS_CLEAR_INT                              (B1_BSRC_REGS_BASE_ADDRESS + 0x18)
#define	REG_B1_BSRC_REGS_INT_ERROR_STATUS                       (B1_BSRC_REGS_BASE_ADDRESS + 0x1C)
#define	REG_B1_BSRC_REGS_INT_ERROR_EN                           (B1_BSRC_REGS_BASE_ADDRESS + 0x20)
#define	REG_B1_BSRC_REGS_CLEAR_INT_ERROR                        (B1_BSRC_REGS_BASE_ADDRESS + 0x24)
#define	REG_B1_BSRC_REGS_AGER_CFG                               (B1_BSRC_REGS_BASE_ADDRESS + 0x28)
#define	REG_B1_BSRC_REGS_SENDER_INDIRECT_ACCESS                 (B1_BSRC_REGS_BASE_ADDRESS + 0x2C)
#define	REG_B1_BSRC_REGS_SENDER_AGER_PERIOD                     (B1_BSRC_REGS_BASE_ADDRESS + 0x30)
#define	REG_B1_BSRC_REGS_SENDER_BUF_STS_CNT_1_0                 (B1_BSRC_REGS_BASE_ADDRESS + 0x34)
#define	REG_B1_BSRC_REGS_SENDER_BUF_STS_CNT_3_2                 (B1_BSRC_REGS_BASE_ADDRESS + 0x38)
#define	REG_B1_BSRC_REGS_SENDER_BUF_STS_CNT_5_4                 (B1_BSRC_REGS_BASE_ADDRESS + 0x3C)
#define	REG_B1_BSRC_REGS_SENDER_BUF_STS_CNT_7_6                 (B1_BSRC_REGS_BASE_ADDRESS + 0x40)
#define	REG_B1_BSRC_REGS_FW_INDIRECT_ACCESS                     (B1_BSRC_REGS_BASE_ADDRESS + 0x44)
#define	REG_B1_BSRC_REGS_FW_AGER_PERIOD                         (B1_BSRC_REGS_BASE_ADDRESS + 0x48)
#define	REG_B1_BSRC_REGS_FW_BUF_STS_CNT_1_0                     (B1_BSRC_REGS_BASE_ADDRESS + 0x4C)
#define	REG_B1_BSRC_REGS_FW_BUF_STS_CNT_3_2                     (B1_BSRC_REGS_BASE_ADDRESS + 0x50)
#define	REG_B1_BSRC_REGS_FW_BUF_STS_CNT_5_4                     (B1_BSRC_REGS_BASE_ADDRESS + 0x54)
#define	REG_B1_BSRC_REGS_FW_BUF_STS_CNT_7_6                     (B1_BSRC_REGS_BASE_ADDRESS + 0x58)
#define	REG_B1_BSRC_REGS_NDPFB_CFG0                             (B1_BSRC_REGS_BASE_ADDRESS + 0x5C)
#define	REG_B1_BSRC_REGS_NDPFB_CFG1                             (B1_BSRC_REGS_BASE_ADDRESS + 0x60)
#define	REG_B1_BSRC_REGS_NDPFB_CFG2                             (B1_BSRC_REGS_BASE_ADDRESS + 0x64)
#define	REG_B1_BSRC_REGS_NDPFB_REPORT_FIFO_BASE_ADDR            (B1_BSRC_REGS_BASE_ADDRESS + 0x68)
#define	REG_B1_BSRC_REGS_NDPFB_REPORT_FIFO_DEPTH_MINUS_ONE      (B1_BSRC_REGS_BASE_ADDRESS + 0x6C)
#define	REG_B1_BSRC_REGS_NDPFB_REPORT_FIFO_CLEAR_STRB           (B1_BSRC_REGS_BASE_ADDRESS + 0x70)
#define	REG_B1_BSRC_REGS_NDPFB_REPORT_FIFO_RD_ENTRIES_NUM       (B1_BSRC_REGS_BASE_ADDRESS + 0x74)
#define	REG_B1_BSRC_REGS_NDPFB_REPORT_FIFO_NUM_ENTRIES_COUNT    (B1_BSRC_REGS_BASE_ADDRESS + 0x78)
#define	REG_B1_BSRC_REGS_NDPFB_REPORT_FIFO_DEBUG                (B1_BSRC_REGS_BASE_ADDRESS + 0x7C)
#define	REG_B1_BSRC_REGS_LOGGER_REG                             (B1_BSRC_REGS_BASE_ADDRESS + 0x80)
#define	REG_B1_BSRC_REGS_LOGGER_FILTER                          (B1_BSRC_REGS_BASE_ADDRESS + 0x84)
#define	REG_B1_BSRC_REGS_FIFO_STATUS0                           (B1_BSRC_REGS_BASE_ADDRESS + 0x88)
#define	REG_B1_BSRC_REGS_FIFO_STATUS1                           (B1_BSRC_REGS_BASE_ADDRESS + 0x8C)
#define	REG_B1_BSRC_REGS_FSM_STATUS                             (B1_BSRC_REGS_BASE_ADDRESS + 0x90)
#define	REG_B1_BSRC_REGS_SPARE_REG                              (B1_BSRC_REGS_BASE_ADDRESS + 0xA0)
/*---------------------------------------------------------------------------------
/						Data Type Definition										
/----------------------------------------------------------------------------------*/
/*REG_B1_BSRC_REGS_GLOBAL_REG 0x0 */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsGlobalReg_u;

/*REG_B1_BSRC_REGS_SENDER_INT_STATUS 0x4 */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsSenderIntStatus_u;

/*REG_B1_BSRC_REGS_SENDER_INT_EN 0x8 */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsSenderIntEn_u;

/*REG_B1_BSRC_REGS_SENDER_CLEAR_INT 0xC */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsSenderClearInt_u;

/*REG_B1_BSRC_REGS_INT_STATUS 0x10 */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsIntStatus_u;

/*REG_B1_BSRC_REGS_INT_EN 0x14 */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsIntEn_u;

/*REG_B1_BSRC_REGS_CLEAR_INT 0x18 */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsClearInt_u;

/*REG_B1_BSRC_REGS_INT_ERROR_STATUS 0x1C */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsIntErrorStatus_u;

/*REG_B1_BSRC_REGS_INT_ERROR_EN 0x20 */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsIntErrorEn_u;

/*REG_B1_BSRC_REGS_CLEAR_INT_ERROR 0x24 */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsClearIntError_u;

/*REG_B1_BSRC_REGS_AGER_CFG 0x28 */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsAgerCfg_u;

/*REG_B1_BSRC_REGS_SENDER_INDIRECT_ACCESS 0x2C */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsSenderIndirectAccess_u;

/*REG_B1_BSRC_REGS_SENDER_AGER_PERIOD 0x30 */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsSenderAgerPeriod_u;

/*REG_B1_BSRC_REGS_SENDER_BUF_STS_CNT_1_0 0x34 */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsSenderBufStsCnt10_u;

/*REG_B1_BSRC_REGS_SENDER_BUF_STS_CNT_3_2 0x38 */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsSenderBufStsCnt32_u;

/*REG_B1_BSRC_REGS_SENDER_BUF_STS_CNT_5_4 0x3C */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsSenderBufStsCnt54_u;

/*REG_B1_BSRC_REGS_SENDER_BUF_STS_CNT_7_6 0x40 */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsSenderBufStsCnt76_u;

/*REG_B1_BSRC_REGS_FW_INDIRECT_ACCESS 0x44 */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsFwIndirectAccess_u;

/*REG_B1_BSRC_REGS_FW_AGER_PERIOD 0x48 */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsFwAgerPeriod_u;

/*REG_B1_BSRC_REGS_FW_BUF_STS_CNT_1_0 0x4C */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsFwBufStsCnt10_u;

/*REG_B1_BSRC_REGS_FW_BUF_STS_CNT_3_2 0x50 */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsFwBufStsCnt32_u;

/*REG_B1_BSRC_REGS_FW_BUF_STS_CNT_5_4 0x54 */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsFwBufStsCnt54_u;

/*REG_B1_BSRC_REGS_FW_BUF_STS_CNT_7_6 0x58 */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsFwBufStsCnt76_u;

/*REG_B1_BSRC_REGS_NDPFB_CFG0 0x5C */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsNdpfbCfg0_u;

/*REG_B1_BSRC_REGS_NDPFB_CFG1 0x60 */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsNdpfbCfg1_u;

/*REG_B1_BSRC_REGS_NDPFB_CFG2 0x64 */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsNdpfbCfg2_u;

/*REG_B1_BSRC_REGS_NDPFB_REPORT_FIFO_BASE_ADDR 0x68 */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsNdpfbReportFifoBaseAddr_u;

/*REG_B1_BSRC_REGS_NDPFB_REPORT_FIFO_DEPTH_MINUS_ONE 0x6C */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsNdpfbReportFifoDepthMinusOne_u;

/*REG_B1_BSRC_REGS_NDPFB_REPORT_FIFO_CLEAR_STRB 0x70 */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsNdpfbReportFifoClearStrb_u;

/*REG_B1_BSRC_REGS_NDPFB_REPORT_FIFO_RD_ENTRIES_NUM 0x74 */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsNdpfbReportFifoRdEntriesNum_u;

/*REG_B1_BSRC_REGS_NDPFB_REPORT_FIFO_NUM_ENTRIES_COUNT 0x78 */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsNdpfbReportFifoNumEntriesCount_u;

/*REG_B1_BSRC_REGS_NDPFB_REPORT_FIFO_DEBUG 0x7C */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsNdpfbReportFifoDebug_u;

/*REG_B1_BSRC_REGS_LOGGER_REG 0x80 */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsLoggerReg_u;

/*REG_B1_BSRC_REGS_LOGGER_FILTER 0x84 */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsLoggerFilter_u;

/*REG_B1_BSRC_REGS_FIFO_STATUS0 0x88 */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsFifoStatus0_u;

/*REG_B1_BSRC_REGS_FIFO_STATUS1 0x8C */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsFifoStatus1_u;

/*REG_B1_BSRC_REGS_FSM_STATUS 0x90 */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsFsmStatus_u;

/*REG_B1_BSRC_REGS_SPARE_REG 0xA0 */
typedef union
{
	uint32 val;
	struct
...
} RegB1BsrcRegsSpareReg_u;



#endif // _B1_BSRC_REGS_REGS_H_
