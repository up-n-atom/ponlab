...
#define	REG_TX_HANDLER_ASPM_CONTROL                        (TX_HANDLER_BASE_ADDRESS + 0x14)
...
#define	REG_TX_HANDLER_DEBUG_MU_EDCA_TIMER_RESOLUTION      (TX_HANDLER_BASE_ADDRESS + 0xB0)
...
} RegTxHandlerDebugMuEdcaTimerResolution_u;
