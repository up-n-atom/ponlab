...
/** \brief Field SN - Sequence Number */
#define CCW_EIPX_TR_CCW_SN_MASK 0x30000000u
...
/**@{*/
/** \brief MACsec Cipher Suites for data encryption  */
enum crypto_algorithm {
	/** \brief GCM-AES-128 (32-bit packet number, 128-bit key) */
	GCM_AES_128 = 1,
	/** \brief GCM-AES-256 (32-bit packet number, 256-bit key) */
	GCM_AES_256 = 2,
	/** \brief Extendede PN GCM-AES-128 (64-bit packet number, 128-bit key) */
	GCM_AES_XPN_128 = 3,
	/** \brief Extended PN GCM-AES-256 (64-bit packet number, 256-bit key) */
	GCM_AES_XPN_256 = 4,
};
...
struct ctx_ctrl_word {
	...
	u8 an;
	/** \brief Sequence number type. (Deprecated - should be derived from \ref
	crypto_algorithm enum). Valid values are defined in \ref seq_type enum */
