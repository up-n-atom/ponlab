...
int gpy211_add_txsa(struct sk_buff *skb, struct genl_info *info)
{
	...
	msec_data->egr_data.trans_rec.ccw.ca_type = 5;
	...
	msec_data->egr_data.trans_rec.sa_index = 0;
	...
	//User need update all below vars.
	msec_data->egr_data.sam_param.rule_index = 0;
	...
	//User need update all below vars.
	msec_data->egr_data.sam_fca.flow_index = 0;
	...
	msec_data->egr_data.sam_eex.eex_type = SAM_ENTRY_ENABLE;
...
int gpy211_add_rxsa(struct sk_buff *skb, struct genl_info *info)
{
	...
	//Set to default values
	msec_data->ing_data.trans_rec.ccw.ca_type = 5;
	...
	msec_data->ing_data.sam_eex.eex_type = SAM_ENTRY_ENABLE;
