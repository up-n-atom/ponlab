...
#define DC_DP_F_FLAG_LIST  \
    ...
    DC_DP_F_ENUM_OR_STRING(DC_DP_F_FAST_WLAN, 0x00000100, "WLAN"), \
    DC_DP_F_ENUM_OR_STRING(DC_DP_F_FAST_DSL, 0x00000200, "DSL"), \
    DC_DP_F_ENUM_OR_STRING(DC_DP_F_FAST_WLAN_2_4G, 0x00001000, "2.4G"), \
    DC_DP_F_ENUM_OR_STRING(DC_DP_F_FAST_WLAN_5G, 0x00002000, "5G"), \
    DC_DP_F_ENUM_OR_STRING(DC_DP_F_FAST_WLAN_6G, 0x00004000, "6G"), \
    DC_DP_F_ENUM_OR_STRING(DC_DP_F_FAST_WLAN_EXT, 0x00008000, "EXT"), \
    DC_DP_F_ENUM_OR_STRING(DC_DP_F_MULTI_PORT, 0x00010000, "MULTI"), \
    DC_DP_F_ENUM_OR_STRING(DC_DP_F_SHARED_RES, 0x00020000, "SHARED")
...
static struct proc_ops g_dc_dp_dbg_proc_fops = {
    .proc_open    = proc_read_dc_dp_dbg_seq_open,
    .proc_read    = seq_read,
    .proc_write   = proc_write_dc_dp_dbg,
    .proc_lseek   = seq_lseek,
    .proc_release = seq_release,
};

static struct proc_ops g_dc_dp_dev_proc_fops = {
    .proc_open    = proc_read_dc_dp_dev_open,
    .proc_read    = seq_read,
#if 0
    .proc_write   = proc_write_dc_dp_dev,
#endif
    .proc_lseek   = seq_lseek,
    .proc_release = single_release,
};

static struct proc_ops g_dc_dp_dcmode_proc_fops = {
    .proc_open      = proc_read_dc_dp_dcmode_open,
    .proc_read      = seq_read,
    .proc_lseek     = seq_lseek,
    .proc_release   = single_release,
};

static struct proc_ops g_dc_dp_protodb_proc_fops = {
    .proc_open    = proc_read_dc_dp_protodb_open,
    .proc_read    = seq_read,
    .proc_write   = proc_write_dc_dp_protodb,
    .proc_lseek   = seq_lseek,
    .proc_release = single_release,
};
#else
