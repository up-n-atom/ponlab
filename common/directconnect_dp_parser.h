...
/* Macro definitions for handling under size Rx packets */
#define DCDP_UNDERSZ_PKT_DW0_BIT_POS		18
...
dc_dp_pad_is_available(struct sk_buff *skb)
{
	...
	return test_bit(DCDP_UNDERSZ_PKT_DW0_BIT_POS, (unsigned long *)&skb->DW0);
#else
