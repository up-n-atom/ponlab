nobase_lib_LTLIBRARIES += opencryptoki/stdll/libpkcs11_mxl.la


noinst_HEADERS +=							\
	usr/lib/mxl_stdll/tok_struct.h

opencryptoki_stdll_libpkcs11_mxl_la_CFLAGS =				\
	-DDEV -D_THREAD_SAFE -DSHALLOW=0 -DEPSWTOK=1 -DLITE=0		\
	-DNOMD2	-DNORIPE -fPIC -DDEFENSIVE_MECHLIST			\
	-DTOK_NEW_DATA_STORE=0x0003000c					\
	-DSTDLL_NAME=\"mxl-tok\"					\
	-I${srcdir}/usr/lib/mxl_stdll -I${srcdir}/usr/lib/common	\
	-I${srcdir}/usr/include -I${top_builddir}/usr/lib/api		\
	-I${srcdir}/usr/lib/api -I${top_builddir}/usr/lib/config

opencryptoki_stdll_libpkcs11_mxl_la_LDFLAGS =				\
	-shared -Wl,-z,defs,-Bsymbolic -lc -lpthread -lcrypto -lrt	\
	-llber -ldl -lsecurefapi -lteec -Wl,--version-script=${srcdir}/opencryptoki_tok.map

opencryptoki_stdll_libpkcs11_mxl_la_SOURCES = usr/lib/common/asn1.c	\
	...
	usr/lib/common/dlist.c usr/lib/common/mech_pqc.c		\
	usr/lib/mxl_stdll/new_host.c usr/lib/common/mech_openssl.c      \
	usr/lib/mxl_stdll/mxl_loadsave.c				\
	usr/lib/mxl_stdll/mxl_specific.c				\
...
if !NO_PKEY
opencryptoki_stdll_libpkcs11_mxl_la_SOURCES +=				\
