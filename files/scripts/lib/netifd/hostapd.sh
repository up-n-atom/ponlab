...
hostapd_prepare_device_config() {
	...
	json_get_vars country country_ie beacon_int:100 doth require_mode legacy_rates \
					...
					allow_scan_during_cac dfs_ch_state_file sBfMode \
					colocated_6g_radio_info colocated_6g_vap_info \
					sConfigMRCoexActiveTime sQAMplus sConfigMRCoex \
					sConfigMRCoexInactiveTime \
...
hostapd_set_bss_options() {
	...
	json_get_vars \
		...
		sBridgeMode sAddPeerAP bss_beacon_int enable_hairpin
