...
/*!
	\brief Checks if the given paramlist is empty or not
	\param[in] pxParamList ParamList  ptr
	\return true/false
*/
static inline bool HELP_IS_EMPTY_PARAM(IN ParamList *pxParamList)
{
	return list_empty(&pxParamList->xPlist);
}
