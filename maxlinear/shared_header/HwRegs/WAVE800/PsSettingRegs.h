...
#define	REG_PS_SETTING_PS_STATUS_CHANGE_STA_0TO31_PS_REQ_NOTIFY_EN       (PS_SETTING_BASE_ADDRESS + 0x70)
#define	REG_PS_SETTING_PS_STATUS_CHANGE_STA_32TO63_PS_REQ_NOTIFY_EN      (PS_SETTING_BASE_ADDRESS + 0x74)
#define	REG_PS_SETTING_PS_STATUS_CHANGE_STA_64TO95_PS_REQ_NOTIFY_EN      (PS_SETTING_BASE_ADDRESS + 0x78)
#define	REG_PS_SETTING_PS_STATUS_CHANGE_STA_96TO127_PS_REQ_NOTIFY_EN     (PS_SETTING_BASE_ADDRESS + 0x7C)
#define	REG_PS_SETTING_PS_STATUS_CHANGE_STA_128TO159_PS_REQ_NOTIFY_EN    (PS_SETTING_BASE_ADDRESS + 0x80)
#define	REG_PS_SETTING_PS_STATUS_CHANGE_STA_160TO191_PS_REQ_NOTIFY_EN    (PS_SETTING_BASE_ADDRESS + 0x84)
#define	REG_PS_SETTING_PS_STATUS_CHANGE_STA_192TO223_PS_REQ_NOTIFY_EN    (PS_SETTING_BASE_ADDRESS + 0x88)
#define	REG_PS_SETTING_PS_STATUS_CHANGE_STA_224TO255_PS_REQ_NOTIFY_EN    (PS_SETTING_BASE_ADDRESS + 0x8C)
/*---------------------------------------------------------------------------------
...
} RegPsSettingPsStatusChangeSta0To31PsReqNotifyEn_u;
...
} RegPsSettingPsStatusChangeSta32To63PsReqNotifyEn_u;
...
} RegPsSettingPsStatusChangeSta64To95PsReqNotifyEn_u;
...
} RegPsSettingPsStatusChangeSta96To127PsReqNotifyEn_u;
...
} RegPsSettingPsStatusChangeSta128To159PsReqNotifyEn_u;
...
} RegPsSettingPsStatusChangeSta160To191PsReqNotifyEn_u;
...
} RegPsSettingPsStatusChangeSta192To223PsReqNotifyEn_u;
...
} RegPsSettingPsStatusChangeSta224To255PsReqNotifyEn_u;
