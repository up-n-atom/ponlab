...
#define PHY_RX_TD_BASE_ADDRESS                                          MEMORY_MAP_UNIT_200_BASE_ADDRESS
...
#define	REG_PHY_RX_TD_MY_BAND_TYPE                                      (PHY_RX_TD_BASE_ADDRESS + 0x18)
...
#define	REG_PHY_RX_TD_SIG3_READY_EHT                                    (PHY_RX_TD_BASE_ADDRESS + 0x240)
...
#define	REG_PHY_RX_TD_TD_DEBUG_CONTROL                                  (PHY_RX_TD_BASE_ADDRESS + 0x274)
...
#define	REG_PHY_RX_TD_BAND_320                                          (PHY_RX_TD_BASE_ADDRESS + 0x46C)
#define	REG_PHY_RX_TD_PM_IND_NOISE_CTRL                                 (PHY_RX_TD_BASE_ADDRESS + 0x470)
#define	REG_PHY_RX_TD_SPARE_FROM_FD0                                    (PHY_RX_TD_BASE_ADDRESS + 0x474)
#define	REG_PHY_RX_TD_SPARE_FROM_FD1                                    (PHY_RX_TD_BASE_ADDRESS + 0x478)
#define	REG_PHY_RX_TD_SPARE_FROM_TX                                     (PHY_RX_TD_BASE_ADDRESS + 0x47C)
#define	REG_PHY_RX_TD_SPARE_FROM_BE                                     (PHY_RX_TD_BASE_ADDRESS + 0x480)
#define	REG_PHY_RX_TD_SPARE_TO_FD0                                      (PHY_RX_TD_BASE_ADDRESS + 0x484)
#define	REG_PHY_RX_TD_SPARE_TO_FD1                                      (PHY_RX_TD_BASE_ADDRESS + 0x488)
#define	REG_PHY_RX_TD_SPARE_TO_TX                                       (PHY_RX_TD_BASE_ADDRESS + 0x48C)
#define	REG_PHY_RX_TD_SPARE_TO_BE                                       (PHY_RX_TD_BASE_ADDRESS + 0x490)
#define	REG_PHY_RX_TD_SPARE_TO_MAC                                      (PHY_RX_TD_BASE_ADDRESS + 0x494)
#define	REG_PHY_RX_TD_SPARE_FROM_MAC                                    (PHY_RX_TD_BASE_ADDRESS + 0x498)
#define	REG_PHY_RX_TD_SPARE_FROM_CPU                                    (PHY_RX_TD_BASE_ADDRESS + 0x49C)
#define	REG_PHY_RX_TD_SPARE_FROM_HOST                                   (PHY_RX_TD_BASE_ADDRESS + 0x4A0)
#define	REG_PHY_RX_TD_RADAR_DETECTOR_TX_ON_OTHER_BAND_EN                (PHY_RX_TD_BASE_ADDRESS + 0x4A4)
#define	REG_PHY_RX_TD_TX_PER_BAND                                       (PHY_RX_TD_BASE_ADDRESS + 0x4A8)
#define	REG_PHY_RX_TD_GOERTZEL_MODE                                     (PHY_RX_TD_BASE_ADDRESS + 0x4AC)
#define	REG_PHY_RX_TD_DET_LPI_CTRL                                      (PHY_RX_TD_BASE_ADDRESS + 0x4B0)
#define	REG_PHY_RX_TD_DET_LPI_THR0                                      (PHY_RX_TD_BASE_ADDRESS + 0x4B4)
#define	REG_PHY_RX_TD_DET_LPI_THR1                                      (PHY_RX_TD_BASE_ADDRESS + 0x4B8)
#define	REG_PHY_RX_TD_DET_LPI_THR2                                      (PHY_RX_TD_BASE_ADDRESS + 0x4BC)
#define	REG_PHY_RX_TD_EARLY_EHT_PPM_DELAY_CNT_VAL                       (PHY_RX_TD_BASE_ADDRESS + 0x4C0)
#define	REG_PHY_RX_TD_LAST_SAMPLE_OFFSET_REG1                           (PHY_RX_TD_BASE_ADDRESS + 0x4C4)
#define	REG_PHY_RX_TD_LAST_SAMPLE_OFFSET_REG2                           (PHY_RX_TD_BASE_ADDRESS + 0x4C8)
#define	REG_PHY_RX_TD_DFS_BLOCK_ACTIVE                                  (PHY_RX_TD_BASE_ADDRESS + 0x4CC)
#define	REG_PHY_RX_TD_EARLY_EHT_TRIG_MUX_DELAY_CNT_VAL                  (PHY_RX_TD_BASE_ADDRESS + 0x4D0)
#define	REG_PHY_RX_TD_GCLK_BYPASS                                       (PHY_RX_TD_BASE_ADDRESS + 0x4D4)
#define	REG_PHY_RX_TD_REWIND_EN                                         (PHY_RX_TD_BASE_ADDRESS + 0x4D8)
/*---------------------------------------------------------------------------------
...
} RegPhyRxTdRadarDetectorTxOnOtherBandEn_u;
...
} RegPhyRxTdEarlyEhtPpmDelayCntVal_u;
...
} RegPhyRxTdLastSampleOffsetReg1_u;
...
} RegPhyRxTdLastSampleOffsetReg2_u;
...
} RegPhyRxTdEarlyEhtTrigMuxDelayCntVal_u;
