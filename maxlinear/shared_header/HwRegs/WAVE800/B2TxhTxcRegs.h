...
#define B2_TXH_TXC_TXH_TXC_ENABLE_FIELD_TXH_TXC_ENABLE_MASK                                                       0x00000001
//========================================
/* REG_TXH_TXC_TXH_TXC_CONTROL 0x4 */
#define B2_TXH_TXC_TXH_TXC_CONTROL_FIELD_ABORT_EIFS_ON_CCA_BUSY_EN_MASK                                           0x00000001
//========================================
/* REG_TXH_TXC_SIFS_ELEMENT 0x10 */
#define B2_TXH_TXC_SIFS_ELEMENT_FIELD_SIFS_ELEMENT_MASK                                                           0x000000FF
//========================================
/* REG_TXH_TXC_TXC_SENSITIVE_DEFAULT 0x20 */
#define B2_TXH_TXC_TXC_SENSITIVE_DEFAULT_FIELD_TXC_CCA_SENSITIVE_DEFAULT_MASK                                     0x00000001
#define B2_TXH_TXC_TXC_SENSITIVE_DEFAULT_FIELD_TXC_RX_NAV_SENSITIVE_DEFAULT_MASK                                  0x00000002
#define B2_TXH_TXC_TXC_SENSITIVE_DEFAULT_FIELD_TXC_TX_NAV_SENSITIVE_DEFAULT_MASK                                  0x00000004
//========================================
/* REG_TXH_TXC_RESP_TIMEOUT_VALUE_SET 0x24 */
#define B2_TXH_TXC_RESP_TIMEOUT_VALUE_SET_FIELD_RESP_TIMEOUT_VALUE_SET_MASK                                       0x00001FFF
//========================================
/* REG_TXH_TXC_RESP_TIMEOUT_RD 0x28 */
#define B2_TXH_TXC_RESP_TIMEOUT_RD_FIELD_RESP_TIMEOUT_RD_MASK                                                     0x00001FFF
#define B2_TXH_TXC_RESP_TIMEOUT_RD_FIELD_RESP_TIMEOUT_EN_RD_MASK                                                  0x00010000
//========================================
/* REG_TXH_TXC_TXC_DEBUG 0x2C */
#define B2_TXH_TXC_TXC_DEBUG_FIELD_TXC_SM_MASK                                                                    0x0000000F
//========================================
/* REG_TXH_TXC_START_SLOT_AFTER_SIFS_CTR 0x30 */
#define B2_TXH_TXC_START_SLOT_AFTER_SIFS_CTR_FIELD_START_SLOT_AFTER_SIFS_CTR_MASK                                 0x0000FFFF
//========================================
/* REG_TXH_TXC_START_SLOT_AFTER_SLOT_CTR 0x34 */
#define B2_TXH_TXC_START_SLOT_AFTER_SLOT_CTR_FIELD_START_SLOT_AFTER_SLOT_CTR_MASK                                 0x00FFFFFF
