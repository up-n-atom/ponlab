...
#define	REG_HOB_PAC_DUR_TSF_FIELD_SFR6_LOW                             (HOB_PAC_DUR_BASE_ADDRESS + 0xC8)
#define	REG_HOB_PAC_DUR_TSF_FIELD_SFR6_HIGH                            (HOB_PAC_DUR_BASE_ADDRESS + 0xCC)
...
} RegHobPacDurTsfFieldSfr6High_u;
