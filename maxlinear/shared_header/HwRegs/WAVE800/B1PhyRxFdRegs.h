...
#define	REG_B1_PHY_RX_FD_FD_TEST_BUS_GCLK_EN                   (B1_PHY_RX_FD_BASE_ADDRESS + 0x59C)
#define	REG_B1_PHY_RX_FD_DFE_ENABLE                            (B1_PHY_RX_FD_BASE_ADDRESS + 0x5A0)
#define	REG_B1_PHY_RX_FD_QR_LOW_POWER                          (B1_PHY_RX_FD_BASE_ADDRESS + 0x5A4)
#define	REG_B1_PHY_RX_FD_TEST_BUS_GROUPING                     (B1_PHY_RX_FD_BASE_ADDRESS + 0x5A8)
#define	REG_B1_PHY_RX_FD_MAX_QR_TIME                           (B1_PHY_RX_FD_BASE_ADDRESS + 0x5AC)
#define	REG_B1_PHY_RX_FD_FFT_OUT_MULT_SHIFT                    (B1_PHY_RX_FD_BASE_ADDRESS + 0x5B0)
#define	REG_B1_PHY_RX_FD_QR_NOISE_GAIN_FREEZE_DISABLE          (B1_PHY_RX_FD_BASE_ADDRESS + 0x5B4)
#define	REG_B1_PHY_RX_FD_MIN_SPHERE_CYCLES                     (B1_PHY_RX_FD_BASE_ADDRESS + 0x5B8)
#define	REG_B1_PHY_RX_FD_SMOOTH_WDATA_DELAY_RM                 (B1_PHY_RX_FD_BASE_ADDRESS + 0x5BC)
#define	REG_B1_PHY_RX_FD_RCR_MAX_VAL                           (B1_PHY_RX_FD_BASE_ADDRESS + 0x5C0)
#define	REG_B1_PHY_RX_FD_SU_BF_ERROR_MASK                      (B1_PHY_RX_FD_BASE_ADDRESS + 0x5C4)
#define	REG_B1_PHY_RX_FD_SU_BF_OFDMA_ERROR_REG0                (B1_PHY_RX_FD_BASE_ADDRESS + 0x5C8)
#define	REG_B1_PHY_RX_FD_SU_BF_OFDMA_ERROR_REG1                (B1_PHY_RX_FD_BASE_ADDRESS + 0x5CC)
#define	REG_B1_PHY_RX_FD_SU_BF_OFDMA_ERROR_REG2                (B1_PHY_RX_FD_BASE_ADDRESS + 0x5D0)
#define	REG_B1_PHY_RX_FD_SU_BF_OFDMA_ERROR_REG3                (B1_PHY_RX_FD_BASE_ADDRESS + 0x5D4)
#define	REG_B1_PHY_RX_FD_MU_TX_ERROR_CAUSE_MASK                (B1_PHY_RX_FD_BASE_ADDRESS + 0x5D8)
#define	REG_B1_PHY_RX_FD_BF_EQ_POWER_PER_SS                    (B1_PHY_RX_FD_BASE_ADDRESS + 0x5DC)
#define	REG_B1_PHY_RX_FD_QR_ACTIVATIONS                        (B1_PHY_RX_FD_BASE_ADDRESS + 0x5E0)
#define	REG_B1_PHY_RX_FD_NOISE_TRK_FREEZE_SHIFTER_THR          (B1_PHY_RX_FD_BASE_ADDRESS + 0x5E4)
#define	REG_B1_PHY_RX_FD_SUPERSEG_NOT_ON_PRIMARY_CB            (B1_PHY_RX_FD_BASE_ADDRESS + 0x5E8)
#define	REG_B1_PHY_RX_FD_HE_DFE_SYM_START                      (B1_PHY_RX_FD_BASE_ADDRESS + 0x5EC)
#define	REG_B1_PHY_RX_FD_VHT_DFE_SYM_START                     (B1_PHY_RX_FD_BASE_ADDRESS + 0x5F0)
#define	REG_B1_PHY_RX_FD_START_FROM_QR_0_ENABLE                (B1_PHY_RX_FD_BASE_ADDRESS + 0x5F4)
#define	REG_B1_PHY_RX_FD_SYMBOL_TIME_EHT_2SEG_COUNT0           (B1_PHY_RX_FD_BASE_ADDRESS + 0x5F8)
#define	REG_B1_PHY_RX_FD_SYMBOL_TIME_EHT_2SEG_COUNT1           (B1_PHY_RX_FD_BASE_ADDRESS + 0x5FC)
#define	REG_B1_PHY_RX_FD_PHY_RXFD_REG_RAM_RM                   (B1_PHY_RX_FD_BASE_ADDRESS + 0x600)
#define	REG_B1_PHY_RX_FD_PHY_RXFD_REG_CH_ESTI                  (B1_PHY_RX_FD_BASE_ADDRESS + 0x604)
#define	REG_B1_PHY_RX_FD_QR_LIMIT_1SS                          (B1_PHY_RX_FD_BASE_ADDRESS + 0x608)
#define	REG_B1_PHY_RX_FD_QR_LIMIT_2SS                          (B1_PHY_RX_FD_BASE_ADDRESS + 0x60C)
#define	REG_B1_PHY_RX_FD_QR_LIMIT_3SS                          (B1_PHY_RX_FD_BASE_ADDRESS + 0x610)
#define	REG_B1_PHY_RX_FD_QR_LIMIT_4SS                          (B1_PHY_RX_FD_BASE_ADDRESS + 0x614)
#define	REG_B1_PHY_RX_FD_RISC_SPHERE_CYCLES_REWIND_OVERRIDE    (B1_PHY_RX_FD_BASE_ADDRESS + 0x618)
#define	REG_B1_PHY_RX_FD_PM_FD_OVERHEAD                        (B1_PHY_RX_FD_BASE_ADDRESS + 0x61C)
#define	REG_B1_PHY_RX_FD_PHY_RXFD_BF_SETUP                     (B1_PHY_RX_FD_BASE_ADDRESS + 0x620)
#define	REG_B1_PHY_RX_FD_SMOOTHING_LONG_FILTER_ENABLE          (B1_PHY_RX_FD_BASE_ADDRESS + 0x624)
#define	REG_B1_PHY_RX_FD_SPHERE_CYC_CT_CAN_WORK                (B1_PHY_RX_FD_BASE_ADDRESS + 0x628)
#define	REG_B1_PHY_RX_FD_TD_GAIN_CONFIG                        (B1_PHY_RX_FD_BASE_ADDRESS + 0x62C)
#define	REG_B1_PHY_RX_FD_SPHERE_POWER_SAVE                     (B1_PHY_RX_FD_BASE_ADDRESS + 0x630)
#define	REG_B1_PHY_RX_FD_SPHERE_CYCLES_RO                      (B1_PHY_RX_FD_BASE_ADDRESS + 0x634)
/*---------------------------------------------------------------------------------
...
/*REG_B1_PHY_RX_FD_FD_TEST_BUS_GCLK_EN 0x59C */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdFdTestBusGclkEn_u;

/*REG_B1_PHY_RX_FD_DFE_ENABLE 0x5A0 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdDfeEnable_u;

/*REG_B1_PHY_RX_FD_QR_LOW_POWER 0x5A4 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdQrLowPower_u;

/*REG_B1_PHY_RX_FD_TEST_BUS_GROUPING 0x5A8 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdTestBusGrouping_u;

/*REG_B1_PHY_RX_FD_MAX_QR_TIME 0x5AC */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdMaxQrTime_u;

/*REG_B1_PHY_RX_FD_FFT_OUT_MULT_SHIFT 0x5B0 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdFftOutMultShift_u;

/*REG_B1_PHY_RX_FD_QR_NOISE_GAIN_FREEZE_DISABLE 0x5B4 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdQrNoiseGainFreezeDisable_u;

/*REG_B1_PHY_RX_FD_MIN_SPHERE_CYCLES 0x5B8 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdMinSphereCycles_u;

/*REG_B1_PHY_RX_FD_SMOOTH_WDATA_DELAY_RM 0x5BC */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdSmoothWdataDelayRm_u;

/*REG_B1_PHY_RX_FD_RCR_MAX_VAL 0x5C0 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdRcrMaxVal_u;

/*REG_B1_PHY_RX_FD_SU_BF_ERROR_MASK 0x5C4 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdSuBfErrorMask_u;

/*REG_B1_PHY_RX_FD_SU_BF_OFDMA_ERROR_REG0 0x5C8 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdSuBfOfdmaErrorReg0_u;

/*REG_B1_PHY_RX_FD_SU_BF_OFDMA_ERROR_REG1 0x5CC */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdSuBfOfdmaErrorReg1_u;

/*REG_B1_PHY_RX_FD_SU_BF_OFDMA_ERROR_REG2 0x5D0 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdSuBfOfdmaErrorReg2_u;

/*REG_B1_PHY_RX_FD_SU_BF_OFDMA_ERROR_REG3 0x5D4 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdSuBfOfdmaErrorReg3_u;

/*REG_B1_PHY_RX_FD_MU_TX_ERROR_CAUSE_MASK 0x5D8 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdMuTxErrorCauseMask_u;

/*REG_B1_PHY_RX_FD_BF_EQ_POWER_PER_SS 0x5DC */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdBfEqPowerPerSs_u;

/*REG_B1_PHY_RX_FD_QR_ACTIVATIONS 0x5E0 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdQrActivations_u;

/*REG_B1_PHY_RX_FD_NOISE_TRK_FREEZE_SHIFTER_THR 0x5E4 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdNoiseTrkFreezeShifterThr_u;

/*REG_B1_PHY_RX_FD_SUPERSEG_NOT_ON_PRIMARY_CB 0x5E8 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdSupersegNotOnPrimaryCb_u;

/*REG_B1_PHY_RX_FD_HE_DFE_SYM_START 0x5EC */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdHeDfeSymStart_u;

/*REG_B1_PHY_RX_FD_VHT_DFE_SYM_START 0x5F0 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdVhtDfeSymStart_u;

/*REG_B1_PHY_RX_FD_START_FROM_QR_0_ENABLE 0x5F4 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdStartFromQr0Enable_u;

/*REG_B1_PHY_RX_FD_SYMBOL_TIME_EHT_2SEG_COUNT0 0x5F8 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdSymbolTimeEht2SegCount0_u;

/*REG_B1_PHY_RX_FD_SYMBOL_TIME_EHT_2SEG_COUNT1 0x5FC */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdSymbolTimeEht2SegCount1_u;

/*REG_B1_PHY_RX_FD_PHY_RXFD_REG_RAM_RM 0x600 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdPhyRxfdRegRamRm_u;

/*REG_B1_PHY_RX_FD_PHY_RXFD_REG_CH_ESTI 0x604 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdPhyRxfdRegChEsti_u;

/*REG_B1_PHY_RX_FD_QR_LIMIT_1SS 0x608 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdQrLimit1Ss_u;

/*REG_B1_PHY_RX_FD_QR_LIMIT_2SS 0x60C */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdQrLimit2Ss_u;

/*REG_B1_PHY_RX_FD_QR_LIMIT_3SS 0x610 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdQrLimit3Ss_u;

/*REG_B1_PHY_RX_FD_QR_LIMIT_4SS 0x614 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdQrLimit4Ss_u;

/*REG_B1_PHY_RX_FD_RISC_SPHERE_CYCLES_REWIND_OVERRIDE 0x618 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdRiscSphereCyclesRewindOverride_u;

/*REG_B1_PHY_RX_FD_PM_FD_OVERHEAD 0x61C */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdPmFdOverhead_u;

/*REG_B1_PHY_RX_FD_PHY_RXFD_BF_SETUP 0x620 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdPhyRxfdBfSetup_u;

/*REG_B1_PHY_RX_FD_SMOOTHING_LONG_FILTER_ENABLE 0x624 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdSmoothingLongFilterEnable_u;

/*REG_B1_PHY_RX_FD_SPHERE_CYC_CT_CAN_WORK 0x628 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdSphereCycCtCanWork_u;

/*REG_B1_PHY_RX_FD_TD_GAIN_CONFIG 0x62C */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdTdGainConfig_u;

/*REG_B1_PHY_RX_FD_SPHERE_POWER_SAVE 0x630 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdSpherePowerSave_u;

/*REG_B1_PHY_RX_FD_SPHERE_CYCLES_RO 0x634 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyRxFdSphereCyclesRo_u;

//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG06 0x18 */
#define B1_PHY_RX_FD_PHY_RXFD_REG06_FIELD_PT_BYPASS_MASK                                                          0x00000001
#define B1_PHY_RX_FD_PHY_RXFD_REG06_FIELD_NCO_FUNC_BYPASS_MASK                                                    0x00000002
#define B1_PHY_RX_FD_PHY_RXFD_REG06_FIELD_CH_TRK_BYPASS_MASK                                                      0x00000020
#define B1_PHY_RX_FD_PHY_RXFD_REG06_FIELD_INDPNDT_NE_SW_BYPASS_MASK                                               0x00000040
#define B1_PHY_RX_FD_PHY_RXFD_REG06_FIELD_DPNDT_NE_SW_BYPASS_MASK                                                 0x00000080
#define B1_PHY_RX_FD_PHY_RXFD_REG06_FIELD_CH_TRK_BYPASS_LEGACY_PREAMBLE_MASK                                      0x00000100
#define B1_PHY_RX_FD_PHY_RXFD_REG06_FIELD_RX_ENABLE_OVERRIDE_MASK                                                 0x00000200
#define B1_PHY_RX_FD_PHY_RXFD_REG06_FIELD_DPNDT_NE_SYMMETRIC_MODE_MASK                                            0x00000400
#define B1_PHY_RX_FD_PHY_RXFD_REG06_FIELD_SPUR_CANC_SW_BYPASS_MASK                                                0x00000800
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG07 0x1C */
#define B1_PHY_RX_FD_PHY_RXFD_REG07_FIELD_FFT_OLA_SELECT_MASK                                                     0x0000000F
#define B1_PHY_RX_FD_PHY_RXFD_REG07_FIELD_FFT_RND_MASK                                                            0x00000300
#define B1_PHY_RX_FD_PHY_RXFD_REG07_FIELD_FCB_SHORT_CP_TIM_SHIFT_MASK                                             0x01F00000
#define B1_PHY_RX_FD_PHY_RXFD_REG07_FIELD_NCB_SHORT_CP_TIM_SHIFT_MASK                                             0xF8000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG08 0x20 */
#define B1_PHY_RX_FD_PHY_RXFD_REG08_FIELD_FFT_START_WADDR_MASK                                                    0x000001FF
#define B1_PHY_RX_FD_PHY_RXFD_REG08_FIELD_FFT_START_WADDR_2X_MASK                                                 0x0007FE00
#define B1_PHY_RX_FD_PHY_RXFD_REG08_FIELD_FFT_START_WADDR_4X_MASK                                                 0x3FF80000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG09 0x24 */
#define B1_PHY_RX_FD_PHY_RXFD_REG09_FIELD_SHORT_CP_TIM_SHIFT_MASK                                                 0x000003FF
#define B1_PHY_RX_FD_PHY_RXFD_REG09_FIELD_CP_1_6_TIM_SHIFT_MASK                                                   0x000FFC00
#define B1_PHY_RX_FD_PHY_RXFD_REG09_FIELD_CP_3_2_TIM_SHIFT_MASK                                                   0x3FF00000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG0A 0x28 */
#define B1_PHY_RX_FD_PHY_RXFD_REG0A_FIELD_PT_SMOOTHING_VHT_INIT_SYM_MASK                                          0x00000001
#define B1_PHY_RX_FD_PHY_RXFD_REG0A_FIELD_PT_SMOOTHING_PHASE_INIT_MODE_MASK                                       0x00000030
#define B1_PHY_RX_FD_PHY_RXFD_REG0A_FIELD_PT_SMOOTHING_TIMING_INIT_MODE_MASK                                      0x00000300
#define B1_PHY_RX_FD_PHY_RXFD_REG0A_FIELD_FT_ENABLE_MASK                                                          0x00001000
#define B1_PHY_RX_FD_PHY_RXFD_REG0A_FIELD_NUM_OF_SYM_MASK_MASK                                                    0x7FF00000
#define B1_PHY_RX_FD_PHY_RXFD_REG0A_FIELD_RF_DATA_TYPE_MASK                                                       0x80000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG0B 0x2C */
#define B1_PHY_RX_FD_PHY_RXFD_REG0B_FIELD_CT_2_TB_EN_MASK                                                         0x00000020
#define B1_PHY_RX_FD_PHY_RXFD_REG0B_FIELD_CT_FORCE_LLR_VALID_CH_TRK_MASK                                          0x00000040
#define B1_PHY_RX_FD_PHY_RXFD_REG0B_FIELD_CT_FORCE_LLR_VALID_NOISE_TRK_MASK                                       0x00000080
#define B1_PHY_RX_FD_PHY_RXFD_REG0B_FIELD_CT_TX_EQUAL_NORM_MODE_MASK                                              0x00000100
#define B1_PHY_RX_FD_PHY_RXFD_REG0B_FIELD_TONE_ROTATION_EN_MASK                                                   0x00000200
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG0C 0x30 */
#define B1_PHY_RX_FD_PHY_RXFD_REG0C_FIELD_CE_TABLE_1_START_MASK                                                   0x000003FF
#define B1_PHY_RX_FD_PHY_RXFD_REG0C_FIELD_CE_TABLE_2_START_MASK                                                   0x000FFC00
#define B1_PHY_RX_FD_PHY_RXFD_REG0C_FIELD_CE_TABLE_3_START_MASK                                                   0x3FF00000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG0D 0x34 */
#define B1_PHY_RX_FD_PHY_RXFD_REG0D_FIELD_CE_H0_SET_MASK                                                          0x000003FF
#define B1_PHY_RX_FD_PHY_RXFD_REG0D_FIELD_CE_H1_SET_MASK                                                          0x03FF0000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG0E 0x38 */
#define B1_PHY_RX_FD_PHY_RXFD_REG0E_FIELD_CE_H2_SET_MASK                                                          0x000003FF
#define B1_PHY_RX_FD_PHY_RXFD_REG0E_FIELD_CE_H3_SET_MASK                                                          0x03FF0000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG0F 0x3C */
#define B1_PHY_RX_FD_PHY_RXFD_REG0F_FIELD_CE_H4_SET_MASK                                                          0x000003FF
#define B1_PHY_RX_FD_PHY_RXFD_REG0F_FIELD_CE_H5_SET_MASK                                                          0x03FF0000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG11 0x44 */
#define B1_PHY_RX_FD_PHY_RXFD_REG11_FIELD_LONG1_SCRM_INIT_VAL_MASK                                                0x0000007F
#define B1_PHY_RX_FD_PHY_RXFD_REG11_FIELD_FCB_PRANK3_MASK_AN0_MASK                                                0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REG11_FIELD_FCB_PRANK3_MASK_AN1_MASK                                                0x00FF0000
#define B1_PHY_RX_FD_PHY_RXFD_REG11_FIELD_FCB_PRANK3_MASK_AN2_MASK                                                0xFF000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG12 0x48 */
#define B1_PHY_RX_FD_PHY_RXFD_REG12_FIELD_TWO_BAND_PRANK1_MASK_MASK                                               0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REG12_FIELD_LONG3_FCB_PRANK1_MASK_MASK                                              0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REG12_FIELD_LONG3_NCB_PRANK1_MASK_MASK                                              0x00FF0000
#define B1_PHY_RX_FD_PHY_RXFD_REG12_FIELD_NCB_PRANK3_MASK_AN0_MASK                                                0xFF000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG13 0x4C */
#define B1_PHY_RX_FD_PHY_RXFD_REG13_FIELD_FCB_PRANK1_MASK_MASK                                                    0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REG13_FIELD_NCB_PRANK1_MASK_MASK                                                    0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REG13_FIELD_NCB_PRANK3_MASK_AN1_MASK                                                0x00FF0000
#define B1_PHY_RX_FD_PHY_RXFD_REG13_FIELD_NCB_PRANK3_MASK_AN2_MASK                                                0xFF000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG14 0x50 */
#define B1_PHY_RX_FD_PHY_RXFD_REG14_FIELD_FCB_PRANK2_MASK_AN0_MASK                                                0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REG14_FIELD_FCB_PRANK2_MASK_AN1_MASK                                                0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REG14_FIELD_NCB_PRANK2_MASK_AN0_MASK                                                0x00FF0000
#define B1_PHY_RX_FD_PHY_RXFD_REG14_FIELD_NCB_PRANK2_MASK_AN1_MASK                                                0xFF000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG15 0x54 */
#define B1_PHY_RX_FD_PHY_RXFD_REG15_FIELD_TD_HT_MODE_JUMP_ADD_MASK                                                0x0000000F
#define B1_PHY_RX_FD_PHY_RXFD_REG15_FIELD_TD_HT_LTF2_JUMP_ADD_MASK                                                0x000000F0
#define B1_PHY_RX_FD_PHY_RXFD_REG15_FIELD_TD_HT_CP_1_JUMP_ADD_MASK                                                0x00000F00
#define B1_PHY_RX_FD_PHY_RXFD_REG15_FIELD_TD_HT_CP_0_JUMP_ADD_MASK                                                0x0000F000
#define B1_PHY_RX_FD_PHY_RXFD_REG15_FIELD_TD_HT_LTF3_JUMP_ADD_MASK                                                0x000F0000
#define B1_PHY_RX_FD_PHY_RXFD_REG15_FIELD_TD_HT_ELTF_SKIP_ADD_MASK                                                0x00F00000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG16 0x58 */
#define B1_PHY_RX_FD_PHY_RXFD_REG16_FIELD_FD_HT_MODE_JUMP_ADD_MASK                                                0x0000000F
#define B1_PHY_RX_FD_PHY_RXFD_REG16_FIELD_FD_HT_LTF2_JUMP_ADD_MASK                                                0x000000F0
#define B1_PHY_RX_FD_PHY_RXFD_REG16_FIELD_FD_HT_BF_LTF_JUMP_ADD_MASK                                              0x00000F00
#define B1_PHY_RX_FD_PHY_RXFD_REG16_FIELD_FD_HT_LTF3_JUMP_ADD_MASK                                                0x0000F000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG1B 0x6C */
#define B1_PHY_RX_FD_PHY_RXFD_REG1B_FIELD_GSM_ABORT_THR_MASK                                                      0x0000FFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG1C 0x70 */
#define B1_PHY_RX_FD_PHY_RXFD_REG1C_FIELD_LEN_TP0_MASK                                                            0x00000001
#define B1_PHY_RX_FD_PHY_RXFD_REG1C_FIELD_LEN_TP1_MASK                                                            0x00000010
#define B1_PHY_RX_FD_PHY_RXFD_REG1C_FIELD_LEN_TP2_MASK                                                            0x00000100
#define B1_PHY_RX_FD_PHY_RXFD_REG1C_FIELD_LEN_TP3_MASK                                                            0x00001000
#define B1_PHY_RX_FD_PHY_RXFD_REG1C_FIELD_GSM_2_TB_RATE_MASK                                                      0xF0000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG1D 0x74 */
#define B1_PHY_RX_FD_PHY_RXFD_REG1D_FIELD_SPARE_REG_MASK                                                          0x0000FFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG1E 0x78 */
#define B1_PHY_RX_FD_PHY_RXFD_REG1E_FIELD_TB_R_NON_DIAGONAL_MASK                                                  0x00000008
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG34 0xD0 */
#define B1_PHY_RX_FD_PHY_RXFD_REG34_FIELD_SW_HT_DETECTOR_EN_MASK                                                  0x00010000
#define B1_PHY_RX_FD_PHY_RXFD_REG34_FIELD_SW_HT_DETECTOR_11N_MASK                                                 0x00020000
#define B1_PHY_RX_FD_PHY_RXFD_REG34_FIELD_CDD_POLARITY_MASK                                                       0x000C0000
#define B1_PHY_RX_FD_PHY_RXFD_REG34_FIELD_CE_UPDATE_CH_MASK                                                       0x00200000
#define B1_PHY_RX_FD_PHY_RXFD_REG34_FIELD_OLA_MODE_MASK                                                           0x00400000
#define B1_PHY_RX_FD_PHY_RXFD_REG34_FIELD_OLA_FFT_DONE_MASK                                                       0x00800000
#define B1_PHY_RX_FD_PHY_RXFD_REG34_FIELD_OLA_SW_FFT_P_MASK                                                       0x01000000
#define B1_PHY_RX_FD_PHY_RXFD_REG34_FIELD_GREENFIELD_DTCTR_EN_MASK                                                0x02000000
#define B1_PHY_RX_FD_PHY_RXFD_REG34_FIELD_ENABLE_ERROR_EVENT_MASK                                                 0x08000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG35 0xD4 */
#define B1_PHY_RX_FD_PHY_RXFD_REG35_FIELD_CE_TABLE_4_START_MASK                                                   0x000003FF
#define B1_PHY_RX_FD_PHY_RXFD_REG35_FIELD_CE_TABLE_5_START_MASK                                                   0x000FFC00
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG36 0xD8 */
#define B1_PHY_RX_FD_PHY_RXFD_REG36_FIELD_SW_BIST_START_MASK                                                      0x00100000
#define B1_PHY_RX_FD_PHY_RXFD_REG36_FIELD_CLEAR_RAM_MODE_MASK                                                     0x00200000
#define B1_PHY_RX_FD_PHY_RXFD_REG36_FIELD_TEST_BUS_LOW_MUX_CTRL_MASK                                              0x00C00000
#define B1_PHY_RX_FD_PHY_RXFD_REG36_FIELD_TEST_BUS_MID_MUX_CTRL_MASK                                              0x03000000
#define B1_PHY_RX_FD_PHY_RXFD_REG36_FIELD_TEST_BUS_HIGH_MUX_CTRL_MASK                                             0x0C000000
#define B1_PHY_RX_FD_PHY_RXFD_REG36_FIELD_TEST_BUS_FOUR_MUX_CTRL_MASK                                             0x30000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG38 0xE0 */
#define B1_PHY_RX_FD_PHY_RXFD_REG38_FIELD_FD_GF_LSIG_MODE_JUMP_ADD_MASK                                           0x00000F00
#define B1_PHY_RX_FD_PHY_RXFD_REG38_FIELD_FD_GF_HTSIG2_MODE_JUMP_ADD_MASK                                         0x0000F000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG3A 0xE8 */
#define B1_PHY_RX_FD_PHY_RXFD_REG3A_FIELD_HYP_RXFD_RCR_RAM_RM_MASK                                                0x00007000
#define B1_PHY_RX_FD_PHY_RXFD_REG3A_FIELD_HYP_RXFD_NE_RAM_RM_MASK                                                 0x00070000
#define B1_PHY_RX_FD_PHY_RXFD_REG3A_FIELD_HYP_RXFD_PHASE_RAM_RM_MASK                                              0x00700000
#define B1_PHY_RX_FD_PHY_RXFD_REG3A_FIELD_HYP_RXFD_PHASE_SMOOTHING_RAM_RM_MASK                                    0x07000000
#define B1_PHY_RX_FD_PHY_RXFD_REG3A_FIELD_HYP_RXFD_TIMING_SMOOTHING_RAM_RM_MASK                                   0x70000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG3B 0xEC */
#define B1_PHY_RX_FD_PHY_RXFD_REG3B_FIELD_HYP_RXFD_DATA_0_CH_RAM_RM_MASK                                          0x00000007
#define B1_PHY_RX_FD_PHY_RXFD_REG3B_FIELD_HYP_RXFD_DATA_1_CH_RAM_RM_MASK                                          0x00000070
#define B1_PHY_RX_FD_PHY_RXFD_REG3B_FIELD_HYP_RXFD_PILOT_0_CH_RAM_RM_MASK                                         0x00000700
#define B1_PHY_RX_FD_PHY_RXFD_REG3B_FIELD_HYP_RXFD_PILOT_1_CH_RAM_RM_MASK                                         0x00007000
#define B1_PHY_RX_FD_PHY_RXFD_REG3B_FIELD_HYP_RXFD_FFT_0_IMAGE_RAM_RM_MASK                                        0x00070000
#define B1_PHY_RX_FD_PHY_RXFD_REG3B_FIELD_HYP_RXFD_FFT_0_IMAGE_PILOT_RAM_RM_MASK                                  0x00700000
#define B1_PHY_RX_FD_PHY_RXFD_REG3B_FIELD_HYP_RXFD_PILOT_2_CH_RAM_RM_MASK                                         0x07000000
#define B1_PHY_RX_FD_PHY_RXFD_REG3B_FIELD_HYP_RXFD_PILOT_3_CH_RAM_RM_MASK                                         0x70000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG3C 0xF0 */
#define B1_PHY_RX_FD_PHY_RXFD_REG3C_FIELD_HYP_RXFD_GSM_RAM_STYLE_RM_MASK                                          0x00000007
#define B1_PHY_RX_FD_PHY_RXFD_REG3C_FIELD_HYP_RXFD_E_SNR_THR_RAM_RM_MASK                                          0x00000070
#define B1_PHY_RX_FD_PHY_RXFD_REG3C_FIELD_HYP_RXFD_MU_RAM_RM_MASK                                                 0x00000700
#define B1_PHY_RX_FD_PHY_RXFD_REG3C_FIELD_HYP_RXFD_NOISE_TRK_MU_RAM_RM_MASK                                       0x00007000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG3E 0xF8 */
#define B1_PHY_RX_FD_PHY_RXFD_REG3E_FIELD_HYP_RXFD_DATA_2_CH_RAM_RM_MASK                                          0x00070000
#define B1_PHY_RX_FD_PHY_RXFD_REG3E_FIELD_HYP_RXFD_DATA_3_CH_RAM_RM_MASK                                          0x00700000
#define B1_PHY_RX_FD_PHY_RXFD_REG3E_FIELD_HYP_RXFD_IMPL_CHANN_PRE_PHASE_RAM_RM_MASK                               0x07000000
#define B1_PHY_RX_FD_PHY_RXFD_REG3E_FIELD_HYP_RXFD_IMPL_CHANN_PRE_TX_RX_RAM_RM_MASK                               0x70000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG4E 0x138 */
#define B1_PHY_RX_FD_PHY_RXFD_REG4E_FIELD_EFFECTIVE_SNR_GCLK_BYPASS_MASK                                          0x00000001
#define B1_PHY_RX_FD_PHY_RXFD_REG4E_FIELD_BF_RX_PARSER_GCLK_BYPASS_MASK                                           0x00000002
#define B1_PHY_RX_FD_PHY_RXFD_REG4E_FIELD_GUESS_UNIT_GCLK_BYPASS_MASK                                             0x00000004
#define B1_PHY_RX_FD_PHY_RXFD_REG4E_FIELD_FFT_0_GCLK_BYPASS_MASK                                                  0x00000008
#define B1_PHY_RX_FD_PHY_RXFD_REG4E_FIELD_FFT_1_GCLK_BYPASS_MASK                                                  0x00000010
#define B1_PHY_RX_FD_PHY_RXFD_REG4E_FIELD_FFT_2_GCLK_BYPASS_MASK                                                  0x00000020
#define B1_PHY_RX_FD_PHY_RXFD_REG4E_FIELD_FFT_3_GCLK_BYPASS_MASK                                                  0x00000040
#define B1_PHY_RX_FD_PHY_RXFD_REG4E_FIELD_SLICER_GCLK_BYPASS_MASK                                                 0x00000780
#define B1_PHY_RX_FD_PHY_RXFD_REG4E_FIELD_QR_INTERNAL_GCLK_BYPASS_MASK                                            0x00000800
#define B1_PHY_RX_FD_PHY_RXFD_REG4E_FIELD_SPHERE_GCLK_BYPASS_MASK                                                 0x000FF000
#define B1_PHY_RX_FD_PHY_RXFD_REG4E_FIELD_CT_GCLK_DIS_MASK                                                        0x00100000
#define B1_PHY_RX_FD_PHY_RXFD_REG4E_FIELD_IMPL_CHANN_PRE_GCLK_BYPASS_MASK                                         0x80000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG50 0x140 */
#define B1_PHY_RX_FD_PHY_RXFD_REG50_FIELD_COMPRESSED_FOURIER_PHASE_2_MASK                                         0x00003FFF
#define B1_PHY_RX_FD_PHY_RXFD_REG50_FIELD_COMPRESSED_FOURIER_PHASE_3_MASK                                         0x3FFF0000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG51 0x144 */
#define B1_PHY_RX_FD_PHY_RXFD_REG51_FIELD_COMPRESSED_FOURIER_PHASE_4_MASK                                         0x00003FFF
#define B1_PHY_RX_FD_PHY_RXFD_REG51_FIELD_COMPRESSED_FOURIER_PHASE_5_MASK                                         0x3FFF0000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG57 0x15C */
#define B1_PHY_RX_FD_PHY_RXFD_REG57_FIELD_CHANNEL_ESTIMATION_USE_3LTFS_MASK                                       0x00000004
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG68 0x1A0 */
#define B1_PHY_RX_FD_PHY_RXFD_REG68_FIELD_NUM_OF_PGC1_VALUES_MASK                                                 0x000000FC
#define B1_PHY_RX_FD_PHY_RXFD_REG68_FIELD_NUM_OF_PGC2_VALUES_MASK                                                 0x00003F00
#define B1_PHY_RX_FD_PHY_RXFD_REG68_FIELD_NUM_OF_PGC3_VALUES_MASK                                                 0x000FC000
#define B1_PHY_RX_FD_PHY_RXFD_REG68_FIELD_NUM_OF_LNA_VALUES_MASK                                                  0x01F00000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG74 0x1D0 */
#define B1_PHY_RX_FD_PHY_RXFD_REG74_FIELD_HYP_RXFD_GCLK_DISABLE_MASK                                              0x0007FFFE
#define B1_PHY_RX_FD_PHY_RXFD_REG74_FIELD_MEM_GLOBAL_RM_MASK                                                      0x00C00000
#define B1_PHY_RX_FD_PHY_RXFD_REG74_FIELD_MEM_GLOBAL_BIST_SCR_BYPASS_MASK                                         0x01000000
#define B1_PHY_RX_FD_PHY_RXFD_REG74_FIELD_MEM_GLOBAL_RAM_TEST_MODE_MASK                                           0x02000000
#define B1_PHY_RX_FD_PHY_RXFD_REG74_FIELD_MEM_GLOBAL_RAM_TEST_RNM_MODE_MASK                                       0x04000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG75 0x1D4 */
#define B1_PHY_RX_FD_PHY_RXFD_REG75_FIELD_NOISE_TRK_ALPHA_FIRST_MASK                                              0x00000007
#define B1_PHY_RX_FD_PHY_RXFD_REG75_FIELD_NOISE_TRK_ALPHA_SECOND_MASK                                             0x00000070
#define B1_PHY_RX_FD_PHY_RXFD_REG75_FIELD_NOISE_TRK_BYPASS_DATA_MASK                                              0x00040000
#define B1_PHY_RX_FD_PHY_RXFD_REG75_FIELD_NOISE_TRK_BYPASS_SIG_MASK                                               0x00080000
#define B1_PHY_RX_FD_PHY_RXFD_REG75_FIELD_NOISE_TRK_NOISE_GAIN_LIMIT_MASK                                         0x00F00000
#define B1_PHY_RX_FD_PHY_RXFD_REG75_FIELD_NOISE_SPLIT_ENABLE_MASK                                                 0x01000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG76 0x1D8 */
#define B1_PHY_RX_FD_PHY_RXFD_REG76_FIELD_QR_GC0_PM_RM_VALUE_MASK                                                 0x00000007
#define B1_PHY_RX_FD_PHY_RXFD_REG76_FIELD_QR_GC1_PM_RM_VALUE_MASK                                                 0x00000070
#define B1_PHY_RX_FD_PHY_RXFD_REG76_FIELD_QR_GC2_PM_RM_VALUE_MASK                                                 0x00000700
#define B1_PHY_RX_FD_PHY_RXFD_REG76_FIELD_QR_GC0_UNIT0_H_S_MEM_RM_VALUE_MASK                                      0x00007000
#define B1_PHY_RX_FD_PHY_RXFD_REG76_FIELD_QR_GC0_UNIT0_Q_V_MEM_RM_VALUE_MASK                                      0x00070000
#define B1_PHY_RX_FD_PHY_RXFD_REG76_FIELD_QR_GC1_UNIT0_H_S_MEM_RM_VALUE_MASK                                      0x00700000
#define B1_PHY_RX_FD_PHY_RXFD_REG76_FIELD_QR_GC1_UNIT0_Q_V_MEM_RM_VALUE_MASK                                      0x07000000
#define B1_PHY_RX_FD_PHY_RXFD_REG76_FIELD_QR_GC2_UNIT0_H_S_MEM_RM_VALUE_MASK                                      0x70000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG77 0x1DC */
#define B1_PHY_RX_FD_PHY_RXFD_REG77_FIELD_QR_GC2_UNIT0_Q_V_MEM_RM_VALUE_MASK                                      0x00000007
#define B1_PHY_RX_FD_PHY_RXFD_REG77_FIELD_QR_GC0_UNIT1_H_S_MEM_RM_VALUE_MASK                                      0x00000070
#define B1_PHY_RX_FD_PHY_RXFD_REG77_FIELD_QR_GC0_UNIT1_Q_V_MEM_RM_VALUE_MASK                                      0x00000700
#define B1_PHY_RX_FD_PHY_RXFD_REG77_FIELD_QR_GC1_UNIT1_H_S_MEM_RM_VALUE_MASK                                      0x00007000
#define B1_PHY_RX_FD_PHY_RXFD_REG77_FIELD_QR_GC1_UNIT1_Q_V_MEM_RM_VALUE_MASK                                      0x00070000
#define B1_PHY_RX_FD_PHY_RXFD_REG77_FIELD_QR_GC2_UNIT1_H_S_MEM_RM_VALUE_MASK                                      0x00700000
#define B1_PHY_RX_FD_PHY_RXFD_REG77_FIELD_QR_GC2_UNIT1_Q_V_MEM_RM_VALUE_MASK                                      0x07000000
#define B1_PHY_RX_FD_PHY_RXFD_REG77_FIELD_QR_GC0_UNIT2_H_S_MEM_RM_VALUE_MASK                                      0x70000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG78 0x1E0 */
#define B1_PHY_RX_FD_PHY_RXFD_REG78_FIELD_QR_GC0_UNIT2_Q_V_MEM_RM_VALUE_MASK                                      0x00000007
#define B1_PHY_RX_FD_PHY_RXFD_REG78_FIELD_QR_GC1_UNIT2_H_S_MEM_RM_VALUE_MASK                                      0x00000070
#define B1_PHY_RX_FD_PHY_RXFD_REG78_FIELD_QR_GC1_UNIT2_Q_V_MEM_RM_VALUE_MASK                                      0x00000700
#define B1_PHY_RX_FD_PHY_RXFD_REG78_FIELD_QR_GC2_UNIT2_H_S_MEM_RM_VALUE_MASK                                      0x00007000
#define B1_PHY_RX_FD_PHY_RXFD_REG78_FIELD_QR_GC2_UNIT2_Q_V_MEM_RM_VALUE_MASK                                      0x00070000
#define B1_PHY_RX_FD_PHY_RXFD_REG78_FIELD_QR_LP_GC_PHASE_MEM_RM_VALUE_MASK                                        0x00700000
#define B1_PHY_RX_FD_PHY_RXFD_REG78_FIELD_QR_LP_H_MEM_RM_VALUE_MASK                                               0x07000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG79 0x1E4 */
#define B1_PHY_RX_FD_PHY_RXFD_REG79_FIELD_QR_SPHERE_IF_QAPPLY_MEM_0_RM_VALUE_MASK                                 0x00007000
#define B1_PHY_RX_FD_PHY_RXFD_REG79_FIELD_QR_SPHERE_IF_QAPPLY_MEM_1_RM_VALUE_MASK                                 0x00070000
#define B1_PHY_RX_FD_PHY_RXFD_REG79_FIELD_QR_SPHERE_IF_QAPPLY_MEM_2_RM_VALUE_MASK                                 0x00700000
#define B1_PHY_RX_FD_PHY_RXFD_REG79_FIELD_QR_SPHERE_IF_QAPPLY_MEM_3_RM_VALUE_MASK                                 0x07000000
#define B1_PHY_RX_FD_PHY_RXFD_REG79_FIELD_QR_SPHERE_IF_QR_MEM_0_RM_VALUE_MASK                                     0x70000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG7A 0x1E8 */
#define B1_PHY_RX_FD_PHY_RXFD_REG7A_FIELD_QR_SPHERE_IF_QR_MEM_1_RM_VALUE_MASK                                     0x00000007
#define B1_PHY_RX_FD_PHY_RXFD_REG7A_FIELD_QR_SPHERE_IF_QR_MEM_2_RM_VALUE_MASK                                     0x00000070
#define B1_PHY_RX_FD_PHY_RXFD_REG7A_FIELD_QR_SPHERE_IF_QR_MEM_3_RM_VALUE_MASK                                     0x00000700
#define B1_PHY_RX_FD_PHY_RXFD_REG7A_FIELD_QR_SORT_MEM_RM_VALUE_MASK                                               0x00007000
#define B1_PHY_RX_FD_PHY_RXFD_REG7A_FIELD_QR_SORT_MEM_SPHERE_RM_VALUE_MASK                                        0x00070000
#define B1_PHY_RX_FD_PHY_RXFD_REG7A_FIELD_QR_NCO_MEM_RM_VALUE_MASK                                                0x00700000
#define B1_PHY_RX_FD_PHY_RXFD_REG7A_FIELD_QR_SPHERE_OPERATIONS_CALC_MEM_RM_VALUE_MASK                             0x07000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG7B 0x1EC */
#define B1_PHY_RX_FD_PHY_RXFD_REG7B_FIELD_QR_START_ADDR_MASK                                                      0x000003FF
#define B1_PHY_RX_FD_PHY_RXFD_REG7B_FIELD_QR_END_ADDR_MASK                                                        0x000FFC00
#define B1_PHY_RX_FD_PHY_RXFD_REG7B_FIELD_QR_START_ADDR_1SS_MASK                                                  0x3FF00000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG7C 0x1F0 */
#define B1_PHY_RX_FD_PHY_RXFD_REG7C_FIELD_QR_END_ADDR_1SS_MASK                                                    0x000003FF
#define B1_PHY_RX_FD_PHY_RXFD_REG7C_FIELD_SVD_CSD_START_ADDR_MASK                                                 0x000FFC00
#define B1_PHY_RX_FD_PHY_RXFD_REG7C_FIELD_SVD_CSD_END_ADDR_MASK                                                   0x3FF00000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG7D 0x1F4 */
#define B1_PHY_RX_FD_PHY_RXFD_REG7D_FIELD_SVD_TRANS_CSD_START_ADDR_MASK                                           0x000003FF
#define B1_PHY_RX_FD_PHY_RXFD_REG7D_FIELD_SVD_TRANS_CSD_END_ADDR_MASK                                             0x000FFC00
#define B1_PHY_RX_FD_PHY_RXFD_REG7D_FIELD_SVD_QR_START_ADDR_MASK                                                  0x3FF00000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG7E 0x1F8 */
#define B1_PHY_RX_FD_PHY_RXFD_REG7E_FIELD_SVD_QR_END_ADDR_MASK                                                    0x000003FF
#define B1_PHY_RX_FD_PHY_RXFD_REG7E_FIELD_SVD_START_ADDR_IMPLICIT_MASK                                            0x000FFC00
#define B1_PHY_RX_FD_PHY_RXFD_REG7E_FIELD_SVD_END_ADDR_IMPLICIT_MASK                                              0x3FF00000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG7F 0x1FC */
#define B1_PHY_RX_FD_PHY_RXFD_REG7F_FIELD_SVD_MULT_BY_Q_END_ADDR_MASK                                             0x000003FF
#define B1_PHY_RX_FD_PHY_RXFD_REG7F_FIELD_SVD_ADDR_FOR_INDICATION_MASK                                            0x000FFC00
#define B1_PHY_RX_FD_PHY_RXFD_REG7F_FIELD_COMPRESS_4ANT_START_ADDR_MASK                                           0x3FF00000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG80 0x200 */
#define B1_PHY_RX_FD_PHY_RXFD_REG80_FIELD_COMPRESS_4ANT_END_ADDR_MASK                                             0x000003FF
#define B1_PHY_RX_FD_PHY_RXFD_REG80_FIELD_COMPRESS_3ANT_START_ADDR_MASK                                           0x000FFC00
#define B1_PHY_RX_FD_PHY_RXFD_REG80_FIELD_COMPRESS_3ANT_END_ADDR_MASK                                             0x3FF00000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG81 0x204 */
#define B1_PHY_RX_FD_PHY_RXFD_REG81_FIELD_COMPRESS_2ANT_START_ADDR_MASK                                           0x000003FF
#define B1_PHY_RX_FD_PHY_RXFD_REG81_FIELD_COMPRESS_2ANT_END_ADDR_MASK                                             0x000FFC00
#define B1_PHY_RX_FD_PHY_RXFD_REG81_FIELD_DECOMPRESS_4ANT_START_ADDR_MASK                                         0x3FF00000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG82 0x208 */
#define B1_PHY_RX_FD_PHY_RXFD_REG82_FIELD_DECOMPRESS_4ANT_END_ADDR_MASK                                           0x000003FF
#define B1_PHY_RX_FD_PHY_RXFD_REG82_FIELD_DECOMPRESS_3ANT_START_ADDR_MASK                                         0x000FFC00
#define B1_PHY_RX_FD_PHY_RXFD_REG82_FIELD_DECOMPRESS_3ANT_END_ADDR_MASK                                           0x3FF00000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG83 0x20C */
#define B1_PHY_RX_FD_PHY_RXFD_REG83_FIELD_DECOMPRESS_2ANT_START_ADDR_MASK                                         0x000003FF
#define B1_PHY_RX_FD_PHY_RXFD_REG83_FIELD_DECOMPRESS_2ANT_END_ADDR_MASK                                           0x000FFC00
#define B1_PHY_RX_FD_PHY_RXFD_REG83_FIELD_STBC_START_ADDR_MASK                                                    0x3FF00000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG84 0x210 */
#define B1_PHY_RX_FD_PHY_RXFD_REG84_FIELD_STBC_END_ADDR_MASK                                                      0x000003FF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG86 0x218 */
#define B1_PHY_RX_FD_PHY_RXFD_REG86_FIELD_COMPRESSED_FOURIER_PHASE_0_MASK                                         0x00003FFF
#define B1_PHY_RX_FD_PHY_RXFD_REG86_FIELD_COMPRESSED_FOURIER_PHASE_1_MASK                                         0x3FFF0000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG87 0x21C */
#define B1_PHY_RX_FD_PHY_RXFD_REG87_FIELD_COMPRESSED_FOURIER_PHASE_6_MASK                                         0x00003FFF
#define B1_PHY_RX_FD_PHY_RXFD_REG87_FIELD_COMPRESSED_FOURIER_PHASE_7_MASK                                         0x3FFF0000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG88 0x220 */
#define B1_PHY_RX_FD_PHY_RXFD_REG88_FIELD_COMPRESSED_FOURIER_PHASE_8_MASK                                         0x00003FFF
#define B1_PHY_RX_FD_PHY_RXFD_REG88_FIELD_COMPRESSED_FOURIER_PHASE_9_MASK                                         0x3FFF0000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG89 0x224 */
#define B1_PHY_RX_FD_PHY_RXFD_REG89_FIELD_COMPRESSED_FOURIER_PHASE_10_MASK                                        0x00003FFF
#define B1_PHY_RX_FD_PHY_RXFD_REG89_FIELD_COMPRESSED_FOURIER_PHASE_11_MASK                                        0x3FFF0000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG8A 0x228 */
#define B1_PHY_RX_FD_PHY_RXFD_REG8A_FIELD_CE_TABLE_6_START_MASK                                                   0x000003FF
#define B1_PHY_RX_FD_PHY_RXFD_REG8A_FIELD_CE_TABLE_END_ADDR_MASK                                                  0x003FF000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG8B 0x22C */
#define B1_PHY_RX_FD_PHY_RXFD_REG8B_FIELD_NCB_PRANK4_MASK_AN0_MASK                                                0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REG8B_FIELD_NCB_PRANK4_MASK_AN1_MASK                                                0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REG8B_FIELD_NCB_PRANK4_MASK_AN2_MASK                                                0x00FF0000
#define B1_PHY_RX_FD_PHY_RXFD_REG8B_FIELD_NCB_PRANK4_MASK_AN3_MASK                                                0xFF000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG8C 0x230 */
#define B1_PHY_RX_FD_PHY_RXFD_REG8C_FIELD_FCB_PRANK4_MASK_AN0_MASK                                                0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REG8C_FIELD_FCB_PRANK4_MASK_AN1_MASK                                                0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REG8C_FIELD_FCB_PRANK4_MASK_AN2_MASK                                                0x00FF0000
#define B1_PHY_RX_FD_PHY_RXFD_REG8C_FIELD_FCB_PRANK4_MASK_AN3_MASK                                                0xFF000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG8D 0x234 */
#define B1_PHY_RX_FD_PHY_RXFD_REG8D_FIELD_CB80_PRANK1_MASK_MASK                                                   0x000000FF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_IF08E 0x238 */
#define B1_PHY_RX_FD_PHY_RXFD_IF08E_FIELD_QR_MAX_PRESCALE_1SS_QR_MASK                                             0x00000007
#define B1_PHY_RX_FD_PHY_RXFD_IF08E_FIELD_QR_MAX_PRESCALE_2SS_QR_MASK                                             0x00000070
#define B1_PHY_RX_FD_PHY_RXFD_IF08E_FIELD_QR_MAX_PRESCALE_3SS_QR_MASK                                             0x00000700
#define B1_PHY_RX_FD_PHY_RXFD_IF08E_FIELD_QR_MAX_PRESCALE_4SS_QR_MASK                                             0x00007000
#define B1_PHY_RX_FD_PHY_RXFD_IF08E_FIELD_QR_MAX_PRESCALE_1SS_QAPPLY_MASK                                         0x00070000
#define B1_PHY_RX_FD_PHY_RXFD_IF08E_FIELD_QR_MAX_PRESCALE_2SS_QAPPLY_MASK                                         0x00700000
#define B1_PHY_RX_FD_PHY_RXFD_IF08E_FIELD_QR_MAX_PRESCALE_3SS_QAPPLY_MASK                                         0x07000000
#define B1_PHY_RX_FD_PHY_RXFD_IF08E_FIELD_QR_MAX_PRESCALE_4SS_QAPPLY_MASK                                         0x70000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG90 0x240 */
#define B1_PHY_RX_FD_PHY_RXFD_REG90_FIELD_FD_VHT_SIGB_JUMP_ADD_MASK                                               0x0000000F
#define B1_PHY_RX_FD_PHY_RXFD_REG90_FIELD_TD_VHT_SIGB_JUMP_ADD_MASK                                               0x000000F0
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG91 0x244 */
#define B1_PHY_RX_FD_PHY_RXFD_REG91_FIELD_CB80_SHORT_CP_TIM_SHIFT_MASK                                            0x0000001F
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG92 0x248 */
#define B1_PHY_RX_FD_PHY_RXFD_REG92_FIELD_CH_ESTI_SMOOTH_RM_VALUE_MASK                                            0x00000007
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG93 0x24C */
#define B1_PHY_RX_FD_PHY_RXFD_REG93_FIELD_LONG3_CB80_PRANK1_MASK_MASK                                             0x000000FF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG94 0x250 */
#define B1_PHY_RX_FD_PHY_RXFD_REG94_FIELD_HYP_RXFD_GPR1_MASK                                                      0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG95 0x254 */
#define B1_PHY_RX_FD_PHY_RXFD_REG95_FIELD_HYP_RXFD_GPR2_MASK                                                      0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG96 0x258 */
#define B1_PHY_RX_FD_PHY_RXFD_REG96_FIELD_HYP_RXFD_GPR3_MASK                                                      0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG97 0x25C */
#define B1_PHY_RX_FD_PHY_RXFD_REG97_FIELD_HYP_RXFD_GPR4_MASK                                                      0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG98 0x260 */
#define B1_PHY_RX_FD_PHY_RXFD_REG98_FIELD_TX_CT_SM_MATRIX_CUSTOM1_2SS_0_I_MASK                                    0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REG98_FIELD_TX_CT_SM_MATRIX_CUSTOM1_2SS_0_Q_MASK                                    0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REG98_FIELD_TX_CT_SM_MATRIX_CUSTOM1_2SS_1_I_MASK                                    0x00FF0000
#define B1_PHY_RX_FD_PHY_RXFD_REG98_FIELD_TX_CT_SM_MATRIX_CUSTOM1_2SS_1_Q_MASK                                    0xFF000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG99 0x264 */
#define B1_PHY_RX_FD_PHY_RXFD_REG99_FIELD_TX_CT_SM_MATRIX_CUSTOM1_2SS_2_I_MASK                                    0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REG99_FIELD_TX_CT_SM_MATRIX_CUSTOM1_2SS_2_Q_MASK                                    0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REG99_FIELD_TX_CT_SM_MATRIX_CUSTOM1_2SS_3_I_MASK                                    0x00FF0000
#define B1_PHY_RX_FD_PHY_RXFD_REG99_FIELD_TX_CT_SM_MATRIX_CUSTOM1_2SS_3_Q_MASK                                    0xFF000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG9A 0x268 */
#define B1_PHY_RX_FD_PHY_RXFD_REG9A_FIELD_TX_CT_SM_MATRIX_CUSTOM1_2SS_4_I_MASK                                    0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REG9A_FIELD_TX_CT_SM_MATRIX_CUSTOM1_2SS_4_Q_MASK                                    0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REG9A_FIELD_TX_CT_SM_MATRIX_CUSTOM1_2SS_5_I_MASK                                    0x00FF0000
#define B1_PHY_RX_FD_PHY_RXFD_REG9A_FIELD_TX_CT_SM_MATRIX_CUSTOM1_2SS_5_Q_MASK                                    0xFF000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG9B 0x26C */
#define B1_PHY_RX_FD_PHY_RXFD_REG9B_FIELD_TX_CT_SM_MATRIX_CUSTOM1_2SS_6_I_MASK                                    0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REG9B_FIELD_TX_CT_SM_MATRIX_CUSTOM1_2SS_6_Q_MASK                                    0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REG9B_FIELD_TX_CT_SM_MATRIX_CUSTOM1_2SS_7_I_MASK                                    0x00FF0000
#define B1_PHY_RX_FD_PHY_RXFD_REG9B_FIELD_TX_CT_SM_MATRIX_CUSTOM1_2SS_7_Q_MASK                                    0xFF000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG9C 0x270 */
#define B1_PHY_RX_FD_PHY_RXFD_REG9C_FIELD_TX_CT_SM_MATRIX_CUSTOM2_2SS_0_I_MASK                                    0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REG9C_FIELD_TX_CT_SM_MATRIX_CUSTOM2_2SS_0_Q_MASK                                    0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REG9C_FIELD_TX_CT_SM_MATRIX_CUSTOM2_2SS_1_I_MASK                                    0x00FF0000
#define B1_PHY_RX_FD_PHY_RXFD_REG9C_FIELD_TX_CT_SM_MATRIX_CUSTOM2_2SS_1_Q_MASK                                    0xFF000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG9D 0x274 */
#define B1_PHY_RX_FD_PHY_RXFD_REG9D_FIELD_TX_CT_SM_MATRIX_CUSTOM2_2SS_2_I_MASK                                    0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REG9D_FIELD_TX_CT_SM_MATRIX_CUSTOM2_2SS_2_Q_MASK                                    0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REG9D_FIELD_TX_CT_SM_MATRIX_CUSTOM2_2SS_3_I_MASK                                    0x00FF0000
#define B1_PHY_RX_FD_PHY_RXFD_REG9D_FIELD_TX_CT_SM_MATRIX_CUSTOM2_2SS_3_Q_MASK                                    0xFF000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG9E 0x278 */
#define B1_PHY_RX_FD_PHY_RXFD_REG9E_FIELD_TX_CT_SM_MATRIX_CUSTOM2_2SS_4_I_MASK                                    0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REG9E_FIELD_TX_CT_SM_MATRIX_CUSTOM2_2SS_4_Q_MASK                                    0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REG9E_FIELD_TX_CT_SM_MATRIX_CUSTOM2_2SS_5_I_MASK                                    0x00FF0000
#define B1_PHY_RX_FD_PHY_RXFD_REG9E_FIELD_TX_CT_SM_MATRIX_CUSTOM2_2SS_5_Q_MASK                                    0xFF000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG9F 0x27C */
#define B1_PHY_RX_FD_PHY_RXFD_REG9F_FIELD_TX_CT_SM_MATRIX_CUSTOM2_2SS_6_I_MASK                                    0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REG9F_FIELD_TX_CT_SM_MATRIX_CUSTOM2_2SS_6_Q_MASK                                    0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REG9F_FIELD_TX_CT_SM_MATRIX_CUSTOM2_2SS_7_I_MASK                                    0x00FF0000
#define B1_PHY_RX_FD_PHY_RXFD_REG9F_FIELD_TX_CT_SM_MATRIX_CUSTOM2_2SS_7_Q_MASK                                    0xFF000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGA0 0x280 */
#define B1_PHY_RX_FD_PHY_RXFD_REGA0_FIELD_TX_CT_SM_MATRIX_CUSTOM1_3SS_0_I_MASK                                    0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REGA0_FIELD_TX_CT_SM_MATRIX_CUSTOM1_3SS_0_Q_MASK                                    0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REGA0_FIELD_TX_CT_SM_MATRIX_CUSTOM1_3SS_1_I_MASK                                    0x00FF0000
#define B1_PHY_RX_FD_PHY_RXFD_REGA0_FIELD_TX_CT_SM_MATRIX_CUSTOM1_3SS_1_Q_MASK                                    0xFF000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGA1 0x284 */
#define B1_PHY_RX_FD_PHY_RXFD_REGA1_FIELD_TX_CT_SM_MATRIX_CUSTOM1_3SS_2_I_MASK                                    0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REGA1_FIELD_TX_CT_SM_MATRIX_CUSTOM1_3SS_2_Q_MASK                                    0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REGA1_FIELD_TX_CT_SM_MATRIX_CUSTOM1_3SS_3_I_MASK                                    0x00FF0000
#define B1_PHY_RX_FD_PHY_RXFD_REGA1_FIELD_TX_CT_SM_MATRIX_CUSTOM1_3SS_3_Q_MASK                                    0xFF000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGA2 0x288 */
#define B1_PHY_RX_FD_PHY_RXFD_REGA2_FIELD_TX_CT_SM_MATRIX_CUSTOM1_3SS_4_I_MASK                                    0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REGA2_FIELD_TX_CT_SM_MATRIX_CUSTOM1_3SS_4_Q_MASK                                    0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REGA2_FIELD_TX_CT_SM_MATRIX_CUSTOM1_3SS_5_I_MASK                                    0x00FF0000
#define B1_PHY_RX_FD_PHY_RXFD_REGA2_FIELD_TX_CT_SM_MATRIX_CUSTOM1_3SS_5_Q_MASK                                    0xFF000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGA3 0x28C */
#define B1_PHY_RX_FD_PHY_RXFD_REGA3_FIELD_TX_CT_SM_MATRIX_CUSTOM1_3SS_6_I_MASK                                    0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REGA3_FIELD_TX_CT_SM_MATRIX_CUSTOM1_3SS_6_Q_MASK                                    0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REGA3_FIELD_TX_CT_SM_MATRIX_CUSTOM1_3SS_7_I_MASK                                    0x00FF0000
#define B1_PHY_RX_FD_PHY_RXFD_REGA3_FIELD_TX_CT_SM_MATRIX_CUSTOM1_3SS_7_Q_MASK                                    0xFF000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGA4 0x290 */
#define B1_PHY_RX_FD_PHY_RXFD_REGA4_FIELD_TX_CT_SM_MATRIX_CUSTOM1_3SS_8_I_MASK                                    0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REGA4_FIELD_TX_CT_SM_MATRIX_CUSTOM1_3SS_8_Q_MASK                                    0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REGA4_FIELD_TX_CT_SM_MATRIX_CUSTOM1_3SS_9_I_MASK                                    0x00FF0000
#define B1_PHY_RX_FD_PHY_RXFD_REGA4_FIELD_TX_CT_SM_MATRIX_CUSTOM1_3SS_9_Q_MASK                                    0xFF000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGA5 0x294 */
#define B1_PHY_RX_FD_PHY_RXFD_REGA5_FIELD_TX_CT_SM_MATRIX_CUSTOM1_3SS_10_I_MASK                                   0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REGA5_FIELD_TX_CT_SM_MATRIX_CUSTOM1_3SS_10_Q_MASK                                   0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REGA5_FIELD_TX_CT_SM_MATRIX_CUSTOM1_3SS_11_I_MASK                                   0x00FF0000
#define B1_PHY_RX_FD_PHY_RXFD_REGA5_FIELD_TX_CT_SM_MATRIX_CUSTOM1_3SS_11_Q_MASK                                   0xFF000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGA6 0x298 */
#define B1_PHY_RX_FD_PHY_RXFD_REGA6_FIELD_TX_CT_SM_MATRIX_CUSTOM2_3SS_0_I_MASK                                    0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REGA6_FIELD_TX_CT_SM_MATRIX_CUSTOM2_3SS_0_Q_MASK                                    0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REGA6_FIELD_TX_CT_SM_MATRIX_CUSTOM2_3SS_1_I_MASK                                    0x00FF0000
#define B1_PHY_RX_FD_PHY_RXFD_REGA6_FIELD_TX_CT_SM_MATRIX_CUSTOM2_3SS_1_Q_MASK                                    0xFF000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGA7 0x29C */
#define B1_PHY_RX_FD_PHY_RXFD_REGA7_FIELD_TX_CT_SM_MATRIX_CUSTOM2_3SS_2_I_MASK                                    0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REGA7_FIELD_TX_CT_SM_MATRIX_CUSTOM2_3SS_2_Q_MASK                                    0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REGA7_FIELD_TX_CT_SM_MATRIX_CUSTOM2_3SS_3_I_MASK                                    0x00FF0000
#define B1_PHY_RX_FD_PHY_RXFD_REGA7_FIELD_TX_CT_SM_MATRIX_CUSTOM2_3SS_3_Q_MASK                                    0xFF000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGA8 0x2A0 */
#define B1_PHY_RX_FD_PHY_RXFD_REGA8_FIELD_TX_CT_SM_MATRIX_CUSTOM2_3SS_4_I_MASK                                    0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REGA8_FIELD_TX_CT_SM_MATRIX_CUSTOM2_3SS_4_Q_MASK                                    0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REGA8_FIELD_TX_CT_SM_MATRIX_CUSTOM2_3SS_5_I_MASK                                    0x00FF0000
#define B1_PHY_RX_FD_PHY_RXFD_REGA8_FIELD_TX_CT_SM_MATRIX_CUSTOM2_3SS_5_Q_MASK                                    0xFF000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGA9 0x2A4 */
#define B1_PHY_RX_FD_PHY_RXFD_REGA9_FIELD_TX_CT_SM_MATRIX_CUSTOM2_3SS_6_I_MASK                                    0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REGA9_FIELD_TX_CT_SM_MATRIX_CUSTOM2_3SS_6_Q_MASK                                    0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REGA9_FIELD_TX_CT_SM_MATRIX_CUSTOM2_3SS_7_I_MASK                                    0x00FF0000
#define B1_PHY_RX_FD_PHY_RXFD_REGA9_FIELD_TX_CT_SM_MATRIX_CUSTOM2_3SS_7_Q_MASK                                    0xFF000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGAA 0x2A8 */
#define B1_PHY_RX_FD_PHY_RXFD_REGAA_FIELD_TX_CT_SM_MATRIX_CUSTOM2_3SS_8_I_MASK                                    0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REGAA_FIELD_TX_CT_SM_MATRIX_CUSTOM2_3SS_8_Q_MASK                                    0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REGAA_FIELD_TX_CT_SM_MATRIX_CUSTOM2_3SS_9_I_MASK                                    0x00FF0000
#define B1_PHY_RX_FD_PHY_RXFD_REGAA_FIELD_TX_CT_SM_MATRIX_CUSTOM2_3SS_9_Q_MASK                                    0xFF000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGAB 0x2AC */
#define B1_PHY_RX_FD_PHY_RXFD_REGAB_FIELD_TX_CT_SM_MATRIX_CUSTOM2_3SS_10_I_MASK                                   0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REGAB_FIELD_TX_CT_SM_MATRIX_CUSTOM2_3SS_10_Q_MASK                                   0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REGAB_FIELD_TX_CT_SM_MATRIX_CUSTOM2_3SS_11_I_MASK                                   0x00FF0000
#define B1_PHY_RX_FD_PHY_RXFD_REGAB_FIELD_TX_CT_SM_MATRIX_CUSTOM2_3SS_11_Q_MASK                                   0xFF000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGBE 0x2F8 */
#define B1_PHY_RX_FD_PHY_RXFD_REGBE_FIELD_AVG_SNR_ADD_FACTOR_MASK                                                 0x00000FFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGC0 0x300 */
#define B1_PHY_RX_FD_PHY_RXFD_REGC0_FIELD_FFT_RND_HB20160_MASK                                                    0x00000003
#define B1_PHY_RX_FD_PHY_RXFD_REGC0_FIELD_FFT_RND_HB40160_MASK                                                    0x0000000C
#define B1_PHY_RX_FD_PHY_RXFD_REGC0_FIELD_FFT_RND_HB80160_MASK                                                    0x00000030
#define B1_PHY_RX_FD_PHY_RXFD_REGC0_FIELD_BYPASS_HALT_SPHERE_MASK                                                 0x00000100
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGC1 0x304 */
#define B1_PHY_RX_FD_PHY_RXFD_REGC1_FIELD_MU_QR_DECOMPRESS_4ANT_START_ADDR_MASK                                   0x000003FF
#define B1_PHY_RX_FD_PHY_RXFD_REGC1_FIELD_MU_QR_DECOMPRESS_4ANT_END_ADDR_MASK                                     0x003FF000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGC2 0x308 */
#define B1_PHY_RX_FD_PHY_RXFD_REGC2_FIELD_MU_QR_DECOMPRESS_3ANT_START_ADDR_MASK                                   0x000003FF
#define B1_PHY_RX_FD_PHY_RXFD_REGC2_FIELD_MU_QR_DECOMPRESS_3ANT_END_ADDR_MASK                                     0x003FF000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGC3 0x30C */
#define B1_PHY_RX_FD_PHY_RXFD_REGC3_FIELD_MU_QR_DECOMPRESS_2ANT_START_ADDR_MASK                                   0x000003FF
#define B1_PHY_RX_FD_PHY_RXFD_REGC3_FIELD_MU_QR_DECOMPRESS_2ANT_END_ADDR_MASK                                     0x003FF000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGC4 0x310 */
#define B1_PHY_RX_FD_PHY_RXFD_REGC4_FIELD_MU_QR_QAPPLY_START_ADDR_MASK                                            0x000003FF
#define B1_PHY_RX_FD_PHY_RXFD_REGC4_FIELD_MU_QR_QAPPLY_END_ADDR_MASK                                              0x003FF000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGC5 0x314 */
#define B1_PHY_RX_FD_PHY_RXFD_REGC5_FIELD_MU_PHASES_RM_VALUE_MASK                                                 0x00000007
#define B1_PHY_RX_FD_PHY_RXFD_REGC5_FIELD_MU_TRAIN_EFF_RATE_RM_VALUE_MASK                                         0x00000070
#define B1_PHY_RX_FD_PHY_RXFD_REGC5_FIELD_MU_DELTA_SNR_RM_VALUE_MASK                                              0x00000700
#define B1_PHY_RX_FD_PHY_RXFD_REGC5_FIELD_HYP_RXFD_E_SNR_GAMA_RAM_RM_MASK                                         0x00007000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGC6 0x318 */
#define B1_PHY_RX_FD_PHY_RXFD_REGC6_FIELD_MU_QR_4X2_START_ADDR_MASK                                               0x000003FF
#define B1_PHY_RX_FD_PHY_RXFD_REGC6_FIELD_MU_QR_4X2_END_ADDR_MASK                                                 0x003FF000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGCB 0x32C */
#define B1_PHY_RX_FD_PHY_RXFD_REGCB_FIELD_BF_HT_CODEBOOK_INFO_MASK                                                0x00000003
#define B1_PHY_RX_FD_PHY_RXFD_REGCB_FIELD_BF_VHT_CODEBOOK_INFO_MASK                                               0x00000004
#define B1_PHY_RX_FD_PHY_RXFD_REGCB_FIELD_BF_VHT_MU_CODEBOOK_INFO_MASK                                            0x00000008
#define B1_PHY_RX_FD_PHY_RXFD_REGCB_FIELD_BF_HE_CODEBOOK_INFO_MASK                                                0x00000010
#define B1_PHY_RX_FD_PHY_RXFD_REGCB_FIELD_BF_HE_MU_CODEBOOK_INFO_MASK                                             0x00000020
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGCC 0x330 */
#define B1_PHY_RX_FD_PHY_RXFD_REGCC_FIELD_LLTF_SMOOTH_EN_MASK                                                     0x00000001
#define B1_PHY_RX_FD_PHY_RXFD_REGCC_FIELD_HTLTF_SMOOTH_EN_MASK                                                    0x00000010
#define B1_PHY_RX_FD_PHY_RXFD_REGCC_FIELD_FORCE_SPECIAL_FILTERS_MASK                                              0x00000100
#define B1_PHY_RX_FD_PHY_RXFD_REGCC_FIELD_USE_SNR_EST_L_MASK                                                      0x00001000
#define B1_PHY_RX_FD_PHY_RXFD_REGCC_FIELD_USE_SNR_EST_HT_MASK                                                     0x00002000
#define B1_PHY_RX_FD_PHY_RXFD_REGCC_FIELD_CP_OVERRIDE_MASK                                                        0x00030000
#define B1_PHY_RX_FD_PHY_RXFD_REGCC_FIELD_SMOOTH_IF_BF_MASK                                                       0x00100000
#define B1_PHY_RX_FD_PHY_RXFD_REGCC_FIELD_SMOOTH_HE_SU_BF_2X_EN_MASK                                              0x01000000
#define B1_PHY_RX_FD_PHY_RXFD_REGCC_FIELD_SMOOTH_HE_SU_BF_4X_EN_MASK                                              0x10000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGCD 0x334 */
#define B1_PHY_RX_FD_PHY_RXFD_REGCD_FIELD_SNR_THRESHOLD_LOW_MASK                                                  0x0000007F
#define B1_PHY_RX_FD_PHY_RXFD_REGCD_FIELD_SNR_THRESHOLD_MEDIUM_MASK                                               0x00007F00
#define B1_PHY_RX_FD_PHY_RXFD_REGCD_FIELD_SNR_THRESHOLD_HIGH_MASK                                                 0x007F0000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGCE 0x338 */
#define B1_PHY_RX_FD_PHY_RXFD_REGCE_FIELD_TIMING_OFFSET_CP04_MASK                                                 0x0000000F
#define B1_PHY_RX_FD_PHY_RXFD_REGCE_FIELD_TIMING_OFFSET_CP08_MASK                                                 0x000000F0
#define B1_PHY_RX_FD_PHY_RXFD_REGCE_FIELD_TIMING_OFFSET_CP16_MASK                                                 0x00000F00
#define B1_PHY_RX_FD_PHY_RXFD_REGCE_FIELD_TIMING_OFFSET_CP32_MASK                                                 0x0000F000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGCF 0x33C */
#define B1_PHY_RX_FD_PHY_RXFD_REGCF_FIELD_PT_SU_PH_HIS_BPSK_MASK                                                  0x0000000F
#define B1_PHY_RX_FD_PHY_RXFD_REGCF_FIELD_PT_SU_PH_HIS_QPSK_MASK                                                  0x000000F0
#define B1_PHY_RX_FD_PHY_RXFD_REGCF_FIELD_PT_SU_PH_HIS_16QAM_MASK                                                 0x00000F00
#define B1_PHY_RX_FD_PHY_RXFD_REGCF_FIELD_PT_SU_PH_HIS_64QAM_MASK                                                 0x0000F000
#define B1_PHY_RX_FD_PHY_RXFD_REGCF_FIELD_PT_TRIG_PH_HIS_BPSK_MASK                                                0x000F0000
#define B1_PHY_RX_FD_PHY_RXFD_REGCF_FIELD_PT_TRIG_PH_HIS_QPSK_MASK                                                0x00F00000
#define B1_PHY_RX_FD_PHY_RXFD_REGCF_FIELD_PT_TRIG_PH_HIS_16QAM_MASK                                               0x0F000000
#define B1_PHY_RX_FD_PHY_RXFD_REGCF_FIELD_PT_TRIG_PH_HIS_64QAM_MASK                                               0xF0000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGD0 0x340 */
#define B1_PHY_RX_FD_PHY_RXFD_REGD0_FIELD_PT_SU_TIM_HIS_BPSK_MASK                                                 0x0000001F
#define B1_PHY_RX_FD_PHY_RXFD_REGD0_FIELD_PT_SU_TIM_HIS_QPSK_MASK                                                 0x000003E0
#define B1_PHY_RX_FD_PHY_RXFD_REGD0_FIELD_PT_SU_TIM_HIS_16QAM_MASK                                                0x00007C00
#define B1_PHY_RX_FD_PHY_RXFD_REGD0_FIELD_PT_SU_TIM_HIS_64QAM_MASK                                                0x000F8000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGD1 0x344 */
#define B1_PHY_RX_FD_PHY_RXFD_REGD1_FIELD_PT_TRIG_TIM_HIS_BPSK_MASK                                               0x0000001F
#define B1_PHY_RX_FD_PHY_RXFD_REGD1_FIELD_PT_TRIG_TIM_HIS_QPSK_MASK                                               0x000003E0
#define B1_PHY_RX_FD_PHY_RXFD_REGD1_FIELD_PT_TRIG_TIM_HIS_16QAM_MASK                                              0x00007C00
#define B1_PHY_RX_FD_PHY_RXFD_REGD1_FIELD_PT_TRIG_TIM_HIS_64QAM_MASK                                              0x000F8000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGD2 0x348 */
#define B1_PHY_RX_FD_PHY_RXFD_REGD2_FIELD_PT_DUP_PHASE_TRACK_MASK                                                 0x00000001
#define B1_PHY_RX_FD_PHY_RXFD_REGD2_FIELD_PT_MISC_MASK                                                            0xFFFFFFFE
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGD3 0x34C */
#define B1_PHY_RX_FD_PHY_RXFD_REGD3_FIELD_LONG3_CB160_PRANK1_MASK_MASK                                            0x0000FFFF
#define B1_PHY_RX_FD_PHY_RXFD_REGD3_FIELD_CB160_PRANK1_MASK_MASK                                                  0xFFFF0000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGD4 0x350 */
#define B1_PHY_RX_FD_PHY_RXFD_REGD4_FIELD_SMOOTH_INTERP_FILTER_RAM_RM_MASK                                        0x00000007
#define B1_PHY_RX_FD_PHY_RXFD_REGD4_FIELD_SMOOTH_INTERP_USER_RU_MAP_RM_MASK                                       0x00000038
#define B1_PHY_RX_FD_PHY_RXFD_REGD4_FIELD_SMOOTH_INTERP_MCS_SNR_RAM_RM_MASK                                       0x000001C0
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGD5 0x354 */
#define B1_PHY_RX_FD_PHY_RXFD_REGD5_FIELD_SMOOTH_INTERP_MISC_MASK                                                 0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGD6 0x358 */
#define B1_PHY_RX_FD_PHY_RXFD_REGD6_FIELD_SMOOTH_INTERP_MISC2_MASK                                                0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGD7 0x35C */
#define B1_PHY_RX_FD_PHY_RXFD_REGD7_FIELD_CH_ENERGY_E_NORM_LUT_3_0_MASK                                           0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGD8 0x360 */
#define B1_PHY_RX_FD_PHY_RXFD_REGD8_FIELD_CH_ENERGY_E_NORM_LUT_7_4_MASK                                           0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGD9 0x364 */
#define B1_PHY_RX_FD_PHY_RXFD_REGD9_FIELD_CH_ENERGY_E_NORM_LUT_11_8_MASK                                          0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGDA 0x368 */
#define B1_PHY_RX_FD_PHY_RXFD_REGDA_FIELD_CH_ENERGY_E_NORM_LUT_15_12_MASK                                         0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGDB 0x36C */
#define B1_PHY_RX_FD_PHY_RXFD_REGDB_FIELD_CH_ENERGY_E_NORM_LUT_SNR_SHIFT_MASK                                     0x000001FF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGDC 0x370 */
#define B1_PHY_RX_FD_PHY_RXFD_REGDC_FIELD_HE_FD_DET_SNR_THRESHOLD_MASK                                            0x0000007F
#define B1_PHY_RX_FD_PHY_RXFD_REGDC_FIELD_HE_FD_DET_VIT_ERROR_THRESHOLD_MASK                                      0x00007F00
#define B1_PHY_RX_FD_PHY_RXFD_REGDC_FIELD_HE_FD_DET_DECISION_THRESHOLD_MASK                                       0x007F0000
#define B1_PHY_RX_FD_PHY_RXFD_REGDC_FIELD_HE_FD_DET_MAX_DET_BW_MASK                                               0x03000000
#define B1_PHY_RX_FD_PHY_RXFD_REGDC_FIELD_HE_FD_DET_EXT_ONLY_MASK                                                 0x10000000
#define B1_PHY_RX_FD_PHY_RXFD_REGDC_FIELD_HE_FD_DET_EN_MASK                                                       0x80000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGDD 0x374 */
#define B1_PHY_RX_FD_PHY_RXFD_REGDD_FIELD_FFT_OUT_SHIFT_26B_MASK                                                  0x00000003
#define B1_PHY_RX_FD_PHY_RXFD_REGDD_FIELD_FFT_OUT_SHIFT_52B_MASK                                                  0x0000000C
#define B1_PHY_RX_FD_PHY_RXFD_REGDD_FIELD_FFT_OUT_SHIFT_106B_MASK                                                 0x00000030
#define B1_PHY_RX_FD_PHY_RXFD_REGDD_FIELD_FFT_OUT_SHIFT_20_MASK                                                   0x000000C0
#define B1_PHY_RX_FD_PHY_RXFD_REGDD_FIELD_FFT_OUT_SHIFT_40_MASK                                                   0x00000300
#define B1_PHY_RX_FD_PHY_RXFD_REGDD_FIELD_FFT_OUT_SHIFT_80_MASK                                                   0x00000C00
#define B1_PHY_RX_FD_PHY_RXFD_REGDD_FIELD_FFT_OUT_SHIFT_160_MASK                                                  0x00003000
#define B1_PHY_RX_FD_PHY_RXFD_REGDD_FIELD_FFT_OUT_SHIFT_HESTF_MASK                                                0x0000C000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGDE 0x378 */
#define B1_PHY_RX_FD_PHY_RXFD_REGDE_FIELD_FFT_OUT_MULT_26B_MASK                                                   0x0000000F
#define B1_PHY_RX_FD_PHY_RXFD_REGDE_FIELD_FFT_OUT_MULT_52B_MASK                                                   0x000000F0
#define B1_PHY_RX_FD_PHY_RXFD_REGDE_FIELD_FFT_OUT_MULT_106B_MASK                                                  0x00000F00
#define B1_PHY_RX_FD_PHY_RXFD_REGDE_FIELD_FFT_OUT_MULT_20_MASK                                                    0x0000F000
#define B1_PHY_RX_FD_PHY_RXFD_REGDE_FIELD_FFT_OUT_MULT_40_MASK                                                    0x000F0000
#define B1_PHY_RX_FD_PHY_RXFD_REGDE_FIELD_FFT_OUT_MULT_80_MASK                                                    0x00F00000
#define B1_PHY_RX_FD_PHY_RXFD_REGDE_FIELD_FFT_OUT_MULT_160_MASK                                                   0x0F000000
#define B1_PHY_RX_FD_PHY_RXFD_REGDE_FIELD_FFT_OUT_MULT_HESTF_MASK                                                 0xF0000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGDF 0x37C */
#define B1_PHY_RX_FD_PHY_RXFD_REGDF_FIELD_PT_PHASE_LIMIT_MASK                                                     0x000003FF
#define B1_PHY_RX_FD_PHY_RXFD_REGDF_FIELD_PT_PHASE_LIMIT_TRIG_BASED_MASK                                          0x000FFC00
#define B1_PHY_RX_FD_PHY_RXFD_REGDF_FIELD_PT_TIMING_LIMIT_MASK                                                    0x3FF00000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGE0 0x380 */
#define B1_PHY_RX_FD_PHY_RXFD_REGE0_FIELD_PT_TIMING_LIMIT_TRIG_BASED_MASK                                         0x000003FF
#define B1_PHY_RX_FD_PHY_RXFD_REGE0_FIELD_PT_FFT_K_USER_RAM_RM_MASK                                               0x00007C00
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGE1 0x384 */
#define B1_PHY_RX_FD_PHY_RXFD_REGE1_FIELD_NOISE_INIT_REG_FROM_TD_MASK                                             0x007FFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGE2 0x388 */
#define B1_PHY_RX_FD_PHY_RXFD_REGE2_FIELD_RSSI_PER_RU_RAM_RM_MASK                                                 0x00000007
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGE3 0x38C */
#define B1_PHY_RX_FD_PHY_RXFD_REGE3_FIELD_HE_FD_DET_PRE_LOAD_RAM_RM_MASK                                          0x00000007
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGE4 0x390 */
#define B1_PHY_RX_FD_PHY_RXFD_REGE4_FIELD_HE_FD_DET_LSIG_METRIC_MASK                                              0x00007FFF
#define B1_PHY_RX_FD_PHY_RXFD_REGE4_FIELD_HE_FD_DET_RLSIG_METRIC_MASK                                             0x7FFF0000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGE5 0x394 */
#define B1_PHY_RX_FD_PHY_RXFD_REGE5_FIELD_HE_FD_DET_METRIC_MASK                                                   0x00007FFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGE6 0x398 */
#define B1_PHY_RX_FD_PHY_RXFD_REGE6_FIELD_CT_DATA_E4_IN_FOR_IIR0_MASK                                             0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGE7 0x39C */
#define B1_PHY_RX_FD_PHY_RXFD_REGE7_FIELD_CT_DATA_E4_IN_FOR_IIR1_MASK                                             0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGE8 0x3A0 */
#define B1_PHY_RX_FD_PHY_RXFD_REGE8_FIELD_CT_DATA_E4_IN_FOR_IIR2_MASK                                             0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGE9 0x3A4 */
#define B1_PHY_RX_FD_PHY_RXFD_REGE9_FIELD_CT_DATA_E4_IN_FOR_IIR3_MASK                                             0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGEA 0x3A8 */
#define B1_PHY_RX_FD_PHY_RXFD_REGEA_FIELD_CT_DATA_E4_IN_FOR_IIR4_MASK                                             0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGEB 0x3AC */
#define B1_PHY_RX_FD_PHY_RXFD_REGEB_FIELD_SPHERE_MAX_LLR_MASK                                                     0x000003FF
#define B1_PHY_RX_FD_PHY_RXFD_REGEB_FIELD_SPHERE_NOISE_POWER_PROG_MODEL_MASK                                      0x00007000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGEC 0x3B0 */
#define B1_PHY_RX_FD_PHY_RXFD_REGEC_FIELD_SPHERE_TREE_PART_THR_MASK                                               0x00000007
#define B1_PHY_RX_FD_PHY_RXFD_REGEC_FIELD_SPHERE_LLR_THRESHOLD_MASK                                               0x000001F0
#define B1_PHY_RX_FD_PHY_RXFD_REGEC_FIELD_SPHERE_NOISE_POWER_TREE_PART_THR_MASK                                   0x00000200
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGED 0x3B4 */
#define B1_PHY_RX_FD_PHY_RXFD_REGED_FIELD_LINEAR_FIFO_RAM_RM_MASK                                                 0x00000007
#define B1_PHY_RX_FD_PHY_RXFD_REGED_FIELD_SPHERE_FIFO_RAM_RM_MASK                                                 0x00000070
#define B1_PHY_RX_FD_PHY_RXFD_REGED_FIELD_TCR_RAM_RM_MASK                                                         0x00000700
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGEE 0x3B8 */
#define B1_PHY_RX_FD_PHY_RXFD_REGEE_FIELD_SPHERE_BUS0_LEN_MASK                                                    0x00000001
#define B1_PHY_RX_FD_PHY_RXFD_REGEE_FIELD_SPHERE_BUS1_LEN_MASK                                                    0x00000002
#define B1_PHY_RX_FD_PHY_RXFD_REGEE_FIELD_SPHERE_BUS2_LEN_MASK                                                    0x00000004
#define B1_PHY_RX_FD_PHY_RXFD_REGEE_FIELD_SPHERE_BUS3_LEN_MASK                                                    0x00000008
#define B1_PHY_RX_FD_PHY_RXFD_REGEE_FIELD_SPHERE_TB_MODE_MASK                                                     0x00000010
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_APB_CONTROL 0x3C0 */
#define B1_PHY_RX_FD_PHY_RXFD_APB_CONTROL_FIELD_RXFD_APB_DEBUG_SELECT_MASK                                        0x00000003
#define B1_PHY_RX_FD_PHY_RXFD_APB_CONTROL_FIELD_CH_PAGE_MASK                                                      0x000000F0
#define B1_PHY_RX_FD_PHY_RXFD_APB_CONTROL_FIELD_SU_PAGE_MASK                                                      0x00000700
#define B1_PHY_RX_FD_PHY_RXFD_APB_CONTROL_FIELD_MU_PAGE_MASK                                                      0x00001000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGF1 0x3C4 */
#define B1_PHY_RX_FD_PHY_RXFD_REGF1_FIELD_POWER_LOAD_GAIN_SW_MASK                                                 0x00000001
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGF2 0x3C8 */
#define B1_PHY_RX_FD_PHY_RXFD_REGF2_FIELD_CH_RAM_BANK_SEL_MASK                                                    0x00000003
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGF3 0x3CC */
#define B1_PHY_RX_FD_PHY_RXFD_REGF3_FIELD_QR_GC3_UNIT0_H_S_MEM_RM_VALUE_MASK                                      0x00000007
#define B1_PHY_RX_FD_PHY_RXFD_REGF3_FIELD_QR_GC3_UNIT0_Q_V_MEM_RM_VALUE_MASK                                      0x00000070
#define B1_PHY_RX_FD_PHY_RXFD_REGF3_FIELD_QR_GC3_UNIT1_H_S_MEM_RM_VALUE_MASK                                      0x00000700
#define B1_PHY_RX_FD_PHY_RXFD_REGF3_FIELD_QR_GC3_UNIT1_Q_V_MEM_RM_VALUE_MASK                                      0x00007000
#define B1_PHY_RX_FD_PHY_RXFD_REGF3_FIELD_QR_GC3_UNIT2_H_S_MEM_RM_VALUE_MASK                                      0x00070000
#define B1_PHY_RX_FD_PHY_RXFD_REGF3_FIELD_QR_GC3_UNIT2_Q_V_MEM_RM_VALUE_MASK                                      0x00700000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGF4 0x3D0 */
#define B1_PHY_RX_FD_PHY_RXFD_REGF4_FIELD_QR_GC4_UNIT0_H_S_MEM_RM_VALUE_MASK                                      0x00000007
#define B1_PHY_RX_FD_PHY_RXFD_REGF4_FIELD_QR_GC4_UNIT0_Q_V_MEM_RM_VALUE_MASK                                      0x00000070
#define B1_PHY_RX_FD_PHY_RXFD_REGF4_FIELD_QR_GC4_UNIT1_H_S_MEM_RM_VALUE_MASK                                      0x00000700
#define B1_PHY_RX_FD_PHY_RXFD_REGF4_FIELD_QR_GC4_UNIT1_Q_V_MEM_RM_VALUE_MASK                                      0x00007000
#define B1_PHY_RX_FD_PHY_RXFD_REGF4_FIELD_QR_GC4_UNIT2_H_S_MEM_RM_VALUE_MASK                                      0x00070000
#define B1_PHY_RX_FD_PHY_RXFD_REGF4_FIELD_QR_GC4_UNIT2_Q_V_MEM_RM_VALUE_MASK                                      0x00700000
#define B1_PHY_RX_FD_PHY_RXFD_REGF4_FIELD_MU_UL_HRAM_MEM_RM_VALUE_MASK                                            0x07000000
//========================================
/* REG_PHY_RX_FD_STREAMER_CONTROL 0x3D4 */
#define B1_PHY_RX_FD_STREAMER_CONTROL_FIELD_STREAMER_ENABLE_MASK                                                  0x00000001
#define B1_PHY_RX_FD_STREAMER_CONTROL_FIELD_STREAMER_MODE_MASK                                                    0x00000002
#define B1_PHY_RX_FD_STREAMER_CONTROL_FIELD_STREAMER_ALL_ANTENNAS_SAME_DATA_MASK                                  0x00000004
#define B1_PHY_RX_FD_STREAMER_CONTROL_FIELD_STREAMER_RATE_MASK                                                    0x00000070
//========================================
/* REG_PHY_RX_FD_STREAMER_ADDRESS 0x3D8 */
#define B1_PHY_RX_FD_STREAMER_ADDRESS_FIELD_STREAMER_START_ADDRESS_MASK                                           0x00003FFF
#define B1_PHY_RX_FD_STREAMER_ADDRESS_FIELD_STREAMER_END_ADDRESS_MASK                                             0x3FFF0000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGF7 0x3DC */
#define B1_PHY_RX_FD_PHY_RXFD_REGF7_FIELD_SU_PHASE_RAM_SEL_MASK                                                   0x00000001
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGF8 0x3E0 */
#define B1_PHY_RX_FD_PHY_RXFD_REGF8_FIELD_LINEAR_EVM_MU_MEM_RM_MASK                                               0x00000007
#define B1_PHY_RX_FD_PHY_RXFD_REGF8_FIELD_LINEAR_RCR_MEM_RM_MASK                                                  0x00000070
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGF9 0x3E4 */
#define B1_PHY_RX_FD_PHY_RXFD_REGF9_FIELD_HE_STF_NOISE_GAIN_RAM_RM_MASK                                           0x00000007
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGFA 0x3E8 */
#define B1_PHY_RX_FD_PHY_RXFD_REGFA_FIELD_HESTF_FFT_GAIN_MAX_VALUE_MINUS_MOD_PAR_MASK                             0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REGFA_FIELD_HESTF_FFT_GAIN_FFT_IN_SHIFT_HESTF_MASK                                  0x00000700
#define B1_PHY_RX_FD_PHY_RXFD_REGFA_FIELD_HESTF_FFT_LIMIT_GAIN_MASK                                               0x00010000
#define B1_PHY_RX_FD_PHY_RXFD_REGFA_FIELD_HESTF_FFT_GAIN_EN_MASK                                                  0x80000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGFB 0x3EC */
#define B1_PHY_RX_FD_PHY_RXFD_REGFB_FIELD_HESTF_FFT_GAIN_EXTRA_NOISE_BACKOFF_MCS0_MASK                            0x0000007F
#define B1_PHY_RX_FD_PHY_RXFD_REGFB_FIELD_HESTF_FFT_GAIN_EXTRA_NOISE_BACKOFF_MCS1_MASK                            0x00007F00
#define B1_PHY_RX_FD_PHY_RXFD_REGFB_FIELD_HESTF_FFT_GAIN_EXTRA_NOISE_BACKOFF_MCS2_MASK                            0x007F0000
#define B1_PHY_RX_FD_PHY_RXFD_REGFB_FIELD_HESTF_FFT_GAIN_EXTRA_NOISE_BACKOFF_MCS3_MASK                            0x7F000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGFC 0x3F0 */
#define B1_PHY_RX_FD_PHY_RXFD_REGFC_FIELD_HESTF_FFT_GAIN_EXTRA_NOISE_BACKOFF_MCS4_MASK                            0x0000007F
#define B1_PHY_RX_FD_PHY_RXFD_REGFC_FIELD_HESTF_FFT_GAIN_EXTRA_NOISE_BACKOFF_MCS5_MASK                            0x00007F00
#define B1_PHY_RX_FD_PHY_RXFD_REGFC_FIELD_HESTF_FFT_GAIN_EXTRA_BACKOFF_NDP_FDBK_MASK                              0x007F0000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGFD 0x3F4 */
#define B1_PHY_RX_FD_PHY_RXFD_REGFD_FIELD_HESTF_FFT_GAIN_RES_IN_SHIFT_MASK                                        0x00000007
#define B1_PHY_RX_FD_PHY_RXFD_REGFD_FIELD_HESTF_FFT_GAIN_RES_IN_MULT_MASK                                         0x00000010
#define B1_PHY_RX_FD_PHY_RXFD_REGFD_FIELD_HESTF_FFT_GAIN_RES_OUT_MULT_MASK                                        0x00000F00
#define B1_PHY_RX_FD_PHY_RXFD_REGFD_FIELD_HESTF_FFT_GAIN_RES_VALID_MASK                                           0x80000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGFE 0x3F8 */
#define B1_PHY_RX_FD_PHY_RXFD_REGFE_FIELD_HESTF_MISC_RO_MASK                                                      0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REGFF 0x3FC */
#define B1_PHY_RX_FD_PHY_RXFD_REGFF_FIELD_HESTF_NOISE_GAIN_SIGMA_MIN_MASK                                         0x007FFFFF
#define B1_PHY_RX_FD_PHY_RXFD_REGFF_FIELD_HESTF_NOISE_GAIN_RES_VALID_MASK                                         0x80000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG100 0x400 */
#define B1_PHY_RX_FD_PHY_RXFD_REG100_FIELD_POWER_PER_RU_TD_GAIN_ANT0_MASK                                         0x000001FF
#define B1_PHY_RX_FD_PHY_RXFD_REG100_FIELD_POWER_PER_RU_TD_GAIN_ANT1_MASK                                         0x01FF0000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG101 0x404 */
#define B1_PHY_RX_FD_PHY_RXFD_REG101_FIELD_POWER_PER_RU_TD_GAIN_ANT2_MASK                                         0x000001FF
#define B1_PHY_RX_FD_PHY_RXFD_REG101_FIELD_POWER_PER_RU_TD_GAIN_ANT3_MASK                                         0x01FF0000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG102 0x408 */
#define B1_PHY_RX_FD_PHY_RXFD_REG102_FIELD_POWER_PER_RU_SYSTEM_GAIN_ANT0_MASK                                     0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REG102_FIELD_POWER_PER_RU_SYSTEM_GAIN_ANT1_MASK                                     0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REG102_FIELD_POWER_PER_RU_SYSTEM_GAIN_ANT2_MASK                                     0x00FF0000
#define B1_PHY_RX_FD_PHY_RXFD_REG102_FIELD_POWER_PER_RU_SYSTEM_GAIN_ANT3_MASK                                     0xFF000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG103 0x40C */
#define B1_PHY_RX_FD_PHY_RXFD_REG103_FIELD_POWER_PER_RU_FFT_GAIN_MASK                                             0x000003FF
#define B1_PHY_RX_FD_PHY_RXFD_REG103_FIELD_POWER_PER_RU_NORM_OFFSET_MASK                                          0x00FF0000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG104 0x410 */
#define B1_PHY_RX_FD_PHY_RXFD_REG104_FIELD_HESTF_FFT_GAIN_RES_VALID_CLR_MASK                                      0x00000001
#define B1_PHY_RX_FD_PHY_RXFD_REG104_FIELD_HESTF_NOISE_GAIN_RES_VALID_CLR_MASK                                    0x00000002
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG105 0x414 */
#define B1_PHY_RX_FD_PHY_RXFD_REG105_FIELD_HESTF_NOISE_GAIN_ANT0_MASK                                             0x0000007F
#define B1_PHY_RX_FD_PHY_RXFD_REG105_FIELD_HESTF_NOISE_GAIN_ANT1_MASK                                             0x00007F00
#define B1_PHY_RX_FD_PHY_RXFD_REG105_FIELD_HESTF_NOISE_GAIN_ANT2_MASK                                             0x007F0000
#define B1_PHY_RX_FD_PHY_RXFD_REG105_FIELD_HESTF_NOISE_GAIN_ANT3_MASK                                             0x7F000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG106 0x418 */
#define B1_PHY_RX_FD_PHY_RXFD_REG106_FIELD_TEST_BUS_HEADER_MASK                                                   0x00FFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG107 0x41C */
#define B1_PHY_RX_FD_PHY_RXFD_REG107_FIELD_HESTF_NOISE_GAIN_BYPASS_MASK                                           0x00000001
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG108 0x420 */
#define B1_PHY_RX_FD_PHY_RXFD_REG108_FIELD_SPHERE_CYCLES_MASK                                                     0x00003FFF
#define B1_PHY_RX_FD_PHY_RXFD_REG108_FIELD_SPHERE_CYCLES_LAST_SYM_MASK                                            0x3FFF0000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG109 0x424 */
#define B1_PHY_RX_FD_PHY_RXFD_REG109_FIELD_SPHERE_CYCELS_VALID_PULSE_MASK                                         0x00000001
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG110 0x428 */
#define B1_PHY_RX_FD_PHY_RXFD_REG110_FIELD_SPHERE_CYCELS_GR_ENABLE_MASK                                           0x00000001
#define B1_PHY_RX_FD_PHY_RXFD_REG110_FIELD_LINEAR_FIFO_WAIT_MECH_MASK                                             0x00000002
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG111 0x42C */
#define B1_PHY_RX_FD_PHY_RXFD_REG111_FIELD_HYP_RXFD_NCO_RAM_RM_MASK                                               0x00000007
#define B1_PHY_RX_FD_PHY_RXFD_REG111_FIELD_HYP_RXFD_TRAINING_RAM_RM_MASK                                          0x00000038
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG112 0x430 */
#define B1_PHY_RX_FD_PHY_RXFD_REG112_FIELD_SU_DB_VALID_RD0_MASK                                                   0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG113 0x434 */
#define B1_PHY_RX_FD_PHY_RXFD_REG113_FIELD_SU_DB_VALID_RD1_MASK                                                   0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG114 0x438 */
#define B1_PHY_RX_FD_PHY_RXFD_REG114_FIELD_SU_DB_VALID_RD2_MASK                                                   0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG115 0x43C */
#define B1_PHY_RX_FD_PHY_RXFD_REG115_FIELD_SU_DB_VALID_RD3_MASK                                                   0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG116 0x440 */
#define B1_PHY_RX_FD_PHY_RXFD_REG116_FIELD_SU_DB_VALID_RD4_MASK                                                   0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG117 0x444 */
#define B1_PHY_RX_FD_PHY_RXFD_REG117_FIELD_SU_DB_VALID_RD5_MASK                                                   0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG118 0x448 */
#define B1_PHY_RX_FD_PHY_RXFD_REG118_FIELD_SU_DB_VALID_RD6_MASK                                                   0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG119 0x44C */
#define B1_PHY_RX_FD_PHY_RXFD_REG119_FIELD_SU_DB_VALID_RD7_MASK                                                   0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG120 0x450 */
#define B1_PHY_RX_FD_PHY_RXFD_REG120_FIELD_SU_DB_VALID_SW0_MASK                                                   0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG121 0x454 */
#define B1_PHY_RX_FD_PHY_RXFD_REG121_FIELD_SU_DB_VALID_SW1_MASK                                                   0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG122 0x458 */
#define B1_PHY_RX_FD_PHY_RXFD_REG122_FIELD_SU_DB_VALID_SW2_MASK                                                   0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG123 0x45C */
#define B1_PHY_RX_FD_PHY_RXFD_REG123_FIELD_SU_DB_VALID_SW3_MASK                                                   0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG124 0x460 */
#define B1_PHY_RX_FD_PHY_RXFD_REG124_FIELD_SU_DB_VALID_SW4_MASK                                                   0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG125 0x464 */
#define B1_PHY_RX_FD_PHY_RXFD_REG125_FIELD_SU_DB_VALID_SW5_MASK                                                   0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG126 0x468 */
#define B1_PHY_RX_FD_PHY_RXFD_REG126_FIELD_SU_DB_VALID_SW6_MASK                                                   0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG127 0x46C */
#define B1_PHY_RX_FD_PHY_RXFD_REG127_FIELD_SU_DB_VALID_SW7_MASK                                                   0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG128 0x470 */
#define B1_PHY_RX_FD_PHY_RXFD_REG128_FIELD_SU_DB_VALID_CLR_MASK                                                   0x00000001
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG129 0x474 */
#define B1_PHY_RX_FD_PHY_RXFD_REG129_FIELD_SU_BF_ERROR_MASK                                                       0x0000FFFF
#define B1_PHY_RX_FD_PHY_RXFD_REG129_FIELD_SU_BF_OFDMA_ERROR_MASK                                                 0x00070000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG130 0x478 */
#define B1_PHY_RX_FD_PHY_RXFD_REG130_FIELD_SU_BF_OFDMA_SEL_MASK                                                   0x0000003F
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG131 0x47C */
#define B1_PHY_RX_FD_PHY_RXFD_REG131_FIELD_SU_BF_ERR_CLR_MASK                                                     0x00000001
#define B1_PHY_RX_FD_PHY_RXFD_REG131_FIELD_SU_BF_OFDMA_ERR_CLR_MASK                                               0x00000002
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG132 0x480 */
#define B1_PHY_RX_FD_PHY_RXFD_REG132_FIELD_NOISE_GAIN_LOW_TH_MASK                                                 0x000001FF
#define B1_PHY_RX_FD_PHY_RXFD_REG132_FIELD_NOISE_GAIN_HIGH_TH_MASK                                                0x001FF000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG133 0x484 */
#define B1_PHY_RX_FD_PHY_RXFD_REG133_FIELD_NOISE_GAIN_HIGH_TH_CONS_0_MASK                                         0x000001FF
#define B1_PHY_RX_FD_PHY_RXFD_REG133_FIELD_NOISE_GAIN_HIGH_TH_CONS_1_MASK                                         0x001FF000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG134 0x488 */
#define B1_PHY_RX_FD_PHY_RXFD_REG134_FIELD_NOISE_GAIN_HIGH_TH_CONS_2_MASK                                         0x000001FF
#define B1_PHY_RX_FD_PHY_RXFD_REG134_FIELD_NOISE_GAIN_HIGH_TH_CONS_3_MASK                                         0x001FF000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG135 0x48C */
#define B1_PHY_RX_FD_PHY_RXFD_REG135_FIELD_NOISE_GAIN_HIGH_TH_CONS_4_MASK                                         0x000001FF
#define B1_PHY_RX_FD_PHY_RXFD_REG135_FIELD_NOISE_GAIN_HIGH_TH_CONS_5_MASK                                         0x001FF000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG136 0x490 */
#define B1_PHY_RX_FD_PHY_RXFD_REG136_FIELD_NOISE_GAIN_HIGH_TH_CONS_6_MASK                                         0x000001FF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG137 0x494 */
#define B1_PHY_RX_FD_PHY_RXFD_REG137_FIELD_EN_SPHERE_FAST_CONVERGANCE_MASK                                        0x00000001
#define B1_PHY_RX_FD_PHY_RXFD_REG137_FIELD_NE_SMOOTHING_PIPE_MULT_CFG_MASK                                        0x00000002
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG138 0x498 */
#define B1_PHY_RX_FD_PHY_RXFD_REG138_FIELD_SPHERE_REDUCE_CYCLES_80M_U13_MASK                                      0x0000003F
#define B1_PHY_RX_FD_PHY_RXFD_REG138_FIELD_SPHERE_REDUCE_CYCLES_80M_U14_MASK                                      0x00003F00
#define B1_PHY_RX_FD_PHY_RXFD_REG138_FIELD_SPHERE_REDUCE_CYCLES_80M_U15_MASK                                      0x003F0000
#define B1_PHY_RX_FD_PHY_RXFD_REG138_FIELD_SPHERE_REDUCE_CYCLES_80M_U16_MASK                                      0x3F000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG139 0x49C */
#define B1_PHY_RX_FD_PHY_RXFD_REG139_FIELD_SPHERE_REDUCE_CYCLES_80M_U17_MASK                                      0x0000003F
#define B1_PHY_RX_FD_PHY_RXFD_REG139_FIELD_SPHERE_REDUCE_CYCLES_80M_U18_MASK                                      0x00003F00
#define B1_PHY_RX_FD_PHY_RXFD_REG139_FIELD_SPHERE_REDUCE_CYCLES_80M_U19_MASK                                      0x003F0000
#define B1_PHY_RX_FD_PHY_RXFD_REG139_FIELD_SPHERE_REDUCE_CYCLES_80M_U20_MASK                                      0x3F000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG140 0x4A0 */
#define B1_PHY_RX_FD_PHY_RXFD_REG140_FIELD_SPHERE_REDUCE_CYCLES_80M_U21_MASK                                      0x0000003F
#define B1_PHY_RX_FD_PHY_RXFD_REG140_FIELD_SPHERE_REDUCE_CYCLES_80M_U22_MASK                                      0x00003F00
#define B1_PHY_RX_FD_PHY_RXFD_REG140_FIELD_SPHERE_REDUCE_CYCLES_80M_U23_MASK                                      0x003F0000
#define B1_PHY_RX_FD_PHY_RXFD_REG140_FIELD_SPHERE_REDUCE_CYCLES_80M_U24_MASK                                      0x3F000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG141 0x4A4 */
#define B1_PHY_RX_FD_PHY_RXFD_REG141_FIELD_SPHERE_REDUCE_CYCLES_80M_U25_MASK                                      0x0000003F
#define B1_PHY_RX_FD_PHY_RXFD_REG141_FIELD_SPHERE_REDUCE_CYCLES_80M_U26_MASK                                      0x00003F00
#define B1_PHY_RX_FD_PHY_RXFD_REG141_FIELD_SPHERE_REDUCE_CYCLES_80M_U27_MASK                                      0x003F0000
#define B1_PHY_RX_FD_PHY_RXFD_REG141_FIELD_SPHERE_REDUCE_CYCLES_80M_U28_MASK                                      0x3F000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG142 0x4A8 */
#define B1_PHY_RX_FD_PHY_RXFD_REG142_FIELD_SPHERE_REDUCE_CYCLES_80M_U29_MASK                                      0x0000003F
#define B1_PHY_RX_FD_PHY_RXFD_REG142_FIELD_SPHERE_REDUCE_CYCLES_80M_U30_MASK                                      0x00003F00
#define B1_PHY_RX_FD_PHY_RXFD_REG142_FIELD_SPHERE_REDUCE_CYCLES_80M_U31_MASK                                      0x003F0000
#define B1_PHY_RX_FD_PHY_RXFD_REG142_FIELD_SPHERE_REDUCE_CYCLES_80M_U32_MASK                                      0x3F000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG143 0x4AC */
#define B1_PHY_RX_FD_PHY_RXFD_REG143_FIELD_SPHERE_REDUCE_CYCLES_160M_U13_MASK                                     0x0000003F
#define B1_PHY_RX_FD_PHY_RXFD_REG143_FIELD_SPHERE_REDUCE_CYCLES_160M_U14_MASK                                     0x00003F00
#define B1_PHY_RX_FD_PHY_RXFD_REG143_FIELD_SPHERE_REDUCE_CYCLES_160M_U15_MASK                                     0x003F0000
#define B1_PHY_RX_FD_PHY_RXFD_REG143_FIELD_SPHERE_REDUCE_CYCLES_160M_U16_MASK                                     0x3F000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG144 0x4B0 */
#define B1_PHY_RX_FD_PHY_RXFD_REG144_FIELD_SPHERE_REDUCE_CYCLES_160M_U17_MASK                                     0x0000003F
#define B1_PHY_RX_FD_PHY_RXFD_REG144_FIELD_SPHERE_REDUCE_CYCLES_160M_U18_MASK                                     0x00003F00
#define B1_PHY_RX_FD_PHY_RXFD_REG144_FIELD_SPHERE_REDUCE_CYCLES_160M_U19_MASK                                     0x003F0000
#define B1_PHY_RX_FD_PHY_RXFD_REG144_FIELD_SPHERE_REDUCE_CYCLES_160M_U20_MASK                                     0x3F000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG145 0x4B4 */
#define B1_PHY_RX_FD_PHY_RXFD_REG145_FIELD_SPHERE_REDUCE_CYCLES_160M_U21_MASK                                     0x0000003F
#define B1_PHY_RX_FD_PHY_RXFD_REG145_FIELD_SPHERE_REDUCE_CYCLES_160M_U22_MASK                                     0x00003F00
#define B1_PHY_RX_FD_PHY_RXFD_REG145_FIELD_SPHERE_REDUCE_CYCLES_160M_U23_MASK                                     0x003F0000
#define B1_PHY_RX_FD_PHY_RXFD_REG145_FIELD_SPHERE_REDUCE_CYCLES_160M_U24_MASK                                     0x3F000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG146 0x4B8 */
#define B1_PHY_RX_FD_PHY_RXFD_REG146_FIELD_SPHERE_REDUCE_CYCLES_160M_U25_MASK                                     0x0000003F
#define B1_PHY_RX_FD_PHY_RXFD_REG146_FIELD_SPHERE_REDUCE_CYCLES_160M_U26_MASK                                     0x00003F00
#define B1_PHY_RX_FD_PHY_RXFD_REG146_FIELD_SPHERE_REDUCE_CYCLES_160M_U27_MASK                                     0x003F0000
#define B1_PHY_RX_FD_PHY_RXFD_REG146_FIELD_SPHERE_REDUCE_CYCLES_160M_U28_MASK                                     0x3F000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG147 0x4BC */
#define B1_PHY_RX_FD_PHY_RXFD_REG147_FIELD_SPHERE_REDUCE_CYCLES_160M_U29_MASK                                     0x0000003F
#define B1_PHY_RX_FD_PHY_RXFD_REG147_FIELD_SPHERE_REDUCE_CYCLES_160M_U30_MASK                                     0x00003F00
#define B1_PHY_RX_FD_PHY_RXFD_REG147_FIELD_SPHERE_REDUCE_CYCLES_160M_U31_MASK                                     0x003F0000
#define B1_PHY_RX_FD_PHY_RXFD_REG147_FIELD_SPHERE_REDUCE_CYCLES_160M_U32_MASK                                     0x3F000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG148 0x4C0 */
#define B1_PHY_RX_FD_PHY_RXFD_REG148_FIELD_NOISE_FOR_AV_SNR_MASK                                                  0x00FFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG149 0x4C4 */
#define B1_PHY_RX_FD_PHY_RXFD_REG149_FIELD_SPHERE_REDUCE_CYCLES_80M_U12_MASK                                      0x0000003F
#define B1_PHY_RX_FD_PHY_RXFD_REG149_FIELD_SPHERE_REDUCE_CYCLES_160M_U12_MASK                                     0x00003F00
#define B1_PHY_RX_FD_PHY_RXFD_REG149_FIELD_SPHERE_REDUCE_CYCLES_80P80_MASK                                        0x003F0000
#define B1_PHY_RX_FD_PHY_RXFD_REG149_FIELD_SPHERE_REDUCE_CYCLES_RISC_MASK                                         0x3F000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG150 0x4C8 */
#define B1_PHY_RX_FD_PHY_RXFD_REG150_FIELD_STS_FD_STATUS1_MASK                                                    0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG151 0x4D0 */
#define B1_PHY_RX_FD_PHY_RXFD_REG151_FIELD_STS_FD_STATUS2_MASK                                                    0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG152 0x4D4 */
#define B1_PHY_RX_FD_PHY_RXFD_REG152_FIELD_PEAK_ERROR4_SS0_MASK                                                   0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REG152_FIELD_PEAK_ERROR4_SS1_MASK                                                   0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REG152_FIELD_PEAK_ERROR4_SS2_MASK                                                   0x00FF0000
#define B1_PHY_RX_FD_PHY_RXFD_REG152_FIELD_PEAK_ERROR4_SS3_MASK                                                   0xFF000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG153 0x4D8 */
#define B1_PHY_RX_FD_PHY_RXFD_REG153_FIELD_TEST_PLUG_LEN_MASK                                                     0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG154 0x4DC */
#define B1_PHY_RX_FD_PHY_RXFD_REG154_FIELD_SYMBOL_TIME_FEATURE_ENABLE_MASK                                        0x00000001
#define B1_PHY_RX_FD_PHY_RXFD_REG154_FIELD_SYMBOL_TIME_LEGACY_ENABLE_MASK                                         0x00000002
#define B1_PHY_RX_FD_PHY_RXFD_REG154_FIELD_SYMBOL_TIME_HT_ENABLE_MASK                                             0x00000004
#define B1_PHY_RX_FD_PHY_RXFD_REG154_FIELD_SYMBOL_TIME_VHT_ENABLE_MASK                                            0x00000008
#define B1_PHY_RX_FD_PHY_RXFD_REG154_FIELD_SYMBOL_TIME_HE_SU_ENABLE_MASK                                          0x00000010
#define B1_PHY_RX_FD_PHY_RXFD_REG154_FIELD_SYMBOL_TIME_HE_TB_ENABLE_MASK                                          0x00000020
#define B1_PHY_RX_FD_PHY_RXFD_REG154_FIELD_SYMBOL_TIME_HE_SU_LCP_COUNT_MASK                                       0x3FFF0000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG155 0x4E0 */
#define B1_PHY_RX_FD_PHY_RXFD_REG155_FIELD_SYMBOL_TIME_HE_SU_MCP_COUNT_MASK                                       0x00003FFF
#define B1_PHY_RX_FD_PHY_RXFD_REG155_FIELD_SYMBOL_TIME_HE_SU_SCP_COUNT_MASK                                       0x3FFF0000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG156 0x4E4 */
#define B1_PHY_RX_FD_PHY_RXFD_REG156_FIELD_SYMBOL_TIME_VHT_LCP_COUNT_MASK                                         0x00003FFF
#define B1_PHY_RX_FD_PHY_RXFD_REG156_FIELD_SYMBOL_TIME_VHT_SCP_COUNT_MASK                                         0x3FFF0000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG157 0x4E8 */
#define B1_PHY_RX_FD_PHY_RXFD_REG157_FIELD_SYMBOL_TIME_HE_TB_LCP_COUNT_MASK                                       0x00003FFF
#define B1_PHY_RX_FD_PHY_RXFD_REG157_FIELD_SYMBOL_TIME_HE_TB_MCP_COUNT_MASK                                       0x3FFF0000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG158 0x4EC */
#define B1_PHY_RX_FD_PHY_RXFD_REG158_FIELD_STS_FD_STATUS3_MASK                                                    0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG159 0x4F0 */
#define B1_PHY_RX_FD_PHY_RXFD_REG159_FIELD_LOG2_EVM_DONE_MASK                                                     0x00000001
#define B1_PHY_RX_FD_PHY_RXFD_REG159_FIELD_LSIG_EVM_DONE_MASK                                                     0x00000002
#define B1_PHY_RX_FD_PHY_RXFD_REG159_FIELD_LSIG_EVM_MASK                                                          0x0000FF00
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG160 0x4F4 */
#define B1_PHY_RX_FD_PHY_RXFD_REG160_FIELD_SHORT_PACKET_SCYCLES_ENABLE_MASK                                       0x00000001
#define B1_PHY_RX_FD_PHY_RXFD_REG160_FIELD_SHORT_PACKET_SCYCLES_BW_MASK                                           0x000000F0
#define B1_PHY_RX_FD_PHY_RXFD_REG160_FIELD_SHORT_PACKET_SCYCLES_SYMBOL_THR_MASK                                   0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REG160_FIELD_SHORT_PACKET_SCYCLES_USER_THR_MASK                                     0x003F0000
#define B1_PHY_RX_FD_PHY_RXFD_REG160_FIELD_SHORT_PACKET_SCYCLES_VALUE_MASK                                        0xFFC00000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG161 0x4F8 */
#define B1_PHY_RX_FD_PHY_RXFD_REG161_FIELD_HE_EXT_MODE_MASK                                                       0x00000001
#define B1_PHY_RX_FD_PHY_RXFD_REG161_FIELD_HE_EXT_MODE_VALID_MASK                                                 0x00000002
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG162 0x4FC */
#define B1_PHY_RX_FD_PHY_RXFD_REG162_FIELD_SPHERE_REDUCE_WAFA_TONES_HE_CP_1_MASK                                  0x0000003F
#define B1_PHY_RX_FD_PHY_RXFD_REG162_FIELD_SPHERE_REDUCE_WAFA_TONES_HE_CP_2_MASK                                  0x00000FC0
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG163 0x500 */
#define B1_PHY_RX_FD_PHY_RXFD_REG163_FIELD_NOISE_GAIN_MAX_MASK                                                    0x000001FF
#define B1_PHY_RX_FD_PHY_RXFD_REG163_FIELD_NOISE_GAIN_BIN_NUM_MASK                                                0x07FF0000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG164 0x504 */
#define B1_PHY_RX_FD_PHY_RXFD_REG164_FIELD_NOISE_GAIN_SUM_MASK                                                    0x000FFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG165 0x508 */
#define B1_PHY_RX_FD_PHY_RXFD_REG165_FIELD_SPHERE_REDUCE_CYCLES_MU_UL_20M_MASK                                    0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REG165_FIELD_SPHERE_REDUCE_CYCLES_MU_UL_40M_MASK                                    0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REG165_FIELD_SPHERE_REDUCE_CYCLES_MU_UL_80M_MASK                                    0x00FF0000
#define B1_PHY_RX_FD_PHY_RXFD_REG165_FIELD_SPHERE_REDUCE_CYCLES_MU_UL_160M_MASK                                   0xFF000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG166 0x50C */
#define B1_PHY_RX_FD_PHY_RXFD_REG166_FIELD_POWER_PER_RU_TD_GAIN_ANT4_MASK                                         0x000001FF
#define B1_PHY_RX_FD_PHY_RXFD_REG166_FIELD_POWER_PER_RU_SYSTEM_GAIN_ANT4_MASK                                     0x00FF0000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG167 0x510 */
#define B1_PHY_RX_FD_PHY_RXFD_REG167_FIELD_HESTF_NOISE_GAIN_ANT4_MASK                                             0x0000007F
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG168 0x514 */
#define B1_PHY_RX_FD_PHY_RXFD_REG168_FIELD_NCB_PRANK4_MASK_AN4_MASK                                               0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REG168_FIELD_FCB_PRANK4_MASK_AN4_MASK                                               0x0000FF00
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG169 0x518 */
#define B1_PHY_RX_FD_PHY_RXFD_REG169_FIELD_SECOND_DECODE_AFTER_AIDED_PHASE_CORRECTION_MASK                        0x00000001
#define B1_PHY_RX_FD_PHY_RXFD_REG169_FIELD_SECOND_PHASE_TRACKING_EN_SMOOTHING_MASK                                0x00000002
#define B1_PHY_RX_FD_PHY_RXFD_REG169_FIELD_KPI_PREAMBLE_SYMBOLS_SUPPORT_MASK                                      0x00000004
#define B1_PHY_RX_FD_PHY_RXFD_REG169_FIELD_KPI_PACKET_TYPE_SUPPORT_MASK                                           0x000000F8
#define B1_PHY_RX_FD_PHY_RXFD_REG169_FIELD_KPI_BANDWIDTH_SUPPORT_MASK                                             0x00000F00
#define B1_PHY_RX_FD_PHY_RXFD_REG169_FIELD_SECOND_PHASE_TRACKING_ADDED_SMOOTHING_SNR_MASK                         0x000FF000
#define B1_PHY_RX_FD_PHY_RXFD_REG169_FIELD_KPI_SPHERE_CYCLES_20M_MASK                                             0xFFF00000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG170 0x51C */
#define B1_PHY_RX_FD_PHY_RXFD_REG170_FIELD_NDP_FDBK_K_RATIO_4_ANTS_MASK                                           0x0000001F
#define B1_PHY_RX_FD_PHY_RXFD_REG170_FIELD_NDP_FDBK_K_RATIO_3_ANTS_MASK                                           0x000003E0
#define B1_PHY_RX_FD_PHY_RXFD_REG170_FIELD_NDP_FDBK_K_RATIO_2_ANTS_MASK                                           0x00007C00
#define B1_PHY_RX_FD_PHY_RXFD_REG170_FIELD_NDP_FDBK_K_RATIO_1_ANTS_MASK                                           0x000F8000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG171 0x520 */
#define B1_PHY_RX_FD_PHY_RXFD_REG171_FIELD_NDP_FDBK_P_THRESHOLD_CFG_MASK                                          0x000FFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG172 0x524 */
#define B1_PHY_RX_FD_PHY_RXFD_REG172_FIELD_MU_HDR_MEMORY_RM_MASK                                                  0x0000001F
#define B1_PHY_RX_FD_PHY_RXFD_REG172_FIELD_SU_HDR_MEMORY_RM_MASK                                                  0x000003E0
#define B1_PHY_RX_FD_PHY_RXFD_REG172_FIELD_SU_PHASES_RM_VALUE_MASK                                                0x00001C00
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG173 0x528 */
#define B1_PHY_RX_FD_PHY_RXFD_REG173_FIELD_LAST_QR_NUM_OF_CYCELS_MASK                                             0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REG173_FIELD_MU_UL_4SS_ENABLE_NOISE_TRK_MASK                                        0x00000100
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG174 0x52C */
#define B1_PHY_RX_FD_PHY_RXFD_REG174_FIELD_QR_GC5_UNIT0_H_S_MEM_RM_VALUE_MASK                                     0x00000007
#define B1_PHY_RX_FD_PHY_RXFD_REG174_FIELD_QR_GC5_UNIT0_Q_V_MEM_RM_VALUE_MASK                                     0x00000070
#define B1_PHY_RX_FD_PHY_RXFD_REG174_FIELD_QR_GC5_UNIT1_H_S_MEM_RM_VALUE_MASK                                     0x00000700
#define B1_PHY_RX_FD_PHY_RXFD_REG174_FIELD_QR_GC5_UNIT1_Q_V_MEM_RM_VALUE_MASK                                     0x00007000
#define B1_PHY_RX_FD_PHY_RXFD_REG174_FIELD_QR_GC5_UNIT2_H_S_MEM_RM_VALUE_MASK                                     0x00070000
#define B1_PHY_RX_FD_PHY_RXFD_REG174_FIELD_QR_GC5_UNIT2_Q_V_MEM_RM_VALUE_MASK                                     0x00700000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG175 0x530 */
#define B1_PHY_RX_FD_PHY_RXFD_REG175_FIELD_QR_GC6_UNIT0_H_S_MEM_RM_VALUE_MASK                                     0x00000007
#define B1_PHY_RX_FD_PHY_RXFD_REG175_FIELD_QR_GC6_UNIT0_Q_V_MEM_RM_VALUE_MASK                                     0x00000070
#define B1_PHY_RX_FD_PHY_RXFD_REG175_FIELD_QR_GC6_UNIT1_H_S_MEM_RM_VALUE_MASK                                     0x00000700
#define B1_PHY_RX_FD_PHY_RXFD_REG175_FIELD_QR_GC6_UNIT1_Q_V_MEM_RM_VALUE_MASK                                     0x00007000
#define B1_PHY_RX_FD_PHY_RXFD_REG175_FIELD_QR_GC6_UNIT2_H_S_MEM_RM_VALUE_MASK                                     0x00070000
#define B1_PHY_RX_FD_PHY_RXFD_REG175_FIELD_QR_GC6_UNIT2_Q_V_MEM_RM_VALUE_MASK                                     0x00700000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG176 0x534 */
#define B1_PHY_RX_FD_PHY_RXFD_REG176_FIELD_QR_GC3_PM_RM_VALUE_MASK                                                0x00000007
#define B1_PHY_RX_FD_PHY_RXFD_REG176_FIELD_QR_GC4_PM_RM_VALUE_MASK                                                0x00000070
#define B1_PHY_RX_FD_PHY_RXFD_REG176_FIELD_QR_GC5_PM_RM_VALUE_MASK                                                0x00000700
#define B1_PHY_RX_FD_PHY_RXFD_REG176_FIELD_QR_GC6_PM_RM_VALUE_MASK                                                0x00007000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG177 0x538 */
#define B1_PHY_RX_FD_PHY_RXFD_REG177_FIELD_ERROR4_MIN_0_MASK                                                      0x0003FFFF
#define B1_PHY_RX_FD_PHY_RXFD_REG177_FIELD_ERROR4_BIN_0_MASK                                                      0x7FF00000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG178 0x53C */
#define B1_PHY_RX_FD_PHY_RXFD_REG178_FIELD_ERROR4_MIN_1_MASK                                                      0x0003FFFF
#define B1_PHY_RX_FD_PHY_RXFD_REG178_FIELD_ERROR4_BIN_1_MASK                                                      0x7FF00000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG179 0x540 */
#define B1_PHY_RX_FD_PHY_RXFD_REG179_FIELD_ERROR4_MIN_2_MASK                                                      0x0003FFFF
#define B1_PHY_RX_FD_PHY_RXFD_REG179_FIELD_ERROR4_BIN_2_MASK                                                      0x7FF00000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG180 0x544 */
#define B1_PHY_RX_FD_PHY_RXFD_REG180_FIELD_ERROR4_MIN_3_MASK                                                      0x0003FFFF
#define B1_PHY_RX_FD_PHY_RXFD_REG180_FIELD_ERROR4_BIN_3_MASK                                                      0x7FF00000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG181 0x548 */
#define B1_PHY_RX_FD_PHY_RXFD_REG181_FIELD_CSM_SMOOTHING_OLD_SCHEM_MASK                                           0x00000001
#define B1_PHY_RX_FD_PHY_RXFD_REG181_FIELD_CSM_PACKET_DETECT_OLD_SCHEM_MASK                                       0x00000002
#define B1_PHY_RX_FD_PHY_RXFD_REG181_FIELD_DISABLE_SPHERE_COLUMN_SORTING_MASK                                     0x00000004
#define B1_PHY_RX_FD_PHY_RXFD_REG181_FIELD_DISABLE_SPHERE_COLUMN_SORTING_4SS_MASK                                 0x00000008
#define B1_PHY_RX_FD_PHY_RXFD_REG181_FIELD_CSM_WAIT_FOR_SIG1_MASK                                                 0x00000010
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG182 0x54C */
#define B1_PHY_RX_FD_PHY_RXFD_REG182_FIELD_WAIT_1X1_CYC_LEG_MASK                                                  0x000007FF
#define B1_PHY_RX_FD_PHY_RXFD_REG182_FIELD_WAIT_1X1_CYC_HE_MASK                                                   0x07FF0000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG183 0x550 */
#define B1_PHY_RX_FD_PHY_RXFD_REG183_FIELD_MEM_RXFD_DS_MASK                                                       0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG184 0x554 */
#define B1_PHY_RX_FD_PHY_RXFD_REG184_FIELD_MEM_RXFD_SD_MASK                                                       0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG185 0x558 */
#define B1_PHY_RX_FD_PHY_RXFD_REG185_FIELD_MEM_RXFD_ROP_MASK                                                      0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG186 0x55C */
#define B1_PHY_RX_FD_PHY_RXFD_REG186_FIELD_MEM_RXFD_LS1_MASK                                                      0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG187 0x560 */
#define B1_PHY_RX_FD_PHY_RXFD_REG187_FIELD_MEM_RXFD_LS2_MASK                                                      0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG188 0x564 */
#define B1_PHY_RX_FD_PHY_RXFD_REG188_FIELD_HYP_RXFD_DATA_CH_RAM_1X1_RM_MASK                                       0x00000007
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG189 0x568 */
#define B1_PHY_RX_FD_PHY_RXFD_REG189_FIELD_FFT_SATURATION_SAMPLES_ANT0_MASK                                       0x000000FF
#define B1_PHY_RX_FD_PHY_RXFD_REG189_FIELD_FFT_SATURATION_SAMPLES_ANT1_MASK                                       0x0000FF00
#define B1_PHY_RX_FD_PHY_RXFD_REG189_FIELD_FFT_SATURATION_SAMPLES_ANT2_MASK                                       0x00FF0000
#define B1_PHY_RX_FD_PHY_RXFD_REG189_FIELD_FFT_SATURATION_SAMPLES_ANT3_MASK                                       0xFF000000
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG190 0x56C */
#define B1_PHY_RX_FD_PHY_RXFD_REG190_FIELD_FFT_SATURATION_SAMPLES_ANT4_MASK                                       0x000000FF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG191 0x570 */
#define B1_PHY_RX_FD_PHY_RXFD_REG191_FIELD_SECOND_PHASE_TRACKING_ADDED_SMOOTHING_SYMBOLS_MASK                     0x00007FFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG192 0x574 */
#define B1_PHY_RX_FD_PHY_RXFD_REG192_FIELD_KPI_SPHERE_CYCLES_40M_MASK                                             0x00000FFF
#define B1_PHY_RX_FD_PHY_RXFD_REG192_FIELD_REDUCE_SPHERE_CYC_LAST_SYM_OFDMA_VIT_MASK                              0x00010000
#define B1_PHY_RX_FD_PHY_RXFD_REG192_FIELD_REDUCE_SPHERE_CYC_LAST_SYM_MIMO_20_LDPC_MASK                           0x00020000
#define B1_PHY_RX_FD_PHY_RXFD_REG192_FIELD_REDUCE_SPHERE_CYC_LAST_SYM_OFDMA_20_MASK                               0x00040000
#define B1_PHY_RX_FD_PHY_RXFD_REG192_FIELD_REDUCE_SPHERE_CYC_LAST_SYM_HE_TRIG_40_MASK                             0x00080000
#define B1_PHY_RX_FD_PHY_RXFD_REG192_FIELD_REDUCE_SPHERE_CYC_LAST_SYM_HE_TRIG_80_MASK                             0x00100000
#define B1_PHY_RX_FD_PHY_RXFD_REG192_FIELD_KPI_SMOOTHING_SECOND_SYMBOL_MASK                                       0x01000000
#define B1_PHY_RX_FD_PHY_RXFD_REG192_FIELD_KPI_SMOOTHING_THIRD_SYMBOL_NOT_LEGACY_MASK                             0x02000000
//========================================
/* REG_PHY_RX_FD_SPARE_FROM_FD 0x578 */
#define B1_PHY_RX_FD_SPARE_FROM_FD_FIELD_SPARE_FROM_FD_MASK                                                       0x0000FFFF
//========================================
/* REG_PHY_RX_FD_SPARE_FROM_TX 0x57C */
#define B1_PHY_RX_FD_SPARE_FROM_TX_FIELD_SPARE_FROM_TX_MASK                                                       0x0000FFFF
//========================================
/* REG_PHY_RX_FD_SPARE_FROM_BE 0x580 */
#define B1_PHY_RX_FD_SPARE_FROM_BE_FIELD_SPARE_FROM_BE_MASK                                                       0x0000FFFF
//========================================
/* REG_PHY_RX_FD_SPARE_FROM_TD 0x584 */
#define B1_PHY_RX_FD_SPARE_FROM_TD_FIELD_SPARE_FROM_TD_MASK                                                       0x0000FFFF
//========================================
/* REG_PHY_RX_FD_SPARE_TO_FD 0x588 */
#define B1_PHY_RX_FD_SPARE_TO_FD_FIELD_SPARE_TO_FD_MASK                                                           0x0000FFFF
//========================================
/* REG_PHY_RX_FD_SPARE_TO_TX 0x58C */
#define B1_PHY_RX_FD_SPARE_TO_TX_FIELD_SPARE_TO_TX_MASK                                                           0x0000FFFF
//========================================
/* REG_PHY_RX_FD_SPARE_TO_BE 0x590 */
#define B1_PHY_RX_FD_SPARE_TO_BE_FIELD_SPARE_TO_BE_MASK                                                           0x0000FFFF
//========================================
/* REG_PHY_RX_FD_SPARE_TO_TD 0x594 */
#define B1_PHY_RX_FD_SPARE_TO_TD_FIELD_SPARE_TO_TD_MASK                                                           0x0000FFFF
//========================================
/* REG_PHY_RX_FD_NUM_OF_ACTIVE_USERS 0x598 */
#define B1_PHY_RX_FD_NUM_OF_ACTIVE_USERS_FIELD_NUM_OF_ACTIVE_USERS_MASK                                           0x0000003F
//========================================
/* REG_PHY_RX_FD_FD_TEST_BUS_GCLK_EN 0x59C */
#define B1_PHY_RX_FD_FD_TEST_BUS_GCLK_EN_FIELD_FD_TEST_BUS_GCLK_EN_MASK                                           0x00000001
#define B1_PHY_RX_FD_FD_TEST_BUS_GCLK_EN_FIELD_TEST_BUS_GENERATORS_EN_MASK                                        0x00000002
//========================================
/* REG_PHY_RX_FD_DFE_ENABLE 0x5A0 */
#define B1_PHY_RX_FD_DFE_ENABLE_FIELD_DFE_ENABLE_MASK                                                             0x00000001
//========================================
/* REG_PHY_RX_FD_QR_LOW_POWER 0x5A4 */
#define B1_PHY_RX_FD_QR_LOW_POWER_FIELD_QR_UPD_NUM_INIT_SYM_MASK                                                  0x0000001F
#define B1_PHY_RX_FD_QR_LOW_POWER_FIELD_QR_UPD_PERIOD_MASK                                                        0x00000F00
#define B1_PHY_RX_FD_QR_LOW_POWER_FIELD_QR_UPD_COUNT_ALL_OFDM_SYMBOLS_MASK                                        0x00001000
#define B1_PHY_RX_FD_QR_LOW_POWER_FIELD_QR_UPD_NUM_INIT_SYM_DFE_MASK                                              0x0003E000
//========================================
/* REG_PHY_RX_FD_TEST_BUS_GROUPING 0x5A8 */
#define B1_PHY_RX_FD_TEST_BUS_GROUPING_FIELD_TEST_BUS_GROUPING_MASK                                               0x00000003
//========================================
/* REG_PHY_RX_FD_MAX_QR_TIME 0x5AC */
#define B1_PHY_RX_FD_MAX_QR_TIME_FIELD_MAX_QR_TIME_MASK                                                           0x000003FF
//========================================
/* REG_PHY_RX_FD_FFT_OUT_MULT_SHIFT 0x5B0 */
#define B1_PHY_RX_FD_FFT_OUT_MULT_SHIFT_FIELD_FFT_OUT_SHIFT_60_MASK                                               0x00000003
#define B1_PHY_RX_FD_FFT_OUT_MULT_SHIFT_FIELD_FFT_OUT_MULT_60_MASK                                                0x0000003C
#define B1_PHY_RX_FD_FFT_OUT_MULT_SHIFT_FIELD_FFT_OUT_SHIFT_120_MASK                                              0x000000C0
#define B1_PHY_RX_FD_FFT_OUT_MULT_SHIFT_FIELD_FFT_OUT_MULT_120_MASK                                               0x00000F00
#define B1_PHY_RX_FD_FFT_OUT_MULT_SHIFT_FIELD_FFT_OUT_SHIFT_140_MASK                                              0x00003000
#define B1_PHY_RX_FD_FFT_OUT_MULT_SHIFT_FIELD_FFT_OUT_MULT_140_MASK                                               0x0003C000
//========================================
/* REG_PHY_RX_FD_QR_NOISE_GAIN_FREEZE_DISABLE 0x5B4 */
#define B1_PHY_RX_FD_QR_NOISE_GAIN_FREEZE_DISABLE_FIELD_QR_NOISE_GAIN_FREEZE_DISABLE_MASK                         0x00000001
//========================================
/* REG_PHY_RX_FD_MIN_SPHERE_CYCLES 0x5B8 */
#define B1_PHY_RX_FD_MIN_SPHERE_CYCLES_FIELD_MIN_SPHERE_CYCLES_2QR_MASK                                           0x000003FF
#define B1_PHY_RX_FD_MIN_SPHERE_CYCLES_FIELD_MIN_SPHERE_CYCLES_6QR_MASK                                           0x000FFC00
//========================================
/* REG_PHY_RX_FD_SMOOTH_WDATA_DELAY_RM 0x5BC */
#define B1_PHY_RX_FD_SMOOTH_WDATA_DELAY_RM_FIELD_SMOOTH_WDATA_DELAY_RM_MASK                                       0x00000007
//========================================
/* REG_PHY_RX_FD_RCR_MAX_VAL 0x5C0 */
#define B1_PHY_RX_FD_RCR_MAX_VAL_FIELD_MAX_NSS_MASK                                                               0x00000003
#define B1_PHY_RX_FD_RCR_MAX_VAL_FIELD_MAX_MCS_MASK                                                               0x000000F0
//========================================
/* REG_PHY_RX_FD_SU_BF_ERROR_MASK 0x5C4 */
#define B1_PHY_RX_FD_SU_BF_ERROR_MASK_FIELD_SU_BF_ERROR_MASK_MASK                                                 0x0000FFFF
//========================================
/* REG_PHY_RX_FD_SU_BF_OFDMA_ERROR_REG0 0x5C8 */
#define B1_PHY_RX_FD_SU_BF_OFDMA_ERROR_REG0_FIELD_SU_BF_OFDMA_ERROR_REG0_MASK                                     0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_SU_BF_OFDMA_ERROR_REG1 0x5CC */
#define B1_PHY_RX_FD_SU_BF_OFDMA_ERROR_REG1_FIELD_SU_BF_OFDMA_ERROR_REG1_MASK                                     0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_SU_BF_OFDMA_ERROR_REG2 0x5D0 */
#define B1_PHY_RX_FD_SU_BF_OFDMA_ERROR_REG2_FIELD_SU_BF_OFDMA_ERROR_REG2_MASK                                     0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_SU_BF_OFDMA_ERROR_REG3 0x5D4 */
#define B1_PHY_RX_FD_SU_BF_OFDMA_ERROR_REG3_FIELD_SU_BF_OFDMA_ERROR_REG3_MASK                                     0xFFFFFFFF
//========================================
/* REG_PHY_RX_FD_MU_TX_ERROR_CAUSE_MASK 0x5D8 */
#define B1_PHY_RX_FD_MU_TX_ERROR_CAUSE_MASK_FIELD_MU_TX_ERROR_CAUSE_MASK_MASK                                     0x00000FFF
#define B1_PHY_RX_FD_MU_TX_ERROR_CAUSE_MASK_FIELD_MU_TX_ERROR_CAUSE2_MASK_MASK                                    0x01FFF000
//========================================
/* REG_PHY_RX_FD_BF_EQ_POWER_PER_SS 0x5DC */
#define B1_PHY_RX_FD_BF_EQ_POWER_PER_SS_FIELD_BF_EQ_POWER_PER_SS_MASK                                             0x00000001
#define B1_PHY_RX_FD_BF_EQ_POWER_PER_SS_FIELD_BF_EQ_POWER_PER_SS_N_STREAMS_MASK                                   0x0000001E
//========================================
/* REG_PHY_RX_FD_QR_ACTIVATIONS 0x5E0 */
#define B1_PHY_RX_FD_QR_ACTIVATIONS_FIELD_QR_ACTIVATIONS_MASK                                                     0x0000007F
//========================================
/* REG_PHY_RX_FD_NOISE_TRK_FREEZE_SHIFTER_THR 0x5E4 */
#define B1_PHY_RX_FD_NOISE_TRK_FREEZE_SHIFTER_THR_FIELD_NOISE_TRK_FREEZE_SHIFTER_THR_MASK                         0x00000003
//========================================
/* REG_PHY_RX_FD_SUPERSEG_NOT_ON_PRIMARY_CB 0x5E8 */
#define B1_PHY_RX_FD_SUPERSEG_NOT_ON_PRIMARY_CB_FIELD_SUPERSEG_NOT_ON_PRIMARY_CB_MASK                             0x00000001
//========================================
/* REG_PHY_RX_FD_HE_DFE_SYM_START 0x5EC */
#define B1_PHY_RX_FD_HE_DFE_SYM_START_FIELD_HE_DFE_SYM_START_MASK                                                 0x00007FFF
//========================================
/* REG_PHY_RX_FD_VHT_DFE_SYM_START 0x5F0 */
#define B1_PHY_RX_FD_VHT_DFE_SYM_START_FIELD_VHT_DFE_SYM_START_MASK                                               0x00007FFF
//========================================
/* REG_PHY_RX_FD_START_FROM_QR_0_ENABLE 0x5F4 */
#define B1_PHY_RX_FD_START_FROM_QR_0_ENABLE_FIELD_START_FROM_QR_0_ENABLE_MASK                                     0x00000001
//========================================
/* REG_PHY_RX_FD_SYMBOL_TIME_EHT_2SEG_COUNT0 0x5F8 */
#define B1_PHY_RX_FD_SYMBOL_TIME_EHT_2SEG_COUNT0_FIELD_SYMBOL_TIME_EHT_2SEG_LCP_COUNT_MASK                        0x00003FFF
#define B1_PHY_RX_FD_SYMBOL_TIME_EHT_2SEG_COUNT0_FIELD_SYMBOL_TIME_EHT_2SEG_MCP_COUNT_MASK                        0x0FFFC000
//========================================
/* REG_PHY_RX_FD_SYMBOL_TIME_EHT_2SEG_COUNT1 0x5FC */
#define B1_PHY_RX_FD_SYMBOL_TIME_EHT_2SEG_COUNT1_FIELD_SYMBOL_TIME_EHT_2SEG_SCP_COUNT_MASK                        0x00003FFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG_RAM_RM 0x600 */
#define B1_PHY_RX_FD_PHY_RXFD_REG_RAM_RM_FIELD_AMP_COR_REF_PRV_RAM_RM_MASK                                        0x00000007
#define B1_PHY_RX_FD_PHY_RXFD_REG_RAM_RM_FIELD_HYP_RXFD_CH_ESTI_RAM_RM_MASK                                       0x00000038
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_REG_CH_ESTI 0x604 */
#define B1_PHY_RX_FD_PHY_RXFD_REG_CH_ESTI_FIELD_EX_LTF_NOISE_EN_MASK                                              0x00000001
//========================================
/* REG_PHY_RX_FD_QR_LIMIT_1SS 0x608 */
#define B1_PHY_RX_FD_QR_LIMIT_1SS_FIELD_QR_LIMIT_1SS_BAND_2G_MASK                                                 0x000001FF
#define B1_PHY_RX_FD_QR_LIMIT_1SS_FIELD_QR_LIMIT_1SS_BAND_5G_MASK                                                 0x0003FE00
#define B1_PHY_RX_FD_QR_LIMIT_1SS_FIELD_QR_LIMIT_1SS_BAND_6G_MASK                                                 0x07FC0000
//========================================
/* REG_PHY_RX_FD_QR_LIMIT_2SS 0x60C */
#define B1_PHY_RX_FD_QR_LIMIT_2SS_FIELD_QR_LIMIT_2SS_BAND_2G_MASK                                                 0x000001FF
#define B1_PHY_RX_FD_QR_LIMIT_2SS_FIELD_QR_LIMIT_2SS_BAND_5G_MASK                                                 0x0003FE00
#define B1_PHY_RX_FD_QR_LIMIT_2SS_FIELD_QR_LIMIT_2SS_BAND_6G_MASK                                                 0x07FC0000
//========================================
/* REG_PHY_RX_FD_QR_LIMIT_3SS 0x610 */
#define B1_PHY_RX_FD_QR_LIMIT_3SS_FIELD_QR_LIMIT_3SS_BAND_2G_MASK                                                 0x000001FF
#define B1_PHY_RX_FD_QR_LIMIT_3SS_FIELD_QR_LIMIT_3SS_BAND_5G_MASK                                                 0x0003FE00
#define B1_PHY_RX_FD_QR_LIMIT_3SS_FIELD_QR_LIMIT_3SS_BAND_6G_MASK                                                 0x07FC0000
//========================================
/* REG_PHY_RX_FD_QR_LIMIT_4SS 0x614 */
#define B1_PHY_RX_FD_QR_LIMIT_4SS_FIELD_QR_LIMIT_4SS_BAND_2G_MASK                                                 0x000001FF
#define B1_PHY_RX_FD_QR_LIMIT_4SS_FIELD_QR_LIMIT_4SS_BAND_5G_MASK                                                 0x0003FE00
#define B1_PHY_RX_FD_QR_LIMIT_4SS_FIELD_QR_LIMIT_4SS_BAND_6G_MASK                                                 0x07FC0000
//========================================
/* REG_PHY_RX_FD_RISC_SPHERE_CYCLES_REWIND_OVERRIDE 0x618 */
#define B1_PHY_RX_FD_RISC_SPHERE_CYCLES_REWIND_OVERRIDE_FIELD_RISC_SPHERE_CYCLES_REWIND_OVERRIDE_MASK             0x000001FF
//========================================
/* REG_PHY_RX_FD_PM_FD_OVERHEAD 0x61C */
#define B1_PHY_RX_FD_PM_FD_OVERHEAD_FIELD_PM_FD_OVERHEAD_MASK                                                     0x00000FFF
//========================================
/* REG_PHY_RX_FD_PHY_RXFD_BF_SETUP 0x620 */
#define B1_PHY_RX_FD_PHY_RXFD_BF_SETUP_FIELD_SU_BF_INTERP_MASK                                                    0x00000001
//========================================
/* REG_PHY_RX_FD_SMOOTHING_LONG_FILTER_ENABLE 0x624 */
#define B1_PHY_RX_FD_SMOOTHING_LONG_FILTER_ENABLE_FIELD_SMOOTHING_LONG_FILTER_ENABLE_MASK                         0x00000001
//========================================
/* REG_PHY_RX_FD_SPHERE_CYC_CT_CAN_WORK 0x628 */
#define B1_PHY_RX_FD_SPHERE_CYC_CT_CAN_WORK_FIELD_SPHERE_CYC_CT_CAN_WORK_MASK                                     0x00003FFF
//========================================
/* REG_PHY_RX_FD_TD_GAIN_CONFIG 0x62C */
#define B1_PHY_RX_FD_TD_GAIN_CONFIG_FIELD_PM_SU_BF_TD_GAIN_EN_MASK                                                0x00000001
#define B1_PHY_RX_FD_TD_GAIN_CONFIG_FIELD_PM_SU_BF_SPMAP_NORMALIZATION_EN_MASK                                    0x00000002
//========================================
/* REG_PHY_RX_FD_SPHERE_POWER_SAVE 0x630 */
#define B1_PHY_RX_FD_SPHERE_POWER_SAVE_FIELD_SPHERE_POWER_SAVE_MASK                                               0x00000001
//========================================
/* REG_PHY_RX_FD_SPHERE_CYCLES_RO 0x634 */
#define B1_PHY_RX_FD_SPHERE_CYCLES_RO_FIELD_SPHERE_CYCLES_INIT_VAL_MASK                                           0x00003FFF
#define B1_PHY_RX_FD_SPHERE_CYCLES_RO_FIELD_SPHERE_CYCLES_REWIND_MASK                                             0x3FFF0000
