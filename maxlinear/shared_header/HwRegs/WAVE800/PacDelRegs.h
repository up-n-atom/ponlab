...
#define	REG_PAC_DEL_DELIA_CNTRL_REGISTER                 (PAC_DEL_BASE_ADDRESS + 0xA4)
...
#define	REG_PAC_DEL_RECIPE_WR_CNT                        (PAC_DEL_BASE_ADDRESS + 0xD0)
