...
#define B1_HOB_PAC_DEL_HOB_DEL_COUNTER0_EVENT_FIELD_HOB_DEL_COUNTER0_EVENT_MASK                                   0x00000FFF
//========================================
/* REG_HOB_PAC_DEL_HOB_DEL_COUNTER1_EVENT 0x4 */
#define B1_HOB_PAC_DEL_HOB_DEL_COUNTER1_EVENT_FIELD_HOB_DEL_COUNTER1_EVENT_MASK                                   0x00000FFF
//========================================
/* REG_HOB_PAC_DEL_NOP_WAIT_EVENT_VECTOR 0x8 */
#define B1_HOB_PAC_DEL_NOP_WAIT_EVENT_VECTOR_FIELD_NOP_WAIT_EVENT_VECTOR_MASK                                     0x003FFFFF
//========================================
/* REG_HOB_PAC_DEL_TX_DATA_STRUCTURE_ADDR 0xC */
#define B1_HOB_PAC_DEL_TX_DATA_STRUCTURE_ADDR_FIELD_TX_DATA_STRUCTURE_ADDR_MASK                                   0x03FFFFFF
//========================================
/* REG_HOB_PAC_DEL_DEL2GENRISC_START_TX_INT 0x10 */
#define B1_HOB_PAC_DEL_DEL2GENRISC_START_TX_INT_FIELD_DEL2GENRISC_START_TX_INT_MASK                               0x0000003F
//========================================
/* REG_HOB_PAC_DEL_PRBS_DATA 0x18 */
#define B1_HOB_PAC_DEL_PRBS_DATA_FIELD_PRBS_DATA_MASK                                                             0x000000FF
//========================================
/* REG_HOB_PAC_DEL_PHY_MODE 0x1C */
#define B1_HOB_PAC_DEL_PHY_MODE_FIELD_PAC_PHY_11AG_MODE_MASK                                                      0x00000001
#define B1_HOB_PAC_DEL_PHY_MODE_FIELD_PAC_PHY_11B_MODE_MASK                                                       0x00000002
#define B1_HOB_PAC_DEL_PHY_MODE_FIELD_PAC_PHY_11N_MODE_MASK                                                       0x00000004
#define B1_HOB_PAC_DEL_PHY_MODE_FIELD_PAC_PHY_11AC_MODE_MASK                                                      0x00000008
#define B1_HOB_PAC_DEL_PHY_MODE_FIELD_PAC_PHY_HE_SU_MASK                                                          0x00000010
#define B1_HOB_PAC_DEL_PHY_MODE_FIELD_PAC_PHY_HE_EX_SU_MASK                                                       0x00000020
#define B1_HOB_PAC_DEL_PHY_MODE_FIELD_PAC_PHY_HE_MU_TF_MASK                                                       0x00000040
#define B1_HOB_PAC_DEL_PHY_MODE_FIELD_PAC_PHY_HE_MU_MASK                                                          0x00000080
#define B1_HOB_PAC_DEL_PHY_MODE_FIELD_PAC_PHY_EHT_SU_MASK                                                         0x00000100
#define B1_HOB_PAC_DEL_PHY_MODE_FIELD_PAC_PHY_EHT_MU_TF_MASK                                                      0x00000200
#define B1_HOB_PAC_DEL_PHY_MODE_FIELD_PAC_PHY_EHT_MU_MASK                                                         0x00000400
#define B1_HOB_PAC_DEL_PHY_MODE_FIELD_PAC_PHY_VHT_HE_EHT_MASK                                                     0x00000800
//========================================
/* REG_HOB_PAC_DEL_BF_TX_MAX_THRESHOLD_TIMER 0x20 */
#define B1_HOB_PAC_DEL_BF_TX_MAX_THRESHOLD_TIMER_FIELD_BF_TX_MAX_THRESHOLD_TIMER_MASK                             0x000003FF
//========================================
/* REG_HOB_PAC_DEL_ZLD_VAL 0x24 */
#define B1_HOB_PAC_DEL_ZLD_VAL_FIELD_ZLD_VAL_MASK                                                                 0xFFFFFFFF
//========================================
/* REG_HOB_PAC_DEL_DEL_TXC_RESP_TIMEOUT_VALUE 0x28 */
#define B1_HOB_PAC_DEL_DEL_TXC_RESP_TIMEOUT_VALUE_FIELD_DEL_TXC_RESP_TIMEOUT_VALUE_MASK                           0x00001FFF
//========================================
/* REG_HOB_PAC_DEL_RX_LAST_MPDU_IN_PTR 0x2C */
#define B1_HOB_PAC_DEL_RX_LAST_MPDU_IN_PTR_FIELD_RX_LAST_MPDU_IN_PTR_MASK                                         0x01FFFFFF
//========================================
/* REG_HOB_PAC_DEL_CTR_DATA 0x34 */
#define B1_HOB_PAC_DEL_CTR_DATA_FIELD_CTR_DATA_MASK                                                               0x000000FF
//========================================
/* REG_HOB_PAC_DEL_LOGGER_HOB_INFO 0x38 */
#define B1_HOB_PAC_DEL_LOGGER_HOB_INFO_FIELD_LOGGER_HOB_INFO_MASK                                                 0x000000FF
//========================================
/* REG_HOB_PAC_DEL_HT_DELIMITER_DATA_IN 0x3C */
#define B1_HOB_PAC_DEL_HT_DELIMITER_DATA_IN_FIELD_DELIMITER_DATA_IN_MASK                                          0x0000FFFF
//========================================
/* REG_HOB_PAC_DEL_VHT_DELIMITER_DATA_IN 0x40 */
#define B1_HOB_PAC_DEL_VHT_DELIMITER_DATA_IN_FIELD_DELIMITER_DATA_IN_MASK                                         0x0000FFFF
//========================================
/* REG_HOB_PAC_DEL_VHT_EOF_DELIMITER_DATA_IN 0x44 */
#define B1_HOB_PAC_DEL_VHT_EOF_DELIMITER_DATA_IN_FIELD_DELIMITER_DATA_IN_MASK                                     0x0000FFFF
//========================================
/* REG_HOB_PAC_DEL_DELIMITER_DATA_OUT 0x48 */
#define B1_HOB_PAC_DEL_DELIMITER_DATA_OUT_FIELD_DELIMITER_DATA_OUT_MASK                                           0xFFFFFFFF
//========================================
/* REG_HOB_PAC_DEL_DELIA_EVENT_THRESHOLD_TIMER 0x4C */
#define B1_HOB_PAC_DEL_DELIA_EVENT_THRESHOLD_TIMER_FIELD_DELIA_EVENT_THRESHOLD_TIMER_MASK                         0x00FFFFFF
//========================================
/* REG_HOB_PAC_DEL_TIM_DEL_EVENT_TIMER_EXPIRED 0x50 */
#define B1_HOB_PAC_DEL_TIM_DEL_EVENT_TIMER_EXPIRED_FIELD_TIM_DEL_EVENT_TIMER_EXPIRED_MASK                         0x00000001
//========================================
/* REG_HOB_PAC_DEL_TCR_TXOP_DUR_FROM_MAC 0x54 */
#define B1_HOB_PAC_DEL_TCR_TXOP_DUR_FROM_MAC_FIELD_TCR_TXOP_DUR_FROM_MAC_MASK                                     0x00000001
//========================================
/* REG_HOB_PAC_DEL_DELIA_TX_MPDU_DUR_FIELD 0x5C */
#define B1_HOB_PAC_DEL_DELIA_TX_MPDU_DUR_FIELD_FIELD_TX_MPDU_DUR_FIELD_MASK                                       0x0000FFFF
//========================================
/* REG_HOB_PAC_DEL_PAC_PHY_TX_LENGTH_ZERO 0x60 */
#define B1_HOB_PAC_DEL_PAC_PHY_TX_LENGTH_ZERO_FIELD_PAC_PHY_TX_LENGTH_ZERO_MASK                                   0x00000001
//========================================
/* REG_HOB_PAC_DEL_DELIMITER_VALUE_PRE_TX_DATA 0x64 */
#define B1_HOB_PAC_DEL_DELIMITER_VALUE_PRE_TX_DATA_FIELD_DELIMITER_VALUE_PRE_TX_DATA_MASK                         0xFFFFFFFF
//========================================
/* REG_HOB_PAC_DEL_NUM_OF_USER_TCRS 0x68 */
#define B1_HOB_PAC_DEL_NUM_OF_USER_TCRS_FIELD_NUM_OF_USER_TCRS_MASK                                               0x000000FF
//========================================
/* REG_HOB_PAC_DEL_NUM_OF_USER_TCR_BYTES 0x6C */
#define B1_HOB_PAC_DEL_NUM_OF_USER_TCR_BYTES_FIELD_NUM_OF_USER_TCR_BYTES_MASK                                     0x00000FFF
//========================================
/* REG_HOB_PAC_DEL_EXPECTED_RCRS 0x70 */
#define B1_HOB_PAC_DEL_EXPECTED_RCRS_FIELD_EXPECTED_RCRS_MASK                                                     0x00000001
//========================================
/* REG_HOB_PAC_DEL_NUM_OF_USER_RCR_BYTES 0x74 */
#define B1_HOB_PAC_DEL_NUM_OF_USER_RCR_BYTES_FIELD_NUM_OF_USER_RCR_BYTES_MASK                                     0x00000FFF
//========================================
/* REG_HOB_PAC_DEL_TX_CIR_BUF_BASE_ADDR 0x78 */
#define B1_HOB_PAC_DEL_TX_CIR_BUF_BASE_ADDR_FIELD_TX_CIR_BUF_BASE_ADDR_MASK                                       0xFFFFFFFF
//========================================
/* REG_HOB_PAC_DEL_REG2HOB_GP0 0x7C */
#define B1_HOB_PAC_DEL_REG2HOB_GP0_FIELD_REG2HOB_GP0_MASK                                                         0xFFFFFFFF
//========================================
/* REG_HOB_PAC_DEL_REG2HOB_GP1 0x80 */
#define B1_HOB_PAC_DEL_REG2HOB_GP1_FIELD_REG2HOB_GP1_MASK                                                         0xFFFFFFFF
//========================================
/* REG_HOB_PAC_DEL_TCR_BASE_ADDR1 0x84 */
#define B1_HOB_PAC_DEL_TCR_BASE_ADDR1_FIELD_TCR_BASE_ADDR2_MASK                                                   0x03FFFFFF
//========================================
/* REG_HOB_PAC_DEL_TCR_BASE_ADDR2 0x88 */
#define B1_HOB_PAC_DEL_TCR_BASE_ADDR2_FIELD_TCR_BASE_ADDR2_MASK                                                   0x03FFFFFF
//========================================
/* REG_HOB_PAC_DEL_RCR_BASE_ADDR 0x8C */
#define B1_HOB_PAC_DEL_RCR_BASE_ADDR_FIELD_RCR_BASE_ADDR_MASK                                                     0x03FFFFFF
//========================================
/* REG_HOB_PAC_DEL_SENDER_MPDU_DURATION 0x90 */
#define B1_HOB_PAC_DEL_SENDER_MPDU_DURATION_FIELD_SENDER_MPDU_DURATION_MASK                                       0x0000FFFF
//========================================
/* REG_HOB_PAC_DEL_ALL_ONES_PADDING 0x94 */
#define B1_HOB_PAC_DEL_ALL_ONES_PADDING_FIELD_ALL_ONES_PADDING_MASK                                               0xFFFFFFFF
//========================================
/* REG_HOB_PAC_DEL_TCC_CRC 0x98 */
#define B1_HOB_PAC_DEL_TCC_CRC_FIELD_TCC_CRC_MASK                                                                 0xFFFFFFFF
