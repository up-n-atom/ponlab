...
#define	REG_DMAC_WRAPPER_DMA0_LAT_MSR_CFG                    (DMAC_WRAPPER_BASE_ADDRESS + 0xF80)
#define	REG_DMAC_WRAPPER_DMA0_WR_MAX_LAT_ID0                 (DMAC_WRAPPER_BASE_ADDRESS + 0xF84)
#define	REG_DMAC_WRAPPER_DMA0_WR_MAX_LAT_ID1                 (DMAC_WRAPPER_BASE_ADDRESS + 0xF88)
#define	REG_DMAC_WRAPPER_DMA0_RD_MAX_LAT_ID0                 (DMAC_WRAPPER_BASE_ADDRESS + 0xF8C)
#define	REG_DMAC_WRAPPER_DMA0_RD_MAX_LAT_ID1                 (DMAC_WRAPPER_BASE_ADDRESS + 0xF90)
#define	REG_DMAC_WRAPPER_DMA1_LAT_MSR_CFG                    (DMAC_WRAPPER_BASE_ADDRESS + 0xF94)
#define	REG_DMAC_WRAPPER_DMA1_WR_MAX_LAT_ID0                 (DMAC_WRAPPER_BASE_ADDRESS + 0xF98)
#define	REG_DMAC_WRAPPER_DMA1_WR_MAX_LAT_ID1                 (DMAC_WRAPPER_BASE_ADDRESS + 0xF9C)
#define	REG_DMAC_WRAPPER_DMA1_WR_MAX_LAT_ID2                 (DMAC_WRAPPER_BASE_ADDRESS + 0xFA0)
#define	REG_DMAC_WRAPPER_DMA1_WR_MAX_LAT_ID3                 (DMAC_WRAPPER_BASE_ADDRESS + 0xFA4)
#define	REG_DMAC_WRAPPER_DMA1_RD_MAX_LAT_ID0                 (DMAC_WRAPPER_BASE_ADDRESS + 0xFA8)
#define	REG_DMAC_WRAPPER_DMA1_RD_MAX_LAT_ID1                 (DMAC_WRAPPER_BASE_ADDRESS + 0xFAC)
#define	REG_DMAC_WRAPPER_DMA1_RD_MAX_LAT_ID2                 (DMAC_WRAPPER_BASE_ADDRESS + 0xFB0)
#define	REG_DMAC_WRAPPER_DMA1_RD_MAX_LAT_ID3                 (DMAC_WRAPPER_BASE_ADDRESS + 0xFB4)
...
/*REG_DMAC_WRAPPER_DMA0_LAT_MSR_CFG 0xF80 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 dma0LatMsrEna : 1; //no description, reset value: 0x0, access type: RW
		uint32 dma0LatMsrClr : 1; //no description, reset value: 0x0, access type: RW
		uint32 dma0LatMsrFifoError : 1; //no description, reset value: 0x0, access type: RO
		uint32 reserved0 : 29;
	} bitFields;
} RegDmacWrapperDma0LatMsrCfg_u;

/*REG_DMAC_WRAPPER_DMA0_WR_MAX_LAT_ID0 0xF84 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 dma0WrMaxLatId0 : 32; //no description, reset value: 0x0, access type: RO
	} bitFields;
} RegDmacWrapperDma0WrMaxLatId0_u;

/*REG_DMAC_WRAPPER_DMA0_WR_MAX_LAT_ID1 0xF88 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 dma0WrMaxLatId1 : 32; //no description, reset value: 0x0, access type: RO
	} bitFields;
} RegDmacWrapperDma0WrMaxLatId1_u;

/*REG_DMAC_WRAPPER_DMA0_RD_MAX_LAT_ID0 0xF8C */
typedef union
{
	uint32 val;
	struct
	{
		uint32 dma0RdMaxLatId0 : 32; //no description, reset value: 0x0, access type: RO
	} bitFields;
} RegDmacWrapperDma0RdMaxLatId0_u;

/*REG_DMAC_WRAPPER_DMA0_RD_MAX_LAT_ID1 0xF90 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 dma0RdMaxLatId1 : 32; //no description, reset value: 0x0, access type: RO
	} bitFields;
} RegDmacWrapperDma0RdMaxLatId1_u;

/*REG_DMAC_WRAPPER_DMA1_LAT_MSR_CFG 0xF94 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 dma1LatMsrEna : 1; //no description, reset value: 0x0, access type: RW
		uint32 dma1LatMsrClr : 1; //no description, reset value: 0x0, access type: RW
		uint32 dma1LatMsrFifoError : 1; //no description, reset value: 0x0, access type: RO
		uint32 reserved0 : 29;
	} bitFields;
} RegDmacWrapperDma1LatMsrCfg_u;

/*REG_DMAC_WRAPPER_DMA1_WR_MAX_LAT_ID0 0xF98 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 dma1WrMaxLatId0 : 32; //no description, reset value: 0x0, access type: RO
	} bitFields;
} RegDmacWrapperDma1WrMaxLatId0_u;

/*REG_DMAC_WRAPPER_DMA1_WR_MAX_LAT_ID1 0xF9C */
typedef union
{
	uint32 val;
	struct
	{
		uint32 dma1WrMaxLatId1 : 32; //no description, reset value: 0x0, access type: RO
	} bitFields;
} RegDmacWrapperDma1WrMaxLatId1_u;

/*REG_DMAC_WRAPPER_DMA1_WR_MAX_LAT_ID2 0xFA0 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 dma1WrMaxLatId2 : 32; //no description, reset value: 0x0, access type: RO
	} bitFields;
} RegDmacWrapperDma1WrMaxLatId2_u;

/*REG_DMAC_WRAPPER_DMA1_WR_MAX_LAT_ID3 0xFA4 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 dma1WrMaxLatId3 : 32; //no description, reset value: 0x0, access type: RO
	} bitFields;
} RegDmacWrapperDma1WrMaxLatId3_u;

/*REG_DMAC_WRAPPER_DMA1_RD_MAX_LAT_ID0 0xFA8 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 dma1RdMaxLatId0 : 32; //no description, reset value: 0x0, access type: RO
	} bitFields;
} RegDmacWrapperDma1RdMaxLatId0_u;

/*REG_DMAC_WRAPPER_DMA1_RD_MAX_LAT_ID1 0xFAC */
typedef union
{
	uint32 val;
	struct
	{
		uint32 dma1RdMaxLatId1 : 32; //no description, reset value: 0x0, access type: RO
	} bitFields;
} RegDmacWrapperDma1RdMaxLatId1_u;

/*REG_DMAC_WRAPPER_DMA1_RD_MAX_LAT_ID2 0xFB0 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 dma1RdMaxLatId2 : 32; //no description, reset value: 0x0, access type: RO
	} bitFields;
} RegDmacWrapperDma1RdMaxLatId2_u;

/*REG_DMAC_WRAPPER_DMA1_RD_MAX_LAT_ID3 0xFB4 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 dma1RdMaxLatId3 : 32; //no description, reset value: 0x0, access type: RO
	} bitFields;
} RegDmacWrapperDma1RdMaxLatId3_u;
