...
#define	REG_HOST_IF_ACC_GP0_DMA_JOBS_COUNT_SUB           (HOST_IF_ACC_BASE_ADDRESS + 0x110)
#define	REG_HOST_IF_ACC_GP1_DMA_JOBS_COUNT_SUB           (HOST_IF_ACC_BASE_ADDRESS + 0x114)
#define	REG_HOST_IF_ACC_GP2_DMA_JOBS_COUNT_SUB           (HOST_IF_ACC_BASE_ADDRESS + 0x118)
#define	REG_HOST_IF_ACC_GP3_DMA_JOBS_COUNT_SUB           (HOST_IF_ACC_BASE_ADDRESS + 0x11C)
#define	REG_HOST_IF_ACC_GP0_DMA_JOBS_COUNT               (HOST_IF_ACC_BASE_ADDRESS + 0x120)
#define	REG_HOST_IF_ACC_GP1_DMA_JOBS_COUNT               (HOST_IF_ACC_BASE_ADDRESS + 0x124)
#define	REG_HOST_IF_ACC_GP2_DMA_JOBS_COUNT               (HOST_IF_ACC_BASE_ADDRESS + 0x128)
#define	REG_HOST_IF_ACC_GP3_DMA_JOBS_COUNT               (HOST_IF_ACC_BASE_ADDRESS + 0x12C)
...
typedef union
{
	...
	struct
	{
		uint32 rxOutShadowHdBufferFreeInt : 1; //Rx out shadow hd buffer free int, reset value: 0x0, access type: RO
		uint32 rxOutPendingJobsInt : 1; //Rx out pending jobs int, reset value: 0x0, access type: RO
		uint32 rxInHdBufferFreeInt : 1; //Rx in hd buffer free int, reset value: 0x0, access type: RO
		uint32 rxInShadowPendingJobsInt : 1; //Rx in shadow pending jobs int, reset value: 0x0, access type: RO
		uint32 txOutShadowHdBufferFreeInt : 1; //Tx out shadow hd buffer free int, reset value: 0x0, access type: RO
		...
		uint32 txInShadowPendingJobsInt : 1; //Tx in shadow pending jobs int, reset value: 0x0, access type: RO
		...
		uint32 gp0DmaJobsCounterNotEmptyIrq : 1; //gp0 dma jobs counter not empty irq, reset value: 0x0, access type: RO
		uint32 gp1DmaJobsCounterNotEmptyIrq : 1; //gp1 dma jobs counter not empty irq, reset value: 0x0, access type: RO
		uint32 gp2DmaJobsCounterNotEmptyIrq : 1; //gp2 dma jobs counter not empty irq, reset value: 0x0, access type: RO
		uint32 gp3DmaJobsCounterNotEmptyIrq : 1; //gp3 dma jobs counter not empty irq, reset value: 0x0, access type: RO
...
/*REG_HOST_IF_ACC_GP0_DMA_JOBS_COUNT_SUB 0x110 */
typedef union
{
	uint32 val;
	struct
...
/*REG_HOST_IF_ACC_GP1_DMA_JOBS_COUNT_SUB 0x114 */
typedef union
{
	uint32 val;
	struct
...
/*REG_HOST_IF_ACC_GP2_DMA_JOBS_COUNT_SUB 0x118 */
typedef union
{
	uint32 val;
	struct
...
/*REG_HOST_IF_ACC_GP3_DMA_JOBS_COUNT_SUB 0x11C */
typedef union
{
	uint32 val;
	struct
...
/*REG_HOST_IF_ACC_GP0_DMA_JOBS_COUNT 0x120 */
typedef union
{
	uint32 val;
	struct
...
/*REG_HOST_IF_ACC_GP1_DMA_JOBS_COUNT 0x124 */
typedef union
{
	uint32 val;
	struct
...
/*REG_HOST_IF_ACC_GP2_DMA_JOBS_COUNT 0x128 */
typedef union
{
	uint32 val;
	struct
...
/*REG_HOST_IF_ACC_GP3_DMA_JOBS_COUNT 0x12C */
typedef union
{
	uint32 val;
	struct
...
typedef union
{
	...
	struct
	{
		uint32 rdThres : 17; //RD threshold limit for FW IRQ, reset value: 0x10, access type: RW
		uint32 reserved0 : 15;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		...
		uint32 txPdQosCountersUpdateDone : 1; //no description, reset value: 0x0, access type: RO
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 genriscHostPdListIdxForIrq : 6; //PD list index for Not empty IRQ to GenRisc HOST, reset value: 0x0, access type: RW
		uint32 reserved0 : 2;
		uint32 genriscHostRdListIdxForIrq : 6; //RD list index for Not empty IRQ to GenRisc HOST, reset value: 0x0, access type: RW
		uint32 reserved1 : 18;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		...
		uint32 aqmDropListId : 6; //List index of the dropped PD, reset value: 0x0, access type: RW
		uint32 reserved0 : 25;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 aqmDbg : 32; //Various debug signals. Refer to the AQM HW RTL for the exact list., reset value: 0x0, access type: RO
	} bitFields;
