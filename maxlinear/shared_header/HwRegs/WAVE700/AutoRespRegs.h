...
Module:				autoResp
SOC Revision:		latest
Generated at:       2022-05-04 10:58:57
Purpose:
...
#define	REG_AUTO_RESP_AUTO_RESP_OT_CFG                                (AUTO_RESP_BASE_ADDRESS + 0x60)
...
#define	REG_AUTO_RESP_AUTO_REPLY_OVERRIDE_PARAMS_DBG1                 (AUTO_RESP_BASE_ADDRESS + 0x114)
...
#define	REG_AUTO_RESP_CLEAR_HISTORY_TID_CTRL                          (AUTO_RESP_BASE_ADDRESS + 0x190)
...
#define	REG_AUTO_RESP_AUTO_REPLY_OVERRIDE_PARAMS_DBG2                 (AUTO_RESP_BASE_ADDRESS + 0x2A0)
...
#define	REG_AUTO_RESP_AUTO_RESP_VAP_DUR_IDX0                          (AUTO_RESP_BASE_ADDRESS + 0x2D0)
#define	REG_AUTO_RESP_AUTO_RESP_VAP_DUR_IDX1                          (AUTO_RESP_BASE_ADDRESS + 0x2D4)
#define	REG_AUTO_RESP_AUTO_RESP_AID_FOR_MLD                           (AUTO_RESP_BASE_ADDRESS + 0x2E0)
...
} RegAutoRespAutoReplyOverrideParamsDbg1_u;
...
} RegAutoRespClearHistoryTidCtrl_u;
...
} RegAutoRespAutoReplyOverrideParamsDbg2_u;
...
} RegAutoRespAutoRespVapDurIdx0_u;
...
} RegAutoRespAutoRespVapDurIdx1_u;
...
} RegAutoRespAutoRespAidForMld_u;
