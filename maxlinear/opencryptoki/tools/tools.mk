...
if CROSS
CFLAGS_FOR_TOOL_BUILD =-O2 -no-pie
tools_tableidxgen_LINK = $(CC_FOR_BUILD) $(CFLAGS_FOR_TOOL_BUILD) $(LDFLAGS_FOR_BUILD) -o $@

$(tools_tableidxgen_OBJECTS): CC=$(CC_FOR_BUILD)
$(tools_tableidxgen_OBJECTS): CFLAGS=$(CFLAGS_FOR_TOOL_BUILD) $(TOOLS_CFLAGS)
$(tools_tableidxgen_OBJECTS): LDFLAGS=$(LDFLAGS_FOR_BUILD)

tools_policyexamplegen_LINK = $(CC_FOR_BUILD) $(CFLAGS_FOR_TOOL_BUILD) $(LDFLAGS_FOR_BUILD) -o $@

$(tools_policyexamplegen_OBJECTS): CC=$(CC_FOR_BUILD)
$(tools_policyexamplegen_OBJECTS): CFLAGS=$(CFLAGS_FOR_TOOL_BUILD)  $(TOOLS_CFLAGS)
