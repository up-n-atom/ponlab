...
/* note: this file was originally generated from bcl_h_gen.xls, but has since been edited and is no longer in sync */
...
MT_UINTPTR WrapperFunction(int index)
{
    switch (index)
    {
    ...
    case 5 : return (MT_UINT32)ditem((MT_UBYTE)MT_BCL_arg[0],(MT_UINTPTR)MT_BCL_arg[1],(MT_UBYTE)MT_BCL_arg[2],(MT_UBYTE)MT_BCL_arg[3]);
    case 6 : return (MT_UINT32)dmem((MT_UBYTE)MT_BCL_arg[0],(void*)MT_BCL_arg[1],(MT_UBYTE)MT_BCL_arg[2]);
    case 7 : return (MT_UINT32)dreg16   ((MT_UBYTE)MT_BCL_arg[0],(void*)MT_BCL_arg[1],(MT_UBYTE)MT_BCL_arg[2]);
    case 8 : return (MT_UINT32)dreg32   ((MT_UBYTE)MT_BCL_arg[0],(void*)MT_BCL_arg[1],(MT_UBYTE)MT_BCL_arg[2]);
    case 9 : return (MT_UINT32)dreg8    ((MT_UBYTE)MT_BCL_arg[0],(void*)MT_BCL_arg[1],(MT_UBYTE)MT_BCL_arg[2]);
    ...
    case 32 : return (MT_UINTPTR)pitemlist((MT_UBYTE)MT_BCL_arg[0]);
