...
/*!
    \brief This is the data structure for reserved MAC address.
*/
typedef struct {
	char8 pcMac[SCAPI_MAC_LEN];	/*!< MAC address */
} ResvMAC;
...
*/
typedef struct dump_lease_info_t
{
    uint8_t lease_mac[6];
    char ipaddr[18];
    char hostname[20];
...
#define MAX_LEN_PARAM_VALUE_D 2048 /*!< Parameter Value string length */
...
#define MAX_LEN_LINE 256 /*!< Max read Line length */
#define MAX_LEN_PARAM_VAL 128 /*!< Parameter Value string length */
...
/* \brief for PPMD status info*/
/*!
    \brief This is the data structure to stores values of PPMD status.
*/
typedef struct
{
    char sADP_DVFS_Thresholds[MAX_LEN_PARAM_VAL];
    char sADP_DVFS_Level[MAX_LEN_PARAM_VAL];
    char sADPCooling[MAX_LEN_PARAM_VAL];
    char sAggregated_Total_Link_Speed[MAX_LEN_PARAM_VAL];
} PPMDInfo_t;

/* \brief for Power Monitor info*/
/*!
    \brief This is the data structure to stores values of Power Monitor.
*/
typedef struct
{
    uint32_t uPower;
