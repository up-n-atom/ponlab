...
struct ieee80211_if_managed {
	...
	struct work_struct color_switch_work;
...
/**
 * struct ieee80211_radar_detection - Radar detection info
 *
 * @chandef: channels related to the radar detection.
 * @radar_bit_map: bitmap indicating on which channels a radar
 *  was detected on. 0x0 or 0xff means radar deteceted on all
 *  channels in chandef.
 */
struct ieee80211_radar_detection {
        struct work_struct radar_detected_work;
        struct mutex radar_detctx_mtx;
        struct cfg80211_chan_def chandef;
        u8 radar_bit_map;
};

/**
 * struct color_coll_notify - BSS color collision notify work
 *
 * @work: work struct
 * @color_bitmap: u64 bit map of colors collision
 * @bssid: BSSID of the OBSS
 */
struct color_collision_notify {
...
struct ieee80211_local {
	...
	struct ieee80211_radar_detection radar_detection;
...
#define IEEE80211_IRQSAFE_QUEUE_LIMIT 128
	...
	u64 obss_bss_color_bitmap;
	time64_t obss_bss_color_last_update_time;
...
/* This struct holds the value parsing from
 * Color chanmax_switch_timege announcement IE
 */
struct ieee80211_cca_ie {
        u8 count;
        u8 color;
};
...
struct ieee802_11_elems {
	...
	const struct ieee80211_cca_ie *cca_ie;
