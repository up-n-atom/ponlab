...
#define	REG_PHY_AGC_ANT2_PM_MAX_LIMIT_ACC_BB_DIGITAL_GAIN       (PHY_AGC_ANT2_BASE_ADDRESS + 0x2EC)
#define	REG_PHY_AGC_ANT2_PM_MIN_LIMIT_ACC_BB_DIGITAL_GAIN       (PHY_AGC_ANT2_BASE_ADDRESS + 0x2F0)
#define	REG_PHY_AGC_ANT2_PM_MAX_LIMIT_ACC_IB_DIGITAL_GAIN       (PHY_AGC_ANT2_BASE_ADDRESS + 0x2F4)
#define	REG_PHY_AGC_ANT2_PM_MIN_LIMIT_ACC_IB_DIGITAL_GAIN       (PHY_AGC_ANT2_BASE_ADDRESS + 0x2F8)
/*---------------------------------------------------------------------------------
...
/*REG_PHY_AGC_ANT2_PM_MAX_LIMIT_ACC_BB_DIGITAL_GAIN 0x2EC */
typedef union
{
	uint32 val;
	struct
...
/*REG_PHY_AGC_ANT2_PM_MIN_LIMIT_ACC_BB_DIGITAL_GAIN 0x2F0 */
typedef union
{
	uint32 val;
	struct
...
/*REG_PHY_AGC_ANT2_PM_MAX_LIMIT_ACC_IB_DIGITAL_GAIN 0x2F4 */
typedef union
{
	uint32 val;
	struct
...
/*REG_PHY_AGC_ANT2_PM_MIN_LIMIT_ACC_IB_DIGITAL_GAIN 0x2F8 */
typedef union
{
	uint32 val;
	struct
