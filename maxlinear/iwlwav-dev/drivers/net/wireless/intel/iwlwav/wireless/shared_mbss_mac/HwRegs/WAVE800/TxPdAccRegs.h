...
#define	REG_TX_PD_ACC_SPP_FRAGMENT_CONTROL                   (TX_PD_ACC_BASE_ADDRESS + 0x3C)
...
#define	REG_TX_PD_ACC_TXPD_OPEARTION_PARAMS_2                (TX_PD_ACC_BASE_ADDRESS + 0x7C)
/*---------------------------------------------------------------------------------
...
} RegTxPdAccSppFragmentControl_u;
...
} RegTxPdAccTxpdOpeartionParams2_u;
