...
#define	REG_MAC_WEP_TX_MLDAR_CTRL                     (MAC_WEP_BASE_ADDRESS + 0x184)
#define	REG_MAC_WEP_TX_MLDAR_RA_TA_READ_ADDR          (MAC_WEP_BASE_ADDRESS + 0x188)
#define	REG_MAC_WEP_TX_MLDAR_RA_TA_RD_DATA0           (MAC_WEP_BASE_ADDRESS + 0x18C)
#define	REG_MAC_WEP_TX_MLDAR_RA_TA_RD_DATA1           (MAC_WEP_BASE_ADDRESS + 0x190)
#define	REG_MAC_WEP_TX_MLDAR_RA_TA_RD_DATA2           (MAC_WEP_BASE_ADDRESS + 0x194)
#define	REG_MAC_WEP_TX_MLDAR_DBG_BUSY_VEC             (MAC_WEP_BASE_ADDRESS + 0x198)
#define	REG_MAC_WEP_TX_MLDAR_DBG_SMC_ADDR             (MAC_WEP_BASE_ADDRESS + 0x19C)
#define	REG_MAC_WEP_TX_MLDAR_DBG                      (MAC_WEP_BASE_ADDRESS + 0x1A0)
#define	REG_MAC_WEP_TX_MLDAR_SKIP_USER                (MAC_WEP_BASE_ADDRESS + 0x1A4)
/*---------------------------------------------------------------------------------
...
} RegMacWepTxMldarRaTaReadAddr_u;
