...
#define	REG_B0_PHY_TXTD_ANT2_TX_POWERSAVING_ENABLE             (B0_PHY_TXTD_ANT2_BASE_ADDRESS + 0x380)
/*---------------------------------------------------------------------------------
...
/*REG_B0_PHY_TXTD_ANT2_TX_POWERSAVING_ENABLE 0x380 */
typedef union
{
	uint32 val;
	struct
...
} RegB0PhyTxtdAnt2TxPowersavingEnable_u;
