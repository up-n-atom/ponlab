...
#define	REG_B1_DFS_PHY_AGC_ANT_AGC_MEASURMENT_FOR_SPUR_CANCEL           (B1_DFS_PHY_AGC_ANT_BASE_ADDRESS + 0x548)
#define	REG_B1_DFS_PHY_AGC_ANT_PM_LIMIT_LNA_MAX_INDEX                   (B1_DFS_PHY_AGC_ANT_BASE_ADDRESS + 0x54C)
/*---------------------------------------------------------------------------------
...
/*REG_B1_DFS_PHY_AGC_ANT_AGC_MEASURMENT_FOR_SPUR_CANCEL 0x548 */
typedef union
{
	uint32 val;
	struct
...
} RegB1DfsPhyAgcAntAgcMeasurmentForSpurCancel_u;

/*REG_B1_DFS_PHY_AGC_ANT_PM_LIMIT_LNA_MAX_INDEX 0x54C */
typedef union
{
	uint32 val;
	struct
...
} RegB1DfsPhyAgcAntPmLimitLnaMaxIndex_u;
