...
#define	REG_LOGGER_BUFFER_LENGTH                         (LOGGER_BASE_ADDRESS + 0xD8)
...
#define	REG_LOGGER_PHY_FIFO1_MESAGE_LENGTH               (LOGGER_BASE_ADDRESS + 0x174)
...
#define	REG_LOGGER_NUM_MESSAGES_8                        (LOGGER_BASE_ADDRESS + 0x1B4)
#define	REG_LOGGER_NUM_BYTES_IN_FIFO_8                   (LOGGER_BASE_ADDRESS + 0x1B8)
#define	REG_LOGGER_LMAC3_DATA_IN                         (LOGGER_BASE_ADDRESS + 0x1BC)
#define	REG_LOGGER_LMAC3_FAST_MES_DATA_IN                (LOGGER_BASE_ADDRESS + 0x1C0)
#define	REG_LOGGER_LMAC3_MESAGE_DONE                     (LOGGER_BASE_ADDRESS + 0x1C4)
#define	REG_LOGGER_RX_HANDLER3_DATA_IN                   (LOGGER_BASE_ADDRESS + 0x1C8)
#define	REG_LOGGER_RX_HANDLER3_FAST_MES_DATA_IN          (LOGGER_BASE_ADDRESS + 0x1CC)
#define	REG_LOGGER_RX_HANDLER3_MESAGE_DONE               (LOGGER_BASE_ADDRESS + 0x1D0)
#define	REG_LOGGER_SENDER3_DATA_IN                       (LOGGER_BASE_ADDRESS + 0x1D4)
#define	REG_LOGGER_SENDER3_FAST_MES_DATA_IN              (LOGGER_BASE_ADDRESS + 0x1D8)
#define	REG_LOGGER_SENDER3_MESAGE_DONE                   (LOGGER_BASE_ADDRESS + 0x1DC)
#define	REG_LOGGER_LMAC_HANDLER3_FAST_MES_SEC_WORD       (LOGGER_BASE_ADDRESS + 0x1E0)
#define	REG_LOGGER_SENDER_PHY_RISC3_FAST_MES_SEC_WORD    (LOGGER_BASE_ADDRESS + 0x1E4)
/*---------------------------------------------------------------------------------
...
typedef union
{
	...
	struct
	{
		...
		uint32 reserved4 : 1;
		uint32 phyRisc3MemRm : 3; //no description, reset value: 0x3, access type: RW
		uint32 reserved5 : 9;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		...
		uint32 lmac3NumMessages : 8; //no description, reset value: 0x0, access type: RO
		uint32 rxHandler3NumMessages : 8; //no description, reset value: 0x0, access type: RO
	} bitFields;
...
typedef union
{
	...
	struct
	{
		...
		uint32 lmac3NumBytesInFifo : 8; //no description, reset value: 0x0, access type: RO
		uint32 rxHandler3NumBytesInFifo : 8; //no description, reset value: 0x0, access type: RO
	} bitFields;
...
typedef union
{
	...
	struct
	{
		...
		uint32 lmac3FifoEnable : 1; //no description, reset value: 0x0, access type: RW
		uint32 rxHandler3FifoEnable : 1; //no description, reset value: 0x0, access type: RW
		uint32 sender3FifoEnable : 1; //no description, reset value: 0x0, access type: RW
		uint32 phyRisc3FifoEnable : 1; //no description, reset value: 0x0, access type: RW
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 bufferEmtyTxDplIdx : 7; //buffer_emty_tx_dpl_idx , MS bit selects target QManager instance, reset value: 0x0, access type: RW
		uint32 reserved0 : 1;
		uint32 bufferFullTxDplIdx : 7; //buffer_full_tx_dpl_idx , MS bit selects target QManager instance, reset value: 0x0, access type: RW
		uint32 reserved1 : 1;
		uint32 loggerRdEmtyRxDplIdx : 7; //logger_rd_emty_rx_dpl_idx , MS bit selects target QManager instance, reset value: 0x0, access type: RW
		uint32 reserved2 : 1;
		uint32 loggerRdFullRxDplIdx : 7; //logger_rd_full_rx_dpl_idx , MS bit selects target QManager instance, reset value: 0x0, access type: RW
		uint32 reserved3 : 1;
	} bitFields;
} RegLoggerListId_u;
...
/*REG_LOGGER_BUFFER_LENGTH 0xD8 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 bufferLength : 16; //buffer_lenght, reset value: 0x500, access type: RW
		uint32 reserved0 : 16;
	} bitFields;
} RegLoggerBufferLength_u;
...
/*REG_LOGGER_PHY_FIFO1_MESAGE_LENGTH 0x174 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 phyFifo1MessageLength : 16; //phy_fifo1_message_lenght, reset value: 0x30, access type: RW
		uint32 phyFifo2MessageLength : 16; //phy_fifo2_message_lenght, reset value: 0x30, access type: RW
	} bitFields;
} RegLoggerPhyFifo1MesageLength_u;
...
/*REG_LOGGER_NUM_MESSAGES_8 0x1B4 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 sender3NumMessages : 8; //no description, reset value: 0x0, access type: RO
		uint32 phyRisc3NumMessages : 8; //no description, reset value: 0x0, access type: RO
		uint32 reserved0 : 16;
	} bitFields;
} RegLoggerNumMessages8_u;

/*REG_LOGGER_NUM_BYTES_IN_FIFO_8 0x1B8 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 sender3NumBytesInFifo : 8; //no description, reset value: 0x0, access type: RO
		uint32 phyRisc3NumBytesInFifo : 8; //no description, reset value: 0x0, access type: RO
		uint32 reserved0 : 16;
	} bitFields;
} RegLoggerNumBytesInFifo8_u;

/*REG_LOGGER_LMAC3_DATA_IN 0x1BC */
typedef union
{
	uint32 val;
	struct
	{
		uint32 lmac3DataIn : 32; //no description, reset value: 0x0, access type: RW
	} bitFields;
} RegLoggerLmac3DataIn_u;

/*REG_LOGGER_LMAC3_FAST_MES_DATA_IN 0x1C0 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 lmac3FastMesDataIn : 32; //no description, reset value: 0x0, access type: RW
	} bitFields;
} RegLoggerLmac3FastMesDataIn_u;

/*REG_LOGGER_LMAC3_MESAGE_DONE 0x1C4 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 lmac3MesageDone : 1; //no description, reset value: 0x0, access type: WO
		uint32 reserved0 : 31;
	} bitFields;
} RegLoggerLmac3MesageDone_u;

/*REG_LOGGER_RX_HANDLER3_DATA_IN 0x1C8 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 rxHandler3DataIn : 32; //no description, reset value: 0x0, access type: RW
	} bitFields;
} RegLoggerRxHandler3DataIn_u;

/*REG_LOGGER_RX_HANDLER3_FAST_MES_DATA_IN 0x1CC */
typedef union
{
	uint32 val;
	struct
	{
		uint32 rxHandler3FastMesDataIn : 32; //no description, reset value: 0x0, access type: RW
	} bitFields;
} RegLoggerRxHandler3FastMesDataIn_u;

/*REG_LOGGER_RX_HANDLER3_MESAGE_DONE 0x1D0 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 rxHandler3MesageDone : 1; //no description, reset value: 0x0, access type: WO
		uint32 reserved0 : 31;
	} bitFields;
} RegLoggerRxHandler3MesageDone_u;

/*REG_LOGGER_SENDER3_DATA_IN 0x1D4 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 sender3DataIn : 32; //no description, reset value: 0x0, access type: RW
	} bitFields;
} RegLoggerSender3DataIn_u;

/*REG_LOGGER_SENDER3_FAST_MES_DATA_IN 0x1D8 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 sender3FastMesDataIn : 32; //no description, reset value: 0x0, access type: RW
	} bitFields;
} RegLoggerSender3FastMesDataIn_u;

/*REG_LOGGER_SENDER3_MESAGE_DONE 0x1DC */
typedef union
{
	uint32 val;
	struct
	{
		uint32 sender3MesageDone : 1; //no description, reset value: 0x0, access type: WO
		uint32 reserved0 : 31;
	} bitFields;
} RegLoggerSender3MesageDone_u;

/*REG_LOGGER_LMAC_HANDLER3_FAST_MES_SEC_WORD 0x1E0 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 lmac3FastMesSecWord : 16; //no description, reset value: 0x0, access type: RW
		uint32 rxHandler3FastMesSecWord : 16; //no description, reset value: 0x0, access type: RW
	} bitFields;
} RegLoggerLmacHandler3FastMesSecWord_u;

/*REG_LOGGER_SENDER_PHY_RISC3_FAST_MES_SEC_WORD 0x1E4 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 sender3FastMesSecWord : 16; //no description, reset value: 0x0, access type: RW
		uint32 phyRisc3FastMesSecWord : 16; //no description, reset value: 0x0, access type: RW
	} bitFields;
} RegLoggerSenderPhyRisc3FastMesSecWord_u;

//========================================
/* REG_LOGGER_MODE 0x0 */
#define LOGGER_MODE_FIELD_LIST_CONVERTER_BLOCK_EN_MASK                                                            0x00000001
#define LOGGER_MODE_FIELD_LOGGER_LC_GCLK_BYPASS_MASK                                                              0x00000002
#define LOGGER_MODE_FIELD_LOGGER_GCLK_BYPASS_EN_MASK                                                              0x00000004
#define LOGGER_MODE_FIELD_SW_MESAGE_STALL_MASK                                                                    0x00000008
//========================================
/* REG_LOGGER_RAM_PARAMETERS 0x4 */
#define LOGGER_RAM_PARAMETERS_FIELD_WRAPPER_RAM_MEM_RM_MASK                                                       0x00000070
#define LOGGER_RAM_PARAMETERS_FIELD_SW_UNIT_MEM_RM_MASK                                                           0x00000700
#define LOGGER_RAM_PARAMETERS_FIELD_HW_UNIT1_MEM_RM_MASK                                                          0x00007000
#define LOGGER_RAM_PARAMETERS_FIELD_HW_UNIT2_MEM_RM_MASK                                                          0x00070000
#define LOGGER_RAM_PARAMETERS_FIELD_HW_UNIT3_MEM_RM_MASK                                                          0x00700000
#define LOGGER_RAM_PARAMETERS_FIELD_HW_UNIT4_MEM_RM_MASK                                                          0x07000000
#define LOGGER_RAM_PARAMETERS_FIELD_HW_UNIT5_MEM_RM_MASK                                                          0x70000000
//========================================
/* REG_LOGGER_RAM_PARAMETERS_2 0x8 */
#define LOGGER_RAM_PARAMETERS_2_FIELD_HW_UNIT6_MEM_RM_MASK                                                        0x00000007
#define LOGGER_RAM_PARAMETERS_2_FIELD_HW_UNIT7_MEM_RM_MASK                                                        0x00000070
#define LOGGER_RAM_PARAMETERS_2_FIELD_HW_UNIT8_MEM_RM_MASK                                                        0x00000700
#define LOGGER_RAM_PARAMETERS_2_FIELD_HW_UNIT9_MEM_RM_MASK                                                        0x00007000
#define LOGGER_RAM_PARAMETERS_2_FIELD_HW_UNIT10_MEM_RM_MASK                                                       0x00070000
#define LOGGER_RAM_PARAMETERS_2_FIELD_HW_UNIT11_MEM_RM_MASK                                                       0x00700000
#define LOGGER_RAM_PARAMETERS_2_FIELD_HW_UNIT12_MEM_RM_MASK                                                       0x07000000
#define LOGGER_RAM_PARAMETERS_2_FIELD_HW_UNIT13_MEM_RM_MASK                                                       0x70000000
//========================================
/* REG_LOGGER_RAM_PARAMETERS_3 0xC */
#define LOGGER_RAM_PARAMETERS_3_FIELD_HW_UNIT14_MEM_RM_MASK                                                       0x00000007
#define LOGGER_RAM_PARAMETERS_3_FIELD_HW_UNIT15_MEM_RM_MASK                                                       0x00000070
#define LOGGER_RAM_PARAMETERS_3_FIELD_HW_UNIT16_MEM_RM_MASK                                                       0x00000700
#define LOGGER_RAM_PARAMETERS_3_FIELD_PHY_RISC1_MEM_RM_MASK                                                       0x00007000
#define LOGGER_RAM_PARAMETERS_3_FIELD_PHY_RISC2_MEM_RM_MASK                                                       0x00070000
#define LOGGER_RAM_PARAMETERS_3_FIELD_PHY_RISC3_MEM_RM_MASK                                                       0x00700000
//========================================
/* REG_LOGGER_SW_PRE_CALCULATED_CHECKSUM_DST0 0x14 */
#define LOGGER_SW_PRE_CALCULATED_CHECKSUM_DST0_FIELD_SW_PRE_CALCULATED_CHECKSUM_DST0_MASK                         0xFFFFFFFF
//========================================
/* REG_LOGGER_SW_PRE_CALCULATED_CHECKSUM_DST1 0x18 */
#define LOGGER_SW_PRE_CALCULATED_CHECKSUM_DST1_FIELD_SW_PRE_CALCULATED_CHECKSUM_DST1_MASK                         0xFFFFFFFF
//========================================
/* REG_LOGGER_SW_PRE_CALCULATED_CHECKSUM_DST2 0x1C */
#define LOGGER_SW_PRE_CALCULATED_CHECKSUM_DST2_FIELD_SW_PRE_CALCULATED_CHECKSUM_DST2_MASK                         0xFFFFFFFF
//========================================
/* REG_LOGGER_SW_PRE_CALCULATED_CHECKSUM_DST3 0x20 */
#define LOGGER_SW_PRE_CALCULATED_CHECKSUM_DST3_FIELD_SW_PRE_CALCULATED_CHECKSUM_DST3_MASK                         0xFFFFFFFF
//========================================
/* REG_LOGGER_NUM_MESSAGES_1 0x24 */
#define LOGGER_NUM_MESSAGES_1_FIELD_UMAC_NUM_MESSAGES_MASK                                                        0x000000FF
#define LOGGER_NUM_MESSAGES_1_FIELD_LMAC1_NUM_MESSAGES_MASK                                                       0x0000FF00
#define LOGGER_NUM_MESSAGES_1_FIELD_HOST_IF_NUM_MESSAGES_MASK                                                     0x00FF0000
#define LOGGER_NUM_MESSAGES_1_FIELD_RX_HANDLER1_NUM_MESSAGES_MASK                                                 0xFF000000
//========================================
/* REG_LOGGER_NUM_MESSAGES_2 0x28 */
#define LOGGER_NUM_MESSAGES_2_FIELD_SENDER1_NUM_MESSAGES_MASK                                                     0x000000FF
#define LOGGER_NUM_MESSAGES_2_FIELD_PHY_RISC1_NUM_MESSAGES_MASK                                                   0x0000FF00
#define LOGGER_NUM_MESSAGES_2_FIELD_HW1_NUM_MESSAGES_MASK                                                         0x00FF0000
#define LOGGER_NUM_MESSAGES_2_FIELD_HW2_NUM_MESSAGES_MASK                                                         0xFF000000
//========================================
/* REG_LOGGER_NUM_MESSAGES_3 0x2C */
#define LOGGER_NUM_MESSAGES_3_FIELD_HW3_NUM_MESSAGES_MASK                                                         0x000000FF
#define LOGGER_NUM_MESSAGES_3_FIELD_HW4_NUM_MESSAGES_MASK                                                         0x0000FF00
#define LOGGER_NUM_MESSAGES_3_FIELD_HW5_NUM_MESSAGES_MASK                                                         0x00FF0000
#define LOGGER_NUM_MESSAGES_3_FIELD_HW6_NUM_MESSAGES_MASK                                                         0xFF000000
//========================================
/* REG_LOGGER_NUM_MESSAGES_4 0x30 */
#define LOGGER_NUM_MESSAGES_4_FIELD_HW7_NUM_MESSAGES_MASK                                                         0x000000FF
#define LOGGER_NUM_MESSAGES_4_FIELD_HW8_NUM_MESSAGES_MASK                                                         0x0000FF00
#define LOGGER_NUM_MESSAGES_4_FIELD_HW9_NUM_MESSAGES_MASK                                                         0x00FF0000
#define LOGGER_NUM_MESSAGES_4_FIELD_HW10_NUM_MESSAGES_MASK                                                        0xFF000000
//========================================
/* REG_LOGGER_NUM_MESSAGES_5 0x34 */
#define LOGGER_NUM_MESSAGES_5_FIELD_HW11_NUM_MESSAGES_MASK                                                        0x000000FF
#define LOGGER_NUM_MESSAGES_5_FIELD_HW12_NUM_MESSAGES_MASK                                                        0x0000FF00
#define LOGGER_NUM_MESSAGES_5_FIELD_HW13_NUM_MESSAGES_MASK                                                        0x00FF0000
#define LOGGER_NUM_MESSAGES_5_FIELD_HW14_NUM_MESSAGES_MASK                                                        0xFF000000
//========================================
/* REG_LOGGER_NUM_MESSAGES_6 0x38 */
#define LOGGER_NUM_MESSAGES_6_FIELD_HW15_NUM_MESSAGES_MASK                                                        0x000000FF
#define LOGGER_NUM_MESSAGES_6_FIELD_HW16_NUM_MESSAGES_MASK                                                        0x0000FF00
#define LOGGER_NUM_MESSAGES_6_FIELD_LMAC2_NUM_MESSAGES_MASK                                                       0x00FF0000
#define LOGGER_NUM_MESSAGES_6_FIELD_RX_HANDLER2_NUM_MESSAGES_MASK                                                 0xFF000000
//========================================
/* REG_LOGGER_NUM_MESSAGES_7 0x3C */
#define LOGGER_NUM_MESSAGES_7_FIELD_SENDER2_NUM_MESSAGES_MASK                                                     0x000000FF
#define LOGGER_NUM_MESSAGES_7_FIELD_PHY_RISC2_NUM_MESSAGES_MASK                                                   0x0000FF00
#define LOGGER_NUM_MESSAGES_7_FIELD_LMAC3_NUM_MESSAGES_MASK                                                       0x00FF0000
#define LOGGER_NUM_MESSAGES_7_FIELD_RX_HANDLER3_NUM_MESSAGES_MASK                                                 0xFF000000
//========================================
/* REG_LOGGER_NUM_BYTES_IN_FIFO_1 0x4C */
#define LOGGER_NUM_BYTES_IN_FIFO_1_FIELD_UMAC_NUM_BYTES_IN_FIFO_MASK                                              0x000000FF
#define LOGGER_NUM_BYTES_IN_FIFO_1_FIELD_LMAC1_NUM_BYTES_IN_FIFO_MASK                                             0x0000FF00
#define LOGGER_NUM_BYTES_IN_FIFO_1_FIELD_HOST_IF_NUM_BYTES_IN_FIFO_MASK                                           0x00FF0000
#define LOGGER_NUM_BYTES_IN_FIFO_1_FIELD_RX_HANDLER1_NUM_BYTES_IN_FIFO_MASK                                       0xFF000000
//========================================
/* REG_LOGGER_NUM_BYTES_IN_FIFO_2 0x50 */
#define LOGGER_NUM_BYTES_IN_FIFO_2_FIELD_SENDER1_NUM_BYTES_IN_FIFO_MASK                                           0x000000FF
#define LOGGER_NUM_BYTES_IN_FIFO_2_FIELD_PHY_RISC1_NUM_BYTES_IN_FIFO_MASK                                         0x0000FF00
#define LOGGER_NUM_BYTES_IN_FIFO_2_FIELD_HW1_NUM_BYTES_IN_FIFO_MASK                                               0x00FF0000
#define LOGGER_NUM_BYTES_IN_FIFO_2_FIELD_HW2_NUM_BYTES_IN_FIFO_MASK                                               0xFF000000
//========================================
/* REG_LOGGER_NUM_BYTES_IN_FIFO_3 0x54 */
#define LOGGER_NUM_BYTES_IN_FIFO_3_FIELD_HW3_NUM_BYTES_IN_FIFO_MASK                                               0x000000FF
#define LOGGER_NUM_BYTES_IN_FIFO_3_FIELD_HW4_NUM_BYTES_IN_FIFO_MASK                                               0x0000FF00
#define LOGGER_NUM_BYTES_IN_FIFO_3_FIELD_HW5_NUM_BYTES_IN_FIFO_MASK                                               0x00FF0000
#define LOGGER_NUM_BYTES_IN_FIFO_3_FIELD_HW6_NUM_BYTES_IN_FIFO_MASK                                               0xFF000000
//========================================
/* REG_LOGGER_NUM_BYTES_IN_FIFO_4 0x58 */
#define LOGGER_NUM_BYTES_IN_FIFO_4_FIELD_HW7_NUM_BYTES_IN_FIFO_MASK                                               0x000000FF
#define LOGGER_NUM_BYTES_IN_FIFO_4_FIELD_HW8_NUM_BYTES_IN_FIFO_MASK                                               0x0000FF00
#define LOGGER_NUM_BYTES_IN_FIFO_4_FIELD_HW9_NUM_BYTES_IN_FIFO_MASK                                               0x00FF0000
#define LOGGER_NUM_BYTES_IN_FIFO_4_FIELD_HW10_NUM_BYTES_IN_FIFO_MASK                                              0xFF000000
//========================================
/* REG_LOGGER_NUM_BYTES_IN_FIFO_5 0x5C */
#define LOGGER_NUM_BYTES_IN_FIFO_5_FIELD_HW11_NUM_BYTES_IN_FIFO_MASK                                              0x000000FF
#define LOGGER_NUM_BYTES_IN_FIFO_5_FIELD_HW12_NUM_BYTES_IN_FIFO_MASK                                              0x0000FF00
#define LOGGER_NUM_BYTES_IN_FIFO_5_FIELD_HW13_NUM_BYTES_IN_FIFO_MASK                                              0x00FF0000
#define LOGGER_NUM_BYTES_IN_FIFO_5_FIELD_HW14_NUM_BYTES_IN_FIFO_MASK                                              0xFF000000
//========================================
/* REG_LOGGER_NUM_BYTES_IN_FIFO_6 0x60 */
#define LOGGER_NUM_BYTES_IN_FIFO_6_FIELD_HW15_NUM_BYTES_IN_FIFO_MASK                                              0x000000FF
#define LOGGER_NUM_BYTES_IN_FIFO_6_FIELD_HW16_NUM_BYTES_IN_FIFO_MASK                                              0x0000FF00
#define LOGGER_NUM_BYTES_IN_FIFO_6_FIELD_LMAC2_NUM_BYTES_IN_FIFO_MASK                                             0x00FF0000
#define LOGGER_NUM_BYTES_IN_FIFO_6_FIELD_RX_HANDLER2_NUM_BYTES_IN_FIFO_MASK                                       0xFF000000
//========================================
/* REG_LOGGER_NUM_BYTES_IN_FIFO_7 0x64 */
#define LOGGER_NUM_BYTES_IN_FIFO_7_FIELD_SENDER2_NUM_BYTES_IN_FIFO_MASK                                           0x000000FF
#define LOGGER_NUM_BYTES_IN_FIFO_7_FIELD_PHY_RISC2_NUM_BYTES_IN_FIFO_MASK                                         0x0000FF00
#define LOGGER_NUM_BYTES_IN_FIFO_7_FIELD_LMAC3_NUM_BYTES_IN_FIFO_MASK                                             0x00FF0000
#define LOGGER_NUM_BYTES_IN_FIFO_7_FIELD_RX_HANDLER3_NUM_BYTES_IN_FIFO_MASK                                       0xFF000000
//========================================
/* REG_LOGGER_UMAC_DATA_IN 0x6C */
#define LOGGER_UMAC_DATA_IN_FIELD_UMAC_DATA_IN_MASK                                                               0xFFFFFFFF
//========================================
/* REG_LOGGER_UMAC_FAST_MES_DATA_IN 0x70 */
#define LOGGER_UMAC_FAST_MES_DATA_IN_FIELD_UMAC_FAST_MES_DATA_IN_MASK                                             0xFFFFFFFF
//========================================
/* REG_LOGGER_UMAC_MESAGE_DONE 0x74 */
#define LOGGER_UMAC_MESAGE_DONE_FIELD_UMAC_MESAGE_DONE_MASK                                                       0x00000001
//========================================
/* REG_LOGGER_LMAC1_DATA_IN 0x78 */
#define LOGGER_LMAC1_DATA_IN_FIELD_LMAC1_DATA_IN_MASK                                                             0xFFFFFFFF
//========================================
/* REG_LOGGER_LMAC1_FAST_MES_DATA_IN 0x7C */
#define LOGGER_LMAC1_FAST_MES_DATA_IN_FIELD_LMAC1_FAST_MES_DATA_IN_MASK                                           0xFFFFFFFF
//========================================
/* REG_LOGGER_LMAC1_MESAGE_DONE 0x80 */
#define LOGGER_LMAC1_MESAGE_DONE_FIELD_LMAC1_MESAGE_DONE_MASK                                                     0x00000001
//========================================
/* REG_LOGGER_HOST_IF_DATA_IN 0x84 */
#define LOGGER_HOST_IF_DATA_IN_FIELD_HOST_IF_DATA_IN_MASK                                                         0xFFFFFFFF
//========================================
/* REG_LOGGER_HOST_IF_FAST_MES_DATA_IN 0x88 */
#define LOGGER_HOST_IF_FAST_MES_DATA_IN_FIELD_HOST_IF_FAST_MES_DATA_IN_MASK                                       0xFFFFFFFF
//========================================
/* REG_LOGGER_HOST_IF_MESAGE_DONE 0x8C */
#define LOGGER_HOST_IF_MESAGE_DONE_FIELD_HOST_IF_MESAGE_DONE_MASK                                                 0x00000001
//========================================
/* REG_LOGGER_RX_HANDLER1_DATA_IN 0x90 */
#define LOGGER_RX_HANDLER1_DATA_IN_FIELD_RX_HANDLER1_DATA_IN_MASK                                                 0xFFFFFFFF
//========================================
/* REG_LOGGER_RX_HANDLER1_FAST_MES_DATA_IN 0x94 */
#define LOGGER_RX_HANDLER1_FAST_MES_DATA_IN_FIELD_RX_HANDLER1_FAST_MES_DATA_IN_MASK                               0xFFFFFFFF
//========================================
/* REG_LOGGER_RX_HANDLER1_MESAGE_DONE 0x98 */
#define LOGGER_RX_HANDLER1_MESAGE_DONE_FIELD_RX_HANDLER1_MESAGE_DONE_MASK                                         0x00000001
//========================================
/* REG_LOGGER_SENDER1_DATA_IN 0x9C */
#define LOGGER_SENDER1_DATA_IN_FIELD_SENDER1_DATA_IN_MASK                                                         0xFFFFFFFF
//========================================
/* REG_LOGGER_SENDER1_FAST_MES_DATA_IN 0xA0 */
#define LOGGER_SENDER1_FAST_MES_DATA_IN_FIELD_SENDER1_FAST_MES_DATA_IN_MASK                                       0xFFFFFFFF
//========================================
/* REG_LOGGER_SENDER1_MESAGE_DONE 0xA4 */
#define LOGGER_SENDER1_MESAGE_DONE_FIELD_SENDER1_MESAGE_DONE_MASK                                                 0x00000001
//========================================
/* REG_LOGGER_LMAC2_DATA_IN 0xA8 */
#define LOGGER_LMAC2_DATA_IN_FIELD_LMAC2_DATA_IN_MASK                                                             0xFFFFFFFF
//========================================
/* REG_LOGGER_LMAC2_FAST_MES_DATA_IN 0xAC */
#define LOGGER_LMAC2_FAST_MES_DATA_IN_FIELD_LMAC2_FAST_MES_DATA_IN_MASK                                           0xFFFFFFFF
//========================================
/* REG_LOGGER_LMAC2_MESAGE_DONE 0xB0 */
#define LOGGER_LMAC2_MESAGE_DONE_FIELD_LMAC2_MESAGE_DONE_MASK                                                     0x00000001
//========================================
/* REG_LOGGER_RX_HANDLER2_DATA_IN 0xB4 */
#define LOGGER_RX_HANDLER2_DATA_IN_FIELD_RX_HANDLER2_DATA_IN_MASK                                                 0xFFFFFFFF
//========================================
/* REG_LOGGER_RX_HANDLER2_FAST_MES_DATA_IN 0xB8 */
#define LOGGER_RX_HANDLER2_FAST_MES_DATA_IN_FIELD_RX_HANDLER2_FAST_MES_DATA_IN_MASK                               0xFFFFFFFF
//========================================
/* REG_LOGGER_RX_HANDLER2_MESAGE_DONE 0xBC */
#define LOGGER_RX_HANDLER2_MESAGE_DONE_FIELD_RX_HANDLER2_MESAGE_DONE_MASK                                         0x00000001
//========================================
/* REG_LOGGER_SENDER2_DATA_IN 0xC0 */
#define LOGGER_SENDER2_DATA_IN_FIELD_SENDER2_DATA_IN_MASK                                                         0xFFFFFFFF
//========================================
/* REG_LOGGER_SENDER2_FAST_MES_DATA_IN 0xC4 */
#define LOGGER_SENDER2_FAST_MES_DATA_IN_FIELD_SENDER2_FAST_MES_DATA_IN_MASK                                       0xFFFFFFFF
//========================================
/* REG_LOGGER_SENDER2_MESAGE_DONE 0xC8 */
#define LOGGER_SENDER2_MESAGE_DONE_FIELD_SENDER2_MESAGE_DONE_MASK                                                 0x00000001
//========================================
/* REG_LOGGER_FIFO_ENABLE 0xCC */
#define LOGGER_FIFO_ENABLE_FIELD_UMAC_FIFO_ENABLE_MASK                                                            0x00000001
#define LOGGER_FIFO_ENABLE_FIELD_LMAC1_FIFO_ENABLE_MASK                                                           0x00000002
#define LOGGER_FIFO_ENABLE_FIELD_HOST_IF_FIFO_ENABLE_MASK                                                         0x00000004
#define LOGGER_FIFO_ENABLE_FIELD_RX_HANDLER1_FIFO_ENABLE_MASK                                                     0x00000008
#define LOGGER_FIFO_ENABLE_FIELD_SENDER1_FIFO_ENABLE_MASK                                                         0x00000010
#define LOGGER_FIFO_ENABLE_FIELD_PHY_RISC1_FIFO_ENABLE_MASK                                                       0x00000020
#define LOGGER_FIFO_ENABLE_FIELD_PHY_FIFO1_ENABLE_MASK                                                            0x00000040
#define LOGGER_FIFO_ENABLE_FIELD_HW1_FIFO_ENABLE_MASK                                                             0x00000080
#define LOGGER_FIFO_ENABLE_FIELD_HW2_FIFO_ENABLE_MASK                                                             0x00000100
#define LOGGER_FIFO_ENABLE_FIELD_HW3_FIFO_ENABLE_MASK                                                             0x00000200
#define LOGGER_FIFO_ENABLE_FIELD_HW4_FIFO_ENABLE_MASK                                                             0x00000400
#define LOGGER_FIFO_ENABLE_FIELD_HW5_FIFO_ENABLE_MASK                                                             0x00000800
#define LOGGER_FIFO_ENABLE_FIELD_HW6_FIFO_ENABLE_MASK                                                             0x00001000
#define LOGGER_FIFO_ENABLE_FIELD_HW7_FIFO_ENABLE_MASK                                                             0x00002000
#define LOGGER_FIFO_ENABLE_FIELD_HW8_FIFO_ENABLE_MASK                                                             0x00004000
#define LOGGER_FIFO_ENABLE_FIELD_HW9_FIFO_ENABLE_MASK                                                             0x00008000
#define LOGGER_FIFO_ENABLE_FIELD_HW10_FIFO_ENABLE_MASK                                                            0x00010000
#define LOGGER_FIFO_ENABLE_FIELD_HW11_FIFO_ENABLE_MASK                                                            0x00020000
#define LOGGER_FIFO_ENABLE_FIELD_HW12_FIFO_ENABLE_MASK                                                            0x00040000
#define LOGGER_FIFO_ENABLE_FIELD_HW13_FIFO_ENABLE_MASK                                                            0x00080000
#define LOGGER_FIFO_ENABLE_FIELD_HW14_FIFO_ENABLE_MASK                                                            0x00100000
#define LOGGER_FIFO_ENABLE_FIELD_HW15_FIFO_ENABLE_MASK                                                            0x00200000
#define LOGGER_FIFO_ENABLE_FIELD_HW16_FIFO_ENABLE_MASK                                                            0x00400000
#define LOGGER_FIFO_ENABLE_FIELD_LMAC2_FIFO_ENABLE_MASK                                                           0x00800000
#define LOGGER_FIFO_ENABLE_FIELD_RX_HANDLER2_FIFO_ENABLE_MASK                                                     0x01000000
#define LOGGER_FIFO_ENABLE_FIELD_SENDER2_FIFO_ENABLE_MASK                                                         0x02000000
#define LOGGER_FIFO_ENABLE_FIELD_PHY_RISC2_FIFO_ENABLE_MASK                                                       0x04000000
#define LOGGER_FIFO_ENABLE_FIELD_PHY_FIFO2_ENABLE_MASK                                                            0x08000000
#define LOGGER_FIFO_ENABLE_FIELD_LMAC3_FIFO_ENABLE_MASK                                                           0x10000000
#define LOGGER_FIFO_ENABLE_FIELD_RX_HANDLER3_FIFO_ENABLE_MASK                                                     0x20000000
#define LOGGER_FIFO_ENABLE_FIELD_SENDER3_FIFO_ENABLE_MASK                                                         0x40000000
#define LOGGER_FIFO_ENABLE_FIELD_PHY_RISC3_FIFO_ENABLE_MASK                                                       0x80000000
//========================================
/* REG_LOGGER_LIST_ID 0xD0 */
#define LOGGER_LIST_ID_FIELD_BUFFER_EMTY_TX_DPL_IDX_MASK                                                          0x0000007F
#define LOGGER_LIST_ID_FIELD_BUFFER_FULL_TX_DPL_IDX_MASK                                                          0x00007F00
#define LOGGER_LIST_ID_FIELD_LOGGER_RD_EMTY_RX_DPL_IDX_MASK                                                       0x007F0000
#define LOGGER_LIST_ID_FIELD_LOGGER_RD_FULL_RX_DPL_IDX_MASK                                                       0x7F000000
//========================================
/* REG_LOGGER_LIST_CONVERTER 0xD4 */
#define LOGGER_LIST_CONVERTER_FIELD_LOGGER_LC_HALT_WORK_MASK                                                      0x00000001
#define LOGGER_LIST_CONVERTER_FIELD_ETH_TYPE_MASK                                                                 0x00000006
#define LOGGER_LIST_CONVERTER_FIELD_LOGGER_LC_WORKING_MASK                                                        0x00000008
//========================================
/* REG_LOGGER_BUFFER_LENGTH 0xD8 */
#define LOGGER_BUFFER_LENGTH_FIELD_BUFFER_LENGTH_MASK                                                             0x0000FFFF
//========================================
/* REG_LOGGER_BUFFER0_1THR 0xDC */
#define LOGGER_BUFFER0_1THR_FIELD_BUFFER0_THR_MASK                                                                0x0000FFFF
#define LOGGER_BUFFER0_1THR_FIELD_BUFFER1_THR_MASK                                                                0xFFFF0000
//========================================
/* REG_LOGGER_BUFFER2_3THR 0xE0 */
#define LOGGER_BUFFER2_3THR_FIELD_BUFFER2_THR_MASK                                                                0x0000FFFF
#define LOGGER_BUFFER2_3THR_FIELD_BUFFER3_THR_MASK                                                                0xFFFF0000
//========================================
/* REG_LOGGER_START_DATA_TRIGGER_LOW 0xE4 */
#define LOGGER_START_DATA_TRIGGER_LOW_FIELD_START_DATA_TRIGGER_LOW_MASK                                           0xFFFFFFFF
//========================================
/* REG_LOGGER_START_DATA_TRIGGER_HIGH 0xE8 */
#define LOGGER_START_DATA_TRIGGER_HIGH_FIELD_START_DATA_TRIGGER_HIGH_MASK                                         0x0000FFFF
//========================================
/* REG_LOGGER_START_MASK_TRIGGER_LOW 0xEC */
#define LOGGER_START_MASK_TRIGGER_LOW_FIELD_START_MASK_TRIGGER_LOW_MASK                                           0xFFFFFFFF
//========================================
/* REG_LOGGER_START_MASK_TRIGGER_HIGH 0xF0 */
#define LOGGER_START_MASK_TRIGGER_HIGH_FIELD_START_MASK_TRIGGER_HIGH_MASK                                         0x0000FFFF
//========================================
/* REG_LOGGER_STOP_DATA_TRIGGER_LOW 0xF4 */
#define LOGGER_STOP_DATA_TRIGGER_LOW_FIELD_STOP_DATA_TRIGGER_LOW_MASK                                             0xFFFFFFFF
//========================================
/* REG_LOGGER_STOP_DATA_TRIGGER_HIGH 0xF8 */
#define LOGGER_STOP_DATA_TRIGGER_HIGH_FIELD_STOP_DATA_TRIGGER_HIGH_MASK                                           0x0000FFFF
//========================================
/* REG_LOGGER_STOP_MASK_TRIGGER_LOW 0xFC */
#define LOGGER_STOP_MASK_TRIGGER_LOW_FIELD_STOP_MASK_TRIGGER_LOW_MASK                                             0xFFFFFFFF
//========================================
/* REG_LOGGER_STOP_MASK_TRIGGER_HIGH 0x100 */
#define LOGGER_STOP_MASK_TRIGGER_HIGH_FIELD_STOP_MASK_TRIGGER_HIGH_MASK                                           0x0000FFFF
#define LOGGER_STOP_MASK_TRIGGER_HIGH_FIELD_LOG_LEVEL_TO_FORWARD_MASK                                             0x00070000
//========================================
/* REG_LOGGER_TIME_TO_RECORDER_AFTER_STOP 0x104 */
#define LOGGER_TIME_TO_RECORDER_AFTER_STOP_FIELD_TIME_TO_RECORDER_AFTER_STOP_MASK                                 0xFFFFFFFF
//========================================
/* REG_LOGGER_HW_UNIT1_FIRST_HEADER_WORD 0x108 */
#define LOGGER_HW_UNIT1_FIRST_HEADER_WORD_FIELD_HW_UNIT1_FIRST_HEADER_WORD_MASK                                   0xFFFFFFFF
//========================================
/* REG_LOGGER_HW_UNIT2_FIRST_HEADER_WORD 0x10C */
#define LOGGER_HW_UNIT2_FIRST_HEADER_WORD_FIELD_HW_UNIT2_FIRST_HEADER_WORD_MASK                                   0xFFFFFFFF
//========================================
/* REG_LOGGER_HW_UNIT3_FIRST_HEADER_WORD 0x110 */
#define LOGGER_HW_UNIT3_FIRST_HEADER_WORD_FIELD_HW_UNIT3_FIRST_HEADER_WORD_MASK                                   0xFFFFFFFF
//========================================
/* REG_LOGGER_HW_UNIT4_FIRST_HEADER_WORD 0x114 */
#define LOGGER_HW_UNIT4_FIRST_HEADER_WORD_FIELD_HW_UNIT4_FIRST_HEADER_WORD_MASK                                   0xFFFFFFFF
//========================================
/* REG_LOGGER_HW_UNIT5_FIRST_HEADER_WORD 0x118 */
#define LOGGER_HW_UNIT5_FIRST_HEADER_WORD_FIELD_HW_UNIT5_FIRST_HEADER_WORD_MASK                                   0xFFFFFFFF
//========================================
/* REG_LOGGER_HW_UNIT6_FIRST_HEADER_WORD 0x11C */
#define LOGGER_HW_UNIT6_FIRST_HEADER_WORD_FIELD_HW_UNIT6_FIRST_HEADER_WORD_MASK                                   0xFFFFFFFF
//========================================
/* REG_LOGGER_HW_UNIT7_FIRST_HEADER_WORD 0x120 */
#define LOGGER_HW_UNIT7_FIRST_HEADER_WORD_FIELD_HW_UNIT7_FIRST_HEADER_WORD_MASK                                   0xFFFFFFFF
//========================================
/* REG_LOGGER_HW_UNIT8_FIRST_HEADER_WORD 0x124 */
#define LOGGER_HW_UNIT8_FIRST_HEADER_WORD_FIELD_HW_UNIT8_FIRST_HEADER_WORD_MASK                                   0xFFFFFFFF
//========================================
/* REG_LOGGER_HW_UNIT9_FIRST_HEADER_WORD 0x128 */
#define LOGGER_HW_UNIT9_FIRST_HEADER_WORD_FIELD_HW_UNIT9_FIRST_HEADER_WORD_MASK                                   0xFFFFFFFF
//========================================
/* REG_LOGGER_HW_UNIT10_FIRST_HEADER_WORD 0x12C */
#define LOGGER_HW_UNIT10_FIRST_HEADER_WORD_FIELD_HW_UNIT10_FIRST_HEADER_WORD_MASK                                 0xFFFFFFFF
//========================================
/* REG_LOGGER_HW_UNIT11_FIRST_HEADER_WORD 0x130 */
#define LOGGER_HW_UNIT11_FIRST_HEADER_WORD_FIELD_HW_UNIT11_FIRST_HEADER_WORD_MASK                                 0xFFFFFFFF
//========================================
/* REG_LOGGER_HW_UNIT12_FIRST_HEADER_WORD 0x134 */
#define LOGGER_HW_UNIT12_FIRST_HEADER_WORD_FIELD_HW_UNIT12_FIRST_HEADER_WORD_MASK                                 0xFFFFFFFF
//========================================
/* REG_LOGGER_HW_UNIT13_FIRST_HEADER_WORD 0x138 */
#define LOGGER_HW_UNIT13_FIRST_HEADER_WORD_FIELD_HW_UNIT13_FIRST_HEADER_WORD_MASK                                 0xFFFFFFFF
//========================================
/* REG_LOGGER_HW_UNIT14_FIRST_HEADER_WORD 0x13C */
#define LOGGER_HW_UNIT14_FIRST_HEADER_WORD_FIELD_HW_UNIT14_FIRST_HEADER_WORD_MASK                                 0xFFFFFFFF
//========================================
/* REG_LOGGER_HW_UNIT15_FIRST_HEADER_WORD 0x140 */
#define LOGGER_HW_UNIT15_FIRST_HEADER_WORD_FIELD_HW_UNIT15_FIRST_HEADER_WORD_MASK                                 0xFFFFFFFF
//========================================
/* REG_LOGGER_HW_UNIT16_FIRST_HEADER_WORD 0x144 */
#define LOGGER_HW_UNIT16_FIRST_HEADER_WORD_FIELD_HW_UNIT16_FIRST_HEADER_WORD_MASK                                 0xFFFFFFFF
//========================================
/* REG_LOGGER_HW_UNIT1_SECOND_HEADER_WORD 0x148 */
#define LOGGER_HW_UNIT1_SECOND_HEADER_WORD_FIELD_HW_UNIT1_SECOND_HEADER_WORD_MASK                                 0x0000FFFF
#define LOGGER_HW_UNIT1_SECOND_HEADER_WORD_FIELD_HW_UNIT2_SECOND_HEADER_WORD_MASK                                 0xFFFF0000
//========================================
/* REG_LOGGER_HW_UNIT3_SECOND_HEADER_WORD 0x14C */
#define LOGGER_HW_UNIT3_SECOND_HEADER_WORD_FIELD_HW_UNIT3_SECOND_HEADER_WORD_MASK                                 0x0000FFFF
#define LOGGER_HW_UNIT3_SECOND_HEADER_WORD_FIELD_HW_UNIT4_SECOND_HEADER_WORD_MASK                                 0xFFFF0000
//========================================
/* REG_LOGGER_HW_UNIT5_SECOND_HEADER_WORD 0x150 */
#define LOGGER_HW_UNIT5_SECOND_HEADER_WORD_FIELD_HW_UNIT5_SECOND_HEADER_WORD_MASK                                 0x0000FFFF
#define LOGGER_HW_UNIT5_SECOND_HEADER_WORD_FIELD_HW_UNIT6_SECOND_HEADER_WORD_MASK                                 0xFFFF0000
//========================================
/* REG_LOGGER_HW_UNIT7_SECOND_HEADER_WORD 0x154 */
#define LOGGER_HW_UNIT7_SECOND_HEADER_WORD_FIELD_HW_UNIT7_SECOND_HEADER_WORD_MASK                                 0x0000FFFF
#define LOGGER_HW_UNIT7_SECOND_HEADER_WORD_FIELD_HW_UNIT8_SECOND_HEADER_WORD_MASK                                 0xFFFF0000
//========================================
/* REG_LOGGER_HW_UNIT9_SECOND_HEADER_WORD 0x158 */
#define LOGGER_HW_UNIT9_SECOND_HEADER_WORD_FIELD_HW_UNIT9_SECOND_HEADER_WORD_MASK                                 0x0000FFFF
#define LOGGER_HW_UNIT9_SECOND_HEADER_WORD_FIELD_HW_UNIT10_SECOND_HEADER_WORD_MASK                                0xFFFF0000
//========================================
/* REG_LOGGER_HW_UNIT11_SECOND_HEADER_WORD 0x15C */
#define LOGGER_HW_UNIT11_SECOND_HEADER_WORD_FIELD_HW_UNIT11_SECOND_HEADER_WORD_MASK                               0x0000FFFF
#define LOGGER_HW_UNIT11_SECOND_HEADER_WORD_FIELD_HW_UNIT12_SECOND_HEADER_WORD_MASK                               0xFFFF0000
//========================================
/* REG_LOGGER_HW_UNIT13_SECOND_HEADER_WORD 0x160 */
#define LOGGER_HW_UNIT13_SECOND_HEADER_WORD_FIELD_HW_UNIT13_SECOND_HEADER_WORD_MASK                               0x0000FFFF
#define LOGGER_HW_UNIT13_SECOND_HEADER_WORD_FIELD_HW_UNIT14_SECOND_HEADER_WORD_MASK                               0xFFFF0000
//========================================
/* REG_LOGGER_HW_UNIT15_SECOND_HEADER_WORD 0x164 */
#define LOGGER_HW_UNIT15_SECOND_HEADER_WORD_FIELD_HW_UNIT15_SECOND_HEADER_WORD_MASK                               0x0000FFFF
#define LOGGER_HW_UNIT15_SECOND_HEADER_WORD_FIELD_HW_UNIT16_SECOND_HEADER_WORD_MASK                               0xFFFF0000
//========================================
/* REG_LOGGER_PHY_FIFO1_SECOND_HEADER_WORD 0x168 */
#define LOGGER_PHY_FIFO1_SECOND_HEADER_WORD_FIELD_PHY_FIFO1_SECOND_HEADER_WORD_MASK                               0x0000FFFF
#define LOGGER_PHY_FIFO1_SECOND_HEADER_WORD_FIELD_PHY_FIFO2_SECOND_HEADER_WORD_MASK                               0xFFFF0000
//========================================
/* REG_LOGGER_PHY_FIFO1_FIRST_HEADER_WORD 0x16C */
#define LOGGER_PHY_FIFO1_FIRST_HEADER_WORD_FIELD_PHY_FIFO1_FIRST_HEADER_WORD_MASK                                 0xFFFFFFFF
//========================================
/* REG_LOGGER_PHY_FIFO2_FIRST_HEADER_WORD 0x170 */
#define LOGGER_PHY_FIFO2_FIRST_HEADER_WORD_FIELD_PHY_FIFO2_FIRST_HEADER_WORD_MASK                                 0xFFFFFFFF
//========================================
/* REG_LOGGER_PHY_FIFO1_MESAGE_LENGTH 0x174 */
#define LOGGER_PHY_FIFO1_MESAGE_LENGTH_FIELD_PHY_FIFO1_MESSAGE_LENGTH_MASK                                        0x0000FFFF
#define LOGGER_PHY_FIFO1_MESAGE_LENGTH_FIELD_PHY_FIFO2_MESSAGE_LENGTH_MASK                                        0xFFFF0000
//========================================
/* REG_LOGGER_SHRAM_DIRECT_MODE 0x178 */
#define LOGGER_SHRAM_DIRECT_MODE_FIELD_SHRAM_DIRECT_MODE_MASK                                                     0x00000001
#define LOGGER_SHRAM_DIRECT_MODE_FIELD_LOGGER_EXT_MEM_MODE_MASK                                                   0x0000000E
#define LOGGER_SHRAM_DIRECT_MODE_FIELD_SHRAM_DIRECT_CYCLIC_MODE_MASK                                              0x00000010
//========================================
/* REG_LOGGER_UMAC_LMAC_FAST_MES_SEC_WORD 0x17C */
#define LOGGER_UMAC_LMAC_FAST_MES_SEC_WORD_FIELD_UMAC_FAST_MES_SEC_WORD_MASK                                      0x0000FFFF
#define LOGGER_UMAC_LMAC_FAST_MES_SEC_WORD_FIELD_LMAC1_FAST_MES_SEC_WORD_MASK                                     0xFFFF0000
//========================================
/* REG_LOGGER_HOST_IF_HANDLER_FAST_MES_SEC_WORD 0x180 */
#define LOGGER_HOST_IF_HANDLER_FAST_MES_SEC_WORD_FIELD_HOST_IF_FAST_MES_SEC_WORD_MASK                             0x0000FFFF
#define LOGGER_HOST_IF_HANDLER_FAST_MES_SEC_WORD_FIELD_RX_HANDLER1_FAST_MES_SEC_WORD_MASK                         0xFFFF0000
//========================================
/* REG_LOGGER_SENDER_FAST_MES_SEC_WORD 0x184 */
#define LOGGER_SENDER_FAST_MES_SEC_WORD_FIELD_SENDER1_FAST_MES_SEC_WORD_MASK                                      0x0000FFFF
#define LOGGER_SENDER_FAST_MES_SEC_WORD_FIELD_PHY_RISC1_FAST_MES_SEC_WORD_MASK                                    0xFFFF0000
//========================================
/* REG_LOGGER_LMAC_HANDLER2_FAST_MES_SEC_WORD 0x188 */
#define LOGGER_LMAC_HANDLER2_FAST_MES_SEC_WORD_FIELD_LMAC2_FAST_MES_SEC_WORD_MASK                                 0x0000FFFF
#define LOGGER_LMAC_HANDLER2_FAST_MES_SEC_WORD_FIELD_RX_HANDLER2_FAST_MES_SEC_WORD_MASK                           0xFFFF0000
//========================================
/* REG_LOGGER_SENDER_PHY_RISC2_FAST_MES_SEC_WORD 0x18C */
#define LOGGER_SENDER_PHY_RISC2_FAST_MES_SEC_WORD_FIELD_SENDER2_FAST_MES_SEC_WORD_MASK                            0x0000FFFF
#define LOGGER_SENDER_PHY_RISC2_FAST_MES_SEC_WORD_FIELD_PHY_RISC2_FAST_MES_SEC_WORD_MASK                          0xFFFF0000
//========================================
/* REG_LOGGER_BUFFER_CLOSE_TIME_THR 0x190 */
#define LOGGER_BUFFER_CLOSE_TIME_THR_FIELD_BUFFER_CLOSE_TIME_THR_MASK                                             0xFFFFFFFF
//========================================
/* REG_LOGGER_LOGGER_HW_UNIT_CFG_MUX 0x194 */
#define LOGGER_LOGGER_HW_UNIT_CFG_MUX_FIELD_LOGGER_HW_UNIT1_CFG_MUX_MASK                                          0x00000007
#define LOGGER_LOGGER_HW_UNIT_CFG_MUX_FIELD_LOGGER_HW_UNIT2_CFG_MUX_MASK                                          0x00000070
#define LOGGER_LOGGER_HW_UNIT_CFG_MUX_FIELD_LOGGER_HW_UNIT3_CFG_MUX_MASK                                          0x00000700
#define LOGGER_LOGGER_HW_UNIT_CFG_MUX_FIELD_LOGGER_HW_UNIT4_CFG_MUX_MASK                                          0x00007000
#define LOGGER_LOGGER_HW_UNIT_CFG_MUX_FIELD_LOGGER_HW_UNIT5_CFG_MUX_MASK                                          0x00070000
#define LOGGER_LOGGER_HW_UNIT_CFG_MUX_FIELD_LOGGER_HW_UNIT6_CFG_MUX_MASK                                          0x00700000
#define LOGGER_LOGGER_HW_UNIT_CFG_MUX_FIELD_LOGGER_HW_UNIT7_CFG_MUX_MASK                                          0x07000000
#define LOGGER_LOGGER_HW_UNIT_CFG_MUX_FIELD_LOGGER_HW_UNIT8_CFG_MUX_MASK                                          0x70000000
//========================================
/* REG_LOGGER_LOGGER_HW2_UNIT_CFG_MUX 0x198 */
#define LOGGER_LOGGER_HW2_UNIT_CFG_MUX_FIELD_LOGGER_HW_UNIT9_CFG_MUX_MASK                                         0x00000007
#define LOGGER_LOGGER_HW2_UNIT_CFG_MUX_FIELD_LOGGER_HW_UNIT10_CFG_MUX_MASK                                        0x00000070
#define LOGGER_LOGGER_HW2_UNIT_CFG_MUX_FIELD_LOGGER_HW_UNIT11_CFG_MUX_MASK                                        0x00000700
#define LOGGER_LOGGER_HW2_UNIT_CFG_MUX_FIELD_LOGGER_HW_UNIT12_CFG_MUX_MASK                                        0x00007000
#define LOGGER_LOGGER_HW2_UNIT_CFG_MUX_FIELD_LOGGER_HW_UNIT13_CFG_MUX_MASK                                        0x00070000
#define LOGGER_LOGGER_HW2_UNIT_CFG_MUX_FIELD_LOGGER_HW_UNIT14_CFG_MUX_MASK                                        0x00700000
#define LOGGER_LOGGER_HW2_UNIT_CFG_MUX_FIELD_LOGGER_HW_UNIT15_CFG_MUX_MASK                                        0x07000000
#define LOGGER_LOGGER_HW2_UNIT_CFG_MUX_FIELD_LOGGER_HW_UNIT16_CFG_MUX_MASK                                        0x70000000
//========================================
/* REG_LOGGER_CLEAR 0x19C */
#define LOGGER_CLEAR_FIELD_PHY_FIFO1_CLEAR_PULSE_MASK                                                             0x00000001
#define LOGGER_CLEAR_FIELD_LOGGER_CLEAR_PULSE_MASK                                                                0x00000002
#define LOGGER_CLEAR_FIELD_CLEAR_POP_WHILE_EMPTY_MASK                                                             0x00000004
#define LOGGER_CLEAR_FIELD_CLEAR_PUSH_WHILE_FULL_MASK                                                             0x00000008
#define LOGGER_CLEAR_FIELD_PHY_FIFO2_CLEAR_PULSE_MASK                                                             0x00000010
//========================================
/* REG_LOGGER_SHRAM_DIRECT_WORDS_IN 0x1A0 */
#define LOGGER_SHRAM_DIRECT_WORDS_IN_FIELD_SH_DIRECT_WORD_IN_MASK                                                 0x0001FFFF
#define LOGGER_SHRAM_DIRECT_WORDS_IN_FIELD_SH_DIRECT_ALIGNER_MASK                                                 0x003E0000
#define LOGGER_SHRAM_DIRECT_WORDS_IN_FIELD_SH_DIRECT_FULL_RAM_MASK                                                0x00400000
//========================================
/* REG_LOGGER_OID_MESAGE_DROP 0x1A4 */
#define LOGGER_OID_MESAGE_DROP_FIELD_OID_MESAGE_DROP_MASK                                                         0x0000001F
#define LOGGER_OID_MESAGE_DROP_FIELD_OID_MESAGE_DROP_OVERIDE_MASK                                                 0x00000020
//========================================
/* REG_LOGGER_PACKAGER_BUFFER_CTRL_STM 0x1A8 */
#define LOGGER_PACKAGER_BUFFER_CTRL_STM_FIELD_PACKAGER_BUFFER_CTRL_STM_MASK                                       0x0000000F
//========================================
/* REG_LOGGER_POP_WHILE_EMPTY_LATCH 0x1AC */
#define LOGGER_POP_WHILE_EMPTY_LATCH_FIELD_POP_WHILE_EMPTY_LATCH_MASK                                             0xFFFFFFFF
//========================================
/* REG_LOGGER_PUSH_WHILE_FULL_LATCH 0x1B0 */
#define LOGGER_PUSH_WHILE_FULL_LATCH_FIELD_PUSH_WHILE_FULL_LATCH_MASK                                             0xFFFFFFFF
//========================================
/* REG_LOGGER_NUM_MESSAGES_8 0x1B4 */
#define LOGGER_NUM_MESSAGES_8_FIELD_SENDER3_NUM_MESSAGES_MASK                                                     0x000000FF
#define LOGGER_NUM_MESSAGES_8_FIELD_PHY_RISC3_NUM_MESSAGES_MASK                                                   0x0000FF00
//========================================
/* REG_LOGGER_NUM_BYTES_IN_FIFO_8 0x1B8 */
#define LOGGER_NUM_BYTES_IN_FIFO_8_FIELD_SENDER3_NUM_BYTES_IN_FIFO_MASK                                           0x000000FF
#define LOGGER_NUM_BYTES_IN_FIFO_8_FIELD_PHY_RISC3_NUM_BYTES_IN_FIFO_MASK                                         0x0000FF00
//========================================
/* REG_LOGGER_LMAC3_DATA_IN 0x1BC */
#define LOGGER_LMAC3_DATA_IN_FIELD_LMAC3_DATA_IN_MASK                                                             0xFFFFFFFF
//========================================
/* REG_LOGGER_LMAC3_FAST_MES_DATA_IN 0x1C0 */
#define LOGGER_LMAC3_FAST_MES_DATA_IN_FIELD_LMAC3_FAST_MES_DATA_IN_MASK                                           0xFFFFFFFF
//========================================
/* REG_LOGGER_LMAC3_MESAGE_DONE 0x1C4 */
#define LOGGER_LMAC3_MESAGE_DONE_FIELD_LMAC3_MESAGE_DONE_MASK                                                     0x00000001
//========================================
/* REG_LOGGER_RX_HANDLER3_DATA_IN 0x1C8 */
#define LOGGER_RX_HANDLER3_DATA_IN_FIELD_RX_HANDLER3_DATA_IN_MASK                                                 0xFFFFFFFF
//========================================
/* REG_LOGGER_RX_HANDLER3_FAST_MES_DATA_IN 0x1CC */
#define LOGGER_RX_HANDLER3_FAST_MES_DATA_IN_FIELD_RX_HANDLER3_FAST_MES_DATA_IN_MASK                               0xFFFFFFFF
//========================================
/* REG_LOGGER_RX_HANDLER3_MESAGE_DONE 0x1D0 */
#define LOGGER_RX_HANDLER3_MESAGE_DONE_FIELD_RX_HANDLER3_MESAGE_DONE_MASK                                         0x00000001
//========================================
/* REG_LOGGER_SENDER3_DATA_IN 0x1D4 */
#define LOGGER_SENDER3_DATA_IN_FIELD_SENDER3_DATA_IN_MASK                                                         0xFFFFFFFF
//========================================
/* REG_LOGGER_SENDER3_FAST_MES_DATA_IN 0x1D8 */
#define LOGGER_SENDER3_FAST_MES_DATA_IN_FIELD_SENDER3_FAST_MES_DATA_IN_MASK                                       0xFFFFFFFF
//========================================
/* REG_LOGGER_SENDER3_MESAGE_DONE 0x1DC */
#define LOGGER_SENDER3_MESAGE_DONE_FIELD_SENDER3_MESAGE_DONE_MASK                                                 0x00000001
//========================================
/* REG_LOGGER_LMAC_HANDLER3_FAST_MES_SEC_WORD 0x1E0 */
#define LOGGER_LMAC_HANDLER3_FAST_MES_SEC_WORD_FIELD_LMAC3_FAST_MES_SEC_WORD_MASK                                 0x0000FFFF
#define LOGGER_LMAC_HANDLER3_FAST_MES_SEC_WORD_FIELD_RX_HANDLER3_FAST_MES_SEC_WORD_MASK                           0xFFFF0000
//========================================
/* REG_LOGGER_SENDER_PHY_RISC3_FAST_MES_SEC_WORD 0x1E4 */
#define LOGGER_SENDER_PHY_RISC3_FAST_MES_SEC_WORD_FIELD_SENDER3_FAST_MES_SEC_WORD_MASK                            0x0000FFFF
#define LOGGER_SENDER_PHY_RISC3_FAST_MES_SEC_WORD_FIELD_PHY_RISC3_FAST_MES_SEC_WORD_MASK                          0xFFFF0000
