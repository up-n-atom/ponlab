...
#define _PCIE_COMMON_HW_REGS_LIST_ \
    ...
    _HW_REG_DEF_(SYS_IF_LM2, EMERALD_ENV, MIPS_CTL)     \
    _HW_REG_DEF_(SYS_IF_LM2, EMERALD_ENV, SECURE_WRITE) \
    /* Upper MAC */ \
    ...
    \
    _HW_REG_DEF_(PHY_RX_TD, PHY_RISC, PHY_PROGMODEL_VER)            \
    _HW_REG_DEF_(PHY_RX_TD, PHY_RISC, PHY_PROGMODEL_VER_MODIFIED)   \
    \
    _HW_REG_DEF_(B0_PHY_RX_TD, PHY_RX_TD, PHY_RXTD_REG096)          \
    _HW_REG_DEF_(B1_PHY_RX_TD, PHY_RX_TD, PHY_RXTD_REG096)          \
    _HW_REG_DEF_(B2_PHY_RX_TD, PHY_RX_TD, PHY_RXTD_REG096)          \
    \
    ...
    _HW_REG_DEF_(B0_PHY_RX_TD_IF, PHY_RX_TD_IF, PHY_RXTD_IF4A)          \
    _HW_REG_DEF_(B1_PHY_RX_TD_IF, PHY_RX_TD_IF, PHY_RXTD_IF4A)          \
    _HW_REG_DEF_(B2_PHY_RX_TD_IF, PHY_RX_TD_IF, PHY_RXTD_IF4A)          \
    \
    ...
    _HW_REG_DEF_(B2_PHY_AGC_ANT0, PHY_AGC_ANT0, INBAND_RSSI_SYSTEM_GAIN_REG) \
    _HW_REG_DEF_(B0_PHY_AGC_ANT0, PHY_AGC_ANT0, IB_POWER_REG)          \
    _HW_REG_DEF_(B1_PHY_AGC_ANT0, PHY_AGC_ANT0, IB_POWER_REG)          \
    _HW_REG_DEF_(B2_PHY_AGC_ANT0, PHY_AGC_ANT0, IB_POWER_REG)          \
    _HW_REG_DEF_(B0_PHY_RX_TD, B0_PHY_RX_TD, TB_ACCESS_CONTROL)        \
    _HW_REG_DEF_(B1_PHY_RX_TD, B1_PHY_RX_TD, TB_ACCESS_CONTROL)        \
    _HW_REG_DEF_(B2_PHY_RX_TD, B2_PHY_RX_TD, TB_ACCESS_CONTROL)        \
...
#define WAVE_PCIE_B2_TXCPU_IRAM_START (B2_MAC_GENRISC_TX_IRAM_OFFSET_FROM_BAR0)
#define WAVE_PCIE_B2_TXCPU_IRAM_SIZE  (B2_MAC_GENRISC_TX_IRAM_SIZE)
...
#define WAVE_PCIE_B2_RXCPU_IRAM_START (B2_MAC_GENRISC_RX_IRAM_OFFSET_FROM_BAR0)
#define WAVE_PCIE_B2_RXCPU_IRAM_SIZE  (B2_MAC_GENRISC_RX_IRAM_SIZE)
...
#define SYS_IF_LM2_BAR0             (SYSTEM_IF_LOWER_B2_CPU_OFFSET_FROM_BAR0)
...
#define PHY_RISC_BAR0               (PHY_RISC_OFFSET_FROM_BAR0)
...
#define B2_PHY_RX_TD_BAR0           (B2_PHY_RX_TD_OFFSET_FROM_BAR0)

#define B0_PHY_AGC_ANT0_BAR0        (B0_PHY_AGC_ANT0_OFFSET_FROM_BAR0)
#define B1_PHY_AGC_ANT0_BAR0        (B1_PHY_AGC_ANT0_OFFSET_FROM_BAR0)
#define B2_PHY_AGC_ANT0_BAR0        (B2_PHY_AGC_ANT0_OFFSET_FROM_BAR0)

#define B0_PHY_RX_TD_IF_BAR0        (B0_PHY_RX_TD_OFFSET_FROM_BAR0)
#define B1_PHY_RX_TD_IF_BAR0        (B1_PHY_RX_TD_OFFSET_FROM_BAR0)
#define B2_PHY_RX_TD_IF_BAR0        (B2_PHY_RX_TD_OFFSET_FROM_BAR0)

/* Progmodel version and Modified flag for new Progmodel version after 2022 */
#define REG_PHY_RISC_PHY_PROGMODEL_VER               0x0040
#define REG_PHY_RISC_PHY_PROGMODEL_VER_MODIFIED      0x0044
#define PHY_RISC_BASE_ADDRESS                        0x10000
...
#define PHY_RX_TD_TB_ACCESS_CONTROL_PAGE_NUM                    MTLK_BFIELD_INFO(0, 4) /* RW */
