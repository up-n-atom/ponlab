...
#define	REG_B1_UL_POST_RX_STA_HE_VARIANT_SUPPORT_BITMAP_159_128     (B1_UL_POST_RX_BASE_ADDRESS + 0x14)
#define	REG_B1_UL_POST_RX_STA_HE_VARIANT_SUPPORT_BITMAP_191_160     (B1_UL_POST_RX_BASE_ADDRESS + 0x18)
#define	REG_B1_UL_POST_RX_STA_HE_VARIANT_SUPPORT_BITMAP_223_192     (B1_UL_POST_RX_BASE_ADDRESS + 0x1C)
#define	REG_B1_UL_POST_RX_STA_HE_VARIANT_SUPPORT_BITMAP_255_224     (B1_UL_POST_RX_BASE_ADDRESS + 0x20)
...
/*REG_B1_UL_POST_RX_STA_HE_VARIANT_SUPPORT_BITMAP_159_128 0x14 */
typedef union
{
	uint32 val;
	struct
...
} RegB1UlPostRxStaHeVariantSupportBitmap159128_u;

/*REG_B1_UL_POST_RX_STA_HE_VARIANT_SUPPORT_BITMAP_191_160 0x18 */
typedef union
{
	uint32 val;
	struct
...
} RegB1UlPostRxStaHeVariantSupportBitmap191160_u;

/*REG_B1_UL_POST_RX_STA_HE_VARIANT_SUPPORT_BITMAP_223_192 0x1C */
typedef union
{
	uint32 val;
	struct
...
} RegB1UlPostRxStaHeVariantSupportBitmap223192_u;

/*REG_B1_UL_POST_RX_STA_HE_VARIANT_SUPPORT_BITMAP_255_224 0x20 */
typedef union
{
	uint32 val;
	struct
...
} RegB1UlPostRxStaHeVariantSupportBitmap255224_u;
