...
************************************************************************************/
#ifndef _RXH_RD_ACC_REGS_H_
#define _RXH_RD_ACC_REGS_H_
...
#define RXH_RD_ACC_BASE_ADDRESS                    MEMORY_MAP_UNIT_63_BASE_ADDRESS
#define	REG_RXH_RD_ACC_CONFIG_INIT                  (RXH_RD_ACC_BASE_ADDRESS + 0x0)
#define	REG_RXH_RD_ACC_STATUS                       (RXH_RD_ACC_BASE_ADDRESS + 0x4)
#define	REG_RXH_RD_ACC_RD_PREFETCH_INTR_MASK        (RXH_RD_ACC_BASE_ADDRESS + 0x8)
#define	REG_RXH_RD_ACC_RD_PREFETCH_INTR_CLEAR       (RXH_RD_ACC_BASE_ADDRESS + 0xC)
#define	REG_RXH_RD_ACC_C0_INCREMENT                 (RXH_RD_ACC_BASE_ADDRESS + 0x10)
#define	REG_RXH_RD_ACC_C0_DECREMENT                 (RXH_RD_ACC_BASE_ADDRESS + 0x14)
#define	REG_RXH_RD_ACC_C1_INCREMENT                 (RXH_RD_ACC_BASE_ADDRESS + 0x18)
#define	REG_RXH_RD_ACC_C1_DECREMENT                 (RXH_RD_ACC_BASE_ADDRESS + 0x1C)
#define	REG_RXH_RD_ACC_C2_INCREMENT                 (RXH_RD_ACC_BASE_ADDRESS + 0x20)
#define	REG_RXH_RD_ACC_C2_DECREMENT                 (RXH_RD_ACC_BASE_ADDRESS + 0x24)
#define	REG_RXH_RD_ACC_RTD_COUNTER                  (RXH_RD_ACC_BASE_ADDRESS + 0x28)
#define	REG_RXH_RD_ACC_MSDU_DESC_PEND_CNT0          (RXH_RD_ACC_BASE_ADDRESS + 0x2C)
#define	REG_RXH_RD_ACC_MSDU_DESC_PEND_CNT1          (RXH_RD_ACC_BASE_ADDRESS + 0x30)
#define	REG_RXH_RD_ACC_MSDU_DESC_PEND_CNT2          (RXH_RD_ACC_BASE_ADDRESS + 0x34)
#define	REG_RXH_RD_ACC_MSDU_DESC_PEND_CNT3          (RXH_RD_ACC_BASE_ADDRESS + 0x38)
#define	REG_RXH_RD_ACC_LOGGER_CTRL                  (RXH_RD_ACC_BASE_ADDRESS + 0x3C)
#define	REG_RXH_RD_ACC_MSDU_DESC_PEND_CNT_CLR       (RXH_RD_ACC_BASE_ADDRESS + 0x40)
#define	REG_RXH_RD_ACC_DBG_STATE_MACHINES           (RXH_RD_ACC_BASE_ADDRESS + 0x44)
#define	REG_RXH_RD_ACC_DBG_ERRORS                   (RXH_RD_ACC_BASE_ADDRESS + 0x48)
#define	REG_RXH_RD_ACC_DBG_STATUSES                 (RXH_RD_ACC_BASE_ADDRESS + 0x4C)
#define	REG_RXH_RD_ACC_FREE_RD_LIST_IDX_CFG         (RXH_RD_ACC_BASE_ADDRESS + 0x50)
#define	REG_RXH_RD_ACC_DA_SA_CHECK_EN               (RXH_RD_ACC_BASE_ADDRESS + 0x54)
#define	REG_RXH_RD_ACC_DBG_PREF0_NXT_DATA_MSB       (RXH_RD_ACC_BASE_ADDRESS + 0x58)
#define	REG_RXH_RD_ACC_DBG_PREF0_NXT_DATA_LSB       (RXH_RD_ACC_BASE_ADDRESS + 0x5C)
#define	REG_RXH_RD_ACC_DBG_PREF1_NXT_DATA_MSB       (RXH_RD_ACC_BASE_ADDRESS + 0x60)
#define	REG_RXH_RD_ACC_DBG_PREF1_NXT_DATA_LSB       (RXH_RD_ACC_BASE_ADDRESS + 0x64)
#define	REG_RXH_RD_ACC_DBG_PREF2_NXT_DATA_MSB       (RXH_RD_ACC_BASE_ADDRESS + 0x68)
#define	REG_RXH_RD_ACC_DBG_PREF2_NXT_DATA_LSB       (RXH_RD_ACC_BASE_ADDRESS + 0x6C)
#define	REG_RXH_RD_ACC_LOGGER_C0_STALLED_LIM_CFG    (RXH_RD_ACC_BASE_ADDRESS + 0x70)
#define	REG_RXH_RD_ACC_DBG_C0_STALLED_MAX_CNT       (RXH_RD_ACC_BASE_ADDRESS + 0x74)
#define	REG_RXH_RD_ACC_RELEASED_RTD_COUNTER         (RXH_RD_ACC_BASE_ADDRESS + 0x78)
#define	REG_RXH_RD_ACC_DBG_MPDU_PTR_RTD_GEN         (RXH_RD_ACC_BASE_ADDRESS + 0x7C)
#define	REG_RXH_RD_ACC_DBG_ETH_PTR_RTD_GEN          (RXH_RD_ACC_BASE_ADDRESS + 0x80)
#define	REG_RXH_RD_ACC_DBG_MPDU_PTR_DESC_UPD        (RXH_RD_ACC_BASE_ADDRESS + 0x84)
#define	REG_RXH_RD_ACC_DBG_ETH_PTR_DESC_UPD         (RXH_RD_ACC_BASE_ADDRESS + 0x88)
/*---------------------------------------------------------------------------------
...
} RegRxhRdAccRdPrefetchIntrMask_u;
...
} RegRxhRdAccRdPrefetchIntrClear_u;
...
} RegRxhRdAccMsduDescPendCntClr_u;
...
} RegRxhRdAccDbgPref0NxtDataMsb_u;
...
} RegRxhRdAccDbgPref0NxtDataLsb_u;
...
} RegRxhRdAccDbgPref1NxtDataMsb_u;
...
} RegRxhRdAccDbgPref1NxtDataLsb_u;
...
} RegRxhRdAccDbgPref2NxtDataMsb_u;
...
} RegRxhRdAccDbgPref2NxtDataLsb_u;
...
} RegRxhRdAccLoggerC0StalledLimCfg_u;
...
} RegRxhRdAccDbgC0StalledMaxCnt_u;
...
} RegRxhRdAccReleasedRtdCounter_u;
...
} RegRxhRdAccDbgMpduPtrDescUpd_u;
