...
typedef struct _wave_ml_vap_str_tid_spreading_info {
  BOOL              active;             /* enable TID spreading for BE AC */
  BOOL              tid_spreading_mode; /* FALSE - static; TRUE - dynamic */
  uint16            tid_split_ratio;
  mtlk_vap_handle_t high_bw_vap;        /* mld affiliated vap which has the higher BW */
} wave_ml_vap_str_tid_spreading_info_t;
#endif
...
void                 __MTLK_IFUNC mtlk_vap_wait_ml_teardown(mtlk_vap_handle_t vap_handle);
...
typedef struct _mtlk_vap_info_internal_t
{
  ...
  MTLK_DECLARE_INIT_LOOP(VAP_HANDLER_PROC_REGISTER);
...
static __INLINE void
mtlk_vap_set_role (mtlk_vap_handle_t vap_handle, mtlk_work_role_e role)
{
  mtlk_vap_info_internal_t *_info = (mtlk_vap_info_internal_t *)vap_handle;
...
int                  __MTLK_IFUNC mtlk_vap_create_secondary_vap(mtlk_vap_handle_t vap_handle,
                                                                ...
                                                                struct net_device *ndev);
void                 __MTLK_IFUNC mtlk_vap_del_secondary_vap (mtlk_vap_handle_t vap_handle, uint8 sec_vap_idx);
void                 __MTLK_IFUNC mtlk_vap_del_all_secondary_vaps(mtlk_vap_handle_t vap_handle);
int                  __MTLK_IFUNC mtlk_vap_bind_backhaul_sta_to_secondary_vap (mtlk_vap_handle_t vap_handle,
                                                                sta_entry *sta, uint8 sec_vap_idx);
int                  __MTLK_IFUNC mtlk_vap_bind_backhaul_sta(mtlk_vap_handle_t vap_handle,
                                                                sta_entry *sta);
void                 __MTLK_IFUNC mtlk_vap_unbind_backhaul_sta(mtlk_vap_handle_t vap_handle,
                                                                sta_entry *sta);
...
mtlk_vap_manager_find_primary_vap (mtlk_vap_manager_t *vap_manager,
  const char* sec_vap_name, mtlk_vap_handle_t *vap_handle);
...
#ifdef MTLK_WAVE_700
#ifdef BEST_EFFORT_TID_SPREADING
static __INLINE wave_ml_vap_str_tid_spreading_info_t *
wave_vap_manager_get_str_tid_spreading_info (mtlk_vap_handle_t vap_handle)
{
  mtlk_vap_info_internal_t *_info = (mtlk_vap_info_internal_t *)vap_handle;

  MTLK_ASSERT(NULL != _info);

  return _info->ml_vap_info.tid_spread_info;
}
#endif
...
static __INLINE BOOL
mtlk_vap_ml_configured(mtlk_vap_handle_t vap_handle)
{
  mtlk_vap_info_internal_t *_info = (mtlk_vap_info_internal_t *)vap_handle;
...
wave_vap_get_sibling_vap_handle (mtlk_vap_handle_t vap_handle)
{
  mtlk_vap_info_internal_t *_info = (mtlk_vap_info_internal_t *)vap_handle;

  MTLK_ASSERT(NULL != _info);
  return _info->ml_vap_info.sibling;
}
#endif
