...
Module:				logger
SOC Revision:		latest
Generated at:       2022-05-04 10:58:45
Purpose:
...
typedef union
{
	...
	struct
	{
		uint32 bufferLength : 16; //buffer_length, reset value: 0x500, access type: RW
		uint32 reserved0 : 16;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 phyFifo1MessageLength : 16; //phy_fifo1_message_length, reset value: 0x30, access type: RW
		uint32 phyFifo2MessageLength : 16; //phy_fifo2_message_length, reset value: 0x30, access type: RW
	} bitFields;
