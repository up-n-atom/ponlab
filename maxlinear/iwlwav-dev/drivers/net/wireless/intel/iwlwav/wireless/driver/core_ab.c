...
static const mtlk_ability_id_t _core_general_abilities[] = {
  ...
  WAVE_CORE_REQ_REQUEST_AID,
  WAVE_CORE_REQ_REMOVE_AID,
  ...
  WAVE_CORE_REQ_GET_WIFI_CHANNEL_STATS,
  WAVE_CORE_REQ_GET_DRV_CHANNEL_STATS,
  ...
  WAVE_CORE_REQ_RESET_STATISTICS,
  WAVE_CORE_REQ_SET_AP_EXCE_RETRY_LIMIT,
  WAVE_CORE_REQ_GET_AP_EXCE_RETRY_LIMIT,
  WAVE_CORE_REQ_SET_MGMT_FRAME_PWR_CTRL,
  WAVE_CORE_REQ_GET_MGMT_FRAME_PWR_CTRL,
  WAVE_CORE_REQ_SET_RSSI_IGNORE_PROBE_REQUEST,
  WAVE_CORE_REQ_GET_PEER_MIXED_STATS,
  WAVE_CORE_REQ_SET_CSI_ENABLE,
  WAVE_CORE_REQ_GET_CSI_ENABLE,
  WAVE_CORE_REQ_SET_CSI_SEND_QOS_NULL,
  WAVE_CORE_REQ_SET_CSI_AUTO_RATE,
  WAVE_CORE_REQ_GET_CSI_AUTO_RATE,
  WAVE_CORE_REQ_GET_CSI_STATS,
  WAVE_CORE_REQ_GET_CSI_COUNTERS,
  WAVE_CORE_REQ_GET_LA_MU_GROUPS_STATS,
  WAVE_CORE_REQ_GET_STA_DISCNT_WARN,
  WAVE_CORE_REQ_TRIGGER_STA_DISCNT_WHM,
  WAVE_CORE_REQ_SET_ALLOW_3ADDR_MCAST,
  WAVE_CORE_REQ_GET_ALLOW_3ADDR_MCAST,
  WAVE_CORE_REQ_GET_LA_SU_MU_RU_OFDMA_STATS,
  WAVE_CORE_REQ_CHANGE_ROLE,
  WAVE_RADIO_REQ_GET_CSI_CAPABILITY,
  ...
  WAVE_CORE_REQ_SET_EHT_OPERATION,
  WAVE_CORE_REQ_GET_EHT_OPERATION,
  WAVE_CORE_REQ_SET_EHT_NON_ADVERTISED,
  WAVE_CORE_REQ_GET_EHT_NON_ADVERTISED,
  WAVE_RADIO_REQ_SET_LOGGER_FIFO_MUX_CFG,
  WAVE_RADIO_REQ_GET_LOGGER_FIFO_MUX_CFG,
  WAVE_CORE_REQ_SETUP_MLD,
  WAVE_CORE_REQ_SET_MLD_INFO,
  WAVE_CORE_REQ_ML_SID,
  WAVE_CORE_REQ_SET_ML_SID,
  WAVE_CORE_REQ_ML_STA_ADD,
  WAVE_CORE_REQ_REMOVE_MLD,
  WAVE_CORE_REQ_SET_ML_CRITICAL_UPDATE,
  WAVE_CORE_REQ_GET_LA_MU_HE_EHT_STATS,
  WAVE_CORE_REQ_SCS_ADD,
  WAVE_CORE_REQ_SCS_REM,
  WAVE_CORE_REQ_ML_TX_T2LM_TEARDOWN,
  WAVE_CORE_REQ_GET_ML_STA_LINK_STATS,
  WAVE_CORE_REQ_SET_ML_STA_LINK_STATS,
  WAVE_CORE_REQ_GET_ML_VAP_LIST,
#ifdef BEST_EFFORT_TID_SPREADING
  WAVE_CORE_REQ_SET_STR_TID_LINK_SPREADING,
  WAVE_CORE_REQ_CLEANUP_SKB_HASH,
  WAVE_CORE_REQ_CALCULATE_EFFECTIVE_RATES_STR,
#endif
  WAVE_CORE_REQ_ML_STA_REASSOC_NOTIFY,
  WAVE_CORE_REQ_GET_ML_PEER_FLOW_STATUS,
  WAVE_CORE_REQ_GET_ML_STA_LIST,
#endif
  WAVE_CORE_REQ_SET_FIXED_RATE_THERMAL,
  WAVE_CORE_REQ_GET_FIXED_RATE_THERMAL,
  WAVE_CORE_REQ_MSCS_ADD,
  WAVE_CORE_REQ_MSCS_REM,
