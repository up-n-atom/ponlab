...
#define PHY_RX_FD_IF_BASE_ADDRESS                   MEMORY_MAP_UNIT_202_BASE_ADDRESS
...
#define	REG_PHY_RX_FD_IF_PHY_RXFD_IF136                (PHY_RX_FD_IF_BASE_ADDRESS + 0x14D8)
...
#define	REG_PHY_RX_FD_IF_PHY_RXFD_IF166                (PHY_RX_FD_IF_BASE_ADDRESS + 0x1598)
#define	REG_PHY_RX_FD_IF_PHY_RXFD_IF167                (PHY_RX_FD_IF_BASE_ADDRESS + 0x159C)
#define	REG_PHY_RX_FD_IF_PHY_RXFD_IF168                (PHY_RX_FD_IF_BASE_ADDRESS + 0x15A0)
#define	REG_PHY_RX_FD_IF_PHY_RXFD_IF169                (PHY_RX_FD_IF_BASE_ADDRESS + 0x15A4)
#define	REG_PHY_RX_FD_IF_PHY_RXFD_IF16A                (PHY_RX_FD_IF_BASE_ADDRESS + 0x15A8)
#define	REG_PHY_RX_FD_IF_PHY_RXFD_IF16B                (PHY_RX_FD_IF_BASE_ADDRESS + 0x15AC)
#define	REG_PHY_RX_FD_IF_CT_DATA_MU                    (PHY_RX_FD_IF_BASE_ADDRESS + 0x15B0)
#define	REG_PHY_RX_FD_IF_GEAR_SHIFT_SYM_NUM_DFE        (PHY_RX_FD_IF_BASE_ADDRESS + 0x15B4)
/*---------------------------------------------------------------------------------
...
} RegPhyRxFdIfGearShiftSymNumDfe_u;
