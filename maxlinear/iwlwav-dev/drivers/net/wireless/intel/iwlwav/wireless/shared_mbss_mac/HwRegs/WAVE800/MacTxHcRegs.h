...
#define	REG_MAC_TX_HC_NON_UNICAST_PARAMS_0              (MAC_TX_HC_BASE_ADDRESS + 0x3C)
...
#define	REG_MAC_TX_HC_NON_UNICAST_PARAMS_1              (MAC_TX_HC_BASE_ADDRESS + 0x48)
#define	REG_MAC_TX_HC_NON_UNICAST_PARAMS_2              (MAC_TX_HC_BASE_ADDRESS + 0x4C)
