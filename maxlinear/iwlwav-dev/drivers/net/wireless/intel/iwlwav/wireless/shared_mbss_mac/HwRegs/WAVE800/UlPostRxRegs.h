...
#define	REG_UL_POST_RX_HE_MU_DL_REPORT_ENABLE                    (UL_POST_RX_BASE_ADDRESS + 0x48)
#define	REG_UL_POST_RX_UL_MU_DISABLE_DATA_CONTROL                (UL_POST_RX_BASE_ADDRESS + 0x4C)
...
#define	REG_UL_POST_RX_ULPR_CONTROL                              (UL_POST_RX_BASE_ADDRESS + 0xA0)
...
} RegUlPostRxHeMuDlReportEnable_u;
...
} RegUlPostRxUlMuDisableDataControl_u;
