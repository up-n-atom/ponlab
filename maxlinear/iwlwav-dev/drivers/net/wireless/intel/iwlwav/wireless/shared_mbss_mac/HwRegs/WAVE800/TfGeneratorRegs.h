...
#define	REG_TF_GENERATOR_TF_GEN_MASK_OFFSET_USER_PARAMS_0                (TF_GENERATOR_BASE_ADDRESS + 0x7C)
#define	REG_TF_GENERATOR_TF_GEN_MASK_OFFSET_USER_PARAMS_1                (TF_GENERATOR_BASE_ADDRESS + 0x80)
#define	REG_TF_GENERATOR_TF_GEN_MASK_OFFSET_USER_PARAMS_2                (TF_GENERATOR_BASE_ADDRESS + 0x84)
#define	REG_TF_GENERATOR_TF_GEN_MASK_OFFSET_USER_PARAMS_3                (TF_GENERATOR_BASE_ADDRESS + 0x88)
#define	REG_TF_GENERATOR_TF_GEN_MASK_OFFSET_USER_PARAMS_4                (TF_GENERATOR_BASE_ADDRESS + 0x8C)
...
} RegTfGeneratorTfGenMaskOffsetUserParams4_u;
