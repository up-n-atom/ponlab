...
mtlk_error_t __MTLK_IFUNC mtlk_core_get_statistics (mtlk_core_t *nic, mtlk_hw_t *hw);
mtlk_error_t __MTLK_IFUNC mtlk_core_get_station_measurements (mtlk_handle_t hcore, const void *data, uint32 data_size);
...
int __MTLK_IFUNC mtlk_core_get_wifi_channel_stats (mtlk_handle_t hcore, const void *data, uint32 data_size);
int __MTLK_IFUNC mtlk_core_get_drv_channel_stats (mtlk_handle_t hcore, const void *data, uint32 data_size);
...
int __MTLK_IFUNC wave_core_reset_statistics(mtlk_handle_t hcore, const void *data, uint32 data_size);
mtlk_error_t __MTLK_IFUNC wave_core_get_peer_mixed_stats (mtlk_handle_t hcore, const void *data, uint32 data_size);
mtlk_error_t __MTLK_IFUNC wave_core_get_la_su_mu_ru_ofdma_stats (mtlk_handle_t hcore, const void *data, uint32 data_size);
mtlk_error_t __MTLK_IFUNC wave_core_get_csi_stats (mtlk_handle_t hcore, const void *data, uint32 data_size);
mtlk_error_t __MTLK_IFUNC wave_core_get_csi_counters (mtlk_handle_t hcore, const void *data, uint32 data_size);
mtlk_error_t __MTLK_IFUNC wave_core_get_radio_sta_list (mtlk_handle_t hcore, const void *data, uint32 data_size);
mtlk_error_t __MTLK_IFUNC wave_core_get_link_adapt_mimo_statistics (mtlk_handle_t hcore, const void *data, uint32 data_size);
mtlk_error_t __MTLK_IFUNC wave_core_get_la_mu_he_eht_stats (mtlk_handle_t hcore, const void *data, uint32 data_size);
mtlk_error_t __MTLK_IFUNC wave_core_get_la_mu_groups_statistics(mtlk_handle_t hcore, const void *data, uint32 data_size);
void __MTLK_IFUNC mtlk_core_find_max_sta_rate (struct nic *nic, sta_entry *sta, struct ieee80211_sta *mac80211_sta);
void __MTLK_IFUNC mtlk_core_save_chan_statistics_info (mtlk_core_t *core, struct intel_vendor_channel_data *ch_data);
...
void __MTLK_IFUNC mtlk_core_reset_stats_internal (mtlk_core_t *core);

#ifdef CONFIG_WAVE_DEBUG
mtlk_error_t __MTLK_IFUNC mtlk_core_reset_stats (mtlk_handle_t hcore, const void* data, uint32 data_size);
...
int __MTLK_IFUNC wave_core_get_la_mu_vht_statistics(mtlk_handle_t hcore, const void *data, uint32 data_size);
