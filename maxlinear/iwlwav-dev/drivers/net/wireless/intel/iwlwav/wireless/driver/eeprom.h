...
#define MAX_NUM_RX_ANTENNAS_665  (5)
#define WAVE_EEPROM_RSSI_DATA_RX_ANT_NUM_OFFS 0
...
/* support 8K EEPROM for W700.
   Offset of each band in the 8k EEPROM */

#define MTLK_WAV700_EEPROM_2_4G_OFFSET (1024) /* cal_wlan0.bin (2.4G) */
#define MTLK_WAV700_EEPROM_5G_OFFSET   (3072) /* cal_wlan2.bin (5G)   */
#define MTLK_WAV700_EEPROM_6G_OFFSET   (5120) /* cal_wlan4.bin (6G)   */
...
typedef struct _mtlk_eeprom_data_cfg_t    mtlk_eeprom_data_cfg_t;
typedef struct _mtlk_eeprom_cfg_t         mtlk_eeprom_cfg_t;
...
void __MTLK_IFUNC
mtlk_eeprom_get_cfg(mtlk_eeprom_data_t *eeprom, struct _mtlk_eeprom_data_cfg_t *cfg);
