...
static const uint32 OperateRateSet[] = {
  ...
  0x1fff80ff, /* 11anacaxbe@5.2GHz MCS [0…13] */
  0xffffffff, /* 11bgnaxbe@2.4Hz */
  0xffff80ff, /* 11gnaxbe@2.4Hz */
  0x1fff80ff  /* 11axbe@6GHz MCS [0…13] */
};
...
uint8 __MTLK_IFUNC net_mode_to_band (uint8 net_mode)
{
  ...
  case MTLK_NETWORK_11BGNAXBE_MIXED:
  case MTLK_NETWORK_11GNAXBE_MIXED:
  ...
  case MTLK_NETWORK_11ANACAXBE_MIXED:
...
/* TODO: To handle the multi radio configuration with 6GHz */
  ...
  case MTLK_NETWORK_11AXBE_MIXED:
