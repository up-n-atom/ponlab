...
#define	REG_B0_PRE_AGG_MAX_PSDU_SIZE_EHT                            (B0_PRE_AGG_BASE_ADDRESS + 0x34)
#define	REG_B0_PRE_AGG_SW_MU_RTS_DUR0                               (B0_PRE_AGG_BASE_ADDRESS + 0x38)
#define	REG_B0_PRE_AGG_SW_MU_RTS_DUR1                               (B0_PRE_AGG_BASE_ADDRESS + 0x3C)
...
#define	REG_B0_PRE_AGG_MRU_VEC_EN_SET0_31_TO_0                      (B0_PRE_AGG_BASE_ADDRESS + 0x3DC)
#define	REG_B0_PRE_AGG_MRU_VEC_EN_SET0_44_TO_32                     (B0_PRE_AGG_BASE_ADDRESS + 0x3E0)
#define	REG_B0_PRE_AGG_MRU_VEC_EN_SET1_31_TO_0                      (B0_PRE_AGG_BASE_ADDRESS + 0x3E4)
#define	REG_B0_PRE_AGG_MRU_VEC_EN_SET1_44_TO_32                     (B0_PRE_AGG_BASE_ADDRESS + 0x3E8)
#define	REG_B0_PRE_AGG_EHT_MISC                                     (B0_PRE_AGG_BASE_ADDRESS + 0x3EC)
...
/*REG_B0_PRE_AGG_MAX_PSDU_SIZE_EHT 0x34 */
typedef union
{
	uint32 val;
	struct
...
} RegB0PreAggMaxPsduSizeEht_u;

/*REG_B0_PRE_AGG_SW_MU_RTS_DUR0 0x38 */
typedef union
{
	uint32 val;
	struct
...
} RegB0PreAggSwMuRtsDur0_u;

/*REG_B0_PRE_AGG_SW_MU_RTS_DUR1 0x3C */
typedef union
{
	uint32 val;
	struct
...
/*REG_B0_PRE_AGG_MRU_VEC_EN_SET0_31_TO_0 0x3DC */
typedef union
{
	uint32 val;
	struct
...
} RegB0PreAggMruVecEnSet031To0_u;

/*REG_B0_PRE_AGG_MRU_VEC_EN_SET0_44_TO_32 0x3E0 */
typedef union
{
	uint32 val;
	struct
...
} RegB0PreAggMruVecEnSet044To32_u;

/*REG_B0_PRE_AGG_MRU_VEC_EN_SET1_31_TO_0 0x3E4 */
typedef union
{
	uint32 val;
	struct
...
} RegB0PreAggMruVecEnSet131To0_u;

/*REG_B0_PRE_AGG_MRU_VEC_EN_SET1_44_TO_32 0x3E8 */
typedef union
{
	uint32 val;
	struct
...
} RegB0PreAggMruVecEnSet144To32_u;

/*REG_B0_PRE_AGG_EHT_MISC 0x3EC */
typedef union
{
	uint32 val;
	struct
