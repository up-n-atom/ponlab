...
Module:				txSequencer
SOC Revision:		latest
Generated at:       2022-03-29 07:46:07
Purpose:
...
typedef union
{
	...
	struct
	{
		uint32 triggerCfEndBaaBusyEn : 8; //Enable trigger CF-end when BAA is still busy, 1 bit per "Data type" enum in STD, reset value: 0x50, access type: RW
		uint32 reserved0 : 24;
	} bitFields;
