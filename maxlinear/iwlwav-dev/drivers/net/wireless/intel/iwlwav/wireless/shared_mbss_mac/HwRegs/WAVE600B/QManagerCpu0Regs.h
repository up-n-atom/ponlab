...
************************************************************************************/
#ifndef _Q_MANAGER_CPU0_REGS_H_
#define _Q_MANAGER_CPU0_REGS_H_
...
#define Q_MANAGER_CPU0_BASE_ADDRESS                             MEMORY_MAP_UNIT_37_BASE_ADDRESS
#define	REG_Q_MANAGER_CPU0_CTL                               (Q_MANAGER_CPU0_BASE_ADDRESS + 0x0)
#define	REG_Q_MANAGER_CPU0_PUSH_ADDR_TOP                     (Q_MANAGER_CPU0_BASE_ADDRESS + 0x4)
#define	REG_Q_MANAGER_CPU0_PUSH_ADDR_BOTTOM                  (Q_MANAGER_CPU0_BASE_ADDRESS + 0x8)
#define	REG_Q_MANAGER_CPU0_POP_ADDR_TOP                      (Q_MANAGER_CPU0_BASE_ADDRESS + 0xC)
#define	REG_Q_MANAGER_CPU0_POP_ADDR_BOTTOM                   (Q_MANAGER_CPU0_BASE_ADDRESS + 0x10)
#define	REG_Q_MANAGER_CPU0_CLEAN_FIFO                        (Q_MANAGER_CPU0_BASE_ADDRESS + 0x14)
#define	REG_Q_MANAGER_CPU0_FIFO_EN                           (Q_MANAGER_CPU0_BASE_ADDRESS + 0x18)
#define	REG_Q_MANAGER_CPU0_INT_CTL                           (Q_MANAGER_CPU0_BASE_ADDRESS + 0x1C)
#define	REG_Q_MANAGER_CPU0_INT_PUSH_ADDR_TOP                 (Q_MANAGER_CPU0_BASE_ADDRESS + 0x20)
#define	REG_Q_MANAGER_CPU0_INT_PUSH_ADDR_BOTTOM              (Q_MANAGER_CPU0_BASE_ADDRESS + 0x24)
#define	REG_Q_MANAGER_CPU0_INT_POP_ADDR_TOP                  (Q_MANAGER_CPU0_BASE_ADDRESS + 0x28)
#define	REG_Q_MANAGER_CPU0_INT_POP_ADDR_BOTTOM               (Q_MANAGER_CPU0_BASE_ADDRESS + 0x2C)
#define	REG_Q_MANAGER_CPU0_INT_STATUS                        (Q_MANAGER_CPU0_BASE_ADDRESS + 0x30)
#define	REG_Q_MANAGER_CPU0_TX_LISTS_EMPTY_INT_EN0_31         (Q_MANAGER_CPU0_BASE_ADDRESS + 0x38)
#define	REG_Q_MANAGER_CPU0_TX_LISTS_EMPTY_INT_EN32_63        (Q_MANAGER_CPU0_BASE_ADDRESS + 0x3C)
#define	REG_Q_MANAGER_CPU0_TX_LISTS_NOT_EMPTY_INT_EN0_31     (Q_MANAGER_CPU0_BASE_ADDRESS + 0x40)
#define	REG_Q_MANAGER_CPU0_TX_LISTS_NOT_EMPTY_INT_EN32_63    (Q_MANAGER_CPU0_BASE_ADDRESS + 0x44)
#define	REG_Q_MANAGER_CPU0_RX_LISTS_EMPTY_INT_EN0_31         (Q_MANAGER_CPU0_BASE_ADDRESS + 0x48)
#define	REG_Q_MANAGER_CPU0_RX_LISTS_EMPTY_INT_EN32_63        (Q_MANAGER_CPU0_BASE_ADDRESS + 0x4C)
#define	REG_Q_MANAGER_CPU0_RX_LISTS_NOT_EMPTY_INT_EN0_31     (Q_MANAGER_CPU0_BASE_ADDRESS + 0x50)
#define	REG_Q_MANAGER_CPU0_RX_LISTS_NOT_EMPTY_INT_EN32_63    (Q_MANAGER_CPU0_BASE_ADDRESS + 0x54)
#define	REG_Q_MANAGER_CPU0_TX_DONE_INT                       (Q_MANAGER_CPU0_BASE_ADDRESS + 0x58)
#define	REG_Q_MANAGER_CPU0_RX_DONE_INT                       (Q_MANAGER_CPU0_BASE_ADDRESS + 0x5C)
#define	REG_Q_MANAGER_CPU0_LO_PRI_TX_READY_INT               (Q_MANAGER_CPU0_BASE_ADDRESS + 0x60)
#define	REG_Q_MANAGER_CPU0_LO_PRI_RX_READY_INT               (Q_MANAGER_CPU0_BASE_ADDRESS + 0x64)
#define	REG_Q_MANAGER_CPU0_HI_PRI_TX_READY_INT               (Q_MANAGER_CPU0_BASE_ADDRESS + 0x68)
#define	REG_Q_MANAGER_CPU0_HI_PRI_RX_READY_INT               (Q_MANAGER_CPU0_BASE_ADDRESS + 0x6C)
#define	REG_Q_MANAGER_CPU0_DESC_POOL_INT_TX                  (Q_MANAGER_CPU0_BASE_ADDRESS + 0x70)
#define	REG_Q_MANAGER_CPU0_DESC_POOL_INT_RX                  (Q_MANAGER_CPU0_BASE_ADDRESS + 0x74)
#define	REG_Q_MANAGER_CPU0_TX_INT_CLR0_31                    (Q_MANAGER_CPU0_BASE_ADDRESS + 0x78)
#define	REG_Q_MANAGER_CPU0_TX_INT_CLR32_63                   (Q_MANAGER_CPU0_BASE_ADDRESS + 0x7C)
#define	REG_Q_MANAGER_CPU0_RX_INT_CLR0_31                    (Q_MANAGER_CPU0_BASE_ADDRESS + 0x80)
#define	REG_Q_MANAGER_CPU0_RX_INT_CLR32_63                   (Q_MANAGER_CPU0_BASE_ADDRESS + 0x84)
#define	REG_Q_MANAGER_CPU0_DISABLE_NOT_EMPTY_INT_EN          (Q_MANAGER_CPU0_BASE_ADDRESS + 0x88)
#define	REG_Q_MANAGER_CPU0_DISABLE_INT_CLR                   (Q_MANAGER_CPU0_BASE_ADDRESS + 0x8C)
#define	REG_Q_MANAGER_CPU0_DISABLE_INT                       (Q_MANAGER_CPU0_BASE_ADDRESS + 0x90)
#define	REG_Q_MANAGER_CPU0_FIFO_STATUS                       (Q_MANAGER_CPU0_BASE_ADDRESS + 0x94)
#define	REG_Q_MANAGER_CPU0_ERR                               (Q_MANAGER_CPU0_BASE_ADDRESS + 0x98)
#define	REG_Q_MANAGER_CPU0_ERR_CLR                           (Q_MANAGER_CPU0_BASE_ADDRESS + 0x9C)
/*---------------------------------------------------------------------------------
...
} RegQManagerCpu0PushAddrBottom_u;
...
} RegQManagerCpu0PopAddrBottom_u;
...
} RegQManagerCpu0IntPushAddrTop_u;
...
} RegQManagerCpu0IntPushAddrBottom_u;
...
} RegQManagerCpu0IntPopAddrTop_u;
...
} RegQManagerCpu0IntPopAddrBottom_u;
...
} RegQManagerCpu0TxListsEmptyIntEn031_u;
...
} RegQManagerCpu0TxListsEmptyIntEn3263_u;
...
} RegQManagerCpu0TxListsNotEmptyIntEn031_u;
...
} RegQManagerCpu0TxListsNotEmptyIntEn3263_u;
...
} RegQManagerCpu0RxListsEmptyIntEn031_u;
...
} RegQManagerCpu0RxListsEmptyIntEn3263_u;
...
} RegQManagerCpu0RxListsNotEmptyIntEn031_u;
...
} RegQManagerCpu0RxListsNotEmptyIntEn3263_u;
...
} RegQManagerCpu0LoPriTxReadyInt_u;
...
} RegQManagerCpu0LoPriRxReadyInt_u;
...
} RegQManagerCpu0HiPriTxReadyInt_u;
...
} RegQManagerCpu0HiPriRxReadyInt_u;
...
} RegQManagerCpu0DescPoolIntTx_u;
...
} RegQManagerCpu0DescPoolIntRx_u;
...
} RegQManagerCpu0DisableNotEmptyIntEn_u;
...
} RegQManagerCpu0DisableIntClr_u;
