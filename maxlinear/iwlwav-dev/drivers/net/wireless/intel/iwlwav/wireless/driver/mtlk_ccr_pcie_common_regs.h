...
#define _PCIE_COMMON_HW_REGS_LIST_ \
    ...
    _HW_REG_DEF_(   PHY_RX_TD, PHY_RX_TD, PHY_PROGMODEL_VER_MODIFIED) \
...
/* Modified flag for new Progmodel version after 2022 */
#define REG_PHY_RX_TD_PHY_PROGMODEL_VER_MODIFIED     (PHY_RX_TD_BASE_ADDRESS + 0x8044)
