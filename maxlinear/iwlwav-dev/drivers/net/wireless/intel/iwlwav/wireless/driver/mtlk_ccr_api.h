...
typedef int   (__MTLK_IFUNC *mtlk_ccr_init_f)(void *ccr_mem, mtlk_hw_t *hw, void *bar0,
                                              void *bar1, void *bar1_phy, void *dev_ctx, void **shram, BOOL is_hw_gen7);
...
typedef uint32(__MTLK_IFUNC *mtlk_ccr_get_progmodel_ver_modified_f)(void *ccr_mem);
...
typedef void  (__MTLK_IFUNC *mtlk_ccr_ring_initiate_bulk_doorbell_f)(void *ccr_mem, void *ring_regs, uint32 hds_ready);
...
typedef uint32(__MTLK_IFUNC *mtlk_ccr_read_chip_type_f)(void *ccr_mem);
...
typedef void(__MTLK_IFUNC *wave_ccr_write_phy_td_tb_page_num_f)(void *ccr_mem, uint8 radio_id, uint8 page_num);
...
typedef struct {
  ...
  mtlk_ccr_get_progmodel_ver_modified_f    get_progmodel_version_modified;
  ...
  mtlk_ccr_ring_initiate_bulk_doorbell_f   ring_initiate_bulk_doorbell_interrupt;
  ...
  mtlk_ccr_read_chip_type_f                read_chip_type;
  wave_ccr_write_phy_td_tb_page_num_f      write_phy_td_tb_page_num;
} mtlk_ccr_api_t;
