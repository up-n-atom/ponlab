...
typedef enum {
  ...
  PARAM_DB_CORE_MULTI_AP_MODE,            /*!< Multi-AP mode for the current AP */
  ...
  PARAM_DB_CORE_INTRA_VAP_MCAST,          /*!< Intra VAP Multicast traffic handling */
  PARAM_DB_CORE_AP_RETRY_LIMIT_EXCE,      /*!< AP retry limit value excessive */
  PARAM_DB_CORE_MGMT_PWR_CTRL,            /*!< Management Frame Power Control */
  PARAM_DB_CORE_RSSI_IGNORE_PROBE_REQ,    /*!< RSSI Ignore probe response value*/
  PARAM_DB_CORE_ALLOW_3ADDR_MCAST,        /*!< Repeater Mode 3-Address Multicast handling */
  PARAM_DB_CORE_HE_BSS_COLOR,             /*!< b7 - BSS Color Disabled, b5-b0 HE BSS color */
  PARAM_DB_CORE_SET_BSS,                  /*!< AP set BSS parameters */

  PARAM_DB_CORE_PROBEREQ_OFFLOAD_MODE,    /*!< Disable probe request offload */

  #ifdef MTLK_WAVE_700
  PARAM_DB_CORE_EHT_MCS_NSS,              /*!< EHT_MCS_NSS from the 802.11BE beacon */
  PARAM_DB_CORE_EHT_OPERATION,            /*!< EHT_OPERATION from the 802.11BE beacon */
  PARAM_DB_CORE_EHT_DEBUG_DATA,           /*!< EHT Capabilities Debug Data */
  PARAM_DB_CORE_EHT_NON_ADVERTISED,       /*!< Non advertised EHT capabilities */
  /* MLD parameter */
  PARAM_DB_CORE_AP_MLD_MAC,               /*!< AP MLD MAC address */
  PARAM_DB_CORE_MLD_ID,                   /*!< MLD ID */
...
typedef enum {
  ...
  PARAM_DB_RADIO_BF_TX_POWER_PSD,                           /*!< radio parameter - BF TX power limit according to PSD per current BW */
  PARAM_DB_RADIO_TX_POWER_CFG,                              /*!< radio parameter - TX power limit configured per current BW */
  PARAM_DB_RADIO_BF_TX_POWER_CFG,                           /*!< radio parameter - BF TX power limit configured per current BW */
  ...
  PARAM_DB_RADIO_TX_POWER_LIMIT_OFFSET_PREV,                /*!< Used to detect changes in Set Power Limit to force SET_CHAN request */
  ...
  PARAM_DB_RADIO_FILS_BEACON_FLAG,                          /*!< Fils Beacon Flag */
  ...
  PARAM_DB_RADIO_CFG_PW_LIMITS_PSD,                         /*!< Radio parameter - TPC power limits according to PSD for all BW */
...
#ifdef MTLK_WAVE_700
  PARAM_DB_RADIO_AMSDU_EHTNUM,                              /*!< AMSDU ehtnum */
#endif
  ...
  PARAM_DB_RADIO_AP_RETRY_LIMIT_PROBERESP,                  /*!< AP retry limit value Probe Response */
  ...
  PARAM_DB_RADIO_6GHZ_REG_FCC_SP,                           /*!< Regulatory table for Standard Power mode AP*/
