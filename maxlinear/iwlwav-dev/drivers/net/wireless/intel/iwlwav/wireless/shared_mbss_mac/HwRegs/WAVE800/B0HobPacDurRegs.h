...
#define	REG_B0_HOB_PAC_DUR_TSF_FIELD_SFR6_LOW                             (B0_HOB_PAC_DUR_BASE_ADDRESS + 0xC8)
#define	REG_B0_HOB_PAC_DUR_TSF_FIELD_SFR6_HIGH                            (B0_HOB_PAC_DUR_BASE_ADDRESS + 0xCC)
...
/*REG_B0_HOB_PAC_DUR_TSF_FIELD_SFR6_LOW 0xC8 */
typedef union
{
	uint32 val;
	struct
...
} RegB0HobPacDurTsfFieldSfr6Low_u;

/*REG_B0_HOB_PAC_DUR_TSF_FIELD_SFR6_HIGH 0xCC */
typedef union
{
	uint32 val;
	struct
...
} RegB0HobPacDurTsfFieldSfr6High_u;
...
#define B0_HOB_PAC_DUR_CF_ACK_SFR_FIELD_PM_SFR_MASK                                                               0x00001000
//========================================
/* REG_HOB_PAC_DUR_LEGACY_TSF_FIELD_SFR_LOW 0x14 */
#define B0_HOB_PAC_DUR_LEGACY_TSF_FIELD_SFR_LOW_FIELD_TSF_FIELD_SFR_LOW_MASK                                      0xFFFFFFFF
//========================================
/* REG_HOB_PAC_DUR_LEGACY_TSF_FIELD_SFR_HIGH 0x18 */
#define B0_HOB_PAC_DUR_LEGACY_TSF_FIELD_SFR_HIGH_FIELD_TSF_FIELD_SFR_HIGH_MASK                                    0xFFFFFFFF
//========================================
/* REG_HOB_PAC_DUR_TXOP_JUMP_TABLE_BASE 0x20 */
#define B0_HOB_PAC_DUR_TXOP_JUMP_TABLE_BASE_FIELD_TXOP_JUMP_TABLE_BASE_MASK                                       0x00FFFFC0
//========================================
/* REG_HOB_PAC_DUR_AUTO_REPLY_DUR 0x50 */
#define B0_HOB_PAC_DUR_AUTO_REPLY_DUR_FIELD_AUTO_REPLY_DUR_MASK                                                   0x0000FFFF
//========================================
/* REG_HOB_PAC_DUR_TSF_FIELD_SFR_LOW 0x54 */
#define B0_HOB_PAC_DUR_TSF_FIELD_SFR_LOW_FIELD_TSF_FIELD_SFR_LOW_MASK                                             0xFFFFFFFF
//========================================
/* REG_HOB_PAC_DUR_TSF_FIELD_SFR_HIGH 0x58 */
#define B0_HOB_PAC_DUR_TSF_FIELD_SFR_HIGH_FIELD_TSF_FIELD_SFR_HIGH_MASK                                           0xFFFFFFFF
//========================================
/* REG_HOB_PAC_DUR_TSF_FIELD_SFR1_LOW 0x5C */
#define B0_HOB_PAC_DUR_TSF_FIELD_SFR1_LOW_FIELD_TSF_FIELD_SFR1_LOW_MASK                                           0xFFFFFFFF
//========================================
/* REG_HOB_PAC_DUR_TSF_FIELD_SFR1_HIGH 0x60 */
#define B0_HOB_PAC_DUR_TSF_FIELD_SFR1_HIGH_FIELD_TSF_FIELD_SFR1_HIGH_MASK                                         0xFFFFFFFF
//========================================
/* REG_HOB_PAC_DUR_TSF_FIELD_SFR2_LOW 0x64 */
#define B0_HOB_PAC_DUR_TSF_FIELD_SFR2_LOW_FIELD_TSF_FIELD_SFR2_LOW_MASK                                           0xFFFFFFFF
//========================================
/* REG_HOB_PAC_DUR_TSF_FIELD_SFR2_HIGH 0x68 */
#define B0_HOB_PAC_DUR_TSF_FIELD_SFR2_HIGH_FIELD_TSF_FIELD_SFR2_HIGH_MASK                                         0xFFFFFFFF
//========================================
/* REG_HOB_PAC_DUR_TSF_FIELD_SFR3_LOW 0x6C */
#define B0_HOB_PAC_DUR_TSF_FIELD_SFR3_LOW_FIELD_TSF_FIELD_SFR3_LOW_MASK                                           0xFFFFFFFF
//========================================
/* REG_HOB_PAC_DUR_TSF_FIELD_SFR3_HIGH 0x70 */
#define B0_HOB_PAC_DUR_TSF_FIELD_SFR3_HIGH_FIELD_TSF_FIELD_SFR3_HIGH_MASK                                         0xFFFFFFFF
//========================================
/* REG_HOB_PAC_DUR_TSF_FIELD_SFR4_LOW 0xB0 */
#define B0_HOB_PAC_DUR_TSF_FIELD_SFR4_LOW_FIELD_TSF_FIELD_SFR4_LOW_MASK                                           0xFFFFFFFF
//========================================
/* REG_HOB_PAC_DUR_TSF_FIELD_SFR4_HIGH 0xB4 */
#define B0_HOB_PAC_DUR_TSF_FIELD_SFR4_HIGH_FIELD_TSF_FIELD_SFR4_HIGH_MASK                                         0xFFFFFFFF
//========================================
/* REG_HOB_PAC_DUR_TSF_OFFSET_INDEX 0xB8 */
#define B0_HOB_PAC_DUR_TSF_OFFSET_INDEX_FIELD_TSF_OFFSET_INDEX_MASK                                               0x0000001F
//========================================
/* REG_HOB_PAC_DUR_TSF_FIELD_SFR5_LOW 0xBC */
#define B0_HOB_PAC_DUR_TSF_FIELD_SFR5_LOW_FIELD_TSF_FIELD_SFR5_LOW_MASK                                           0xFFFFFFFF
//========================================
/* REG_HOB_PAC_DUR_TSF_FIELD_SFR5_HIGH 0xC0 */
#define B0_HOB_PAC_DUR_TSF_FIELD_SFR5_HIGH_FIELD_TSF_FIELD_SFR5_HIGH_MASK                                         0xFFFFFFFF
//========================================
/* REG_HOB_PAC_DUR_AUTO_REPLY_BF_REPORT_DUR 0xC4 */
#define B0_HOB_PAC_DUR_AUTO_REPLY_BF_REPORT_DUR_FIELD_AUTO_REPLY_BF_REPORT_DUR_MASK                               0x0000FFFF
//========================================
/* REG_HOB_PAC_DUR_TSF_FIELD_SFR6_LOW 0xC8 */
#define B0_HOB_PAC_DUR_TSF_FIELD_SFR6_LOW_FIELD_TSF_FIELD_SFR6_LOW_MASK                                           0xFFFFFFFF
//========================================
/* REG_HOB_PAC_DUR_TSF_FIELD_SFR6_HIGH 0xCC */
#define B0_HOB_PAC_DUR_TSF_FIELD_SFR6_HIGH_FIELD_TSF_FIELD_SFR6_HIGH_MASK                                         0xFFFFFFFF
//========================================
/* REG_HOB_PAC_DUR_RX_ADDR1_IDX 0x104 */
#define B0_HOB_PAC_DUR_RX_ADDR1_IDX_FIELD_RX_ADDR1_IDX_MASK                                                       0x0000001F
//========================================
/* REG_HOB_PAC_DUR_TX_MPDU_DUR_FIELD 0x108 */
#define B0_HOB_PAC_DUR_TX_MPDU_DUR_FIELD_FIELD_TX_MPDU_DUR_FIELD_MASK                                             0x0000FFFF
//========================================
/* REG_HOB_PAC_DUR_TX_ADDR3_SELECT 0x10C */
#define B0_HOB_PAC_DUR_TX_ADDR3_SELECT_FIELD_TX_ADDR3_SELECT_MASK                                                 0x00000001
//========================================
/* REG_HOB_PAC_DUR_TX_NAV_TIMER_AT_TX_EN_RISE_15BITS 0x110 */
#define B0_HOB_PAC_DUR_TX_NAV_TIMER_AT_TX_EN_RISE_15BITS_FIELD_TX_NAV_TIMER_AT_TX_EN_RISE_15BITS_MASK             0x00007FFF
//========================================
/* REG_HOB_PAC_DUR_AUTO_REPLY_DUR_NO_AIR_TIME_15BITS 0x114 */
#define B0_HOB_PAC_DUR_AUTO_REPLY_DUR_NO_AIR_TIME_15BITS_FIELD_AUTO_REPLY_DUR_NO_AIR_TIME_15BITS_MASK             0x00007FFF
//========================================
/* REG_HOB_PAC_DUR_RX_PHY_STATUS_BUFFER 0x118 */
#define B0_HOB_PAC_DUR_RX_PHY_STATUS_BUFFER_FIELD_RX_PHY_STATUS_BUFFER_ID_MASK                                    0x00000001
#define B0_HOB_PAC_DUR_RX_PHY_STATUS_BUFFER_FIELD_RX_PHY_STATUS_BUFFER_VALID_MASK                                 0x00000002
//========================================
/* REG_HOB_PAC_DUR_AUTO_REPLY_DUR_BF_REPORT_NO_AIR_TIME_15BITS 0x11C */
#define B0_HOB_PAC_DUR_AUTO_REPLY_DUR_BF_REPORT_NO_AIR_TIME_15BITS_FIELD_AUTO_REPLY_DUR_BF_REPORT_NO_AIR_TIME_15BITS_MASK 0x00007FFF
