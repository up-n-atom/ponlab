...
struct rmon_ops {
	...
	/* Command: GSW_RMON_CTP_GET ; Index: 0x0D */
	GSW_return_t (*RMON_CTP_Get)(void *, GSW_RMON_CTP_cnt_t *);
};
...
/*Vlan Counter operations*/
struct vlan_counter_ops {
	/* Command: (NULL); Index: 0x00 */
	GSW_return_t (*null)(void);
	/* Command: GSW_VLAN_COUNTER_MAPPING_SET ; Index: 0x01 */
	GSW_return_t (*GSW_VlanCounterMapSet)(void *, GSW_VlanCounterMapping_config_t *);
	/* Command: GSW_VLAN_COUNTER_MAPPING_GET ; Index: 0x02 */
	GSW_return_t (*GSW_VlanCounterMapGet)(void *, GSW_VlanCounterMapping_config_t *);
	/* Command: GSW_VLAN_RMON_GET ; Index: 0x03 */
	GSW_return_t (*GSW_Vlan_RMON_Get)(void *, GSW_VLAN_RMON_cnt_t *);
	/* Command: GSW_VLAN_RMON_CONTROL_SET ; Index: 0x04 */
	GSW_return_t (*GSW_Vlan_RMONControl_Set)(void *, GSW_VLAN_RMON_control_t *);
	/* Command: GSW_VLAN_RMON_CONTROL_GET ; Index: 0x05 */
	GSW_return_t (*GSW_Vlan_RMONControl_Get)(void *, GSW_VLAN_RMON_control_t *);
	/* Command: GSW_VLAN_RMON_CONTROL_GET ; Index: 0x06 */
	GSW_return_t (*GSW_Vlan_RMON_Clear)(void *, GSW_VLAN_RMON_cnt_t *);
};
...
struct qos_ops {
	...
	/* Command: GSW_QOS_REDUCED_CLASS_SET ; Index: 0x40 */
	GSW_return_t (*QoS_ReducedClassSet)(void *, GSW_QoS_RdTraffic_ClassCfg_t *);
	/* Command: GSW_QOS_REDUCED_CLASS_GET ; Index: 0x41 */
	GSW_return_t (*QoS_ReducedClassGet)(void *, GSW_QoS_RdTraffic_ClassCfg_t *);
};
...
struct debug_ops {
	...
	GSW_return_t (*Macsec)(void *, GSW_MACSec_cfg_t *);
...
struct core_ops {
	...
	/*Vlan rmon counter operation
	  applicable for GSWIP-3.2*/
	struct vlan_counter_ops gsw_vlan_counter_ops;
};
