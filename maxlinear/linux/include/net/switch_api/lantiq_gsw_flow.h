...
/* nInsertionFlag match on no insertion flag */
#define GSW_PCE_INSERT_MATCH_NO_INSERT_FLAG	0
/* nInsertionFlag match on insertion flag */
#define GSW_PCE_INSERT_MATCH_INSERT_FLAG	1
/* nInsertionFlag match on no special tag */
#define GSW_PCE_INSERT_MATCH_NO_STAG		2
