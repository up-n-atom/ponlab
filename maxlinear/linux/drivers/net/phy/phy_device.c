...
int genphy_read_status(struct phy_device *phydev)
{
	...
	/* The link autonegotiation may not be completed by now,
	 * resulting in link speed and duplex not detected correctly.
	 * Continue to monitor the link partner advertisement.
	 */
	#if 0
