...
// LSD Source          : /home/l1502/lgm_chip/v_leichuan.priv.v-dfv.lgm_chip.leichuan/ipg_lsd/lsd_sys/source/xml/reg_files/FSQM.xml
// Register File Name  : FSQM
// Register File Title : On-chip Buffer Manager Register Description
// Register Width      : 32
...
//! \defgroup FSQM Register File FSQM - On-chip Buffer Manager Register Description
//! @{

//! Base Address of ON_CHIP_BUFFER_MANAGER
#define ON_CHIP_BUFFER_MANAGER_MODULE_BASE 0xE6700000u
//! Base Address of ON_CHIP_BUFFER_MANAGER
#define ON_CHIP_BUFFER_MANAGER_MODULE_BASE 0xE6700000u
...
//! Register Offset (absolute) for 1st Instance ON_CHIP_BUFFER_MANAGER
#define ON_CHIP_BUFFER_MANAGER_FSQM_CTRL 0xE6700000u
...
//! Field AD20 - Alloc Disable for master 20
#define FSQM_CTRL_AD20_POS 28
//! Field AD20 - Alloc Disable for master 20
#define FSQM_CTRL_AD20_MASK 0x10000000u
//! Constant NSEL - NSEL
#define CONST_FSQM_CTRL_AD20_NSEL 0x0
//! Constant SEL - SEL
#define CONST_FSQM_CTRL_AD20_SEL 0x1

//! Field AD21 - Alloc Disable for master 21
#define FSQM_CTRL_AD21_POS 29
//! Field AD21 - Alloc Disable for master 21
#define FSQM_CTRL_AD21_MASK 0x20000000u
//! Constant NSEL - NSEL
#define CONST_FSQM_CTRL_AD21_NSEL 0x0
//! Constant SEL - SEL
#define CONST_FSQM_CTRL_AD21_SEL 0x1
...
//! Register Offset (absolute) for 1st Instance ON_CHIP_BUFFER_MANAGER
#define ON_CHIP_BUFFER_MANAGER_IO_BUF_RD 0xE6700008u
...
//! Field BUF_EN - Enable/disable specific IO-Buffer(s)
#define IO_BUF_RD_BUF_EN_MASK 0x3FFFFFu
...
//! Register Offset (absolute) for 1st Instance ON_CHIP_BUFFER_MANAGER
#define ON_CHIP_BUFFER_MANAGER_IO_BUF_WR 0xE670000Cu
...
//! Register Offset (absolute) for 1st Instance ON_CHIP_BUFFER_MANAGER
#define ON_CHIP_BUFFER_MANAGER_FSQM_IRNCR 0xE6700010u
...
//! Register Offset (absolute) for 1st Instance ON_CHIP_BUFFER_MANAGER
#define ON_CHIP_BUFFER_MANAGER_FSQM_IRNICR 0xE6700014u
...
//! Register Offset (absolute) for 1st Instance ON_CHIP_BUFFER_MANAGER
#define ON_CHIP_BUFFER_MANAGER_FSQM_IRNEN 0xE6700018u
...
//! Register Offset (absolute) for 1st Instance ON_CHIP_BUFFER_MANAGER
#define ON_CHIP_BUFFER_MANAGER_TAILCAPR 0xE6700020u
...
#define OFSQ 0x24
//! Register Offset (absolute) for 1st Instance ON_CHIP_BUFFER_MANAGER
#define ON_CHIP_BUFFER_MANAGER_OFSQ 0xE6700024u
...
#define OFSC 0x2C
//! Register Offset (absolute) for 1st Instance ON_CHIP_BUFFER_MANAGER
#define ON_CHIP_BUFFER_MANAGER_OFSC 0xE670002Cu
...
#define FSQT0 0x30
//! Register Offset (absolute) for 1st Instance ON_CHIP_BUFFER_MANAGER
#define ON_CHIP_BUFFER_MANAGER_FSQT0 0xE6700030u
...
#define FSQT1 0x70
//! Register Offset (absolute) for 1st Instance ON_CHIP_BUFFER_MANAGER
#define ON_CHIP_BUFFER_MANAGER_FSQT1 0xE6700070u
...
#define FSQT2 0xB0
//! Register Offset (absolute) for 1st Instance ON_CHIP_BUFFER_MANAGER
#define ON_CHIP_BUFFER_MANAGER_FSQT2 0xE67000B0u
...
#define FSQT3 0xF0
//! Register Offset (absolute) for 1st Instance ON_CHIP_BUFFER_MANAGER
#define ON_CHIP_BUFFER_MANAGER_FSQT3 0xE67000F0u
...
#define FSQT4 0x130
//! Register Offset (absolute) for 1st Instance ON_CHIP_BUFFER_MANAGER
#define ON_CHIP_BUFFER_MANAGER_FSQT4 0xE6700130u
...
#define LSARNG 0x180
//! Register Offset (absolute) for 1st Instance ON_CHIP_BUFFER_MANAGER
#define ON_CHIP_BUFFER_MANAGER_LSARNG 0xE6700180u
...
#define OMQ 0x60000
//! Register Offset (absolute) for 1st Instance ON_CHIP_BUFFER_MANAGER
#define ON_CHIP_BUFFER_MANAGER_OMQ 0xE6760000u
...
#define RCNT 0x80000
//! Register Offset (absolute) for 1st Instance ON_CHIP_BUFFER_MANAGER
#define ON_CHIP_BUFFER_MANAGER_RCNT 0xE6780000u
...
//! Register Offset (absolute) for 1st Instance ON_CHIP_BUFFER_MANAGER
#define ON_CHIP_BUFFER_MANAGER_RCNT_INCDEC 0xE67A0000u
...
#define RAM 0xC0000
//! Register Offset (absolute) for 1st Instance ON_CHIP_BUFFER_MANAGER
#define ON_CHIP_BUFFER_MANAGER_RAM 0xE67C0000u
