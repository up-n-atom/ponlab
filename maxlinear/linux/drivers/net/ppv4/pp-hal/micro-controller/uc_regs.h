...
#include "uc_single_pp_egress_s0_regs.h"
#include "uc_single_pp_egress_s1_regs.h"
#include "uc_single_pp_egress_s2_regs.h"
#include "uc_single_pp_egress_s3_regs.h"
#include "uc_single_pp_ingress_s0_regs.h"
#include "uc_single_pp_ingress_s1_regs.h"
#include "uc_single_pp_ingress_s2_regs.h"
#include "uc_single_pp_ingress_s3_regs.h"
#include "ing_uc_sharedaccl_regs.h"
#include "egr_uc_sharedaccl_regs.h"
#include "egr_uc_dmae_regs.h"
#include "ing_uc_dmae_regs.h"

extern u64 uc_egr_base_addr;
extern u64 uc_ing_base_addr;
extern u64 uc_egr_cpus_addr;
extern u64 uc_ing_cpus_addr;

/* uC Cluster has base address: */
#define EGRESS_UC_BASE  uc_egr_base_addr
#define INGRESS_UC_BASE uc_ing_base_addr
#define UC_EGR_S0_BASE_ADDR uc_egr_cpus_addr
#define UC_ING_S0_BASE_ADDR uc_ing_cpus_addr
#define UC_ING_SHACC_BASE_ADDR (uc_ing_base_addr + 0x300000)
#define UC_EGR_SHACC_BASE_ADDR (uc_egr_base_addr + 0x300000)
...
#define UC_B_EGRESS_CPU_SLEEP_CNT(c) \
	(PP_UC_EGR_S0_MTSR_CPU_SLEEP_CNT_LOW_REG | (c << 18))

#define UC_B_INGRESS_CPU_SLEEP_CNT(c) \
	(PP_UC_ING_S0_MTSR_CPU_SLEEP_CNT_LOW_REG | (c << 18))
