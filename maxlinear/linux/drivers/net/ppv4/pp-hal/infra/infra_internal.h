...
#define INFRA_GET_CRU0_OVERRIDE_EN(r)           PP_FIELD_GET((u32)BIT_ULL(0), r)
#define INFRA_GET_CRU1_OVERRIDE_EN(r)           PP_FIELD_GET((u32)BIT_ULL(1), r)
#define INFRA_GET_CRU2_OVERRIDE_EN(r)           PP_FIELD_GET((u32)BIT_ULL(2), r)
#define INFRA_GET_CRU3_OVERRIDE_EN(r)           PP_FIELD_GET((u32)BIT_ULL(3), r)
#define INFRA_GET_CRU4_OVERRIDE_EN(r)           PP_FIELD_GET((u32)BIT_ULL(4), r)
#define INFRA_GET_CRU5_OVERRIDE_EN(r)           PP_FIELD_GET((u32)BIT_ULL(5), r)
#define INFRA_GET_CRU0_OVERRIDE_VAL(r) PP_FIELD_GET((u32)GENMASK_ULL(21, 20), r)
#define INFRA_GET_CRU1_OVERRIDE_VAL(r) PP_FIELD_GET((u32)GENMASK_ULL(23, 22), r)
#define INFRA_GET_CRU2_OVERRIDE_VAL(r) PP_FIELD_GET((u32)GENMASK_ULL(25, 24), r)
#define INFRA_GET_CRU3_OVERRIDE_VAL(r) PP_FIELD_GET((u32)GENMASK_ULL(27, 26), r)
#define INFRA_GET_CRU4_OVERRIDE_VAL(r) PP_FIELD_GET((u32)GENMASK_ULL(29, 28), r)
#define INFRA_GET_CRU5_OVERRIDE_VAL(r) PP_FIELD_GET((u32)GENMASK_ULL(31, 30), r)
...
#define INFRA_SET_MODULE_CRU_STATE(reg, state) \
	PP_FIELD_MOD(GENMASK_ULL(1, 0), state, reg)
...
#define INFRA_SET_MODULE_CRU_FORCE(reg, en) \
	PP_FIELD_MOD(BIT_ULL(0), en, reg)

#define INFRA_SET_ICG_FORCE_CLCK(r, en)      PP_FIELD_MOD((u32)BIT_ULL(0), en, r)
#define INFRA_SET_CRU0_OVR_EN(r, en)         PP_FIELD_MOD((u32)BIT_ULL(0), en, r)
#define INFRA_SET_CRU1_OVR_EN(r, en)         PP_FIELD_MOD((u32)BIT_ULL(1), en, r)
#define INFRA_SET_CRU2_OVR_EN(r, en)         PP_FIELD_MOD((u32)BIT_ULL(2), en, r)
#define INFRA_SET_CRU3_OVR_EN(r, en)         PP_FIELD_MOD((u32)BIT_ULL(3), en, r)
#define INFRA_SET_CRU4_OVR_EN(r, en)         PP_FIELD_MOD((u32)BIT_ULL(4), en, r)
#define INFRA_SET_CRU5_OVR_EN(r, en)         PP_FIELD_MOD((u32)BIT_ULL(5), en, r)
#define INFRA_SET_CRU0_OVR_VAL(r, v) PP_FIELD_MOD((u32)GENMASK_ULL(21, 20), v, r)
#define INFRA_SET_CRU1_OVR_VAL(r, v) PP_FIELD_MOD((u32)GENMASK_ULL(23, 22), v, r)
#define INFRA_SET_CRU2_OVR_VAL(r, v) PP_FIELD_MOD((u32)GENMASK_ULL(25, 24), v, r)
#define INFRA_SET_CRU3_OVR_VAL(r, v) PP_FIELD_MOD((u32)GENMASK_ULL(27, 26), v, r)
#define INFRA_SET_CRU4_OVR_VAL(r, v) PP_FIELD_MOD((u32)GENMASK_ULL(29, 28), v, r)
#define INFRA_SET_CRU5_OVR_VAL(r, v) PP_FIELD_MOD((u32)GENMASK_ULL(31, 30), v, r)

#define SRVICE_LOG_SEQ_ID_MSK         GENMASK_ULL(4, 0)
#define SRVICE_LOG_SUBRANGE_MSK       GENMASK_ULL(8, 5)
#define SRVICE_LOG_TARGET_FLOW_MSK    GENMASK_ULL(13, 9)
#define SRVICE_LOG_INIT_FLOW_MSK      GENMASK_ULL(17, 14)

/**
 * Get the base addres to specific module
 */
#define SERVICE_LOG_BASE_ADDR(m) \
	((m) == SERVICE_INGA ? service_log_inga_base_addr : \
	 (m) == SERVICE_INGB ? service_log_ingb_base_addr : \
	 (m) == SERVICE_QOS  ? service_log_qos_base_addr  : \
	 0)

#define SERVICE_LOG_IS_EN_ADDR(m)   (SERVICE_LOG_BASE_ADDR(m) + 0x0008)
#define SERVICE_LOG_IS_ERR_ADDR(m)  (SERVICE_LOG_BASE_ADDR(m) + 0x000c)
#define SERVICE_LOG_ERR_CLR_ADDR(m) (SERVICE_LOG_BASE_ADDR(m) + 0x0010)
#define SERVICE_LOG_ERR_LOG_ADDR(m) (SERVICE_LOG_BASE_ADDR(m) + 0x0018)
...
/**
 * @brief if service log is valid return true, false otherwise
 * @param srvs_log
 */
bool is_service_log_valid(enum service_log srvs_log);
