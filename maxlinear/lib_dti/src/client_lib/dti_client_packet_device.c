                        ...
                        IFX_uint32_t   mask)
{
   ...
   pPayloadSend = (DTI_H2D_DeviceReset_t *)pDtiPacketSend->payload;
                        ...
                        IFX_uint32_t   loadMask)
{
   ...
   pPayloadSend    = (DTI_H2D_DeviceDownload_t *)pDtiPacketSend->payload;
   (void)DTI_headerPacketTypeSet(
                        pDtiPacketSend,
                        ...
                        IFX_uint_t     lockOnOff)
{
   ...
   pPayloadSend = (DTI_H2D_DeviceLock_t *)pDtiPacketSend->payload;
   (void)DTI_headerPacketTypeSet(
                        pDtiPacketSend,
                        ...
                        IFX_uint_t     regCount)
{
   ...
   pPayloadSend = (DTI_H2D_RegisterGet_t *)pDtiPacketSend->payload;
   (void)DTI_headerPacketTypeSet(
                        pDtiPacketSend,
                        ...
                        IFX_uint_t     regCount_32)
{
   ...
   pPayloadSend = (DTI_H2D_RegisterSet_t *)pDtiPacketSend->payload;
   regCount_32 = 1;
   (void)DTI_headerPacketTypeSet(
                        pDtiPacketSend,
                        ...
                        IFX_uint32_t   keyValue)
{
   ...
   pPayloadSend = (DTI_H2D_DeviceConfigSet_t *)pDtiPacketSend->payload;
   (void)DTI_headerPacketTypeSet(
                        pDtiPacketSend,
                        ...
                        IFX_uint32_t   key)
{
   ...
   pPayloadSend = (DTI_H2D_DeviceConfigGet_t *)pDtiPacketSend->payload;
   (void)DTI_headerPacketTypeSet(
                        pDtiPacketSend,
                        ...
                        IFX_uint_t     usrMsgDataSize_byte)
{
   ...
   uPayloadSend.pMsg32  = (DTI_H2D_vnxMessage32_t *)pDtiPacketSend->payload;
                        ...
                        IFX_uint_t     usrMsgDataSize_byte)
{
   ...
   uPayloadSend.pMsg16  = (DTI_H2D_gmxMessage16_t *)pDtiPacketSend->payload;
   (void)DTI_headerPacketTypeSet(
                  pDtiPacketSend,
                  (IFX_uint32_t)DTI_PacketType_eMessageSend,
                  (IFX_uint32_t)DTI_e16Bit,
                        ...
                        IFX_uint_t     usrMsgDataSize_byte)
{
   ...
   uPayloadSend.pMsg32  = (DTI_H2D_rawMessage32_t *)pDtiPacketSend->payload;
   switch(payloadType)
   {
      case DTI_eMixed:
      case DTI_e8Bit:
                        ...
                        IFX_uint32_t   nfcThreshold)
{
   ...
   pPayloadSend = (DTI_H2D_TraceConfigSet_t *)pDtiPacketSend->payload;
   (void)DTI_headerPacketTypeSet(
                        pDtiPacketSend,
                        ...
                        IFX_uint32_t   readSize_byte)
{
   ...
   pPayloadSend = (DTI_H2D_TraceBufferGet_t *)pDtiPacketSend->payload;
   (void)DTI_headerPacketTypeSet(
                        pDtiPacketSend,
                        ...
                        IFX_uint_t     count_32)
{
   ...
   pPayloadSend = (DTI_H2D_DebugRead_t *)pDtiPacketSend->payload;
   (void)DTI_headerPacketTypeSet(
                        pDtiPacketSend,
                        ...
                        IFX_uint_t     count_32)
{
   ...
   pPayloadSend = (DTI_H2D_DebugWrite_t *)pDtiPacketSend->payload;
