...
extern const DTI_cliConfigKeyword_t DTI_cliControlGroupEntries[];
extern const DTI_cliConfigKeyword_t DTI_cliControlGrConfigEntries[];
extern const DTI_cliConfigKeyword_t DTI_cliControlGrDeviceEntries[];
extern const DTI_cliConfigKeyword_t DTI_cliControlGrCliEntries[];
