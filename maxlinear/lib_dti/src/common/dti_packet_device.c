                        ...
                        IFX_uint32_t            bufferOutSize)
{
   ...
   {
      pDataIn = (DTI_H2D_DeviceReset_t *)pDtiPacketIn->payload;
      pDataOut = (DTI_D2H_DeviceReset_t *)pDtiPacketOut->payload;
                        ...
                        IFX_uint32_t            bufferOutSize)
{
   ...
   {
      pDataIn = (DTI_H2D_DeviceDownload_t *)pDtiPacketIn->payload;
      pDataOut = (DTI_D2H_DeviceDownload_t *)pDtiPacketOut->payload;
                        ...
                        IFX_uint32_t            bufferOutSize)
{
   ...
   {
      pDataIn = (DTI_H2D_DeviceLock_t *)pDtiPacketIn->payload;
      pDataOut = (DTI_D2H_DeviceLock_t *)pDtiPacketOut->payload;
                        ...
                        IFX_uint32_t            bufferOutSize)
{
   ...
   {
      pDataIn = (DTI_H2D_RegisterGet_t *)pDtiPacketIn->payload;
      pDataOut = (DTI_D2H_RegisterGet_t *)pDtiPacketOut->payload;
                        ...
                        IFX_uint32_t            bufferOutSize)
{
   ...
   {
      pDataIn = (DTI_H2D_RegisterSet_t *)pDtiPacketIn->payload;
                        ...
                        IFX_uint32_t            bufferOutSize)
{
   ...
   {
      pDataIn = (DTI_H2D_DeviceConfigSet_t *)pDtiPacketIn->payload;
      pDataOut = (DTI_D2H_DeviceConfigSet_t *)pDtiPacketOut->payload;
                        ...
                        IFX_uint32_t            bufferOutSize)
{
   ...
   {
      pDataIn = (DTI_H2D_DeviceConfigGet_t *)pDtiPacketIn->payload;
      pDataOut = (DTI_D2H_DeviceConfigGet_t *)pDtiPacketOut->payload;
      ...
      case DTI_e8Bit:
         {
            ...
            {
               pDataIn8        = (DTI_H2D_Message8_u *)pDtiPacketIn->payload;
               pDataOut8       = (DTI_D2H_Message8_u *)pDtiPacketOut->payload;
         ...
         case DTI_e16Bit:
         {
            ...
            {
               pDataIn16       = (DTI_H2D_Message16_u *)pDtiPacketIn->payload;
               pDataOut16      = (DTI_D2H_Message16_u *)pDtiPacketOut->payload;
      ...
      case DTI_e32Bit:
         {
            ...
            {
               pDataIn32       = (DTI_H2D_Message32_u *)pDtiPacketIn->payload;
               pDataOut32      = (DTI_D2H_Message32_u *)pDtiPacketOut->payload;
                        ...
                        IFX_uint32_t            bufferOutSize)
{
   ...
   {
      pDataIn = (DTI_H2D_TraceConfigSet_t *)pDtiPacketIn->payload;
      pDataOut = (DTI_D2H_TraceConfigSet_t *)pDtiPacketOut->payload;
                        ...
                        IFX_uint32_t            bufferOutSize)
{
   ...
   {
      pDataOut = (DTI_D2H_TraceStatusGet_t *)pDtiPacketOut->payload;
                        ...
                        IFX_uint32_t            *pBufferOutSize)
{
   ...
   {
      pDataIn = (DTI_H2D_TraceBufferGet_t *)pDtiPacketIn->payload;
      /* Note:
                        ...
                        IFX_uint32_t            bufferOutSize)
{
   ...
   {
      pDataIn = (DTI_H2D_DebugRead_t *)pDtiPacketIn->payload;
      pDataOut = (DTI_D2H_DebugRead_t *)pDtiPacketOut->payload;
                        ...
                        IFX_uint32_t            bufferOutSize)
{
   ...
   {
      pDataIn = (DTI_H2D_DebugWrite_t *)pDtiPacketIn->payload;
