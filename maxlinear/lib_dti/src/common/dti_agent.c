...
#  endif
   ...
   DTI_PRN_USR_ERR_NL(DTI_PROTOCOL, DTI_PRN_LEVEL_ERR,
      ("Info: PRN_USR_ERR - DTI_PROTOCOL::LEVEL_ERR" DTI_CRLF));
   DTI_PRN_USR_DBG_NL(DTI_PROTOCOL, DTI_PRN_LEVEL_HIGH,
      ("Info: PRN_USR_DBG - DTI_PROTOCOL::LEVEL_HIGH" DTI_CRLF));
   DTI_PRN_USR_DBG_NL(DTI_PROTOCOL, DTI_PRN_LEVEL_LOW,
      ("Info: PRN_USR_DBG - DTI_PROTOCOL::LEVEL_LOW" DTI_CRLF));

   DTI_PRN_USR_ERR_NL(DTI_CON, DTI_PRN_LEVEL_ERR,
      ("Info: PRN_USR_ERR - DTI_CON::LEVEL_ERR" DTI_CRLF));
   DTI_PRN_USR_DBG_NL(DTI_CON, DTI_PRN_LEVEL_HIGH,
      ("Info: PRN_USR_DBG - DTI_CON::LEVEL_HIGH" DTI_CRLF));
   DTI_PRN_USR_DBG_NL(DTI_CON, DTI_PRN_LEVEL_LOW,
      ("Info: PRN_USR_DBG - DTI_CON::LEVEL_LOW" DTI_CRLF));

   DTI_PRN_USR_ERR_NL(DTI_DBG, DTI_PRN_LEVEL_ERR,
      ("Info: PRN_USR_ERR - DTI_DBG::LEVEL_ERR" DTI_CRLF));
   DTI_PRN_USR_DBG_NL(DTI_DBG, DTI_PRN_LEVEL_HIGH,
      ("Info: PRN_USR_DBG - DTI_DBG::LEVEL_HIGH" DTI_CRLF));
   DTI_PRN_USR_DBG_NL(DTI_DBG, DTI_PRN_LEVEL_LOW,
      ("Info: PRN_USR_DBG - DTI_DBG::LEVEL_LOW" DTI_CRLF));

   DTI_PRN_USR_ERR_NL(DTI_DEV, DTI_PRN_LEVEL_ERR,
      ("Info: PRN_USR_ERR - DTI_DEV::LEVEL_ERR" DTI_CRLF));
   DTI_PRN_USR_DBG_NL(DTI_DEV, DTI_PRN_LEVEL_HIGH,
      ("Info: PRN_USR_DBG - DTI_DEV::LEVEL_HIGH" DTI_CRLF));
   DTI_PRN_USR_DBG_NL(DTI_DEV, DTI_PRN_LEVEL_LOW,
      ("Info: PRN_USR_DBG - DTI_DEV::LEVEL_LOW" DTI_CRLF));

#  if defined(INCLUDE_CLI_SUPPORT) && (INCLUDE_CLI_SUPPORT == 1)
   DTI_PRN_USR_ERR_NL(DTI_CLI, DTI_PRN_LEVEL_ERR,
      ("Info: PRN_USR_ERR - DTI_CLI::LEVEL_ERR" DTI_CRLF));
   DTI_PRN_USR_DBG_NL(DTI_CLI, DTI_PRN_LEVEL_HIGH,
      ("Info: PRN_USR_DBG - DTI_CLI::LEVEL_HIGH" DTI_CRLF));
   DTI_PRN_USR_DBG_NL(DTI_CLI, DTI_PRN_LEVEL_LOW,
      ("Info: PRN_USR_DBG - DTI_CLI::LEVEL_LOW" DTI_CRLF));
#endif
#endif
