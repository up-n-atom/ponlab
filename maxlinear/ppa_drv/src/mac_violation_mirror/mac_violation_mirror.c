...
static struct dentry *dbgfs_ppa_macv;
...
static const struct file_operations dbgfs_file_mac_threshold_seq_fops = {
	.owner		= THIS_MODULE,
...
static const struct file_operations dbgfs_file_mac_ports_seq_fops = {
	.owner		= THIS_MODULE,
...
static struct ppa_debugfs_files macv_debugfs_files[] = {
	{ "violation_hit_ports",      0600, &dbgfs_file_mac_ports_seq_fops },
	{ "violation_threshold_time", 0600, &dbgfs_file_mac_threshold_seq_fops },
};

static void mac_violation_mirror_debugfs_create(void)
{
	ppa_debugfs_create(ppa_debugfs_dir_get(), "mac_violation",
		&dbgfs_ppa_macv, macv_debugfs_files,
		ARRAY_SIZE(macv_debugfs_files));
}

static void mac_violation_mirror_debugfs_remove(void)
{
	ppa_debugfs_remove(dbgfs_ppa_macv,
		macv_debugfs_files,
		ARRAY_SIZE(macv_debugfs_files));
}
...
static int __init mac_violation_port_mirror_init(void)
{
	...
	mac_violation_mirror_debugfs_create();
...
{
	mac_violation_mirror_debugfs_remove();
