...
#define MAX_GSWL_PORTS	6
#define MAX_SUBIF_IDS	16

#define REG_PCE_CTRL3_BASE			0x48D /* PCE_PCTRL3 register address for port 1 */
...
#define GSWR_CAT_INGQOS_START	32
#define GSWR_CAT_INGQOS_MAX	GSWR_PCE_MAX / 4 // max 64 when GSWR_PCE_MAX is 256

#define GSWR_CAT_VLAN_START	48
#define GSWR_CAT_VLAN_MAX	GSWR_PCE_MAX / 8 // max 32 when GSWR_PCE_MAX is 256
#define GSWL_CAT_VLAN_START	8
#define GSWL_CAT_VLAN_MAX	GSWL_PCE_MAX / 4  // max 16

#define GSWR_CAT_FWD_START	96
...
#define GSWR_CAT_USQOS_START	128
...
#define GSWR_CAT_DSQOS_START	128
