...
static struct dentry *dbgfs_tmu;
...
static const struct file_operations dbgfs_file_queue_info_seq_fops = {
	.owner		= THIS_MODULE,
...
static const struct file_operations dbgfs_file_tc_map_seq_fops = {
	.owner		= THIS_MODULE,
...
static const struct file_operations dbgfs_file_queue_map_seq_fops = {
	.owner		= THIS_MODULE,
...
static const struct file_operations dbgfs_file_tc_group_seq_fops = {
	.owner		= THIS_MODULE,
...
static struct ppa_debugfs_files tmu_hal_debugfs_files[] = {
	{ "queue_info", 0600, &dbgfs_file_queue_info_seq_fops },
	{ "dbg",        0600, &dbgfs_file_dbg_seq_fops },
	{ "tc_map",     0600, &dbgfs_file_tc_map_seq_fops },
	{ "queue_map",  0600, &dbgfs_file_queue_map_seq_fops },
	{ "tc_group",   0600, &dbgfs_file_tc_group_seq_fops },
};

int tmu_hal_debugfs_create(void)
{
	TMU_HAL_DEBUG_MSG(TMU_DEBUG_ERR,"TMU HAL Create Proc entries \n");
	ppa_debugfs_create(ppa_hal_debugfs_dir_get(), "tmu",
		&dbgfs_tmu, tmu_hal_debugfs_files,
		ARRAY_SIZE(tmu_hal_debugfs_files));
...
{
	ppa_debugfs_remove(dbgfs_tmu,
		tmu_hal_debugfs_files,
		ARRAY_SIZE(tmu_hal_debugfs_files));
}
MODULE_LICENSE("GPL");
