...
struct tc_cb_ops {
	/* NOTE: rx cb unused, host rxout ring is used to receive frame */
	cb_tc_recv_atm_frame rx_atm_frame_cb;
	/* NOTE: free cb unused, host txout ring is used to free host buffer */
	...
	int (*cb_tc_decap_rx_frame)(struct atm_aal5_t *atm_rx_pkt);
	int (*cb_tc_encap_tx_frame)(struct atm_aal5_t *atm_tx_pkt);
