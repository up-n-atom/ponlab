...
SET DUT_SKIP_INCREASE_REVISION=1 & SET DUT_SKIP_DEBUG_BUILD=1 & SET DUT_SKIP_CPPCHECK=1 & SET DUT_SKIP_UNIT_TESTS=1 & SET DUT_SKIP_UPDATE_VERSION=1 & SET DUT_SKIP_RELEASE_BUILD=1 & SET DUT_SKIP_CREATE_INSTALLER=1 & SET DUT_SKIP_UPDATE_RELEASE_NOTES=1 & release.bat %1
