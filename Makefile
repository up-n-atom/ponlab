...
CFLAGS += -Wno-error=declaration-after-statement -Wno-error=type-limits
CFLAGS += $(CFLAGS_EVAL)
CFLAGS += $(EXTRA_CFLAGS)
...
override LIBS += -lnl-genl-3 -lnl-3
NLLIBNAME = libnl-3.0
endif

ifeq ($(NL3FOUND),Y)
override CFLAGS += -DCONFIG_LIBNL30
override LIBS += -lnl-genl -lnl-3
NLLIBNAME = libnl-3.0
endif
...
override CFLAGS += $(shell $(PKG_CONFIG) --cflags $(NLLIBNAME)) $(IFX_CFLAGS)
LDFLAGS = $(IFX_LDFLAGS)
endif # NO_PKG_CONFIG
