...
static rtlog_info_app_entry_t rtlog_info_app_array[] =
{
  ...
  {IWLWAV_RTLOG_APP_NAME_RCVRYMONITOR, IWLWAV_RTLOG_APPGROUP_OID_MTTOOLS, {IWLWAV_RTLOG_APP_PID_INVALID}},
...
int rtlog_cfg_line_parse(char *line)
{
    ...
    argc = line_split(line, argv, ARRAY_SIZE(argv));
    if (0 == argc)
        return 0;
