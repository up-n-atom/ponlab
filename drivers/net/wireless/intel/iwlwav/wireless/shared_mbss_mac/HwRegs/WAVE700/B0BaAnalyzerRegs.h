...
************************************************************************************/
#ifndef _B0_BA_ANALYZER_REGS_H_
#define _B0_BA_ANALYZER_REGS_H_
...
#define B0_BA_ANALYZER_BASE_ADDRESS                             MEMORY_MAP_UNIT_45_BASE_ADDRESS
#define	REG_B0_BA_ANALYZER_MODE                                       (B0_BA_ANALYZER_BASE_ADDRESS + 0x0)
#define	REG_B0_BA_ANALYZER_INT_ERROR_STATUS                           (B0_BA_ANALYZER_BASE_ADDRESS + 0x4)
#define	REG_B0_BA_ANALYZER_INT_ERROR_EN                               (B0_BA_ANALYZER_BASE_ADDRESS + 0x8)
#define	REG_B0_BA_ANALYZER_CLEAR_INT_ERROR                            (B0_BA_ANALYZER_BASE_ADDRESS + 0xC)
#define	REG_B0_BA_ANALYZER_INT_STATUS                                 (B0_BA_ANALYZER_BASE_ADDRESS + 0x10)
#define	REG_B0_BA_ANALYZER_INT_EN                                     (B0_BA_ANALYZER_BASE_ADDRESS + 0x14)
#define	REG_B0_BA_ANALYZER_CLEAR_INT                                  (B0_BA_ANALYZER_BASE_ADDRESS + 0x18)
#define	REG_B0_BA_ANALYZER_SENDER_REG                                 (B0_BA_ANALYZER_BASE_ADDRESS + 0x1C)
#define	REG_B0_BA_ANALYZER_SENDER_REG_SEL                             (B0_BA_ANALYZER_BASE_ADDRESS + 0x20)
#define	REG_B0_BA_ANALYZER_DPL_IDX                                    (B0_BA_ANALYZER_BASE_ADDRESS + 0x24)
#define	REG_B0_BA_ANALYZER_TXH_PSDU_LENGHT_THR                        (B0_BA_ANALYZER_BASE_ADDRESS + 0x28)
#define	REG_B0_BA_ANALYZER_SENDER_TX_STATUS_WORD0                     (B0_BA_ANALYZER_BASE_ADDRESS + 0x2C)
#define	REG_B0_BA_ANALYZER_SENDER_TX_STATUS_WORD1                     (B0_BA_ANALYZER_BASE_ADDRESS + 0x30)
#define	REG_B0_BA_ANALYZER_SENDER_RA_COMMON_REPORT_WORD0              (B0_BA_ANALYZER_BASE_ADDRESS + 0x34)
#define	REG_B0_BA_ANALYZER_SENDER_RA_COMMON_REPORT_WORD1              (B0_BA_ANALYZER_BASE_ADDRESS + 0x38)
#define	REG_B0_BA_ANALYZER_BA_ANALYZER_COUNTERS_EN                    (B0_BA_ANALYZER_BASE_ADDRESS + 0x3C)
#define	REG_B0_BA_ANALYZER_MBA_CFG                                    (B0_BA_ANALYZER_BASE_ADDRESS + 0x40)
#define	REG_B0_BA_ANALYZER_CBA_CFG                                    (B0_BA_ANALYZER_BASE_ADDRESS + 0x44)
#define	REG_B0_BA_ANALYZER_TRAFFIC_IND_CFG                            (B0_BA_ANALYZER_BASE_ADDRESS + 0x48)
#define	REG_B0_BA_ANALYZER_CLR_LOCK_PD_TYPE_BITMAP                    (B0_BA_ANALYZER_BASE_ADDRESS + 0x4C)
#define	REG_B0_BA_ANALYZER_EN_SSN_ALIGN_PD_TYPE_BITMAP                (B0_BA_ANALYZER_BASE_ADDRESS + 0x50)
#define	REG_B0_BA_ANALYZER_STS_REPORT_FIFO_BASE_ADDR                  (B0_BA_ANALYZER_BASE_ADDRESS + 0x54)
#define	REG_B0_BA_ANALYZER_STS_REPORT_FIFO_DEPTH_MINUS_ONE            (B0_BA_ANALYZER_BASE_ADDRESS + 0x58)
#define	REG_B0_BA_ANALYZER_STS_REPORT_FIFO_CLEAR_STRB                 (B0_BA_ANALYZER_BASE_ADDRESS + 0x5C)
#define	REG_B0_BA_ANALYZER_STS_REPORT_FIFO_RD_ENTRIES_NUM             (B0_BA_ANALYZER_BASE_ADDRESS + 0x60)
#define	REG_B0_BA_ANALYZER_STS_REPORT_FIFO_NUM_ENTRIES_COUNT          (B0_BA_ANALYZER_BASE_ADDRESS + 0x64)
#define	REG_B0_BA_ANALYZER_STS_REPORT_FIFO_DEBUG                      (B0_BA_ANALYZER_BASE_ADDRESS + 0x68)
#define	REG_B0_BA_ANALYZER_RA_COMMON_REPORT_FIFO_BASE_ADDR            (B0_BA_ANALYZER_BASE_ADDRESS + 0x6C)
#define	REG_B0_BA_ANALYZER_RA_COMMON_REPORT_FIFO_DEPTH_MINUS_ONE      (B0_BA_ANALYZER_BASE_ADDRESS + 0x70)
#define	REG_B0_BA_ANALYZER_RA_COMMON_REPORT_FIFO_CLEAR_STRB           (B0_BA_ANALYZER_BASE_ADDRESS + 0x74)
#define	REG_B0_BA_ANALYZER_RA_COMMON_REPORT_FIFO_RD_ENTRIES_NUM       (B0_BA_ANALYZER_BASE_ADDRESS + 0x78)
#define	REG_B0_BA_ANALYZER_RA_COMMON_REPORT_FIFO_NUM_ENTRIES_COUNT    (B0_BA_ANALYZER_BASE_ADDRESS + 0x7C)
#define	REG_B0_BA_ANALYZER_RA_COMMON_REPORT_FIFO_DEBUG                (B0_BA_ANALYZER_BASE_ADDRESS + 0x80)
#define	REG_B0_BA_ANALYZER_RA_USER_REPORT_FIFO_BASE_ADDR              (B0_BA_ANALYZER_BASE_ADDRESS + 0x84)
#define	REG_B0_BA_ANALYZER_RA_USER_REPORT_FIFO_DEPTH_MINUS_ONE        (B0_BA_ANALYZER_BASE_ADDRESS + 0x88)
#define	REG_B0_BA_ANALYZER_RA_USER_REPORT_FIFO_CLEAR_STRB             (B0_BA_ANALYZER_BASE_ADDRESS + 0x8C)
#define	REG_B0_BA_ANALYZER_RA_USER_REPORT_FIFO_RD_ENTRIES_NUM         (B0_BA_ANALYZER_BASE_ADDRESS + 0x90)
#define	REG_B0_BA_ANALYZER_RA_USER_REPORT_FIFO_NUM_ENTRIES_COUNT      (B0_BA_ANALYZER_BASE_ADDRESS + 0x94)
#define	REG_B0_BA_ANALYZER_RA_USER_REPORT_FIFO_DEBUG0                 (B0_BA_ANALYZER_BASE_ADDRESS + 0x98)
#define	REG_B0_BA_ANALYZER_RA_USER_REPORT_FIFO_DEBUG1                 (B0_BA_ANALYZER_BASE_ADDRESS + 0x9C)
#define	REG_B0_BA_ANALYZER_RTS_CFG                                    (B0_BA_ANALYZER_BASE_ADDRESS + 0xA0)
#define	REG_B0_BA_ANALYZER_ETH_TYPE_OVERHEAD                          (B0_BA_ANALYZER_BASE_ADDRESS + 0xA4)
#define	REG_B0_BA_ANALYZER_STA_MODE_CFG0                              (B0_BA_ANALYZER_BASE_ADDRESS + 0xA8)
#define	REG_B0_BA_ANALYZER_STA_MODE_CFG1                              (B0_BA_ANALYZER_BASE_ADDRESS + 0xAC)
#define	REG_B0_BA_ANALYZER_FIFO_STATUS0                               (B0_BA_ANALYZER_BASE_ADDRESS + 0xB0)
#define	REG_B0_BA_ANALYZER_FIFO_STATUS1                               (B0_BA_ANALYZER_BASE_ADDRESS + 0xB4)
#define	REG_B0_BA_ANALYZER_FSM_STATUS0                                (B0_BA_ANALYZER_BASE_ADDRESS + 0xB8)
#define	REG_B0_BA_ANALYZER_FSM_STATUS1                                (B0_BA_ANALYZER_BASE_ADDRESS + 0xBC)
#define	REG_B0_BA_ANALYZER_LOGGER_REG                                 (B0_BA_ANALYZER_BASE_ADDRESS + 0xC0)
#define	REG_B0_BA_ANALYZER_LOGGER_FILTER0                             (B0_BA_ANALYZER_BASE_ADDRESS + 0xC4)
#define	REG_B0_BA_ANALYZER_LOGGER_FILTER1                             (B0_BA_ANALYZER_BASE_ADDRESS + 0xC8)
#define	REG_B0_BA_ANALYZER_LOGGER_STATISTICS_REG                      (B0_BA_ANALYZER_BASE_ADDRESS + 0xCC)
#define	REG_B0_BA_ANALYZER_CALC_CNT_SET_TO_ZERO_STATUS                (B0_BA_ANALYZER_BASE_ADDRESS + 0xD0)
#define	REG_B0_BA_ANALYZER_BA_ANALYZER_SPARE                          (B0_BA_ANALYZER_BASE_ADDRESS + 0xE0)
/*---------------------------------------------------------------------------------
/						Data Type Definition										
/----------------------------------------------------------------------------------*/
/*REG_B0_BA_ANALYZER_MODE 0x0 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerMode_u;

/*REG_B0_BA_ANALYZER_INT_ERROR_STATUS 0x4 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerIntErrorStatus_u;

/*REG_B0_BA_ANALYZER_INT_ERROR_EN 0x8 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerIntErrorEn_u;

/*REG_B0_BA_ANALYZER_CLEAR_INT_ERROR 0xC */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerClearIntError_u;

/*REG_B0_BA_ANALYZER_INT_STATUS 0x10 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerIntStatus_u;

/*REG_B0_BA_ANALYZER_INT_EN 0x14 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerIntEn_u;

/*REG_B0_BA_ANALYZER_CLEAR_INT 0x18 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerClearInt_u;

/*REG_B0_BA_ANALYZER_SENDER_REG 0x1C */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerSenderReg_u;

/*REG_B0_BA_ANALYZER_SENDER_REG_SEL 0x20 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerSenderRegSel_u;

/*REG_B0_BA_ANALYZER_DPL_IDX 0x24 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerDplIdx_u;

/*REG_B0_BA_ANALYZER_TXH_PSDU_LENGHT_THR 0x28 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerTxhPsduLenghtThr_u;

/*REG_B0_BA_ANALYZER_SENDER_TX_STATUS_WORD0 0x2C */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerSenderTxStatusWord0_u;

/*REG_B0_BA_ANALYZER_SENDER_TX_STATUS_WORD1 0x30 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerSenderTxStatusWord1_u;

/*REG_B0_BA_ANALYZER_SENDER_RA_COMMON_REPORT_WORD0 0x34 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerSenderRaCommonReportWord0_u;

/*REG_B0_BA_ANALYZER_SENDER_RA_COMMON_REPORT_WORD1 0x38 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerSenderRaCommonReportWord1_u;

/*REG_B0_BA_ANALYZER_BA_ANALYZER_COUNTERS_EN 0x3C */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerBaAnalyzerCountersEn_u;

/*REG_B0_BA_ANALYZER_MBA_CFG 0x40 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerMbaCfg_u;

/*REG_B0_BA_ANALYZER_CBA_CFG 0x44 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerCbaCfg_u;

/*REG_B0_BA_ANALYZER_TRAFFIC_IND_CFG 0x48 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerTrafficIndCfg_u;

/*REG_B0_BA_ANALYZER_CLR_LOCK_PD_TYPE_BITMAP 0x4C */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerClrLockPdTypeBitmap_u;

/*REG_B0_BA_ANALYZER_EN_SSN_ALIGN_PD_TYPE_BITMAP 0x50 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerEnSsnAlignPdTypeBitmap_u;

/*REG_B0_BA_ANALYZER_STS_REPORT_FIFO_BASE_ADDR 0x54 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerStsReportFifoBaseAddr_u;

/*REG_B0_BA_ANALYZER_STS_REPORT_FIFO_DEPTH_MINUS_ONE 0x58 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerStsReportFifoDepthMinusOne_u;

/*REG_B0_BA_ANALYZER_STS_REPORT_FIFO_CLEAR_STRB 0x5C */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerStsReportFifoClearStrb_u;

/*REG_B0_BA_ANALYZER_STS_REPORT_FIFO_RD_ENTRIES_NUM 0x60 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerStsReportFifoRdEntriesNum_u;

/*REG_B0_BA_ANALYZER_STS_REPORT_FIFO_NUM_ENTRIES_COUNT 0x64 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerStsReportFifoNumEntriesCount_u;

/*REG_B0_BA_ANALYZER_STS_REPORT_FIFO_DEBUG 0x68 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerStsReportFifoDebug_u;

/*REG_B0_BA_ANALYZER_RA_COMMON_REPORT_FIFO_BASE_ADDR 0x6C */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerRaCommonReportFifoBaseAddr_u;

/*REG_B0_BA_ANALYZER_RA_COMMON_REPORT_FIFO_DEPTH_MINUS_ONE 0x70 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerRaCommonReportFifoDepthMinusOne_u;

/*REG_B0_BA_ANALYZER_RA_COMMON_REPORT_FIFO_CLEAR_STRB 0x74 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerRaCommonReportFifoClearStrb_u;

/*REG_B0_BA_ANALYZER_RA_COMMON_REPORT_FIFO_RD_ENTRIES_NUM 0x78 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerRaCommonReportFifoRdEntriesNum_u;

/*REG_B0_BA_ANALYZER_RA_COMMON_REPORT_FIFO_NUM_ENTRIES_COUNT 0x7C */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerRaCommonReportFifoNumEntriesCount_u;

/*REG_B0_BA_ANALYZER_RA_COMMON_REPORT_FIFO_DEBUG 0x80 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerRaCommonReportFifoDebug_u;

/*REG_B0_BA_ANALYZER_RA_USER_REPORT_FIFO_BASE_ADDR 0x84 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerRaUserReportFifoBaseAddr_u;

/*REG_B0_BA_ANALYZER_RA_USER_REPORT_FIFO_DEPTH_MINUS_ONE 0x88 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerRaUserReportFifoDepthMinusOne_u;

/*REG_B0_BA_ANALYZER_RA_USER_REPORT_FIFO_CLEAR_STRB 0x8C */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerRaUserReportFifoClearStrb_u;

/*REG_B0_BA_ANALYZER_RA_USER_REPORT_FIFO_RD_ENTRIES_NUM 0x90 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerRaUserReportFifoRdEntriesNum_u;

/*REG_B0_BA_ANALYZER_RA_USER_REPORT_FIFO_NUM_ENTRIES_COUNT 0x94 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerRaUserReportFifoNumEntriesCount_u;

/*REG_B0_BA_ANALYZER_RA_USER_REPORT_FIFO_DEBUG0 0x98 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerRaUserReportFifoDebug0_u;

/*REG_B0_BA_ANALYZER_RA_USER_REPORT_FIFO_DEBUG1 0x9C */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerRaUserReportFifoDebug1_u;

/*REG_B0_BA_ANALYZER_RTS_CFG 0xA0 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerRtsCfg_u;

/*REG_B0_BA_ANALYZER_ETH_TYPE_OVERHEAD 0xA4 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerEthTypeOverhead_u;

/*REG_B0_BA_ANALYZER_STA_MODE_CFG0 0xA8 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerStaModeCfg0_u;

/*REG_B0_BA_ANALYZER_STA_MODE_CFG1 0xAC */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerStaModeCfg1_u;

/*REG_B0_BA_ANALYZER_FIFO_STATUS0 0xB0 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerFifoStatus0_u;

/*REG_B0_BA_ANALYZER_FIFO_STATUS1 0xB4 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerFifoStatus1_u;

/*REG_B0_BA_ANALYZER_FSM_STATUS0 0xB8 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerFsmStatus0_u;

/*REG_B0_BA_ANALYZER_FSM_STATUS1 0xBC */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerFsmStatus1_u;

/*REG_B0_BA_ANALYZER_LOGGER_REG 0xC0 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerLoggerReg_u;

/*REG_B0_BA_ANALYZER_LOGGER_FILTER0 0xC4 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerLoggerFilter0_u;

/*REG_B0_BA_ANALYZER_LOGGER_FILTER1 0xC8 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerLoggerFilter1_u;

/*REG_B0_BA_ANALYZER_LOGGER_STATISTICS_REG 0xCC */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerLoggerStatisticsReg_u;

/*REG_B0_BA_ANALYZER_CALC_CNT_SET_TO_ZERO_STATUS 0xD0 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerCalcCntSetToZeroStatus_u;

/*REG_B0_BA_ANALYZER_BA_ANALYZER_SPARE 0xE0 */
typedef union
{
	uint32 val;
	struct
...
} RegB0BaAnalyzerBaAnalyzerSpare_u;



#endif // _B0_BA_ANALYZER_REGS_H_
