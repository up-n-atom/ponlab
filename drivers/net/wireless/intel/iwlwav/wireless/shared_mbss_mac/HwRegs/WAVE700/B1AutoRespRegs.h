...
Module:				b1AutoResp
SOC Revision:		latest
Generated at:       2022-05-04 10:57:32
Purpose:
...
typedef union
{
	...
	struct
	{
		...
		uint32 allowEhtPhyModeResp : 1; //1 - allow to respond in EHT phy mode , 0 - move to 11A/G mcs0, reset value: 0x1, access type: RW
		uint32 reserved0 : 20;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		...
		uint32 reserved0 : 9;
		uint32 autoReplyDisallowedChannelBhvEht : 2; //Behavior in case of a collision with a disallowed channel, one or more. For EHT phy mode in RX , 0 - Reduce to RU and transmit , 1 - Abort transmission , 2 - Ignore and transmit on those disallowed channels , 3 - Static behavior, full CBW minus forbidden channel, reset value: 0x3, access type: RW
