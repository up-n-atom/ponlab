...
#define	REG_MAC_HT_EXTENSIONS_RAMS8_RM                         (MAC_HT_EXTENSIONS_BASE_ADDRESS + 0x90)
#define	REG_MAC_HT_EXTENSIONS_STD_CONTENTION_EVENTS            (MAC_HT_EXTENSIONS_BASE_ADDRESS + 0x94)
#define	REG_MAC_HT_EXTENSIONS_EVENT_CONTROL                    (MAC_HT_EXTENSIONS_BASE_ADDRESS + 0xA0)
#define	REG_MAC_HT_EXTENSIONS_CLK_CONTROL_REG_FORCE_ON         (MAC_HT_EXTENSIONS_BASE_ADDRESS + 0xA4)
#define	REG_MAC_HT_EXTENSIONS_CLK_CONTROL_REG_DYN_EN           (MAC_HT_EXTENSIONS_BASE_ADDRESS + 0xA8)
#define	REG_MAC_HT_EXTENSIONS_CLK_CONTROL_REG_FORCE_ON2        (MAC_HT_EXTENSIONS_BASE_ADDRESS + 0xAC)
#define	REG_MAC_HT_EXTENSIONS_CLK_CONTROL_REG_MPA_ARB          (MAC_HT_EXTENSIONS_BASE_ADDRESS + 0xB0)
#define	REG_MAC_HT_EXTENSIONS_CLK_CONTROL_REG_DYN_EN2          (MAC_HT_EXTENSIONS_BASE_ADDRESS + 0xC0)
#define	REG_MAC_HT_EXTENSIONS_HT_EXT_SPARE_GPO                 (MAC_HT_EXTENSIONS_BASE_ADDRESS + 0xC4)
#define	REG_MAC_HT_EXTENSIONS_HT_EXT_SPARE_GPI                 (MAC_HT_EXTENSIONS_BASE_ADDRESS + 0xC8)
#define	REG_MAC_HT_EXTENSIONS_PHY_MAC_IF_TEST_BUS_STOP         (MAC_HT_EXTENSIONS_BASE_ADDRESS + 0xF0)
#define	REG_MAC_HT_EXTENSIONS_VAP_MODE_BITMAP                  (MAC_HT_EXTENSIONS_BASE_ADDRESS + 0xF4)
#define	REG_MAC_HT_EXTENSIONS_CLK_CONTROL_REG_FORCE_ON3        (MAC_HT_EXTENSIONS_BASE_ADDRESS + 0xF8)
#define	REG_MAC_HT_EXTENSIONS_CLK_CONTROL_REG_DYN_EN3          (MAC_HT_EXTENSIONS_BASE_ADDRESS + 0xFC)
/*---------------------------------------------------------------------------------
