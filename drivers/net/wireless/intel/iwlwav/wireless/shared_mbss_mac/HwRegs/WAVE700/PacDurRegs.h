...
Module:				pacDur
SOC Revision:		latest
Generated at:       2022-05-04 10:59:06
Purpose:
...
#define	REG_PAC_DUR_TSF_FIELD_TIME6P               (PAC_DUR_BASE_ADDRESS + 0x60)
#define	REG_PAC_DUR_TSF_FIELD_TIME6M               (PAC_DUR_BASE_ADDRESS + 0x64)
...
#define	REG_PAC_DUR_TX_AIR_TIME_CTR_WR_VALUE       (PAC_DUR_BASE_ADDRESS + 0xA4)
#define	REG_PAC_DUR_TX_AIR_TIME_CTR                (PAC_DUR_BASE_ADDRESS + 0xA8)
...
} RegPacDurTxAirTimeCtrWrValue_u;
