...
#define	REG_UP_PHY_RXTD_ANT1_OLA_CONTROL                     (UP_PHY_RXTD_ANT1_BASE_ADDRESS + 0x70)
#define	REG_UP_PHY_RXTD_ANT1_OLA_START                       (UP_PHY_RXTD_ANT1_BASE_ADDRESS + 0x78)
#define	REG_UP_PHY_RXTD_ANT1_OLA_STATUS                      (UP_PHY_RXTD_ANT1_BASE_ADDRESS + 0x7C)
...
#define	REG_UP_PHY_RXTD_ANT1_FDL_RESET_SHIFT                 (UP_PHY_RXTD_ANT1_BASE_ADDRESS + 0x324)
#define	REG_UP_PHY_RXTD_ANT1_ABB_DPD_CONTROLS                (UP_PHY_RXTD_ANT1_BASE_ADDRESS + 0x328)
#define	REG_UP_PHY_RXTD_ANT1_ABB_DFT_CONTROLS                (UP_PHY_RXTD_ANT1_BASE_ADDRESS + 0x32C)
#define	REG_UP_PHY_RXTD_ANT1_FDL_PPM_COMPUTE                 (UP_PHY_RXTD_ANT1_BASE_ADDRESS + 0x330)
#define	REG_UP_PHY_RXTD_ANT1_FFT_IN_GAIN_MRU                 (UP_PHY_RXTD_ANT1_BASE_ADDRESS + 0x334)
#define	REG_UP_PHY_RXTD_ANT1_PRE_FILTER_COEF_LEN_SEL         (UP_PHY_RXTD_ANT1_BASE_ADDRESS + 0x338)
#define	REG_UP_PHY_RXTD_ANT1_INTERP_BEFORE_CHENNEL_FILTER    (UP_PHY_RXTD_ANT1_BASE_ADDRESS + 0x33C)
#define	REG_UP_PHY_RXTD_ANT1_ACI_RSSI_MAX_BAND_PWR           (UP_PHY_RXTD_ANT1_BASE_ADDRESS + 0x340)
#define	REG_UP_PHY_RXTD_ANT1_ACI_RSSI_MAX_BAND_PWR_HB        (UP_PHY_RXTD_ANT1_BASE_ADDRESS + 0x344)
#define	REG_UP_PHY_RXTD_ANT1_ACI_RSSI_SAT_FLAG               (UP_PHY_RXTD_ANT1_BASE_ADDRESS + 0x348)
#define	REG_UP_PHY_RXTD_ANT1_POWER_OPTIMIZATION              (UP_PHY_RXTD_ANT1_BASE_ADDRESS + 0x34C)
#define	REG_UP_PHY_RXTD_ANT1_EMULATION_CONTROL               (UP_PHY_RXTD_ANT1_BASE_ADDRESS + 0x350)
#define	REG_UP_PHY_RXTD_ANT1_ACIDET_POW_HB                   (UP_PHY_RXTD_ANT1_BASE_ADDRESS + 0x354)
/*---------------------------------------------------------------------------------
...
/*REG_UP_PHY_RXTD_ANT1_OLA_CONTROL 0x70 */
typedef union
{
	uint32 val;
	struct
...
} RegUpPhyRxtdAnt1OlaControl_u;

/*REG_UP_PHY_RXTD_ANT1_OLA_START 0x78 */
typedef union
{
	uint32 val;
	struct
...
} RegUpPhyRxtdAnt1OlaStart_u;

/*REG_UP_PHY_RXTD_ANT1_OLA_STATUS 0x7C */
typedef union
{
	uint32 val;
	struct
...
/*REG_UP_PHY_RXTD_ANT1_FDL_RESET_SHIFT 0x324 */
typedef union
{
	uint32 val;
	struct
...
} RegUpPhyRxtdAnt1FdlResetShift_u;

/*REG_UP_PHY_RXTD_ANT1_ABB_DPD_CONTROLS 0x328 */
typedef union
{
	uint32 val;
	struct
...
} RegUpPhyRxtdAnt1AbbDpdControls_u;

/*REG_UP_PHY_RXTD_ANT1_ABB_DFT_CONTROLS 0x32C */
typedef union
{
	uint32 val;
	struct
...
} RegUpPhyRxtdAnt1AbbDftControls_u;

/*REG_UP_PHY_RXTD_ANT1_FDL_PPM_COMPUTE 0x330 */
typedef union
{
	uint32 val;
	struct
...
} RegUpPhyRxtdAnt1FdlPpmCompute_u;

/*REG_UP_PHY_RXTD_ANT1_FFT_IN_GAIN_MRU 0x334 */
typedef union
{
	uint32 val;
	struct
...
} RegUpPhyRxtdAnt1FftInGainMru_u;

/*REG_UP_PHY_RXTD_ANT1_PRE_FILTER_COEF_LEN_SEL 0x338 */
typedef union
{
	uint32 val;
	struct
...
} RegUpPhyRxtdAnt1PreFilterCoefLenSel_u;

/*REG_UP_PHY_RXTD_ANT1_INTERP_BEFORE_CHENNEL_FILTER 0x33C */
typedef union
{
	uint32 val;
	struct
...
} RegUpPhyRxtdAnt1InterpBeforeChennelFilter_u;

/*REG_UP_PHY_RXTD_ANT1_ACI_RSSI_MAX_BAND_PWR 0x340 */
typedef union
{
	uint32 val;
	struct
...
} RegUpPhyRxtdAnt1AciRssiMaxBandPwr_u;

/*REG_UP_PHY_RXTD_ANT1_ACI_RSSI_MAX_BAND_PWR_HB 0x344 */
typedef union
{
	uint32 val;
	struct
...
} RegUpPhyRxtdAnt1AciRssiMaxBandPwrHb_u;

/*REG_UP_PHY_RXTD_ANT1_ACI_RSSI_SAT_FLAG 0x348 */
typedef union
{
	uint32 val;
	struct
...
} RegUpPhyRxtdAnt1AciRssiSatFlag_u;

/*REG_UP_PHY_RXTD_ANT1_POWER_OPTIMIZATION 0x34C */
typedef union
{
	uint32 val;
	struct
...
} RegUpPhyRxtdAnt1PowerOptimization_u;

/*REG_UP_PHY_RXTD_ANT1_EMULATION_CONTROL 0x350 */
typedef union
{
	uint32 val;
	struct
...
} RegUpPhyRxtdAnt1EmulationControl_u;

/*REG_UP_PHY_RXTD_ANT1_ACIDET_POW_HB 0x354 */
typedef union
{
	uint32 val;
	struct
