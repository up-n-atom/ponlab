...
Module:				b1TxSelector
SOC Revision:		latest
Generated at:       2022-05-04 10:57:59
Purpose:
...
typedef union
{
	...
	struct
	{
		...
		uint32 reserved1 : 3;
		uint32 maxGroupNum : 7; //Maximum number of supported groups. Number of groups is equal to max_group_num+1., reset value: 0xF, access type: RW
		uint32 reserved2 : 1;
