...
************************************************************************************/
#ifndef _B0_TX_PD_ACC_REGS_H_
#define _B0_TX_PD_ACC_REGS_H_
...
#define B0_TX_PD_ACC_BASE_ADDRESS                            MEMORY_MAP_UNIT_42_BASE_ADDRESS
#define	REG_B0_TX_PD_ACC_TXPD_ACTIVATION_CTRL                   (B0_TX_PD_ACC_BASE_ADDRESS + 0x0)
#define	REG_B0_TX_PD_ACC_TXPD_OPEARTION_PARAMS                  (B0_TX_PD_ACC_BASE_ADDRESS + 0x4)
#define	REG_B0_TX_PD_ACC_TXPD_ETH_TYPE_OVERHEAD                 (B0_TX_PD_ACC_BASE_ADDRESS + 0x8)
#define	REG_B0_TX_PD_ACC_TXPD_DMA_MODE                          (B0_TX_PD_ACC_BASE_ADDRESS + 0xC)
#define	REG_B0_TX_PD_ACC_TXPD_SENDER_PTD_FIFO_PARAMS            (B0_TX_PD_ACC_BASE_ADDRESS + 0x10)
#define	REG_B0_TX_PD_ACC_TXPD_SENDER_PTD_FIFO_STATUS            (B0_TX_PD_ACC_BASE_ADDRESS + 0x14)
#define	REG_B0_TX_PD_ACC_TXPD_SENDER_PTD_RD_ENTRIES_NUM         (B0_TX_PD_ACC_BASE_ADDRESS + 0x18)
#define	REG_B0_TX_PD_ACC_TXPD_SENDER_PTD_RELEASE_ENTRIES_NUM    (B0_TX_PD_ACC_BASE_ADDRESS + 0x1C)
#define	REG_B0_TX_PD_ACC_TXPD_ABORT_MODE                        (B0_TX_PD_ACC_BASE_ADDRESS + 0x20)
#define	REG_B0_TX_PD_ACC_TXPD_CONTROL_BITS                      (B0_TX_PD_ACC_BASE_ADDRESS + 0x24)
#define	REG_B0_TX_PD_ACC_TXPD_STATUS_0                          (B0_TX_PD_ACC_BASE_ADDRESS + 0x28)
#define	REG_B0_TX_PD_ACC_TXPD_STATUS_1                          (B0_TX_PD_ACC_BASE_ADDRESS + 0x2C)
#define	REG_B0_TX_PD_ACC_SPP_PER_PD_BITMAP                      (B0_TX_PD_ACC_BASE_ADDRESS + 0x30)
#define	REG_B0_TX_PD_ACC_SKIP_DMA_PER_PD_BITMAP                 (B0_TX_PD_ACC_BASE_ADDRESS + 0x34)
#define	REG_B0_TX_PD_ACC_ADD_MPDU_PER_PD_BITMAP                 (B0_TX_PD_ACC_BASE_ADDRESS + 0x38)
#define	REG_B0_TX_PD_ACC_SPP_FRAGMENT_CONTROL                   (B0_TX_PD_ACC_BASE_ADDRESS + 0x3C)
#define	REG_B0_TX_PD_ACC_DBG_DLM_COUNTERS_CONTROL               (B0_TX_PD_ACC_BASE_ADDRESS + 0x40)
#define	REG_B0_TX_PD_ACC_DBG_DLM_MPDU_COUNT                     (B0_TX_PD_ACC_BASE_ADDRESS + 0x44)
#define	REG_B0_TX_PD_ACC_DBG_DLM_PD_COUNT                       (B0_TX_PD_ACC_BASE_ADDRESS + 0x48)
#define	REG_B0_TX_PD_ACC_TXPD_LOGGER_CONTROL                    (B0_TX_PD_ACC_BASE_ADDRESS + 0x50)
#define	REG_B0_TX_PD_ACC_TXPD_LOGGER_STATUS                     (B0_TX_PD_ACC_BASE_ADDRESS + 0x54)
#define	REG_B0_TX_PD_ACC_TXPD_INT_ERROR_STATUS                  (B0_TX_PD_ACC_BASE_ADDRESS + 0x60)
#define	REG_B0_TX_PD_ACC_TXPD_INT_ERROR_EN                      (B0_TX_PD_ACC_BASE_ADDRESS + 0x64)
#define	REG_B0_TX_PD_ACC_TXPD_INT_ERROR_CLEAR                   (B0_TX_PD_ACC_BASE_ADDRESS + 0x68)
#define	REG_B0_TX_PD_ACC_TXPD_SPARE_REGISTER                    (B0_TX_PD_ACC_BASE_ADDRESS + 0x70)
#define	REG_B0_TX_PD_ACC_TXPD_SM_DEBUG                          (B0_TX_PD_ACC_BASE_ADDRESS + 0x74)
#define	REG_B0_TX_PD_ACC_STATISTICS_COUNTERS_EN                 (B0_TX_PD_ACC_BASE_ADDRESS + 0x78)
#define	REG_B0_TX_PD_ACC_TXPD_OPEARTION_PARAMS_2                (B0_TX_PD_ACC_BASE_ADDRESS + 0x7C)
/*---------------------------------------------------------------------------------
/						Data Type Definition										
/----------------------------------------------------------------------------------*/
/*REG_B0_TX_PD_ACC_TXPD_ACTIVATION_CTRL 0x0 */
typedef union
{
	uint32 val;
	struct
...
} RegB0TxPdAccTxpdActivationCtrl_u;

/*REG_B0_TX_PD_ACC_TXPD_OPEARTION_PARAMS 0x4 */
typedef union
{
	uint32 val;
	struct
...
} RegB0TxPdAccTxpdOpeartionParams_u;

/*REG_B0_TX_PD_ACC_TXPD_ETH_TYPE_OVERHEAD 0x8 */
typedef union
{
	uint32 val;
	struct
...
} RegB0TxPdAccTxpdEthTypeOverhead_u;

/*REG_B0_TX_PD_ACC_TXPD_DMA_MODE 0xC */
typedef union
{
	uint32 val;
	struct
...
} RegB0TxPdAccTxpdDmaMode_u;

/*REG_B0_TX_PD_ACC_TXPD_SENDER_PTD_FIFO_PARAMS 0x10 */
typedef union
{
	uint32 val;
	struct
...
} RegB0TxPdAccTxpdSenderPtdFifoParams_u;

/*REG_B0_TX_PD_ACC_TXPD_SENDER_PTD_FIFO_STATUS 0x14 */
typedef union
{
	uint32 val;
	struct
...
} RegB0TxPdAccTxpdSenderPtdFifoStatus_u;

/*REG_B0_TX_PD_ACC_TXPD_SENDER_PTD_RD_ENTRIES_NUM 0x18 */
typedef union
{
	uint32 val;
	struct
...
} RegB0TxPdAccTxpdSenderPtdRdEntriesNum_u;

/*REG_B0_TX_PD_ACC_TXPD_SENDER_PTD_RELEASE_ENTRIES_NUM 0x1C */
typedef union
{
	uint32 val;
	struct
...
} RegB0TxPdAccTxpdSenderPtdReleaseEntriesNum_u;

/*REG_B0_TX_PD_ACC_TXPD_ABORT_MODE 0x20 */
typedef union
{
	uint32 val;
	struct
...
} RegB0TxPdAccTxpdAbortMode_u;

/*REG_B0_TX_PD_ACC_TXPD_CONTROL_BITS 0x24 */
typedef union
{
	uint32 val;
	struct
...
} RegB0TxPdAccTxpdControlBits_u;

/*REG_B0_TX_PD_ACC_TXPD_STATUS_0 0x28 */
typedef union
{
	uint32 val;
	struct
...
} RegB0TxPdAccTxpdStatus0_u;

/*REG_B0_TX_PD_ACC_TXPD_STATUS_1 0x2C */
typedef union
{
	uint32 val;
	struct
...
} RegB0TxPdAccTxpdStatus1_u;

/*REG_B0_TX_PD_ACC_SPP_PER_PD_BITMAP 0x30 */
typedef union
{
	uint32 val;
	struct
...
} RegB0TxPdAccSppPerPdBitmap_u;

/*REG_B0_TX_PD_ACC_SKIP_DMA_PER_PD_BITMAP 0x34 */
typedef union
{
	uint32 val;
	struct
...
} RegB0TxPdAccSkipDmaPerPdBitmap_u;

/*REG_B0_TX_PD_ACC_ADD_MPDU_PER_PD_BITMAP 0x38 */
typedef union
{
	uint32 val;
	struct
...
} RegB0TxPdAccAddMpduPerPdBitmap_u;

/*REG_B0_TX_PD_ACC_SPP_FRAGMENT_CONTROL 0x3C */
typedef union
{
	uint32 val;
	struct
...
} RegB0TxPdAccSppFragmentControl_u;

/*REG_B0_TX_PD_ACC_DBG_DLM_COUNTERS_CONTROL 0x40 */
typedef union
{
	uint32 val;
	struct
...
} RegB0TxPdAccDbgDlmCountersControl_u;

/*REG_B0_TX_PD_ACC_DBG_DLM_MPDU_COUNT 0x44 */
typedef union
{
	uint32 val;
	struct
...
} RegB0TxPdAccDbgDlmMpduCount_u;

/*REG_B0_TX_PD_ACC_DBG_DLM_PD_COUNT 0x48 */
typedef union
{
	uint32 val;
	struct
...
} RegB0TxPdAccDbgDlmPdCount_u;

/*REG_B0_TX_PD_ACC_TXPD_LOGGER_CONTROL 0x50 */
typedef union
{
	uint32 val;
	struct
...
} RegB0TxPdAccTxpdLoggerControl_u;

/*REG_B0_TX_PD_ACC_TXPD_LOGGER_STATUS 0x54 */
typedef union
{
	uint32 val;
	struct
...
} RegB0TxPdAccTxpdLoggerStatus_u;

/*REG_B0_TX_PD_ACC_TXPD_INT_ERROR_STATUS 0x60 */
typedef union
{
	uint32 val;
	struct
...
} RegB0TxPdAccTxpdIntErrorStatus_u;

/*REG_B0_TX_PD_ACC_TXPD_INT_ERROR_EN 0x64 */
typedef union
{
	uint32 val;
	struct
...
} RegB0TxPdAccTxpdIntErrorEn_u;

/*REG_B0_TX_PD_ACC_TXPD_INT_ERROR_CLEAR 0x68 */
typedef union
{
	uint32 val;
	struct
...
} RegB0TxPdAccTxpdIntErrorClear_u;

/*REG_B0_TX_PD_ACC_TXPD_SPARE_REGISTER 0x70 */
typedef union
{
	uint32 val;
	struct
...
} RegB0TxPdAccTxpdSpareRegister_u;

/*REG_B0_TX_PD_ACC_TXPD_SM_DEBUG 0x74 */
typedef union
{
	uint32 val;
	struct
...
} RegB0TxPdAccTxpdSmDebug_u;

/*REG_B0_TX_PD_ACC_STATISTICS_COUNTERS_EN 0x78 */
typedef union
{
	uint32 val;
	struct
...
} RegB0TxPdAccStatisticsCountersEn_u;

/*REG_B0_TX_PD_ACC_TXPD_OPEARTION_PARAMS_2 0x7C */
typedef union
{
	uint32 val;
	struct
...
} RegB0TxPdAccTxpdOpeartionParams2_u;

//========================================
/* REG_TX_PD_ACC_TXPD_ACTIVATION_CTRL 0x0 */
#define B0_TX_PD_ACC_TXPD_ACTIVATION_CTRL_FIELD_TXPD_GO_MASK                                                      0x00000001
//========================================
/* REG_TX_PD_ACC_TXPD_OPEARTION_PARAMS 0x4 */
#define B0_TX_PD_ACC_TXPD_OPEARTION_PARAMS_FIELD_MANIPULATE_RETRY_FIELDS_EN_MASK                                  0x00000001
#define B0_TX_PD_ACC_TXPD_OPEARTION_PARAMS_FIELD_SKIP_MIDDLE_PD_IN_MPDU_MASK                                      0x00000002
#define B0_TX_PD_ACC_TXPD_OPEARTION_PARAMS_FIELD_LONG_MPDU_THRESHOLD_MASK                                         0x3FFF0000
//========================================
/* REG_TX_PD_ACC_TXPD_ETH_TYPE_OVERHEAD 0x8 */
#define B0_TX_PD_ACC_TXPD_ETH_TYPE_OVERHEAD_FIELD_ETH_TYPE0_OVERHEAD_MASK                                         0x0000003F
#define B0_TX_PD_ACC_TXPD_ETH_TYPE_OVERHEAD_FIELD_ETH_TYPE1_OVERHEAD_MASK                                         0x00003F00
#define B0_TX_PD_ACC_TXPD_ETH_TYPE_OVERHEAD_FIELD_ETH_TYPE2_OVERHEAD_MASK                                         0x003F0000
#define B0_TX_PD_ACC_TXPD_ETH_TYPE_OVERHEAD_FIELD_ETH_TYPE3_OVERHEAD_MASK                                         0x3F000000
//========================================
/* REG_TX_PD_ACC_TXPD_DMA_MODE 0xC */
#define B0_TX_PD_ACC_TXPD_DMA_MODE_FIELD_DMA_LAST_CTRL_MASK                                                       0x00000001
//========================================
/* REG_TX_PD_ACC_TXPD_SENDER_PTD_FIFO_PARAMS 0x10 */
#define B0_TX_PD_ACC_TXPD_SENDER_PTD_FIFO_PARAMS_FIELD_TXPD_SENDER_PTD_FIFO_BASE_ADDR_MASK                        0x000007FF
#define B0_TX_PD_ACC_TXPD_SENDER_PTD_FIFO_PARAMS_FIELD_TXPD_SENDER_PTD_FIFO_DEPTH_MINUS_ONE_MASK                  0x007F0000
#define B0_TX_PD_ACC_TXPD_SENDER_PTD_FIFO_PARAMS_FIELD_PTD_WORD_SIZE_MASK                                         0x1F000000
//========================================
/* REG_TX_PD_ACC_TXPD_SENDER_PTD_FIFO_STATUS 0x14 */
#define B0_TX_PD_ACC_TXPD_SENDER_PTD_FIFO_STATUS_FIELD_TXPD_SENDER_PTD_NUM_ENTRIES_COUNT_MASK                     0x0000007F
#define B0_TX_PD_ACC_TXPD_SENDER_PTD_FIFO_STATUS_FIELD_TXPD_SENDER_PTD_FIFO_WR_PTR_MASK                           0x00007F00
#define B0_TX_PD_ACC_TXPD_SENDER_PTD_FIFO_STATUS_FIELD_TXPD_SENDER_PTD_FIFO_RD_PTR_MASK                           0x007F0000
#define B0_TX_PD_ACC_TXPD_SENDER_PTD_FIFO_STATUS_FIELD_TXPD_SENDER_PTD_FIFO_DECREMENT_LESS_THAN_ZERO_MASK         0x10000000
//========================================
/* REG_TX_PD_ACC_TXPD_SENDER_PTD_RD_ENTRIES_NUM 0x18 */
#define B0_TX_PD_ACC_TXPD_SENDER_PTD_RD_ENTRIES_NUM_FIELD_TXPD_SENDER_PTD_RD_ENTRIES_NUM_MASK                     0x0000007F
//========================================
/* REG_TX_PD_ACC_TXPD_SENDER_PTD_RELEASE_ENTRIES_NUM 0x1C */
#define B0_TX_PD_ACC_TXPD_SENDER_PTD_RELEASE_ENTRIES_NUM_FIELD_TXPD_SENDER_PTD_RELEASE_ENTRIES_NUM_MASK           0x0000007F
//========================================
/* REG_TX_PD_ACC_TXPD_ABORT_MODE 0x20 */
#define B0_TX_PD_ACC_TXPD_ABORT_MODE_FIELD_TXPD_ABORT_MODE_MASK                                                   0x00000001
//========================================
/* REG_TX_PD_ACC_TXPD_CONTROL_BITS 0x24 */
#define B0_TX_PD_ACC_TXPD_CONTROL_BITS_FIELD_TXPD_PENDING_PTD_CLEAR_MASK                                          0x00000010
#define B0_TX_PD_ACC_TXPD_CONTROL_BITS_FIELD_TXPD_OCCUPIED_PTD_CLEAR_MASK                                         0x00000020
#define B0_TX_PD_ACC_TXPD_CONTROL_BITS_FIELD_TXPD_RELEASED_PTD_CLEAR_MASK                                         0x00000040
#define B0_TX_PD_ACC_TXPD_CONTROL_BITS_FIELD_TXPD_SENDER_PTD_FIFO_CLEAR_DEC_LESS_THAN_ZERO_MASK                   0x00000080
#define B0_TX_PD_ACC_TXPD_CONTROL_BITS_FIELD_TXPD_PTD_OCCUPANCY_MAX_CLEAR_MASK                                    0x00000100
//========================================
/* REG_TX_PD_ACC_TXPD_STATUS_0 0x28 */
#define B0_TX_PD_ACC_TXPD_STATUS_0_FIELD_TXPD_PENDING_PTD_OCCUPANCY_MAX_MASK                                      0x0000007F
#define B0_TX_PD_ACC_TXPD_STATUS_0_FIELD_TXPD_OCCUPIED_PTD_OCCUPANCY_MAX_MASK                                     0x00007F00
#define B0_TX_PD_ACC_TXPD_STATUS_0_FIELD_TXPD_RELEASED_PTD_OCCUPANCY_MAX_MASK                                     0x007F0000
//========================================
/* REG_TX_PD_ACC_TXPD_STATUS_1 0x2C */
#define B0_TX_PD_ACC_TXPD_STATUS_1_FIELD_TXPD_OCCUPIED_PTD_OCCUPANCY_LIVE_MASK                                    0x0000007F
#define B0_TX_PD_ACC_TXPD_STATUS_1_FIELD_TXPD_RELEASED_PTD_OCCUPANCY_LIVE_MASK                                    0x00007F00
#define B0_TX_PD_ACC_TXPD_STATUS_1_FIELD_TXPD_IS_IDLE_MASK                                                        0x00010000
//========================================
/* REG_TX_PD_ACC_SPP_PER_PD_BITMAP 0x30 */
#define B0_TX_PD_ACC_SPP_PER_PD_BITMAP_FIELD_SPP_PER_PD_BITMAP_MASK                                               0xFFFFFFFF
//========================================
/* REG_TX_PD_ACC_SKIP_DMA_PER_PD_BITMAP 0x34 */
#define B0_TX_PD_ACC_SKIP_DMA_PER_PD_BITMAP_FIELD_SKIP_DMA_PER_PD_BITMAP_MASK                                     0xFFFFFFFF
//========================================
/* REG_TX_PD_ACC_ADD_MPDU_PER_PD_BITMAP 0x38 */
#define B0_TX_PD_ACC_ADD_MPDU_PER_PD_BITMAP_FIELD_ADD_MPDU_PER_PD_BITMAP_MASK                                     0xFFFFFFFF
//========================================
/* REG_TX_PD_ACC_SPP_FRAGMENT_CONTROL 0x3C */
#define B0_TX_PD_ACC_SPP_FRAGMENT_CONTROL_FIELD_SPP_FOR_FIRST_FRAG_PTD_MASK                                       0x00000001
#define B0_TX_PD_ACC_SPP_FRAGMENT_CONTROL_FIELD_SPP_FOR_NON_FIRST_FRAG_FIRST_PTD_MASK                             0x00000002
#define B0_TX_PD_ACC_SPP_FRAGMENT_CONTROL_FIELD_SPP_FOR_NON_FIRST_FRAG_SECOND_PTD_MASK                            0x00000004
//========================================
/* REG_TX_PD_ACC_DBG_DLM_COUNTERS_CONTROL 0x40 */
#define B0_TX_PD_ACC_DBG_DLM_COUNTERS_CONTROL_FIELD_DLM_MPDU_COUNT_USER_TO_MONITOR_MASK                           0x0000007F
#define B0_TX_PD_ACC_DBG_DLM_COUNTERS_CONTROL_FIELD_DLM_PD_COUNT_USER_TO_MONITOR_MASK                             0x00007F00
#define B0_TX_PD_ACC_DBG_DLM_COUNTERS_CONTROL_FIELD_DLM_MPDU_COUNT_CLEAR_MASK                                     0x00010000
#define B0_TX_PD_ACC_DBG_DLM_COUNTERS_CONTROL_FIELD_DLM_PD_COUNT_CLEAR_MASK                                       0x00020000
//========================================
/* REG_TX_PD_ACC_DBG_DLM_MPDU_COUNT 0x44 */
#define B0_TX_PD_ACC_DBG_DLM_MPDU_COUNT_FIELD_DLM_MPDU_COUNT_MASK                                                 0x0000FFFF
//========================================
/* REG_TX_PD_ACC_DBG_DLM_PD_COUNT 0x48 */
#define B0_TX_PD_ACC_DBG_DLM_PD_COUNT_FIELD_DLM_PD_COUNT_MASK                                                     0x000FFFFF
//========================================
/* REG_TX_PD_ACC_TXPD_LOGGER_CONTROL 0x50 */
#define B0_TX_PD_ACC_TXPD_LOGGER_CONTROL_FIELD_TXPD_LOGGER_EN_MASK                                                0x00000001
#define B0_TX_PD_ACC_TXPD_LOGGER_CONTROL_FIELD_TXPD_LOGGER_PRIORITY_MASK                                          0x0000000C
#define B0_TX_PD_ACC_TXPD_LOGGER_CONTROL_FIELD_TXPD_LOGGER_NUM_OF_MSGS_MINUS_ONE_MASK                             0x000000F0
#define B0_TX_PD_ACC_TXPD_LOGGER_CONTROL_FIELD_TXPD_LOGGER_MIDDLE_PD_ENABLE_MASK                                  0x00001000
#define B0_TX_PD_ACC_TXPD_LOGGER_CONTROL_FIELD_TXPD_LOGGER_LAST_PD_ENABLE_MASK                                    0x00002000
#define B0_TX_PD_ACC_TXPD_LOGGER_CONTROL_FIELD_TXPD_LOGGER_MESSAGE_DROP_CLEAR_MASK                                0x00010000
//========================================
/* REG_TX_PD_ACC_TXPD_LOGGER_STATUS 0x54 */
#define B0_TX_PD_ACC_TXPD_LOGGER_STATUS_FIELD_TXPD_LOGGER_IDLE_MASK                                               0x00000001
#define B0_TX_PD_ACC_TXPD_LOGGER_STATUS_FIELD_TXPD_LOGGER_SM_MASK                                                 0x0000000E
#define B0_TX_PD_ACC_TXPD_LOGGER_STATUS_FIELD_TXPD_LOGGER_PACKET_OPEN_MASK                                        0x00000010
#define B0_TX_PD_ACC_TXPD_LOGGER_STATUS_FIELD_TXPD_LOGGER_MESSAGE_DROP_STICKY_MASK                                0x00000020
//========================================
/* REG_TX_PD_ACC_TXPD_INT_ERROR_STATUS 0x60 */
#define B0_TX_PD_ACC_TXPD_INT_ERROR_STATUS_FIELD_TXPD_GO_WHILE_ACTIVE_MISMATCH_STATUS_MASK                        0x00000001
#define B0_TX_PD_ACC_TXPD_INT_ERROR_STATUS_FIELD_TXPD_SYMBOL_OVERHEAD_OVERFLOW_STATUS_MASK                        0x00000002
#define B0_TX_PD_ACC_TXPD_INT_ERROR_STATUS_FIELD_TXPD_LAST_IN_STA_DLM_MISMATCH_STATUS_MASK                        0x00000004
#define B0_TX_PD_ACC_TXPD_INT_ERROR_STATUS_FIELD_TXPD_OCCUPIED_PTD_UNDERFLOW_STATUS_MASK                          0x00000008
#define B0_TX_PD_ACC_TXPD_INT_ERROR_STATUS_FIELD_TXPD_SN_SSN_DIFF_OOR_STATUS_MASK                                 0x00000010
//========================================
/* REG_TX_PD_ACC_TXPD_INT_ERROR_EN 0x64 */
#define B0_TX_PD_ACC_TXPD_INT_ERROR_EN_FIELD_TXPD_GO_WHILE_ACTIVE_MISMATCH_EN_MASK                                0x00000001
#define B0_TX_PD_ACC_TXPD_INT_ERROR_EN_FIELD_TXPD_SYMBOL_OVERHEAD_OVERFLOW_EN_MASK                                0x00000002
#define B0_TX_PD_ACC_TXPD_INT_ERROR_EN_FIELD_TXPD_LAST_IN_STA_DLM_MISMATCH_EN_MASK                                0x00000004
#define B0_TX_PD_ACC_TXPD_INT_ERROR_EN_FIELD_TXPD_OCCUPIED_PTD_UNDERFLOW_EN_MASK                                  0x00000008
#define B0_TX_PD_ACC_TXPD_INT_ERROR_EN_FIELD_TXPD_SN_SSN_DIFF_OOR_EN_MASK                                         0x00000010
//========================================
/* REG_TX_PD_ACC_TXPD_INT_ERROR_CLEAR 0x68 */
#define B0_TX_PD_ACC_TXPD_INT_ERROR_CLEAR_FIELD_TXPD_GO_WHILE_ACTIVE_MISMATCH_CLR_MASK                            0x00000001
#define B0_TX_PD_ACC_TXPD_INT_ERROR_CLEAR_FIELD_TXPD_SYMBOL_OVERHEAD_OVERFLOW_CLR_MASK                            0x00000002
#define B0_TX_PD_ACC_TXPD_INT_ERROR_CLEAR_FIELD_TXPD_LAST_IN_STA_DLM_MISMATCH_CLR_MASK                            0x00000004
#define B0_TX_PD_ACC_TXPD_INT_ERROR_CLEAR_FIELD_TXPD_OCCUPIED_PTD_UNDERFLOW_CLR_MASK                              0x00000008
#define B0_TX_PD_ACC_TXPD_INT_ERROR_CLEAR_FIELD_TXPD_SN_SSN_DIFF_OOR_CLR_MASK                                     0x00000010
//========================================
/* REG_TX_PD_ACC_TXPD_SPARE_REGISTER 0x70 */
#define B0_TX_PD_ACC_TXPD_SPARE_REGISTER_FIELD_SPARE_REGISTER_MASK                                                0x0000FFFF
//========================================
/* REG_TX_PD_ACC_TXPD_SM_DEBUG 0x74 */
#define B0_TX_PD_ACC_TXPD_SM_DEBUG_FIELD_TXPD_CORE_SM_MASK                                                        0x0000000F
#define B0_TX_PD_ACC_TXPD_SM_DEBUG_FIELD_TXPD_PTD_RD_SM_MASK                                                      0x00000070
#define B0_TX_PD_ACC_TXPD_SM_DEBUG_FIELD_TXPD_PD_WR_SM_MASK                                                       0x00000380
#define B0_TX_PD_ACC_TXPD_SM_DEBUG_FIELD_TXPD_RDBM_SM_MASK                                                        0x00003C00
#define B0_TX_PD_ACC_TXPD_SM_DEBUG_FIELD_TXPD_STDM_SM_MASK                                                        0x0003C000
#define B0_TX_PD_ACC_TXPD_SM_DEBUG_FIELD_TXPD_VAPM_SM_MASK                                                        0x000C0000
#define B0_TX_PD_ACC_TXPD_SM_DEBUG_FIELD_TXPD_DBIT_CALC_SM_MASK                                                   0x00300000
#define B0_TX_PD_ACC_TXPD_SM_DEBUG_FIELD_TXPD_INIT_SM_MASK                                                        0x00C00000
#define B0_TX_PD_ACC_TXPD_SM_DEBUG_FIELD_TXPD_PTD_WR_SM_MASK                                                      0x03000000
#define B0_TX_PD_ACC_TXPD_SM_DEBUG_FIELD_TXPD_PTD_WR_WRAP_SM_MASK                                                 0x0C000000
//========================================
/* REG_TX_PD_ACC_STATISTICS_COUNTERS_EN 0x78 */
#define B0_TX_PD_ACC_STATISTICS_COUNTERS_EN_FIELD_RETRY_COUNT_EN_MASK                                             0x00000001
#define B0_TX_PD_ACC_STATISTICS_COUNTERS_EN_FIELD_MULTIPLE_RETRY_COUNT_EN_MASK                                    0x00000002
//========================================
/* REG_TX_PD_ACC_TXPD_OPEARTION_PARAMS_2 0x7C */
#define B0_TX_PD_ACC_TXPD_OPEARTION_PARAMS_2_FIELD_DISCARD_AFFECTED_BY_BA_SESSION_EN_MASK                         0x00000001
#define B0_TX_PD_ACC_TXPD_OPEARTION_PARAMS_2_FIELD_SENDER_NOT_EMPTY_IRQ_NULLIFY_EN_MASK                           0x00000002
