...
#define	REG_PAC_RXC_MT_FORCE_CCA_BAND                          (PAC_RXC_BASE_ADDRESS + 0xA0)
#define	REG_PAC_RXC_PHY_MAC_DBG2                               (PAC_RXC_BASE_ADDRESS + 0xA4)
#define	REG_PAC_RXC_ASPM_CTRL                                  (PAC_RXC_BASE_ADDRESS + 0xA8)
