...
Module:				b0PhyTx
SOC Revision:		latest
Generated at:       2024-06-26 12:54:30
Purpose:
...
#define	REG_B0_PHY_TX_TX_BE_REG_1C                                     (B0_PHY_TX_BASE_ADDRESS + 0x70)
...
#define	REG_B0_PHY_TX_TD_SYMBOL_DELAY_LENGTH_22_ONLY                   (B0_PHY_TX_BASE_ADDRESS + 0x238)
#define	REG_B0_PHY_TX_TD_SYMBOL_DELAY_LENGTH_23_ONLY                   (B0_PHY_TX_BASE_ADDRESS + 0x23C)
...
#define	REG_B0_PHY_TX_TONE_GEN_INVERT_BIN                              (B0_PHY_TX_BASE_ADDRESS + 0x2C0)
#define	REG_B0_PHY_TX_SCALE_DATA_WITH_PUNCTURING                       (B0_PHY_TX_BASE_ADDRESS + 0x2C4)
#define	REG_B0_PHY_TX_PM_EHT_PREAMBLE_TONE_ROTATION_320_DEFAULT_VAL    (B0_PHY_TX_BASE_ADDRESS + 0x2C8)
#define	REG_B0_PHY_TX_PM_EHT_PREAMBLE_TONE_ROTATION_320_MRU_0          (B0_PHY_TX_BASE_ADDRESS + 0x2CC)
#define	REG_B0_PHY_TX_PM_EHT_PREAMBLE_TONE_ROTATION_320_MRU_1          (B0_PHY_TX_BASE_ADDRESS + 0x2D0)
#define	REG_B0_PHY_TX_PM_EHT_PREAMBLE_TONE_ROTATION_320_MRU_2          (B0_PHY_TX_BASE_ADDRESS + 0x2D4)
#define	REG_B0_PHY_TX_PM_EHT_PREAMBLE_TONE_ROTATION_320_NONMRU_0       (B0_PHY_TX_BASE_ADDRESS + 0x2D8)
#define	REG_B0_PHY_TX_PM_EHT_PREAMBLE_TONE_ROTATION_320_NONMRU_1       (B0_PHY_TX_BASE_ADDRESS + 0x2DC)
#define	REG_B0_PHY_TX_PM_EHT_PREAMBLE_TONE_ROTATION_320_NONMRU_2       (B0_PHY_TX_BASE_ADDRESS + 0x2E0)
#define	REG_B0_PHY_TX_PM_EHT_PREAMBLE_TONE_ROTATION_320_NONMRU_3       (B0_PHY_TX_BASE_ADDRESS + 0x2E4)
#define	REG_B0_PHY_TX_PM_EHT_PREAMBLE_TONE_ROTATION_320_NONMRU_4       (B0_PHY_TX_BASE_ADDRESS + 0x2E8)
#define	REG_B0_PHY_TX_PM_EHT_PREAMBLE_TONE_ROTATION_320_NONMRU_5       (B0_PHY_TX_BASE_ADDRESS + 0x2EC)
#define	REG_B0_PHY_TX_TX_TEST_BUS_GCLK_EN                              (B0_PHY_TX_BASE_ADDRESS + 0x2F0)
#define	REG_B0_PHY_TX_CTRL_MU_TD_GAIN_FORCE                            (B0_PHY_TX_BASE_ADDRESS + 0x2F4)
#define	REG_B0_PHY_TX_TX_REWIND_SW_RESET_MASK                          (B0_PHY_TX_BASE_ADDRESS + 0x2F8)
#define	REG_B0_PHY_TX_HE_STF_TB_SCALE_4                                (B0_PHY_TX_BASE_ADDRESS + 0x2FC)
#define	REG_B0_PHY_TX_HE_STF_TB_SCALE_5                                (B0_PHY_TX_BASE_ADDRESS + 0x300)
#define	REG_B0_PHY_TX_TX_MAC_ADDRESS_LO                                (B0_PHY_TX_BASE_ADDRESS + 0x304)
#define	REG_B0_PHY_TX_TX_MAC_ADDRESS_HI                                (B0_PHY_TX_BASE_ADDRESS + 0x308)
#define	REG_B0_PHY_TX_TX_SECURE_LTF_GEN_RAM_RM                         (B0_PHY_TX_BASE_ADDRESS + 0x30C)
/*---------------------------------------------------------------------------------
...
/*REG_B0_PHY_TX_TX_BE_REG_1C 0x70 */
typedef union
{
	uint32 val;
	struct
...
/*REG_B0_PHY_TX_TD_SYMBOL_DELAY_LENGTH_22_ONLY 0x238 */
typedef union
{
	uint32 val;
	struct
...
} RegB0PhyTxTdSymbolDelayLength22Only_u;

/*REG_B0_PHY_TX_TD_SYMBOL_DELAY_LENGTH_23_ONLY 0x23C */
typedef union
{
	uint32 val;
	struct
...
} RegB0PhyTxTdSymbolDelayLength23Only_u;
...
/*REG_B0_PHY_TX_TONE_GEN_INVERT_BIN 0x2C0 */
typedef union
{
	uint32 val;
	struct
...
} RegB0PhyTxToneGenInvertBin_u;

/*REG_B0_PHY_TX_SCALE_DATA_WITH_PUNCTURING 0x2C4 */
typedef union
{
	uint32 val;
	struct
...
} RegB0PhyTxScaleDataWithPuncturing_u;

/*REG_B0_PHY_TX_PM_EHT_PREAMBLE_TONE_ROTATION_320_DEFAULT_VAL 0x2C8 */
typedef union
{
	uint32 val;
	struct
...
} RegB0PhyTxPmEhtPreambleToneRotation320DefaultVal_u;

/*REG_B0_PHY_TX_PM_EHT_PREAMBLE_TONE_ROTATION_320_MRU_0 0x2CC */
typedef union
{
	uint32 val;
	struct
...
} RegB0PhyTxPmEhtPreambleToneRotation320Mru0_u;

/*REG_B0_PHY_TX_PM_EHT_PREAMBLE_TONE_ROTATION_320_MRU_1 0x2D0 */
typedef union
{
	uint32 val;
	struct
...
} RegB0PhyTxPmEhtPreambleToneRotation320Mru1_u;

/*REG_B0_PHY_TX_PM_EHT_PREAMBLE_TONE_ROTATION_320_MRU_2 0x2D4 */
typedef union
{
	uint32 val;
	struct
...
} RegB0PhyTxPmEhtPreambleToneRotation320Mru2_u;

/*REG_B0_PHY_TX_PM_EHT_PREAMBLE_TONE_ROTATION_320_NONMRU_0 0x2D8 */
typedef union
{
	uint32 val;
	struct
...
} RegB0PhyTxPmEhtPreambleToneRotation320Nonmru0_u;

/*REG_B0_PHY_TX_PM_EHT_PREAMBLE_TONE_ROTATION_320_NONMRU_1 0x2DC */
typedef union
{
	uint32 val;
	struct
...
} RegB0PhyTxPmEhtPreambleToneRotation320Nonmru1_u;

/*REG_B0_PHY_TX_PM_EHT_PREAMBLE_TONE_ROTATION_320_NONMRU_2 0x2E0 */
typedef union
{
	uint32 val;
	struct
...
} RegB0PhyTxPmEhtPreambleToneRotation320Nonmru2_u;

/*REG_B0_PHY_TX_PM_EHT_PREAMBLE_TONE_ROTATION_320_NONMRU_3 0x2E4 */
typedef union
{
	uint32 val;
	struct
...
} RegB0PhyTxPmEhtPreambleToneRotation320Nonmru3_u;

/*REG_B0_PHY_TX_PM_EHT_PREAMBLE_TONE_ROTATION_320_NONMRU_4 0x2E8 */
typedef union
{
	uint32 val;
	struct
...
} RegB0PhyTxPmEhtPreambleToneRotation320Nonmru4_u;

/*REG_B0_PHY_TX_PM_EHT_PREAMBLE_TONE_ROTATION_320_NONMRU_5 0x2EC */
typedef union
{
	uint32 val;
	struct
...
} RegB0PhyTxPmEhtPreambleToneRotation320Nonmru5_u;

/*REG_B0_PHY_TX_TX_TEST_BUS_GCLK_EN 0x2F0 */
typedef union
{
	uint32 val;
	struct
...
} RegB0PhyTxTxTestBusGclkEn_u;

/*REG_B0_PHY_TX_CTRL_MU_TD_GAIN_FORCE 0x2F4 */
typedef union
{
	uint32 val;
	struct
...
} RegB0PhyTxCtrlMuTdGainForce_u;

/*REG_B0_PHY_TX_TX_REWIND_SW_RESET_MASK 0x2F8 */
typedef union
{
	uint32 val;
	struct
...
} RegB0PhyTxTxRewindSwResetMask_u;

/*REG_B0_PHY_TX_HE_STF_TB_SCALE_4 0x2FC */
typedef union
{
	uint32 val;
	struct
...
} RegB0PhyTxHeStfTbScale4_u;

/*REG_B0_PHY_TX_HE_STF_TB_SCALE_5 0x300 */
typedef union
{
	uint32 val;
	struct
...
} RegB0PhyTxHeStfTbScale5_u;

/*REG_B0_PHY_TX_TX_MAC_ADDRESS_LO 0x304 */
typedef union
{
	uint32 val;
	struct
...
} RegB0PhyTxTxMacAddressLo_u;

/*REG_B0_PHY_TX_TX_MAC_ADDRESS_HI 0x308 */
typedef union
{
	uint32 val;
	struct
...
} RegB0PhyTxTxMacAddressHi_u;

/*REG_B0_PHY_TX_TX_SECURE_LTF_GEN_RAM_RM 0x30C */
typedef union
{
	uint32 val;
	struct
...
} RegB0PhyTxTxSecureLtfGenRamRm_u;
