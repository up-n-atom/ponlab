...
#define	REG_B1_PHY_TX_TD_SYMBOL_DELAY_LENGTH_22                        (B1_PHY_TX_BASE_ADDRESS + 0x238)
#define	REG_B1_PHY_TX_TD_SYMBOL_DELAY_LENGTH_23                        (B1_PHY_TX_BASE_ADDRESS + 0x23C)
...
} RegB1PhyTxTdSymbolDelayLength2_3_u;
...
/*REG_B1_PHY_TX_TD_SYMBOL_DELAY_LENGTH_22 0x238 */
typedef union
{
	uint32 val;
	struct
...
} RegB1PhyTxTdSymbolDelayLength22_u;

/*REG_B1_PHY_TX_TD_SYMBOL_DELAY_LENGTH_23 0x23C */
typedef union
{
	uint32 val;
	struct
