...
#define	REG_PHY_AGC_ANT0_AGC_MEASURMENT_FOR_SPUR_CANCEL           (PHY_AGC_ANT0_BASE_ADDRESS + 0x548)
#define	REG_PHY_AGC_ANT0_PM_LIMIT_LNA_MAX_INDEX                   (PHY_AGC_ANT0_BASE_ADDRESS + 0x54C)
/*---------------------------------------------------------------------------------
...
} RegPhyAgcAnt0AgcMeasurmentForSpurCancel_u;
...
} RegPhyAgcAnt0PmLimitLnaMaxIndex_u;
