...
Module:				macClc
SOC Revision:		latest
Generated at:       2022-03-29 07:45:53
Purpose:
...
typedef union
{
	...
	struct
	{
		uint32 dynamic : 32; //CLC  dynamic, reset value: 0x0, access type: RW
	} bitFields;
} RegMacClcDynamic_u;
...
typedef union
{
	...
	struct
	{
		uint32 dynamic2 : 32; //CLC  dynamic_2, reset value: 0x0, access type: RW
	} bitFields;
} RegMacClcDynamic2_u;
