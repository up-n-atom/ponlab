...
Module:				rxPp
SOC Revision:		latest
Generated at:       2022-03-29 07:45:48
Purpose:
...
#define	REG_RX_PP_MGMT_TID_CFG                    (RX_PP_BASE_ADDRESS + 0xF8)
/*---------------------------------------------------------------------------------
...
typedef union
{
	...
	struct
	{
		...
		uint32 shramFifoClearFullDropCtrStrb : 1; //no description, reset value: 0x0, access type: WO
		uint32 shramFifoClearDecLessThanZeroStrb : 1; //no description, reset value: 0x0, access type: WO
		uint32 reserved0 : 29;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		...
		uint32 shramFifoDecrementLessThanZero : 1; //no description, reset value: 0x0, access type: RO
