...
typedef union
{
	...
	struct
	{
		uint32 heSelUp0PreAggBitmap : 10; //Pre agg bitmap - {INSERT_A_CONTROL,DISABLE_HE_SU_ER,TOMI_MAX_NSS[2:0],OMI_BW[1:0],ROMI_MAX_NSS[2:0]}, reset value: 0x0, access type: RO
		uint32 reserved0 : 22;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 heSelUp1PreAggBitmap : 10; //Pre agg bitmap - {INSERT_A_CONTROL,DISABLE_HE_SU_ER,TOMI_MAX_NSS[2:0],OMI_BW[1:0],ROMI_MAX_NSS[2:0]}, reset value: 0x0, access type: RO
		uint32 reserved0 : 22;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 heSelUp2PreAggBitmap : 10; //Pre agg bitmap - {INSERT_A_CONTROL,DISABLE_HE_SU_ER,TOMI_MAX_NSS[2:0],OMI_BW[1:0],ROMI_MAX_NSS[2:0]}, reset value: 0x0, access type: RO
		uint32 reserved0 : 22;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 heSelUp3PreAggBitmap : 10; //Pre agg bitmap - {INSERT_A_CONTROL,DISABLE_HE_SU_ER,TOMI_MAX_NSS[2:0],OMI_BW[1:0],ROMI_MAX_NSS[2:0]}, reset value: 0x0, access type: RO
		uint32 reserved0 : 22;
	} bitFields;
