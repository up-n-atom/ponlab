...
/***********************************************************************************
File:				B0RxMsduParserRegs.h
Module:				b0RxMsduParser
SOC Revision:		latest
...
************************************************************************************/
#ifndef _B0_RX_MSDU_PARSER_REGS_H_
#define _B0_RX_MSDU_PARSER_REGS_H_
...
#define B0_RX_MSDU_PARSER_BASE_ADDRESS                             MEMORY_MAP_UNIT_65_BASE_ADDRESS
#define	REG_B0_RX_MSDU_PARSER_RX_MSDU_PARSER_EN                   (B0_RX_MSDU_PARSER_BASE_ADDRESS + 0x0)
#define	REG_B0_RX_MSDU_PARSER_RD_TYPE_CONV_EN                     (B0_RX_MSDU_PARSER_BASE_ADDRESS + 0x4)
#define	REG_B0_RX_MSDU_PARSER_WPA_PT_MODE_EN                      (B0_RX_MSDU_PARSER_BASE_ADDRESS + 0x8)
#define	REG_B0_RX_MSDU_PARSER_RX_MSDU_PARSER_CFG                  (B0_RX_MSDU_PARSER_BASE_ADDRESS + 0xC)
#define	REG_B0_RX_MSDU_PARSER_MSDU_DESC_FIFO_CFG                  (B0_RX_MSDU_PARSER_BASE_ADDRESS + 0x10)
#define	REG_B0_RX_MSDU_PARSER_MSDU_DESC_FIFO_NUM_ENTRIES_COUNT    (B0_RX_MSDU_PARSER_BASE_ADDRESS + 0x14)
#define	REG_B0_RX_MSDU_PARSER_MSDU_DESC_FIFO_RD_ENTRIES_NUM       (B0_RX_MSDU_PARSER_BASE_ADDRESS + 0x18)
#define	REG_B0_RX_MSDU_PARSER_MSDU_DESC_FIFO_DEBUG                (B0_RX_MSDU_PARSER_BASE_ADDRESS + 0x1C)
#define	REG_B0_RX_MSDU_PARSER_MSDU_DESC_FIFO_STUCK                (B0_RX_MSDU_PARSER_BASE_ADDRESS + 0x20)
#define	REG_B0_RX_MSDU_PARSER_NO_MATCH_CONV_TYPE                  (B0_RX_MSDU_PARSER_BASE_ADDRESS + 0x24)
#define	REG_B0_RX_MSDU_PARSER_CONF_LLC                            (B0_RX_MSDU_PARSER_BASE_ADDRESS + 0x28)
#define	REG_B0_RX_MSDU_PARSER_CONF_OUI                            (B0_RX_MSDU_PARSER_BASE_ADDRESS + 0x2C)
#define	REG_B0_RX_MSDU_PARSER_CONF_TYPE                           (B0_RX_MSDU_PARSER_BASE_ADDRESS + 0x30)
#define	REG_B0_RX_MSDU_PARSER_CONF_CONV_TYPE                      (B0_RX_MSDU_PARSER_BASE_ADDRESS + 0x34)
#define	REG_B0_RX_MSDU_PARSER_MSDU_PARSER_STATUS                  (B0_RX_MSDU_PARSER_BASE_ADDRESS + 0x38)
#define	REG_B0_RX_MSDU_PARSER_RX_MSDU_PARSER_LOGGER_CFG           (B0_RX_MSDU_PARSER_BASE_ADDRESS + 0x3C)
/*---------------------------------------------------------------------------------
/						Data Type Definition										
/----------------------------------------------------------------------------------*/
/*REG_B0_RX_MSDU_PARSER_RX_MSDU_PARSER_EN 0x0 */
typedef union
{
	uint32 val;
	struct
...
} RegB0RxMsduParserRxMsduParserEn_u;

/*REG_B0_RX_MSDU_PARSER_RD_TYPE_CONV_EN 0x4 */
typedef union
{
	uint32 val;
	struct
...
} RegB0RxMsduParserRdTypeConvEn_u;

/*REG_B0_RX_MSDU_PARSER_WPA_PT_MODE_EN 0x8 */
typedef union
{
	uint32 val;
	struct
...
} RegB0RxMsduParserWpaPtModeEn_u;

/*REG_B0_RX_MSDU_PARSER_RX_MSDU_PARSER_CFG 0xC */
typedef union
{
	uint32 val;
	struct
...
} RegB0RxMsduParserRxMsduParserCfg_u;

/*REG_B0_RX_MSDU_PARSER_MSDU_DESC_FIFO_CFG 0x10 */
typedef union
{
	uint32 val;
	struct
...
} RegB0RxMsduParserMsduDescFifoCfg_u;

/*REG_B0_RX_MSDU_PARSER_MSDU_DESC_FIFO_NUM_ENTRIES_COUNT 0x14 */
typedef union
{
	uint32 val;
	struct
...
} RegB0RxMsduParserMsduDescFifoNumEntriesCount_u;

/*REG_B0_RX_MSDU_PARSER_MSDU_DESC_FIFO_RD_ENTRIES_NUM 0x18 */
typedef union
{
	uint32 val;
	struct
...
} RegB0RxMsduParserMsduDescFifoRdEntriesNum_u;

/*REG_B0_RX_MSDU_PARSER_MSDU_DESC_FIFO_DEBUG 0x1C */
typedef union
{
	uint32 val;
	struct
...
} RegB0RxMsduParserMsduDescFifoDebug_u;

/*REG_B0_RX_MSDU_PARSER_MSDU_DESC_FIFO_STUCK 0x20 */
typedef union
{
	uint32 val;
	struct
...
} RegB0RxMsduParserMsduDescFifoStuck_u;

/*REG_B0_RX_MSDU_PARSER_NO_MATCH_CONV_TYPE 0x24 */
typedef union
{
	uint32 val;
	struct
...
} RegB0RxMsduParserNoMatchConvType_u;

/*REG_B0_RX_MSDU_PARSER_CONF_LLC 0x28 */
typedef union
{
	uint32 val;
	struct
...
} RegB0RxMsduParserConfLlc_u;

/*REG_B0_RX_MSDU_PARSER_CONF_OUI 0x2C */
typedef union
{
	uint32 val;
	struct
...
} RegB0RxMsduParserConfOui_u;

/*REG_B0_RX_MSDU_PARSER_CONF_TYPE 0x30 */
typedef union
{
	uint32 val;
	struct
...
} RegB0RxMsduParserConfType_u;

/*REG_B0_RX_MSDU_PARSER_CONF_CONV_TYPE 0x34 */
typedef union
{
	uint32 val;
	struct
...
} RegB0RxMsduParserConfConvType_u;

/*REG_B0_RX_MSDU_PARSER_MSDU_PARSER_STATUS 0x38 */
typedef union
{
	uint32 val;
	struct
...
} RegB0RxMsduParserMsduParserStatus_u;

/*REG_B0_RX_MSDU_PARSER_RX_MSDU_PARSER_LOGGER_CFG 0x3C */
typedef union
{
	uint32 val;
	struct
...
} RegB0RxMsduParserRxMsduParserLoggerCfg_u;



#endif // _B0_RX_MSDU_PARSER_REGS_H_
