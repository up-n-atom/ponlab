...
************************************************************************************/
#ifndef _PHY_TXTD_ANT_REGS_H_
#define _PHY_TXTD_ANT_REGS_H_
...
#define PHY_TXTD_ANT_BASE_ADDRESS                             MEMORY_MAP_UNIT_93_BASE_ADDRESS
#define	REG_PHY_TXTD_ANT_TX_MODE_11B_EN                (PHY_TXTD_ANT_BASE_ADDRESS + 0x0)
#define	REG_PHY_TXTD_ANT_TX_DC_OFFSET_0                (PHY_TXTD_ANT_BASE_ADDRESS + 0x8)
#define	REG_PHY_TXTD_ANT_TX_DC_OFFSET_1                (PHY_TXTD_ANT_BASE_ADDRESS + 0xC)
#define	REG_PHY_TXTD_ANT_TX_DC_OFFSET_2                (PHY_TXTD_ANT_BASE_ADDRESS + 0x10)
#define	REG_PHY_TXTD_ANT_TX_DC_OFFSET_3                (PHY_TXTD_ANT_BASE_ADDRESS + 0x14)
#define	REG_PHY_TXTD_ANT_TXTD_TEST_PLUG_MUX_CONTROL    (PHY_TXTD_ANT_BASE_ADDRESS + 0x18)
#define	REG_PHY_TXTD_ANT_TX_ANT_RAM_RM                 (PHY_TXTD_ANT_BASE_ADDRESS + 0x1C)
#define	REG_PHY_TXTD_ANT_TXTD_ANT_SPARE                (PHY_TXTD_ANT_BASE_ADDRESS + 0x20)
#define	REG_PHY_TXTD_ANT_TXTD_ANT_BYPASS_REG           (PHY_TXTD_ANT_BASE_ADDRESS + 0x24)
#define	REG_PHY_TXTD_ANT_TXTD_WINDOWING                (PHY_TXTD_ANT_BASE_ADDRESS + 0x28)
#define	REG_PHY_TXTD_ANT_TXTD_DUP_SWAP_FLIP            (PHY_TXTD_ANT_BASE_ADDRESS + 0x2C)
#define	REG_PHY_TXTD_ANT_TXTD_MIX11B_FREQ_OFFSET       (PHY_TXTD_ANT_BASE_ADDRESS + 0x30)
#define	REG_PHY_TXTD_ANT_TXTD_UPS8_COEFF_0             (PHY_TXTD_ANT_BASE_ADDRESS + 0x34)
#define	REG_PHY_TXTD_ANT_TXTD_UPS8_COEFF_1             (PHY_TXTD_ANT_BASE_ADDRESS + 0x38)
#define	REG_PHY_TXTD_ANT_TXTD_UPS8_COEFF_2             (PHY_TXTD_ANT_BASE_ADDRESS + 0x3C)
#define	REG_PHY_TXTD_ANT_TXTD_UPS8_COEFF_3             (PHY_TXTD_ANT_BASE_ADDRESS + 0x40)
#define	REG_PHY_TXTD_ANT_TXTD_UPS8_COEFF_4             (PHY_TXTD_ANT_BASE_ADDRESS + 0x44)
#define	REG_PHY_TXTD_ANT_TXTD_UPS8_COEFF_5             (PHY_TXTD_ANT_BASE_ADDRESS + 0x48)
#define	REG_PHY_TXTD_ANT_TXTD_UPS8_COEFF_6             (PHY_TXTD_ANT_BASE_ADDRESS + 0x4C)
#define	REG_PHY_TXTD_ANT_TXTD_UPS8_COEFF_7             (PHY_TXTD_ANT_BASE_ADDRESS + 0x50)
#define	REG_PHY_TXTD_ANT_TXTD_MEM_GLOBAL_RM            (PHY_TXTD_ANT_BASE_ADDRESS + 0x54)
#define	REG_PHY_TXTD_ANT_TXTD_MEM_GLOBAL_TEST_MODE     (PHY_TXTD_ANT_BASE_ADDRESS + 0x58)
#define	REG_PHY_TXTD_ANT_TXTD_SPARE                    (PHY_TXTD_ANT_BASE_ADDRESS + 0x5C)
#define	REG_PHY_TXTD_ANT_TXTD_AFE_IDLE_I_DATA          (PHY_TXTD_ANT_BASE_ADDRESS + 0x60)
#define	REG_PHY_TXTD_ANT_TXTD_AFE_IDLE_Q_DATA          (PHY_TXTD_ANT_BASE_ADDRESS + 0x64)
#define	REG_PHY_TXTD_ANT_TXTD_BIST                     (PHY_TXTD_ANT_BASE_ADDRESS + 0x68)
#define	REG_PHY_TXTD_ANT_TX_IQ_RIPPLE                  (PHY_TXTD_ANT_BASE_ADDRESS + 0x6C)
#define	REG_PHY_TXTD_ANT_TXTD_IFFT_IN_OUT_SHIFT        (PHY_TXTD_ANT_BASE_ADDRESS + 0x70)
#define	REG_PHY_TXTD_ANT_TXTD_END_ZEROS                (PHY_TXTD_ANT_BASE_ADDRESS + 0x74)
#define	REG_PHY_TXTD_ANT_TX_ABB_30                     (PHY_TXTD_ANT_BASE_ADDRESS + 0x78)
#define	REG_PHY_TXTD_ANT_TX_ANT_REG_31                 (PHY_TXTD_ANT_BASE_ADDRESS + 0x7C)
#define	REG_PHY_TXTD_ANT_TX_BF_CAL_GAIN_INDEX_ANT      (PHY_TXTD_ANT_BASE_ADDRESS + 0x80)
#define	REG_PHY_TXTD_ANT_TPC_ANT_RAM                   (PHY_TXTD_ANT_BASE_ADDRESS + 0x84)
#define	REG_PHY_TXTD_ANT_TPC_ACCELERATOR               (PHY_TXTD_ANT_BASE_ADDRESS + 0x88)
#define	REG_PHY_TXTD_ANT_TPC_TSSI_A_B                  (PHY_TXTD_ANT_BASE_ADDRESS + 0x8C)
#define	REG_PHY_TXTD_ANT_TPC_TSSI_C                    (PHY_TXTD_ANT_BASE_ADDRESS + 0x90)
#define	REG_PHY_TXTD_ANT_TPC_SHORT                     (PHY_TXTD_ANT_BASE_ADDRESS + 0x94)
#define	REG_PHY_TXTD_ANT_RF_POWER                      (PHY_TXTD_ANT_BASE_ADDRESS + 0x98)
#define	REG_PHY_TXTD_ANT_TX_DIGITAL_GAIN               (PHY_TXTD_ANT_BASE_ADDRESS + 0x9C)
#define	REG_PHY_TXTD_ANT_TX_PGC2_GAIN_SELECT_OUT       (PHY_TXTD_ANT_BASE_ADDRESS + 0xA0)
#define	REG_PHY_TXTD_ANT_RF_POWER_OFFSET               (PHY_TXTD_ANT_BASE_ADDRESS + 0xA4)
#define	REG_PHY_TXTD_ANT_TXTD_11B_IQ_0                 (PHY_TXTD_ANT_BASE_ADDRESS + 0xA8)
#define	REG_PHY_TXTD_ANT_TXTD_11B_IQ_1                 (PHY_TXTD_ANT_BASE_ADDRESS + 0xAC)
#define	REG_PHY_TXTD_ANT_STREAMER                      (PHY_TXTD_ANT_BASE_ADDRESS + 0xB0)
#define	REG_PHY_TXTD_ANT_TEST_PLUG_LEN                 (PHY_TXTD_ANT_BASE_ADDRESS + 0xB4)
#define	REG_PHY_TXTD_ANT_TXTD_UPS_COEFF_0              (PHY_TXTD_ANT_BASE_ADDRESS + 0xB8)
#define	REG_PHY_TXTD_ANT_TXTD_UPS_COEFF_2              (PHY_TXTD_ANT_BASE_ADDRESS + 0xBC)
#define	REG_PHY_TXTD_ANT_TXTD_UPSRF_COEFF_0            (PHY_TXTD_ANT_BASE_ADDRESS + 0xC0)
#define	REG_PHY_TXTD_ANT_PM_ANALOG_LPBK_EN             (PHY_TXTD_ANT_BASE_ADDRESS + 0xC4)
#define	REG_PHY_TXTD_ANT_TXTD_GCLK_EN                  (PHY_TXTD_ANT_BASE_ADDRESS + 0xC8)
#define	REG_PHY_TXTD_ANT_TONE_GEN_BW                   (PHY_TXTD_ANT_BASE_ADDRESS + 0xCC)
#define	REG_PHY_TXTD_ANT_TX_SC2FC_TXON                 (PHY_TXTD_ANT_BASE_ADDRESS + 0xD0)
#define	REG_PHY_TXTD_ANT_TXTD_BYPASS_SEL               (PHY_TXTD_ANT_BASE_ADDRESS + 0xD4)
#define	REG_PHY_TXTD_ANT_TX_PPM_FREQ_IN_CFG            (PHY_TXTD_ANT_BASE_ADDRESS + 0xD8)
#define	REG_PHY_TXTD_ANT_TX_PM_FDL_NCO_UP_LIM_CFG      (PHY_TXTD_ANT_BASE_ADDRESS + 0xE0)
#define	REG_PHY_TXTD_ANT_TX_PM_FDL_NCO_INCR_MAX_CFG    (PHY_TXTD_ANT_BASE_ADDRESS + 0xE4)
#define	REG_PHY_TXTD_ANT_TX_PM_FDL_NCO_INCR_CFG        (PHY_TXTD_ANT_BASE_ADDRESS + 0xE8)
#define	REG_PHY_TXTD_ANT_PM_DPD_CFG_SEL_DPD_PHY_I      (PHY_TXTD_ANT_BASE_ADDRESS + 0xEC)
#define	REG_PHY_TXTD_ANT_PM_DPD_STATUS_DBG_RDY_O       (PHY_TXTD_ANT_BASE_ADDRESS + 0xF0)
#define	REG_PHY_TXTD_ANT_PM_DPD_DBG_CTL_RUN_I          (PHY_TXTD_ANT_BASE_ADDRESS + 0xF4)
#define	REG_PHY_TXTD_ANT_PM_DPD_DBG_RES_O_0            (PHY_TXTD_ANT_BASE_ADDRESS + 0xF8)
#define	REG_PHY_TXTD_ANT_PM_DPD_DBG_RES_O_1            (PHY_TXTD_ANT_BASE_ADDRESS + 0xFC)
#define	REG_PHY_TXTD_ANT_PM_DPD_DBG_RES_O_2            (PHY_TXTD_ANT_BASE_ADDRESS + 0x100)
#define	REG_PHY_TXTD_ANT_PM_DPD_DBG_RES_O_3            (PHY_TXTD_ANT_BASE_ADDRESS + 0x104)
#define	REG_PHY_TXTD_ANT_PM_DPD_DBG_RES_O_4            (PHY_TXTD_ANT_BASE_ADDRESS + 0x108)
#define	REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_0_0_1           (PHY_TXTD_ANT_BASE_ADDRESS + 0x10C)
#define	REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_0_2_3           (PHY_TXTD_ANT_BASE_ADDRESS + 0x110)
#define	REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_0_4_5           (PHY_TXTD_ANT_BASE_ADDRESS + 0x114)
#define	REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_0_6_7           (PHY_TXTD_ANT_BASE_ADDRESS + 0x118)
#define	REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_0_8             (PHY_TXTD_ANT_BASE_ADDRESS + 0x11C)
#define	REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_1_0_1           (PHY_TXTD_ANT_BASE_ADDRESS + 0x120)
#define	REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_1_2_3           (PHY_TXTD_ANT_BASE_ADDRESS + 0x124)
#define	REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_1_4_5           (PHY_TXTD_ANT_BASE_ADDRESS + 0x128)
#define	REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_1_6_7           (PHY_TXTD_ANT_BASE_ADDRESS + 0x12C)
#define	REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_1_8             (PHY_TXTD_ANT_BASE_ADDRESS + 0x130)
#define	REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_2_0_1           (PHY_TXTD_ANT_BASE_ADDRESS + 0x134)
#define	REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_2_2_3           (PHY_TXTD_ANT_BASE_ADDRESS + 0x138)
#define	REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_2_4_5           (PHY_TXTD_ANT_BASE_ADDRESS + 0x13C)
#define	REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_2_6_7           (PHY_TXTD_ANT_BASE_ADDRESS + 0x140)
#define	REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_2_8             (PHY_TXTD_ANT_BASE_ADDRESS + 0x144)
#define	REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_3_0_1           (PHY_TXTD_ANT_BASE_ADDRESS + 0x148)
#define	REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_3_2_3           (PHY_TXTD_ANT_BASE_ADDRESS + 0x14C)
#define	REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_3_4_5           (PHY_TXTD_ANT_BASE_ADDRESS + 0x150)
#define	REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_3_6_7           (PHY_TXTD_ANT_BASE_ADDRESS + 0x154)
#define	REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_3_8             (PHY_TXTD_ANT_BASE_ADDRESS + 0x158)
#define	REG_PHY_TXTD_ANT_TXTD_ANT_RAM_POWER_SAVE       (PHY_TXTD_ANT_BASE_ADDRESS + 0x29C)
#define	REG_PHY_TXTD_ANT_TPC_DPD                       (PHY_TXTD_ANT_BASE_ADDRESS + 0x2A0)
#define	REG_PHY_TXTD_ANT_CLIPPER_CONF                  (PHY_TXTD_ANT_BASE_ADDRESS + 0x2A4)
#define	REG_PHY_TXTD_ANT_CLIPPER_THRESHOLD             (PHY_TXTD_ANT_BASE_ADDRESS + 0x2A8)
#define	REG_PHY_TXTD_ANT_LOOPBACK_PYPASS               (PHY_TXTD_ANT_BASE_ADDRESS + 0x2AC)
#define	REG_PHY_TXTD_ANT_TXTD_GCLK_BYPASS              (PHY_TXTD_ANT_BASE_ADDRESS + 0x2B0)
/*---------------------------------------------------------------------------------
/						Data Type Definition										
/----------------------------------------------------------------------------------*/
/*REG_PHY_TXTD_ANT_TX_MODE_11B_EN 0x0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxMode11BEn_u;

/*REG_PHY_TXTD_ANT_TX_DC_OFFSET_0 0x8 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxDcOffset0_u;

/*REG_PHY_TXTD_ANT_TX_DC_OFFSET_1 0xC */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxDcOffset1_u;

/*REG_PHY_TXTD_ANT_TX_DC_OFFSET_2 0x10 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxDcOffset2_u;

/*REG_PHY_TXTD_ANT_TX_DC_OFFSET_3 0x14 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxDcOffset3_u;

/*REG_PHY_TXTD_ANT_TXTD_TEST_PLUG_MUX_CONTROL 0x18 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtdTestPlugMuxControl_u;

/*REG_PHY_TXTD_ANT_TX_ANT_RAM_RM 0x1C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxAntRamRm_u;

/*REG_PHY_TXTD_ANT_TXTD_ANT_SPARE 0x20 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtdAntSpare_u;

/*REG_PHY_TXTD_ANT_TXTD_ANT_BYPASS_REG 0x24 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtdAntBypassReg_u;

/*REG_PHY_TXTD_ANT_TXTD_WINDOWING 0x28 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtdWindowing_u;

/*REG_PHY_TXTD_ANT_TXTD_DUP_SWAP_FLIP 0x2C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtdDupSwapFlip_u;

/*REG_PHY_TXTD_ANT_TXTD_MIX11B_FREQ_OFFSET 0x30 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtdMix11BFreqOffset_u;

/*REG_PHY_TXTD_ANT_TXTD_UPS8_COEFF_0 0x34 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtdUps8Coeff0_u;

/*REG_PHY_TXTD_ANT_TXTD_UPS8_COEFF_1 0x38 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtdUps8Coeff1_u;

/*REG_PHY_TXTD_ANT_TXTD_UPS8_COEFF_2 0x3C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtdUps8Coeff2_u;

/*REG_PHY_TXTD_ANT_TXTD_UPS8_COEFF_3 0x40 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtdUps8Coeff3_u;

/*REG_PHY_TXTD_ANT_TXTD_UPS8_COEFF_4 0x44 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtdUps8Coeff4_u;

/*REG_PHY_TXTD_ANT_TXTD_UPS8_COEFF_5 0x48 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtdUps8Coeff5_u;

/*REG_PHY_TXTD_ANT_TXTD_UPS8_COEFF_6 0x4C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtdUps8Coeff6_u;

/*REG_PHY_TXTD_ANT_TXTD_UPS8_COEFF_7 0x50 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtdUps8Coeff7_u;

/*REG_PHY_TXTD_ANT_TXTD_MEM_GLOBAL_RM 0x54 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtdMemGlobalRm_u;

/*REG_PHY_TXTD_ANT_TXTD_MEM_GLOBAL_TEST_MODE 0x58 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtdMemGlobalTestMode_u;

/*REG_PHY_TXTD_ANT_TXTD_SPARE 0x5C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtdSpare_u;

/*REG_PHY_TXTD_ANT_TXTD_AFE_IDLE_I_DATA 0x60 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtdAfeIdleIData_u;

/*REG_PHY_TXTD_ANT_TXTD_AFE_IDLE_Q_DATA 0x64 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtdAfeIdleQData_u;

/*REG_PHY_TXTD_ANT_TXTD_BIST 0x68 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtdBist_u;

/*REG_PHY_TXTD_ANT_TX_IQ_RIPPLE 0x6C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxIqRipple_u;

/*REG_PHY_TXTD_ANT_TXTD_IFFT_IN_OUT_SHIFT 0x70 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtdIfftInOutShift_u;

/*REG_PHY_TXTD_ANT_TXTD_END_ZEROS 0x74 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtdEndZeros_u;

/*REG_PHY_TXTD_ANT_TX_ABB_30 0x78 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxAbb30_u;

/*REG_PHY_TXTD_ANT_TX_ANT_REG_31 0x7C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxAntReg31_u;

/*REG_PHY_TXTD_ANT_TX_BF_CAL_GAIN_INDEX_ANT 0x80 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxBfCalGainIndexAnt_u;

/*REG_PHY_TXTD_ANT_TPC_ANT_RAM 0x84 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTpcAntRam_u;

/*REG_PHY_TXTD_ANT_TPC_ACCELERATOR 0x88 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTpcAccelerator_u;

/*REG_PHY_TXTD_ANT_TPC_TSSI_A_B 0x8C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTpcTssiAB_u;

/*REG_PHY_TXTD_ANT_TPC_TSSI_C 0x90 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTpcTssiC_u;

/*REG_PHY_TXTD_ANT_TPC_SHORT 0x94 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTpcShort_u;

/*REG_PHY_TXTD_ANT_RF_POWER 0x98 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntRfPower_u;

/*REG_PHY_TXTD_ANT_TX_DIGITAL_GAIN 0x9C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxDigitalGain_u;

/*REG_PHY_TXTD_ANT_TX_PGC2_GAIN_SELECT_OUT 0xA0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxPgc2GainSelectOut_u;

/*REG_PHY_TXTD_ANT_RF_POWER_OFFSET 0xA4 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntRfPowerOffset_u;

/*REG_PHY_TXTD_ANT_TXTD_11B_IQ_0 0xA8 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtd11BIq0_u;

/*REG_PHY_TXTD_ANT_TXTD_11B_IQ_1 0xAC */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtd11BIq1_u;

/*REG_PHY_TXTD_ANT_STREAMER 0xB0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntStreamer_u;

/*REG_PHY_TXTD_ANT_TEST_PLUG_LEN 0xB4 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTestPlugLen_u;

/*REG_PHY_TXTD_ANT_TXTD_UPS_COEFF_0 0xB8 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtdUpsCoeff0_u;

/*REG_PHY_TXTD_ANT_TXTD_UPS_COEFF_2 0xBC */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtdUpsCoeff2_u;

/*REG_PHY_TXTD_ANT_TXTD_UPSRF_COEFF_0 0xC0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtdUpsrfCoeff0_u;

/*REG_PHY_TXTD_ANT_PM_ANALOG_LPBK_EN 0xC4 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntPmAnalogLpbkEn_u;

/*REG_PHY_TXTD_ANT_TXTD_GCLK_EN 0xC8 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtdGclkEn_u;

/*REG_PHY_TXTD_ANT_TONE_GEN_BW 0xCC */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntToneGenBw_u;

/*REG_PHY_TXTD_ANT_TX_SC2FC_TXON 0xD0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxSc2FcTxon_u;

/*REG_PHY_TXTD_ANT_TXTD_BYPASS_SEL 0xD4 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtdBypassSel_u;

/*REG_PHY_TXTD_ANT_TX_PPM_FREQ_IN_CFG 0xD8 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxPpmFreqInCfg_u;

/*REG_PHY_TXTD_ANT_TX_PM_FDL_NCO_UP_LIM_CFG 0xE0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxPmFdlNcoUpLimCfg_u;

/*REG_PHY_TXTD_ANT_TX_PM_FDL_NCO_INCR_MAX_CFG 0xE4 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxPmFdlNcoIncrMaxCfg_u;

/*REG_PHY_TXTD_ANT_TX_PM_FDL_NCO_INCR_CFG 0xE8 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxPmFdlNcoIncrCfg_u;

/*REG_PHY_TXTD_ANT_PM_DPD_CFG_SEL_DPD_PHY_I 0xEC */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntPmDpdCfgSelDpdPhyI_u;

/*REG_PHY_TXTD_ANT_PM_DPD_STATUS_DBG_RDY_O 0xF0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntPmDpdStatusDbgRdyO_u;

/*REG_PHY_TXTD_ANT_PM_DPD_DBG_CTL_RUN_I 0xF4 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntPmDpdDbgCtlRunI_u;

/*REG_PHY_TXTD_ANT_PM_DPD_DBG_RES_O_0 0xF8 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntPmDpdDbgResO0_u;

/*REG_PHY_TXTD_ANT_PM_DPD_DBG_RES_O_1 0xFC */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntPmDpdDbgResO1_u;

/*REG_PHY_TXTD_ANT_PM_DPD_DBG_RES_O_2 0x100 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntPmDpdDbgResO2_u;

/*REG_PHY_TXTD_ANT_PM_DPD_DBG_RES_O_3 0x104 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntPmDpdDbgResO3_u;

/*REG_PHY_TXTD_ANT_PM_DPD_DBG_RES_O_4 0x108 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntPmDpdDbgResO4_u;

/*REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_0_0_1 0x10C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntPmDpdMemEq001_u;

/*REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_0_2_3 0x110 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntPmDpdMemEq023_u;

/*REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_0_4_5 0x114 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntPmDpdMemEq045_u;

/*REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_0_6_7 0x118 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntPmDpdMemEq067_u;

/*REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_0_8 0x11C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntPmDpdMemEq08_u;

/*REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_1_0_1 0x120 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntPmDpdMemEq101_u;

/*REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_1_2_3 0x124 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntPmDpdMemEq123_u;

/*REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_1_4_5 0x128 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntPmDpdMemEq145_u;

/*REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_1_6_7 0x12C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntPmDpdMemEq167_u;

/*REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_1_8 0x130 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntPmDpdMemEq18_u;

/*REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_2_0_1 0x134 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntPmDpdMemEq201_u;

/*REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_2_2_3 0x138 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntPmDpdMemEq223_u;

/*REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_2_4_5 0x13C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntPmDpdMemEq245_u;

/*REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_2_6_7 0x140 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntPmDpdMemEq267_u;

/*REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_2_8 0x144 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntPmDpdMemEq28_u;

/*REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_3_0_1 0x148 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntPmDpdMemEq301_u;

/*REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_3_2_3 0x14C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntPmDpdMemEq323_u;

/*REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_3_4_5 0x150 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntPmDpdMemEq345_u;

/*REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_3_6_7 0x154 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntPmDpdMemEq367_u;

/*REG_PHY_TXTD_ANT_PM_DPD_MEM_EQ_3_8 0x158 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntPmDpdMemEq38_u;

/*REG_PHY_TXTD_ANT_TXTD_ANT_RAM_POWER_SAVE 0x29C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtdAntRamPowerSave_u;

/*REG_PHY_TXTD_ANT_TPC_DPD 0x2A0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTpcDpd_u;

/*REG_PHY_TXTD_ANT_CLIPPER_CONF 0x2A4 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntClipperConf_u;

/*REG_PHY_TXTD_ANT_CLIPPER_THRESHOLD 0x2A8 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntClipperThreshold_u;

/*REG_PHY_TXTD_ANT_LOOPBACK_PYPASS 0x2AC */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntLoopbackPypass_u;

/*REG_PHY_TXTD_ANT_TXTD_GCLK_BYPASS 0x2B0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyTxtdAntTxtdGclkBypass_u;



#endif // _PHY_TXTD_ANT_REGS_H_
