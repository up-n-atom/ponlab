...
Module:				ulPostRx
SOC Revision:		latest
Generated at:       2022-03-29 07:46:08
Purpose:
...
typedef union
{
	...
	struct
	{
		...
		uint32 reserved0 : 3;
		uint32 ulMuDisableDataFieldBitPosition : 2; //This global configuration defines the location of the UL MU Data Disable field within the Reserved section of the Control Information subfield in case (CTRL_ID == 1). This configuration is valid only in case UL MU Disable Data Field Enable configuration is valid. The field location is decoded as follows: 0 - Bit 9;  1 - Bit 10;  2 - Bit 11;  3 - Reserved, reset value: 0x0, access type: RW
		uint32 reserved1 : 26;
	} bitFields;
