...
#define HOST_IF_ACC_BASE_ADDR                                                  (0xA0257000)
...
#define HOST_IF_ACC_OFFSET_FROM_BAR0                                           (0x00257000)
...
#define HOST_IF_COUNTERS_SIZE                                                  (0x00007000)
...
#define BA_ANALYZER_COUNTER_SIZE                                               (0x00003000)
...
#define REDUCED_CPU_IRAM_SIZE                                                  (0x00180000)
 ...
 /* auto generated from wave600_rams_by_modules_ver1.10.0.xlsm, sheet gen6_wlanip_rams_by_modules */
...
#define CH_RAM_0_DATA_CH_RAM_LO                                                (B0_PHY_RX_FD_BASE_ADDR + 0x00010000) /* MEMORY_MAP_UNIT_51_BASE_ADDRESS */
#define CH_RAM_0_DATA_CH_RAM_HI                                                (B0_PHY_RX_FD_BASE_ADDR + 0x00010000) /* MEMORY_MAP_UNIT_51_BASE_ADDRESS */
#define CH_RAM_1_DATA_CH_RAM_LO                                                (B0_PHY_RX_FD_BASE_ADDR + 0x00010000) /* MEMORY_MAP_UNIT_51_BASE_ADDRESS */
#define CH_RAM_1_DATA_CH_RAM_HI                                                (B0_PHY_RX_FD_BASE_ADDR + 0x00010000) /* MEMORY_MAP_UNIT_51_BASE_ADDRESS */
#define CH_RAM_2_DATA_CH_RAM_LO                                                (B0_PHY_RX_FD_BASE_ADDR + 0x00010000) /* MEMORY_MAP_UNIT_51_BASE_ADDRESS */
#define CH_RAM_2_DATA_CH_RAM_HI                                                (B0_PHY_RX_FD_BASE_ADDR + 0x00010000) /* MEMORY_MAP_UNIT_51_BASE_ADDRESS */
#define CH_RAM_3_DATA_CH_RAM_LO                                                (B0_PHY_RX_FD_BASE_ADDR + 0x00010000) /* MEMORY_MAP_UNIT_51_BASE_ADDRESS */
#define CH_RAM_3_DATA_CH_RAM_HI                                                (B0_PHY_RX_FD_BASE_ADDR + 0x00010000) /* MEMORY_MAP_UNIT_51_BASE_ADDRESS */
...
#define RX_PP_RX_PP_STATISTICS_RAM                                             (RX_PP_COUNTERS_BASE_ADDR + 0x00000800) /* MEMORY_MAP_UNIT_64_BASE_ADDRESS */
...
#define HOST_IF_ACC_HOST_IF_ACC_STATISTICS_RAM                                 (HOST_IF_COUNTERS_BASE_ADDR + 0x00005000) /* MEMORY_MAP_UNIT_63_BASE_ADDRESS */
...
#define HYP_RXTD_SHARED_TEST_BUS_FIFO_0                                        (B0_PHY_TEST_BUS_BASE_ADDR + 0x00020000) /* MEMORY_MAP_UNIT_1096_BASE_ADDRESS */
#define HYP_RXTD_SHARED_TEST_BUS_FIFO_1                                        (B1_PHY_TEST_BUS_BASE_ADDR + 0x00020000) /* MEMORY_MAP_UNIT_11096_BASE_ADDRESS */
...
#define HYP_RXFD_SEG_0_SPHERE_CLOCKS_RAM0                                      (B0_PHY_RX_FD_BASE_ADDR + 0x0000E800) /* MEMORY_MAP_UNIT_51_BASE_ADDRESS */
#define HYP_RXFD_SEG_1_SPHERE_CLOCKS_RAM1                                      (B1_PHY_RX_FD_BASE_ADDR + 0x0000E800) /* MEMORY_MAP_UNIT_10051_BASE_ADDRESS */
