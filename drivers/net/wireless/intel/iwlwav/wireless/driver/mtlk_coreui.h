...
/* Renaming the constants common to 2G, 5G and 6G without changing the Kernel defines */
#define HE_2G_PHY_CAP0_CHAN_WIDTH_SET_40MHZ \
...
#define EVM_INVALID     MIN_EVM

/* EVM is reported in units of 0.5 dBs. Divide by 2 to get dBs*/
#define EVM_TO_DB(__val) \
        ((__val) >> 1)
...
#define MTLK_PARAM_DB_INVALID_UINT8  ((uint8) MAX_UINT8)
#define MTLK_PARAM_DB_INVALID_UINT16 ((uint16)MAX_UINT16)
#define MTLK_PARAM_DB_INVALID_UINT32 ((uint32)MAX_UINT32)
...
#define MTLK_PARAM_DB_VALUE_IS_INVALID(param) \
        wave_param_db_value_is_invalid_ex(param, sizeof(param))

static __INLINE BOOL
wave_param_db_value_is_invalid_ex (unsigned param, size_t size)
{
  return ((((size == sizeof(uint8))  && (((uint8) param) == MTLK_PARAM_DB_INVALID_UINT8)))  ||
          (((size == sizeof(uint16)) && (((uint16)param) == MTLK_PARAM_DB_INVALID_UINT16))) ||
...
#define WAVE_MAX_SID_GEN7                GEN7_MAX_SID
#define WAVE_MAX_STA_ID                  (GEN6_MAX_SID-1)
#define WAVE_MAX_STA_ID_GEN7             (GEN7_MAX_SID-1)
...
typedef enum
{
  ...
  WAVE_CORE_REQ_REQUEST_AID,         /*!< Request AID */
  WAVE_CORE_REQ_REMOVE_AID,          /*!< Remvoe AID */
...
#ifdef UNUSED_CODE
  WAVE_CORE_REQ_ABORT_CCA,                      /*!< Abort CCA */
#endif /* UNUSED_CODE */
  ...
  WAVE_RADIO_REQ_MBSS_VAP_CREATE_SEC_VAP,       /*!< MBSS Create SecVap issued by Master */
  WAVE_RADIO_REQ_MBSS_VAP_DEL_SEC_VAP,          /*!< MBSS Delete SecVap issued by Master */
  ...
  WAVE_RADIO_REQ_SET_FILS_BEACON_FLAG,          /*!< Set Fils Beacon Flag */
  WAVE_RADIO_REQ_GET_FILS_BEACON_FLAG,          /*!< Get Fils Beacon Flag */
  ...
  WAVE_RADIO_REQ_GET_20MHZ_TX_POWER,
  ...
  WAVE_RADIO_REQ_UPDATE_WIPHY_REGDB,            /*!< Update wiphy regdb */
  WAVE_RADIO_REQ_UPDATE_AFC_REG_INFO,           /*!< Update regulatory paramdb table with AFC info */
  ...
  WAVE_CORE_REQ_GET_WIFI_CHANNEL_STATS,         /*!< Get radio channel statistics */
  WAVE_CORE_REQ_GET_DRV_CHANNEL_STATS,          /*!< Get additional radio channel statistics from driver */
  ...
  WAVE_CORE_REQ_RESET_STATISTICS,                /*!< Reset statistics */
  ...
  WAVE_CORE_REQ_SET_MGMT_FRAME_PWR_CTRL,         /*!< Set Management Frame Tx Power */
  WAVE_CORE_REQ_GET_MGMT_FRAME_PWR_CTRL,         /*!< Get Management Frame Tx Power */
  WAVE_CORE_REQ_SET_RSSI_IGNORE_PROBE_REQUEST,   /*!< Set RSSI ignore probe request value */
  WAVE_CORE_REQ_GET_PEER_MIXED_STATS,            /*!< Get peer mixed statistics */
  WAVE_CORE_REQ_SET_CSI_ENABLE,                  /*!< Set Csi configuration */
  WAVE_CORE_REQ_GET_CSI_ENABLE,                  /*!< Get Csi configuration */
  WAVE_CORE_REQ_SET_CSI_SEND_QOS_NULL,           /*!< Set Csi send QOS NULL Frame */
  WAVE_CORE_REQ_SET_CSI_AUTO_RATE,               /*!< Set Csi Auto configuration */
  WAVE_CORE_REQ_GET_CSI_AUTO_RATE,               /*!< Get Csi Auto configuration */
  WAVE_CORE_REQ_GET_CSI_STATS,                   /*!< Get Channel State Info Stats */
  WAVE_CORE_REQ_GET_CSI_COUNTERS,                /*!< Get Channel State Info Counters */
  WAVE_CORE_REQ_GET_LA_MU_GROUPS_STATS,          /*!< Get MU Groups Counters */
  WAVE_CORE_REQ_GET_STA_DISCNT_WARN,             /*!< Get STA Disconnect timer */
  WAVE_CORE_REQ_TRIGGER_STA_DISCNT_WHM,          /*!< Trigger STA Disconnect WHM task */
  WAVE_RADIO_REQ_SET_FIXED_RATE,                 /*!< Set Fixed Rate */
  WAVE_CORE_REQ_SET_ALLOW_3ADDR_MCAST,           /*!< Set 3 Address mode for Multicast */
  WAVE_CORE_REQ_GET_ALLOW_3ADDR_MCAST,           /*!< Get 3 Address mode for multicast */
  WAVE_RADIO_REQ_GET_MU_GROUP_PLAN,              /*!< Get MU Group Plan */
  WAVE_CORE_REQ_GET_LA_SU_MU_RU_OFDMA_STATS,     /*!< Get Link Adapt SuMuRu stats */
  WAVE_CORE_REQ_CHANGE_ROLE,                     /*!< Change interface role (AP or STA) */
  WAVE_RADIO_REQ_GET_CSI_CAPABILITY,             /*!< Get CSI capability */
  WAVE_RADIO_REQ_GET_PROP_PHY_CAP,               /*!< Get proprietary phy capabilities */
  WAVE_CORE_REQ_SET_ACL,                         /*!< Set ACL list */
  WAVE_CORE_REQ_GET_ACL,                         /*!< Get ACL list */
  ...
  WAVE_CORE_REQ_SET_EHT_OPERATION,               /*!< Set EHT Operation */
  WAVE_CORE_REQ_GET_EHT_OPERATION,               /*!< Get EHT Operation */
  WAVE_CORE_REQ_SET_EHT_NON_ADVERTISED,          /*!< Set EHT Non Advertised Capab */
  WAVE_CORE_REQ_GET_EHT_NON_ADVERTISED,          /*!< Get EHT Non Advertised Capab */
  WAVE_RADIO_REQ_GET_LOGGER_FIFO_MUX_CFG,        /*!< Get Logger HW FIFO Mux config */
  WAVE_RADIO_REQ_SET_LOGGER_FIFO_MUX_CFG,        /*!< Set Logger HW FIFO Mux config */
  WAVE_CORE_REQ_SETUP_MLD,                       /*!< setup AP MLD */
  WAVE_CORE_REQ_SET_MLD_INFO,                    /*!< set AP MLD */
  WAVE_CORE_REQ_ML_SID,                          /*!< get SIDs for ML STA(s) */
  ...
  WAVE_CORE_REQ_SCS_REM,                         /*!< SCS REM Request */
  WAVE_CORE_REQ_ML_TX_T2LM_TEARDOWN,             /*!< Send t2lm teardown frame command for ML STA */
  WAVE_CORE_REQ_GET_ML_STA_LINK_STATS,           /*!< Get Link stats */
  WAVE_CORE_REQ_SET_ML_STA_LINK_STATS,           /*!< Reset Link stats */
  WAVE_CORE_REQ_GET_ML_VAP_LIST,                 /*!< Get ML VAP list */
#ifdef BEST_EFFORT_TID_SPREADING
  WAVE_CORE_REQ_SET_STR_TID_LINK_SPREADING,      /*!< enable/disable STR TID to link spreading */
  WAVE_CORE_REQ_CLEANUP_SKB_HASH,                /*!< Cleanup skb hash */
  WAVE_CORE_REQ_CALCULATE_EFFECTIVE_RATES_STR,   /*!< Calculate STR STA effective rates */
#endif
  WAVE_CORE_REQ_ML_STA_REASSOC_NOTIFY,           /*!< ML STA reassoc notify */
...
/* DEBUG COMMANDS */
  ...
  WAVE_CORE_REQ_GET_LA_MU_VHT_STATS,
#endif /* CONFIG_WAVE_DEBUG */
  WAVE_RADIO_REQ_EMULATE_INTERFERER,            /*!< Emulate Interferer */
  WAVE_HW_REQ_SET_PCIE_SPEED,                   /*!< Set PCIE speed cfg */
...
typedef struct mtlk_core_dup_beacon
{
  int enabled;
  int bw;
} mtlk_core_dup_beacon_t;
...
MTLK_DECLARE_CFG_START(mtlk_gen_core_cfg_t)
  ...
  MTLK_CFG_ITEM(int, multi_ap_mode)
...
MTLK_DECLARE_CFG_START(mtlk_core_rssi_ignore_probe_request_t)
  MTLK_CFG_ITEM(int32, rssi_ignore_probe_request)
MTLK_DECLARE_CFG_END(mtlk_core_rssi_ignore_probe_request_t)
...
typedef struct {
  ...
  uint32 max_burst;
  uint16 reserved;
  uint32 minQueueSizeDefault;
  uint32 minQueueSizePs;
  uint32 weigth;
  wave_pie_convertp_t pie_convert_p[PIE_NUM_OF_CONVERSIONS];
  uint32 decay_val;
  uint32 min_drop_prob;
  uint32 max_drop_prob;
  uint16 alpha[ACCESS_CATEGORY_NUM];
  uint16 beta[ACCESS_CATEGORY_NUM];
...
MTLK_DECLARE_CFG_START(mtlk_master_core_cfg_t)
  ...
  MTLK_CFG_ITEM(mtlk_mu_group_config_params_t, mu_group_config_params)
...
typedef struct {
  int8 thermal_enable;
  int8 thermal_threshold;
  int8 thermal_power_reduc_val;
} __MTLK_IDATA wave_fixed_rate_thermal_cfg_t;

MTLK_DECLARE_CFG_START(wave_thermal_cfg_t)
  MTLK_CFG_ITEM(wave_fixed_rate_thermal_cfg_t, thermal_cfg)
MTLK_DECLARE_CFG_END(wave_thermal_cfg_t)
...
typedef struct wave_vap_PDstats64_t {
  mtlk_atomic64_t txInBroadcastBytePD;
  uint64 prevTxInBroadcastBytePD;
  uint64 txInUnicastBytePD;
  uint64 txInMulticastBytePD_ipv4[MAX_NUM_OF_GROUPS];
  uint64 txInMulticastBytePD_ipv6[MAX_NUM_OF_GROUPS];
} wave_vap_PDstats64;

typedef struct wave_vap_PDstats_t {
  mtlk_atomic_t txInBroadcastPD;
  uint32 prevTxInBroadcastPD;
  uint32 txInUnicastPD;
  uint32 txInmulticastPD_ipv4[MAX_NUM_OF_GROUPS];
  uint32 txInmulticastPD_ipv6[MAX_NUM_OF_GROUPS];
} wave_vap_PDstats;

typedef struct _wave_mhi_PDstats_vap_t {
  wave_vap_PDstats64 PDstats64;
  wave_vap_PDstats PDstats;
} wave_mhi_PDstats_vap_t;
...
/* beacon key index */
#define IS_BCN_KEY_IDX(x)                   ((x == WAVE_KEY_IDX6_BIGTK) || (x == WAVE_KEY_IDX7_BIGTK))
...
typedef struct _mtlk_core_ui_get_stadb_status_req_t {
  ...
  uint8      use_cipher;
#ifdef BEST_EFFORT_TID_SPREADING
  uint8      get_str_sta_tid_spread_cfg;
#endif
...
MTLK_DECLARE_CFG_START(mtlk_logger_fifo_mux_cfg_t)
  MTLK_CFG_ITEM(uint8, mode);
MTLK_DECLARE_CFG_END(mtlk_logger_fifo_mux_cfg_t)
#endif
...
#ifdef BEST_EFFORT_TID_SPREADING
typedef struct mtlk_core_str_tid_link_spreading_cfg
{
  uint8 enable;
  uint8 ratio;
  uint8 tid_spreading_mode;
} mtlk_core_str_tid_link_spreading_cfg_t;

MTLK_DECLARE_CFG_START(mtlk_str_tid_link_spreading_cfg_t)
  MTLK_CFG_ITEM(mtlk_core_str_tid_link_spreading_cfg_t, cfg);
MTLK_DECLARE_CFG_END(mtlk_str_tid_link_spreading_cfg_t)

typedef enum skb_priority
{
  TID0,
  TID1,
  TID2,
...
typedef enum str_tid_spread_mode
{
  TID_SPREAD_STATIC,
  TID_SPREAD_DYNAMIC,
  TID_SPREAD_INVALID,
...
MTLK_DECLARE_CFG_START(mtlk_amsdu_num_cfg_t)
  ...
  MTLK_CFG_ITEM(uint32, amsdu_ehtnum);
...
MTLK_DECLARE_CFG_START(wave_mgmt_frame_pwr_ctrl_cfg_t)
  MTLK_CFG_ITEM(int8, mgmt_frame_pwr_ctrl);
MTLK_DECLARE_CFG_END(wave_mgmt_frame_pwr_ctrl_cfg_t)
...
typedef struct mtlk_create_secondary_vap_ret {
  uint8 sec_vap_index;
  void /* mtlk_df_user_t */ *sec_df_user;
} mtlk_create_secondary_vap_ret_t;

typedef struct mtlk_del_secondary_vap_cfg {
  const char *vlan_ifname;
  uint8 sec_vap_index;
} mtlk_del_secondary_vap_cfg_t;
...
MTLK_DECLARE_CFG_START(wave_3addr_mcast_mode_t)
...
typedef struct iwpriv_emulate_params
{
  uint8 rbm;
  uint8 dfs_band;
} iwpriv_emulate_params_t;

typedef struct iwpriv_radar_fifo_params
{
  uint8 enable_dump;
  uint8 immediate;
  uint8 dfs_band;
} iwpriv_radar_fifo_params_t;

MTLK_DECLARE_CFG_START(mtlk_scan_and_calib_cfg_t);
  MTLK_CFG_ITEM(iwpriv_emulate_params_t, emulate_params);
  MTLK_CFG_ITEM(iwpriv_radar_fifo_params_t, radar_fifo_params);
...
/* fils beacon flag */
MTLK_DECLARE_CFG_START(mtlk_fils_beacon_flag_cfg_t)
  MTLK_CFG_ITEM(int, fils_beacon_flag);
MTLK_DECLARE_CFG_END(mtlk_fils_beacon_flag_cfg_t)
...
#ifdef MTLK_WAVE_700
  CW_MAX_6G_GEN6 = CW_160,
  CW_MAX_6G_GEN7 = CW_320
#endif
};
...
{
  return ((NL80211_BAND_2GHZ == band) || (NL80211_BAND_5GHZ == band) ||
		  (NL80211_BAND_6GHZ == band));
}
...
struct set_chan_param_data
{
  ...
  u8 noise[WAVE_STAT_MAX_ANTENNAS];
  /* Rate of last packet received switch_type==ST_NORMAL_AFTER_RSSI */
  u32 rate;
  u8 rf_gain[WAVE_STAT_MAX_ANTENNAS];
  /* This field is valid only if current channel set param is for zwdfs antenna. Applicable only in wav700. */
  bool zwdfs_ant_enabled;
  /* Flag for reset Radio channel statistics */
  BOOL reset_stats;
};
...
struct mtlk_sta_bss_change_parameters
{
  ...
  u8 color_change_cntdown;
  u8 color_change_active;
  u32 color_switchtime;
...
#define NUM_5GHZ_CHANS      36
#define NUM_TOTAL_CHANS     (NUM_2GHZ_CHANS + NUM_5GHZ_CHANS)

#define NUM_5GHZ_CENTRAL_FREQS_BW40     12  /* number of central freqs in 40 MHz mode */
#define NUM_5GHZ_CENTRAL_FREQS_BW80      6  /* number of central freqs in 80 MHz mode */
#define NUM_5GHZ_CENTRAL_FREQS_BW160     3  /* number of central freqs in 160 MHz mode */
...
#define NUM_TOTAL_CHAN_STATS_SIZE       (NUM_TOTAL_CHANS + NUM_TOTAL_CHANS_6G + 1)
...
#ifdef MTLK_WAVE_700
#define MAX_EHT_PPE_THRESHOLDS_SIZE IEEE80211_EHT_PPE_THRES_MAX_LEN
struct wave_eht_debug_mode_data {
  struct ieee80211_eht_cap_elem eht_cap_elem;
  struct ieee80211_eht_mcs_nss_supp eht_mcs_nss_supp;
  u8 eht_ppe_thresholds[MAX_EHT_PPE_THRESHOLDS_SIZE];
  u8 eht_debug_mode_enabled; /* Keep last */
};

struct wave_mld_recovery_params {
  uint8 mld_created;
  uint16 sibling_vapid;
};
#endif
...
typedef enum
{
  ...
  MTLK_CORE_UI_ASSERT_TYPE_FW_LMIPS2,     /* 2 2 */
  MTLK_CORE_UI_ASSERT_TYPE_FW_LMIPS     = MTLK_CORE_UI_ASSERT_TYPE_FW_LMIPS0, /* start number  */
  MTLK_CORE_UI_ASSERT_TYPE_FW_LMIPS_MAX = MTLK_CORE_UI_ASSERT_TYPE_FW_LMIPS2, /* max available */
...
typedef enum
{
  ...
  MTLK_CORE_UI_RCVRY_TYPE_UNRECOVERABLE_ERROR = RCVRY_TYPE_UNRECOVERABLE_ERROR,
...
/* PIE PARAMETERS CONFIGURATION */
#define WAVE_ENABLE_PIE
#define WAVE_PIE_CFG_PARAM_COUNT	48
...
typedef struct wave_csi_enable_t{
  IEEE_ADDR sta_mac;
  IEEE_ADDR brlan_mac;
  uint8     is_enable;
}wave_csi_enable_t;

MTLK_DECLARE_CFG_START(wave_csi_enable_cfg_t)
  MTLK_CFG_ITEM(wave_csi_enable_t, csi_params);
MTLK_DECLARE_CFG_END(wave_csi_enable_cfg_t)

MTLK_DECLARE_CFG_START(wave_csi_send_qos_null_cfg_t)
  MTLK_CFG_ITEM(IEEE_ADDR, sta_mac)
MTLK_DECLARE_CFG_END(wave_csi_send_qos_null_cfg_t)

typedef struct wave_csi_auto_t{
  IEEE_ADDR sta_mac;
  IEEE_ADDR brlan_mac;
  uint8     is_enable;
  uint8     csi_rate;
}wave_csi_auto_rate_t;

MTLK_DECLARE_CFG_START(wave_csi_auto_rate_cfg_t)
  MTLK_CFG_ITEM(wave_csi_auto_rate_t, csi_auto_params)
MTLK_DECLARE_CFG_END(wave_csi_auto_rate_cfg_t)
...
mtlk_error_t __MTLK_IFUNC mtlk_core_mcast_notify_fw (mtlk_vap_handle_t vap_handle, int action, int sta_id, int grp_id);
...
typedef struct {
  u8 category;
  IEEE_ADDR sta_addr;
} wave_vendor_su_mu_ru_stats_t;

enum wave_acl_policy
{
  WAVE_ACL_POLICY_DISABLED,
  WAVE_ACL_POLICY_ACCEPT,
  WAVE_ACL_POLICY_DENY,
};

/* mimic struct cfg80211_acl_data */
typedef struct wave_acl_data
{
  enum wave_acl_policy acl_policy;
  int n_acl_entries;
