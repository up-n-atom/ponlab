...
static const uint8 mtlk_core_initial_rx_mcs_bitmask[16] = { 0 };
static const uint8 mtlk_core_initial_vht_mcs_nss[8] = { 0 };
static const uint32  wave_core_initial_mgmt_pwr = MGMT_PWR_INVALID_VAL;
...
static const UMI_SET_BSS wave_core_initial_set_bss_data = { .protectionMode = -1, .slotTime = -1, .useShortPreamble = -1 };

#ifdef MTLK_WAVE_700
/* 802.11BE support */
static const uint8 wave_core_initial_eht_mcs_nss[9] = { 0 }; /* 3 octets each for <=80MHz/160MHz/320MHz resp */
static const struct mxl_vendor_eht_oper wave_core_initial_eht_operation = {.eht_mcs_nss_set[0] = 0x1};
static const struct wave_eht_debug_mode_data wave_core_initial_eht_debug_mode_data = { 0 };
...
static const mtlk_pdb_initial_value mtlk_core_parameters[] =
{
  ...
  {PARAM_DB_CORE_MULTI_AP_MODE,            PARAM_DB_TYPE_INT, PARAM_DB_VALUE_FLAG_NO_FLAG, sizeof(mtlk_core_initial_zero_int),                 &mtlk_core_initial_zero_int},
  ...
  {PARAM_DB_CORE_MGMT_PWR_CTRL,           PARAM_DB_TYPE_INT,  PARAM_DB_VALUE_FLAG_NO_FLAG, sizeof(wave_core_initial_mgmt_pwr),                 &wave_core_initial_mgmt_pwr},
  {PARAM_DB_CORE_RSSI_IGNORE_PROBE_REQ,   PARAM_DB_TYPE_INT, PARAM_DB_VALUE_FLAG_NO_FLAG, sizeof(wave_core_initial_rssi_ignore_probe_request), &wave_core_initial_rssi_ignore_probe_request},
  {PARAM_DB_CORE_ALLOW_3ADDR_MCAST,       PARAM_DB_TYPE_INT, PARAM_DB_VALUE_FLAG_NO_FLAG, sizeof(mtlk_core_initial_invalid_uint32),            &mtlk_core_initial_invalid_uint32},
  {PARAM_DB_CORE_HE_BSS_COLOR,            PARAM_DB_TYPE_INT, PARAM_DB_VALUE_FLAG_NO_FLAG, sizeof(wave_core_initial_he_bss_color),              &wave_core_initial_he_bss_color},
  {PARAM_DB_CORE_PROBEREQ_OFFLOAD_MODE,   PARAM_DB_TYPE_INT, PARAM_DB_VALUE_FLAG_NO_FLAG, sizeof(mtlk_core_initial_zero_int),                  &mtlk_core_initial_zero_int},
  {PARAM_DB_CORE_SET_BSS,                 PARAM_DB_TYPE_BINARY, PARAM_DB_VALUE_FLAG_NO_FLAG, sizeof(wave_core_initial_set_bss_data),           &wave_core_initial_set_bss_data},

#ifdef MTLK_WAVE_700
  {PARAM_DB_CORE_AP_MLD_MAC,              PARAM_DB_TYPE_MAC, PARAM_DB_VALUE_FLAG_NO_FLAG, sizeof(mtlk_core_initial_mac_addr),                  mtlk_core_initial_mac_addr},
  {PARAM_DB_CORE_MLD_ID,                  PARAM_DB_TYPE_INT, PARAM_DB_VALUE_FLAG_NO_FLAG, sizeof(mtlk_core_initial_invalid_uint8),             &mtlk_core_initial_invalid_uint8},
  {PARAM_DB_CORE_EHT_MCS_NSS, PARAM_DB_TYPE_BINARY, PARAM_DB_VALUE_FLAG_NO_FLAG, sizeof(wave_core_initial_eht_mcs_nss), &wave_core_initial_eht_mcs_nss},
  {PARAM_DB_CORE_EHT_OPERATION, PARAM_DB_TYPE_BINARY, PARAM_DB_VALUE_FLAG_NO_FLAG, sizeof(wave_core_initial_eht_operation), &wave_core_initial_eht_operation},
  {PARAM_DB_CORE_EHT_DEBUG_DATA, PARAM_DB_TYPE_BINARY, PARAM_DB_VALUE_FLAG_NO_FLAG, sizeof(wave_core_initial_eht_debug_mode_data), &wave_core_initial_eht_debug_mode_data},
  {PARAM_DB_CORE_EHT_NON_ADVERTISED, PARAM_DB_TYPE_BINARY, PARAM_DB_VALUE_FLAG_NO_FLAG, sizeof(wave_core_initial_eht_non_advertised), &wave_core_initial_eht_non_advertised},
  {PARAM_DB_CORE_BSS_CRITICAL_UPDATE, PARAM_DB_TYPE_BINARY, PARAM_DB_VALUE_FLAG_NO_FLAG, sizeof(wave_core_initial_ml_critical_update), &wave_core_initial_ml_critical_update},
  {PARAM_DB_CORE_SKIP_SET_BEACON,         PARAM_DB_TYPE_INT, PARAM_DB_VALUE_FLAG_NO_FLAG, sizeof(skip_set_beacon),                             &skip_set_beacon},
