...
void __MTLK_IFUNC get_eht_mcs_nss_20mhz_only(const u8 *ap_eht_mcs_nss, u8 *sta_eht_mcs_nss, u8 *neg_eht_mcs_nss, u8 len);
void __MTLK_IFUNC get_eht_mcs_nss_any_bw(const u8 *ap_eht_mcs_nss, u8 *sta_eht_mcs_nss, u8 *neg_eht_mcs_nss, u8 len);
