...
enum phy_index_config {
  PHY_INDEX_CONFIG_2GHZ = 0,
  PHY_INDEX_CONFIG_5GHZ,
  PHY_INDEX_CONFIG_6GHZ,
  PHY_INDEX_CONFIG_ZWDFS,
  PHY_INDEX_CONFIG_5GHZ_HIGH,
  PHY_INDEX_CONFIG_6GHZ_HIGH, /* NOT IMPLEMENTED (no such cdb config) */
  PHY_INDEX_CONFIG_LIMIT,
};

extern int interface_index[PHY_INDEX_CONFIG_LIMIT];
extern int phy_index[PHY_INDEX_CONFIG_LIMIT];
extern int phy_index_count;
