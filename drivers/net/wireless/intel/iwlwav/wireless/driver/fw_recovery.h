...
typedef enum {
  ...
  RCVRY_TYPE_FAST,
  RCVRY_TYPE_FULL,
  RCVRY_TYPE_UNRECOVERABLE_ERROR,
  RCVRY_TYPE_DUT,
  RCVRY_TYPE_UNDEF,
  RCVRY_TYPE_IGNORE,
  RCVRY_TYPE_DBG,
...
#define WAVE_RCVRY_RETRY_TIMEOUT_MS    10000
#define WAVE_RCVRY_RETRY_DELAY_MS      10
...
void wave_rcvry_card_uninit(mtlk_hw_t *hw_ctx);
...
mtlk_error_t wave_rcvry_wait_completion_if_needed (mtlk_core_t *core);
BOOL __MTLK_IFUNC wave_in_fw_recovery (mtlk_core_t *core);
BOOL __MTLK_IFUNC wave_in_complete_recovery (mtlk_core_t *core);
void __MTLK_IFUNC wave_enable_rcvry_finish_wait (mtlk_core_t *core);
void __MTLK_IFUNC wave_disable_rcvry_finish_wait (mtlk_core_t *core);
