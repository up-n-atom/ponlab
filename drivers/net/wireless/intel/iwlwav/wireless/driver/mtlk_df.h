...
***********************************************************************/
/*! \fn      mtlk_df_t* mtlk_df_create(mtlk_vap_handle_t vap_handle, const char *name, struct net_device *ndev, BOOL is_secondary)
...
/* Remove DCDP entries from routing table */
#if MTLK_USE_DIRECTCONNECT_DP_API
void __MTLK_IFUNC
