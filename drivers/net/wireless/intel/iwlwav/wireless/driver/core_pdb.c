...
static const mtlk_pdb_id_t mtlk_core_hot_path_parameters[CORE_DB_LAST_VALUE_ID + 1] =
{
    ...
    PARAM_DB_CORE_MULTI_AP_MODE,           /*  CORE_DB_CORE_MULTI_AP_MODE         */
    PARAM_DB_CORE_FWRD_UNKWN_MCAST_FLAG,   /*  CORE_DB_CORE_FWRD_UNKWN_MCAST_FLAG */
    PARAM_DB_CORE_INTRA_VAP_MCAST,         /*  CORE_DB_CORE_INTRA_VAP_MCAST       */
    PARAM_DB_CORE_PROBEREQ_OFFLOAD_MODE,   /*  CORE_DB_CORE_PROBEREQ_OFFLOAD_MODE */
