...
static const uint32 wave_radio_initial_bf_tx_power_psd = 0;
static const uint32 wave_radio_initial_tx_power_cfg = 0;
static const uint32 wave_radio_initial_bf_tx_power_cfg = 0;
...
static const psdb_pw_limits_t wave_radio_initial_cfg_pw_limits = {{0,0,0,0,0,0,0,0,0}}; /* MUST be aligned to (PSDB_PHY_CW_LAST - 1) */
...
static const mtlk_mu_group_config_params_t wave_radio_initial_mu_group_cfg[WAVE_NUM_FORMATION_TYPES] = {{MTLK_PARAM_DB_INVALID_UINT32, MTLK_PARAM_DB_INVALID_UINT32, MTLK_PARAM_DB_INVALID_UINT32},
                                                                                                        {MTLK_PARAM_DB_INVALID_UINT32, MTLK_PARAM_DB_INVALID_UINT32, MTLK_PARAM_DB_INVALID_UINT32},
                                                                                                        {MTLK_PARAM_DB_INVALID_UINT32, MTLK_PARAM_DB_INVALID_UINT32, MTLK_PARAM_DB_INVALID_UINT32},
                                                                                                        {MTLK_PARAM_DB_INVALID_UINT32, MTLK_PARAM_DB_INVALID_UINT32, MTLK_PARAM_DB_INVALID_UINT32}};

/* By default alpha2 keep a world regulatory domain */
struct ieee80211_regdomain default_regdata = {
  .n_reg_rules  = 1,
  .alpha2       = "99",
  .reg_rules    = { REG_RULE(5925, 7125, 320, 6, 20, NL80211_RRF_NO_IR) }
};

static const wave_radio_reg_data_t wave_radio_initial_reg_data = {
...
static const mtlk_pdb_initial_value wave_radio_parameters[] =
{
  ...
  {PARAM_DB_RADIO_BF_TX_POWER_PSD,                            PARAM_DB_TYPE_INT,     PARAM_DB_VALUE_FLAG_NO_FLAG,  sizeof(wave_radio_initial_bf_tx_power_psd),  &wave_radio_initial_bf_tx_power_psd},
  {PARAM_DB_RADIO_BF_TX_POWER_CFG,                            PARAM_DB_TYPE_INT,     PARAM_DB_VALUE_FLAG_NO_FLAG,  sizeof(wave_radio_initial_bf_tx_power_cfg),  &wave_radio_initial_bf_tx_power_cfg},
  ...
  {PARAM_DB_RADIO_CFG_PW_LIMITS_PSD,                          PARAM_DB_TYPE_BINARY,  PARAM_DB_VALUE_FLAG_NO_FLAG,  sizeof(wave_radio_initial_cfg_pw_limits), &wave_radio_initial_cfg_pw_limits},
  ...
  {PARAM_DB_RADIO_TX_POWER_LIMIT_OFFSET_PREV,                 PARAM_DB_TYPE_INT,     PARAM_DB_VALUE_FLAG_NO_FLAG,  sizeof(wave_radio_initial_zero_int),       &wave_radio_initial_zero_int},
  ...
  {PARAM_DB_RADIO_FILS_BEACON_FLAG,                           PARAM_DB_TYPE_INT,     PARAM_DB_VALUE_FLAG_NO_FLAG,  sizeof(wave_radio_initial_fils_beacon_flag), &wave_radio_initial_fils_beacon_flag},
...
#ifdef MTLK_WAVE_700
 {PARAM_DB_RADIO_AMSDU_EHTNUM,                                PARAM_DB_TYPE_INT,     PARAM_DB_VALUE_FLAG_NO_FLAG,  sizeof(wave_radio_initial_invalid_uint32),  &wave_radio_initial_invalid_uint32},
#endif
 {PARAM_DB_RADIO_PD_THRESHOLD,                                PARAM_DB_TYPE_BINARY,  PARAM_DB_VALUE_FLAG_NO_FLAG,  sizeof(wave_radio_initial_pd_thresh_cfg),   &wave_radio_initial_pd_thresh_cfg},
  ...
  {PARAM_DB_RADIO_AP_RETRY_LIMIT_PROBERESP,                   PARAM_DB_TYPE_INT,     PARAM_DB_VALUE_FLAG_NO_FLAG,  sizeof(wave_radio_initial_invalid_uint32),        &wave_radio_initial_invalid_uint32},
...
/* DEBUG PARAMS */
  ...
  {PARAM_DB_RADIO_FILS_DISCOVERY_FRAME_LEN,                   PARAM_DB_TYPE_INT,     PARAM_DB_VALUE_FLAG_NO_FLAG,  sizeof(wave_radio_initial_zero_int),             &wave_radio_initial_zero_int},
  ...
  {PARAM_DB_RADIO_6GHZ_REG_FCC_SP,                            PARAM_DB_TYPE_BINARY,  PARAM_DB_VALUE_FLAG_NO_FLAG,  sizeof(wave_radio_initial_reg_data),             &wave_radio_initial_reg_data},
