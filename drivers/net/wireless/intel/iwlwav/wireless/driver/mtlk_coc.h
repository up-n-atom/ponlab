...
#define MTLK_COC_EXTRA_PARAMS         1  /* CoC BW */
#define MTLK_COC_NUM_ANTENNAS         5
...
#define COC_BW_SWITCH_ENABLED    0
#define COC_BW_SWITCH_DISABLED   1
...
typedef struct _mtlk_coc_cfg_t
{
  ...
  uint8                   hw_tx_ant_mask; /* TX */
  uint8                   hw_rx_ant_mask; /* RX */
...
#ifdef MTLK_WAVE_700
  uint32 tx_320_max_tp;     /* max tp for 320 Mhz bw for WAVE700*/
#endif
