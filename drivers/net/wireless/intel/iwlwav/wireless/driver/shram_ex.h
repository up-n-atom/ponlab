...
typedef enum {
  ...
  WAVE_FW_NUM_SECB_PM_SEG,    /* Progmodel Seg, for WAVE700 */
  WAVE_FW_NUM_SECB_PM_TDANT,  /* Progmodel TdAnt, for WAVE700 */
  WAVE_FW_NUM_SECB_PM_DFS,    /* Progmodel DFS, for WAVE700 */
  WAVE_FW_NUM_SECB_PSD_FILE,  /* PSD file */
  WAVE_FW_NUM_SECB_CAL_FILE,  /* Cal file */
  WAVE_FW_NUM_SECB_CAL_HDR_2,   /* Signed Cal file header */
  WAVE_FW_NUM_SECB_CAL_FILE_2,  /* Cal file */
  WAVE_FW_NUM_SECB_CAL_HDR_4,   /* Signed Cal file header */
  WAVE_FW_NUM_SECB_CAL_FILE_4,  /* Cal file */

  WAVE_FW_NUM_CNT,                /* Total number */
  WAVE_FW_NUM_CNT_GEN7_DUAL_BAND =  WAVE_FW_NUM_SECB_CAL_HDR_4/* Total number for GEN7 Dual Band */
} wave_fw_num_e;
