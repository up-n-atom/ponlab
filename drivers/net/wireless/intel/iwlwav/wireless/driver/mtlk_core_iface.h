...
mtlk_error_t __MTLK_IFUNC wave_check_mac_watchdog (mtlk_handle_t core_object, const void *payload, uint32 size);
...
int     __MTLK_IFUNC core_on_rcvry_configure_mld(mtlk_core_t *core, uint32 rcvry_net_state);
...
mtlk_error_t __MTLK_IFUNC core_remove_sid(mtlk_core_t *core, uint16 sid);
