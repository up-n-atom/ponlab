...
#define mtlk_txmm_msg_init(msg) \
  mtlk_txmm_msg_init_objpool((msg), MTLK_SLID)
#endif
...
#define mtlk_txmm_msg_init_with_empty_data(msg, obj, err) \
        mtlk_txmm_msg_init_with_empty_data_objpool((msg), (obj), (err), MTLK_SLID)
