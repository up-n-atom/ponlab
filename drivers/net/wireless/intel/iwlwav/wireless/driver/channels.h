...
#ifdef MTLK_WAVE_700
#define WAVE_BANDWIDTHS_NUM_G7  MAXIMUM_BANDWIDTHS_GEN7
#endif
...
typedef struct {
    ...
    uint8  center_chan;
    uint8  upper_chan;
} __MTLK_IDATA wave_chan_bonding_320mhz_t;
#endif
...
#ifdef MTLK_WAVE_700
#define NUM_6GHZ_CENTRAL_FREQS_BW320    (2 * (NUM_6GHZ_CENTRAL_FREQS_BW160 >> 1))
#endif

#ifndef NUM_6GHZ_CENTRAL_FREQS_BW320
...
#else
#define NUM_HOLES_CHAN_FREQS_6G         2 /* 2 holes: 223,231 */
#define NUM_TOTAL_CHAN_FREQS_6G         (NUM_TOTAL_CHANS_6G + NUM_6GHZ_CENTRAL_FREQS_BW40 +\
                                         NUM_6GHZ_CENTRAL_FREQS_BW80 + NUM_6GHZ_CENTRAL_FREQS_BW160 +\
                                         NUM_6GHZ_CENTRAL_FREQS_BW320 + NUM_HOLES_CHAN_FREQS_6G)
#endif
