...
/* --------------------------------------------------- */
/* Register: 'VLAN RMON Control Configuration'(LTQ_GSWIP_3_2) */
/* Bit: 'VLAN_RMON_EN' */
/* Description: 'Enable vlan rmon' */
#define VLAN_RMON_EN_OFFSET			0xEC4
#define VLAN_RMON_EN_SHIFT			15
#define VLAN_RMON_EN_SIZE			1
/* Bit: 'INC_BCPKT' */
/* Description: 'enable broadcast packet counting' */
#define VLAN_RMON_INC_BCPKT_OFFSET	0xEC4
#define VLAN_RMON_INC_BCPKT_SHIFT	14
#define VLAN_RMON_INC_BCPKT_SIZE	1
/* Bit: 'VLAN_LAST_ENTRY' */
/* Description: 'Vlan last entry' */
#define VLAN_RMON_LAST_ENTRY_OFFSET	0xEC4
#define VLAN_RMON_LAST_ENTRY_SHIFT	0
#define VLAN_RMON_LAST_ENTRY_SIZE	8
/* --------------------------------------------------- */
...
/* --------------------------------------------------- */
/* Register: 'Table Value Register30' (LTQ_GSWIP_3_2)*/
/* Bit: 'VAL30' */
/* Description: 'Data value [15:0]' */
#define PCE_TBL_VAL_30_VAL30_OFFSET	0x405
#define PCE_TBL_VAL_30_VAL30_SHIFT	0
#define PCE_TBL_VAL_30_VAL30_SIZE		16
/* --------------------------------------------------- */

/* --------------------------------------------------- */
/* Register: 'Table Value Register29' (LTQ_GSWIP_3_2)*/
/* Bit: 'VAL29' */
/* Description: 'Data value [15:0]' */
#define PCE_TBL_VAL_29_VAL29_OFFSET	0x406
#define PCE_TBL_VAL_29_VAL29_SHIFT	0
#define PCE_TBL_VAL_29_VAL29_SIZE		16
/* --------------------------------------------------- */

/* --------------------------------------------------- */
/* Register: 'Table Value Register28' (LTQ_GSWIP_3_2)*/
/* Bit: 'VAL28' */
/* Description: 'Data value [15:0]' */
#define PCE_TBL_VAL_28_VAL28_OFFSET	0x407
#define PCE_TBL_VAL_28_VAL28_SHIFT	0
#define PCE_TBL_VAL_28_VAL28_SIZE		16
/* --------------------------------------------------- */

/* --------------------------------------------------- */
/* Register: 'Table Value Register27' (LTQ_GSWIP_3_2)*/
/* Bit: 'VAL27' */
/* Description: 'Data value [15:0]' */
#define PCE_TBL_VAL_27_VAL27_OFFSET	0x408
#define PCE_TBL_VAL_27_VAL27_SHIFT	0
#define PCE_TBL_VAL_27_VAL27_SIZE		16
/* --------------------------------------------------- */

/* --------------------------------------------------- */
/* Register: 'Table Value Register26' (LTQ_GSWIP_3_2)*/
/* Bit: 'VAL26' */
/* Description: 'Data value [15:0]' */
#define PCE_TBL_VAL_26_VAL26_OFFSET	0x409
#define PCE_TBL_VAL_26_VAL26_SHIFT	0
#define PCE_TBL_VAL_26_VAL26_SIZE		16
/* --------------------------------------------------- */
...
/* --------------------------------------------------- */
/* Register: 'Table Key Data 33' GSWIP 3.2 */
/* Bit: 'KEY31' */
/* Description: 'Key Value[15:0]' */
#define PCE_TBL_KEY_33_KEY33_OFFSET	0x40E
#define PCE_TBL_KEY_33_KEY33_SHIFT	0
#define PCE_TBL_KEY_33_KEY33_SIZE		16
/* --------------------------------------------------- */

/* --------------------------------------------------- */
/* Register: 'Table Key Data 32' GSWIP 3.2 */
/* Bit: 'KEY32' */
/* Description: 'Key Value[15:0]' */
#define PCE_TBL_KEY_32_KEY32_OFFSET	0x40F
#define PCE_TBL_KEY_32_KEY32_SHIFT	0
#define PCE_TBL_KEY_32_KEY32_SIZE		16
/* --------------------------------------------------- */

/* --------------------------------------------------- */
/* Register: 'Table Key Data 31' GSWIP 3.2 */
/* Bit: 'KEY31' */
/* Description: 'Key Value[15:0]' */
#define PCE_TBL_KEY_31_KEY31_OFFSET	0x410
#define PCE_TBL_KEY_31_KEY31_SHIFT	0
#define PCE_TBL_KEY_31_KEY31_SIZE		16
/* --------------------------------------------------- */

/* --------------------------------------------------- */
/* Register: 'Table Key Data 30' GSWIP 3.2 */
/* Bit: 'KEY30' */
/* Description: 'Key Value[15:0]' */
#define PCE_TBL_KEY_30_KEY30_OFFSET	0x411
#define PCE_TBL_KEY_30_KEY30_SHIFT	0
#define PCE_TBL_KEY_30_KEY30_SIZE		16
/* --------------------------------------------------- */

/* --------------------------------------------------- */
/* Register: 'Table Key Data 29' GSWIP 3.2 */
/* Bit: 'KEY29' */
/* Description: 'Key Value[15:0]' */
#define PCE_TBL_KEY_29_KEY29_OFFSET	0x412
#define PCE_TBL_KEY_29_KEY29_SHIFT	0
#define PCE_TBL_KEY_29_KEY29_SIZE		16
/* --------------------------------------------------- */

/* --------------------------------------------------- */
/* Register: 'Table Key Data 28' GSWIP 3.2 */
/* Bit: 'KEY28' */
/* Description: 'Key Value[15:0]' */
#define PCE_TBL_KEY_28_KEY28_OFFSET	0x413
#define PCE_TBL_KEY_28_KEY28_SHIFT	0
#define PCE_TBL_KEY_28_KEY28_SIZE		16
/* --------------------------------------------------- */

/* --------------------------------------------------- */
/* Register: 'Table Key Data 27' GSWIP 3.2 */
/* Bit: 'KEY27' */
/* Description: 'Key Value[15:0]' */
#define PCE_TBL_KEY_27_KEY27_OFFSET	0x414
#define PCE_TBL_KEY_27_KEY27_SHIFT	0
#define PCE_TBL_KEY_27_KEY27_SIZE		16
/* --------------------------------------------------- */

/* --------------------------------------------------- */
/* Register: 'Table Key Data 26' GSWIP 3.2 */
/* Bit: 'KEY26' */
/* Description: 'Key Value[15:0]' */
#define PCE_TBL_KEY_26_KEY26_OFFSET	0x415
#define PCE_TBL_KEY_26_KEY26_SHIFT	0
#define PCE_TBL_KEY_26_KEY26_SIZE		16
/* --------------------------------------------------- */

/* --------------------------------------------------- */
/* Register: 'Table Key Data 25' GSWIP 3.2 */
/* Bit: 'KEY25' */
/* Description: 'Key Value[15:0]' */
#define PCE_TBL_KEY_25_KEY25_OFFSET	0x416
#define PCE_TBL_KEY_25_KEY25_SHIFT	0
#define PCE_TBL_KEY_25_KEY25_SIZE		16
/* --------------------------------------------------- */

/* --------------------------------------------------- */
/* Register: 'Table Key Data 24' GSWIP 3.2 */
/* Bit: 'KEY24' */
/* Description: 'Key Value[15:0]' */
#define PCE_TBL_KEY_24_KEY24_OFFSET	0x417
#define PCE_TBL_KEY_24_KEY24_SHIFT	0
#define PCE_TBL_KEY_24_KEY24_SIZE		16
/* --------------------------------------------------- */

/* --------------------------------------------------- */
/* Register: 'Table Key Data 23' GSWIP 3.2 */
/* Bit: 'KEY23' */
/* Description: 'Key Value[15:0]' */
#define PCE_TBL_KEY_23_KEY23_OFFSET	0x418
#define PCE_TBL_KEY_23_KEY23_SHIFT	0
#define PCE_TBL_KEY_23_KEY23_SIZE		16
/* --------------------------------------------------- */

/* --------------------------------------------------- */
/* Register: 'Table Key Data 22' GSWIP 3.2 */
/* Bit: 'KEY22' */
/* Description: 'Key Value[15:0]' */
#define PCE_TBL_KEY_22_KEY22_OFFSET	0x419
#define PCE_TBL_KEY_22_KEY22_SHIFT	0
#define PCE_TBL_KEY_22_KEY22_SIZE		16
/* --------------------------------------------------- */
...
/* Bit: 'SUBID LSB' */
/* Description: 'Monitoring Port Sub-IF ID LSB'
   Applicable for GSWIP 3.2 */
#define PCE_PMAP_1_SUBID_LSB_OFFSET	0x453
#define PCE_PMAP_1_SUBID_LSB_SHIFT	4
#define PCE_PMAP_1_SUBID_LSB_SIZE	12

/* --------------------------------------------------- */
/* Register: 'Port Map Register 2' */
#define PCE_PMAP_2_REG_OFFSET	0x454
/* Bit: 'DMCPMAP' */
/* Description: 'Default Multicast Port Map'
   Applicable for GSWIP 3.0 */
#define PCE_PMAP_2_DMCPMAP_OFFSET	0x454
#define PCE_PMAP_2_DMCPMAP_SHIFT	0
#define PCE_PMAP_2_DMCPMAP_SIZE		16

/* Note In GSWIP 3.1 this register is not avaliable*/

/* Bit: 'SUBID MSB' */
/* Description: 'Monitoring Port Sub-IF ID MSB'
   Applicable for GSWIP 3.2 */

#define PCE_PMAP_2_SUBID_MSB_OFFSET	0x454
#define PCE_PMAP_2_SUBID_MSB_SHIFT	12
#define PCE_PMAP_2_SUBID_MSB_SIZE	4

/* Bit: 'QID' */
/* Description: 'Monitoring QID'
   Applicable for GSWIP 3.2 */
#define PCE_PMAP_2_QID_OFFSET	0x454
#define PCE_PMAP_2_QID_SHIFT	0
#define PCE_PMAP_2_QID_SIZE	    5
...
/* Bit: 'CPUQMAP' */
/* Description: 'CPU Port Queue Mapping Mode'
   NOTE : Applicable for GSWIP 3.2 only*/
#define PCE_GCTRL_0_CPUQMAP_OFFSET	0x456
#define PCE_GCTRL_0_CPUQMAP_SHIFT		4
#define PCE_GCTRL_0_CPUQMAP_SIZE		1
...
/* Bit: 'MODE' */
/* Description: 'PCE Meter Overhead MODE' */
#define PCE_OVERHD_MD_OFFSET	0x46C
#define PCE_OVERHD_MD_SHIFT		15
#define PCE_OVERHD_MD_SIZE		1
...
/* Bit: 'OVERHEAD' */
/* Description: To Configure Packet Mode'
   applicable for GSWIP 3.2 only*/
#define GSW_PCE_TCM_CTRL_OVERHD_OFFSET	0xE10
#define GSW_PCE_TCM_CTRL_OVERHD_SHIFT	5
#define GSW_PCE_TCM_CTRL_OVERHD_SIZE	8

/* Bit: 'MODE' */
/* Description: To Configure Packet Mode'
   applicable for GSWIP 3.2 only*/
#define GSW_PCE_TCM_CTRL_MODE_OFFSET	0xE10
#define GSW_PCE_TCM_CTRL_MODE_SHIFT		4
#define GSW_PCE_TCM_CTRL_MODE_SIZE		1
/* Bit: 'BLIND' */
...
/* Description: 'Time Stamp Field Removal for Non-PTP Packet' for GSWIP3.2 */
#define FDMA_PCTRL_TS_NONPTP_OFFSET	0xA80
#define FDMA_PCTRL_TS_NONPTP_SHIFT	5
#define FDMA_PCTRL_TS_NONPTP_SIZE	1

/* Description: 'Time Stamp Field Removal for PTP Packet' for GSWIP3.2 */
#define FDMA_PCTRL_TS_PTP_OFFSET	0xA80
#define FDMA_PCTRL_TS_PTP_SHIFT		4
#define FDMA_PCTRL_TS_PTP_SIZE		1
...
/* Bit: 'PCEBYP' */
/* Description: 'Ingress PCE Bypass' ,Applicable for GSWIP 3.2*/
#define SDMA_BYPASS_PCE_INGRESS_OFFSET		0xBC4
#define SDMA_BYPASS_PCE_INGRESS_SHIFT		11
#define SDMA_BYPASS_PCE_INGRESS_SIZE		1

/* Bit: 'IGMIR' */
/* Description: 'Ingress Mirror Constants',,Applicable for GSWIP 3.2 */
#define SDMA_BYPASS_PCE_IGMIR_OFFSET		0xBC4
#define SDMA_BYPASS_PCE_IGMIR_SHIFT			12
#define SDMA_BYPASS_PCE_IGMIR_SIZE			1

/* Bit: 'EGMIR' */
/* Description: 'Egress Mirror Constants',,Applicable for GSWIP 3.2 */
#define SDMA_BYPASS_PCE_EGMIR_OFFSET		0xBC4
#define SDMA_BYPASS_PCE_EGMIR_SHIFT			13
#define SDMA_BYPASS_PCE_EGMIR_SIZE			1
...
/* Description: Ethernet Switch CTP Assignment Start Register 0 - Applicable for 3.1 and 3.2 */
...
/* Description: Ethernet Switch CTP Assignment End Register 0 - Applicable for 3.1 and 3.2 */
...
/* Description: Ethernet Switch Default DST/SRC MAC filter Register - Applicable for 3.1 and 3.2 */
...
/* Description: Ethernet Switch Global Port Assignment Start Register 0 - Applicable for 3.2 */
#define ETHSW_GPID_STARTID_0_OFFSET		0xEA0
/* Description: Macro to get Ethernet Switch Global Port Assignment Start Register
Address OFFSET based on Logical Port ID - Applicable for 3.2 */
#define ETHSW_GPID_STARTID_GET(LogicalPortID)	(ETHSW_GPID_STARTID_0_OFFSET+(LogicalPortID)*2)
#define ETHSW_GPID_STARTID_SHIFT			0
#define ETHSW_GPID_STARTID_SIZE				8

#define ETHSW_GPID_VALID_BITS_STARTID_SHIFT	12
#define ETHSW_GPID_VALID_BITS_STARTID_SIZE	3


/* Description: Ethernet Switch Global Port Assignment End Register 0 - Applicable for 3.2 */
#define ETHSW_GPID_ENDID_0_OFFSET		0xEA1
/* Description: Macro to get Ethernet Switch Global Port Assignment End Register
Address OFFSET based on Logical Port ID - Applicable for 3.2 */
#define ETHSW_GPID_ENDID_GET(LogicalPortID)		(ETHSW_GPID_ENDID_0_OFFSET+(LogicalPortID)*2)
#define ETHSW_GPID_ENDID_SHIFT				0
#define ETHSW_GPID_ENDID_SIZE				9


/*Description: Ethernet Switch GPID RAM VAL Register- Applicable for 3.2*/
#define GPID_RAM_VAL_OFFSET					0xEC0
#define GPID_RAM_VAL_SHIFT					0
#define GPID_RAM_VAL_SIZE					16

#define GPID_RAM_VAL_SUBIF_OVERRIDE_OFFSET	0xEC0
#define GPID_RAM_VAL_SUBIF_OVERRIDE_SHIFT	15
#define GPID_RAM_VAL_SUBIF_OVERRIDE_SIZE	1

#define GPID_RAM_VAL_SUBIF_OFFSET			0xEC0
#define GPID_RAM_VAL_SUBIF_SHIFT			4
#define GPID_RAM_VAL_SUBIF_SIZE				8

#define GPID_RAM_VAL_LPID_OFFSET			0xEC0
#define GPID_RAM_VAL_LPID_SHIFT				0
#define GPID_RAM_VAL_LPID_SIZE				4

/*Description: Ethernet Switch Global Port ID Table Access Control Register- Applicable for 3.2*/
#define GPID_RAM_TBL_CTRL_OFFSET			0xEC1
#define GPID_RAM_TBL_CTRL_SHIFT				0
#define GPID_RAM_TBL_CTRL_SIZE				16

#define GPID_RAM_TBL_CTRL_BAS_OFFSET		0xEC1
#define GPID_RAM_TBL_CTRL_BAS_SHIFT			15
#define GPID_RAM_TBL_CTRL_BAS_SIZE			1

#define GPID_RAM_TBL_CTRL_OPMOD_OFFSET		0xEC1
#define GPID_RAM_TBL_CTRL_OPMOD_SHIFT		8
#define GPID_RAM_TBL_CTRL_OPMOD_SIZE		1

#define GPID_RAM_TBL_CTRL_ADDR_OFFSET		0xEC1
#define GPID_RAM_TBL_CTRL_ADDR_SHIFT		0
#define GPID_RAM_TBL_CTRL_ADDR_SIZE			8
...
/* --------------------------------------------------- */
/* Description: Reduced TC register - Applicable for GSW1P 3.2 */
/* --------------------------------------------------- */
#define RD_TC_REG0_OFFSET		0xEC2
#define RD_TC_REG0_SHIFT		0
#define RD_TC_REG0_SIZE			2

#define RD_TC_REG1_OFFSET		0xEC3
#define RD_TC_REG1_SHIFT		0
#define RD_TC_REG1_SIZE			2
