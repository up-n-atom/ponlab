...
#ifndef _DUT_RSSI_CALIBRATION_DATA_VER7_H_
#define _DUT_RSSI_CALIBRATION_DATA_VER7_H_

#include "RssiCalibrationDataVer6_7.h"

namespace dut {
class DUT_API RssiCalibrationDataVer7 : public RssiCalibrationDataVer6_7 {
public:
