...
typedef struct {
	...
	struct {
		...
		bool showtime[2]; /* Current showtime state per link */
		bool tcsync[2];   /* Current TC-Sync state per link */
		spinlock_t spinlock; /* For showtime and tcsync */
...
void asm_tc_sync( u32 linkid, bool up);
