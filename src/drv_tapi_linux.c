...
static int __init ifx_tapi_module_init(void)
{
   ...
   printk("%s, (c) 2001-2017 Lantiq Beteiligungs-GmbH & Co.KG\n", &TAPI_WHATVERSION[4]);
...
MODULE_DESCRIPTION      ("TAPI Driver");
