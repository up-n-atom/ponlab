...
int gsw_defaul_pce_qmap_get(int argc, char *argv[], int fd, int numPar);
int gsw_defaul_bypass_qmap_get(int argc, char *argv[], int fd, int numPar);
int gsw_pmac_get_ig_cfg(int argc, char *argv[], int fd, int numPar);
