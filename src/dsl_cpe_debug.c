...
DSL_CCA_debugDestinations_t DSL_CCA_g_dbgDestination = DSL_CCA_DBG_DST_CONSOLE;
   ...
   DSL_uint16_t *pData)
{
   ...
   if (bFound == DSL_FALSE)
   {
      DSL_CCA_DEBUG(DSL_CCA_DBG_ERR, (DSL_CPE_PREFIX
         "ERROR - CMV read, wrong group type" DSL_CPE_CRLF));
   ...
   {
      DSL_CCA_DEBUG(DSL_CCA_DBG_ERR, (DSL_CPE_PREFIX
         "ERROR - cr read %d %d %d fail" DSL_CPE_CRLF, group, address, index));
   ...
   DSL_uint16_t *pData)
{
   ...
   {
      DSL_CCA_DEBUG(DSL_CCA_DBG_ERR, (DSL_CPE_PREFIX
         "ERROR - CMV write, wrong group type" DSL_CPE_CRLF));
   ...
   {
      DSL_CCA_DEBUG(DSL_CCA_DBG_ERR, (DSL_CPE_PREFIX
         "ERROR - cw %d %d %d failed" DSL_CPE_CRLF, group, address, index));
   ...
   DSL_char_t     *sTcpServerIp)
{
   ...
   DSL_CCA_DEBUG(DSL_CCA_DBG_ERR, (DSL_CPE_PREFIX
      "ERROR - TCP message debug interface thread start error" DSL_CPE_CRLF));
