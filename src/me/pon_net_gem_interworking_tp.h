...
/**
 * \file
 * This file contains functions for GEM Interworking TP ME
 */

#ifndef _PON_NET_GEM_INTERWORKING_TP_
#define _PON_NET_GEM_INTERWORKING_TP_
...
/**
 * Get GEM Port Network CTP ME ID for GEM Interworking TP
 *
 * \param[in] ctx		PON NET context pointer
 * \param[in] me_id		GEM Interworking TP ME ID
