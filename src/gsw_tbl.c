...
const GSW_CommandTable_t cmdTable[] = {
	...
	{/* 228 */ "GSW_DEFAUL_PCE_QMAP_GET", (command_fkt)gsw_defaul_pce_qmap_get},
	{/* 229 */ "GSW_DEFAUL_PCE_BYPASS_QMAP_GET", (command_fkt)gsw_defaul_bypass_qmap_get},
	{/* 230 */ "GSW_IG_CFG_PMAC_GET", (command_fkt)gsw_pmac_get_ig_cfg},
	{NULL, NULL},
};
...
const char *const HelpText[] = {
	...
	/* 227: DUMP_MEM "*/
	"GSW_DUMP_MEM",
	/* 228: GSW_DEFAUL_PCE_QMAP_GET "*/
	"Read out the default PCE Q-MAP"
	"\nParameter:\n----------\n"
	"nPortId :\n",
	/* 229: GSW_DEFAUL_PCE_BYPASS_QMAP_GET "*/
	"Read out the default PCE Bypass Q-MAP"
	"\nParameter:\n----------\n"
	"nPortId :\n",
	/* 230: GSW_IG_CFG_PMAC_GET "*/
	"Read out the default PCE Bypass Q-MAP"
	"\nParameter:\n----------\n"
	"nPortId :\n"
	"nTxDmaChanId :\n",
