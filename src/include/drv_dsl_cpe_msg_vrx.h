...
/*
   This function sends the VRX firmware message CMD_PAF_PME_ID_Set

   \param pContext - Pointer to DSL CPE library context structure, [I]

   \param nPmeId - PME identification number
...
/**
   This function requests the actual active upstream/downstream RA mode
   (ACT-RA-MODEus, Section 7.5.1.33.2 of G.997.1).

   \param pContext - Pointer to DSL library context structure, [I]
   \param nDirection - specifies direction, [I]
   \param pAck - Pointer to the msg ACK, [O]
...
/**
   This function requests the xTU-O T1.413 Revision Number

   pContext - Pointer to DSL library context structure, [I]
   \param pAck - Pointer to the msg ACK, [O]
...
/**
   This function requests the xTU-R T1.413 Revision Number
...
/**
   This function requests the xTU-O T1.413 Vendor Revision Number
...
/**
   This function requests the xTU-R T1.413 Vendor Revision Number
