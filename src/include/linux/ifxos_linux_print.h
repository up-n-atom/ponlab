...
#define IFXOS_DBG_PRINT_INT(fmt, args...)       pr_debug(fmt "\n", ##args)
   /** Kernel - Debug Print on Appl-Level (formated) */
#define IFXOS_DBG_PRINT_USR(fmt, args...)       pr_debug(fmt "\n", ##args)

   /** Kernel - Error Print on Int-Level (formated) */
#define IFXOS_ERR_PRINT_INT(fmt, args...)       pr_err(fmt "\n", ##args)
   /** Kernel - Error Print on Appl-Level (formated) */
#define IFXOS_ERR_PRINT_USR(fmt, args...)       pr_err(fmt "\n", ##args)


   /** Kernel - Print on Int-Level (unformatted) */
#define IFXOS_PRINT_INT_RAW(fmt, args...)       pr_info(fmt, ##args)
   /** Kernel - Print on Appl-Level (unformatted) */
#define IFXOS_PRINT_USR_RAW(fmt, args...)       pr_info(fmt, ##args)
