...
static dwpald_hostap_event hap_events[] = {
	...
	{ "AP-STA-SCS-ADD", sizeof("AP-STA-SCS-ADD") - 1, hostap_event },
	{ "AP-STA-SCS-REM", sizeof("AP-STA-SCS-REM") - 1, hostap_event },
};
...
int main(int argc, char *argv[])
{
	...
	size_t num_hap_events = ARRAY_SIZE(hap_events);
	size_t num_drv_events = ARRAY_SIZE(drv_events);
