...
u32 gsw_mac_reg_read(int fd, GSW_MAC_Cli_t *param)
{
	int ret = 0;
...
int gsw_mac_reg_write(int fd, GSW_MAC_Cli_t *param)
{
...
u32 xgmac_reg_rd(int fd, GSW_MAC_Cli_t *param, u32 reg)
{
	param->cmdType = MAC_CLI_REG_RD;
	param->val[0] = reg;
...
void xgmac_reg_wr(int fd, GSW_MAC_Cli_t *param, u32 reg, u32 data)
{
	param->cmdType = MAC_CLI_REG_RD;
	param->val[0] = reg;
	param->val[1] = data;
...
static int print_mdio_rd_cnt(int fd, GSW_MAC_Cli_t *param)
...
static int print_mdio_rd(int fd, GSW_MAC_Cli_t *param)
...
static int xgmac_cli_mdio_get_int_sts(int fd, GSW_MAC_Cli_t *param)
{
...
static int xgmac_cli_get_tx_cfg(int fd, GSW_MAC_Cli_t *param)
{
	u32 txq_en;
...
static int xgmac_cli_get_counters_cfg(int fd, GSW_MAC_Cli_t *param)
{
	u32 ror = 0;
...
static int xgmac_cli_get_fifo_size(int fd, GSW_MAC_Cli_t *param)
{
...
static int xgmac_cli_get_flow_control_threshold(int fd, GSW_MAC_Cli_t *param)
{
...
static int xgmac_cli_get_mtl_rx_flow_ctl(int fd, GSW_MAC_Cli_t *param)
{
	u32 rx_fc;
...
static int xgmac_cli_get_mtl_tx(int fd, GSW_MAC_Cli_t *param)
{
	u32 tx_mode;
...
static int xgmac_cli_get_mtl_rx(int fd, GSW_MAC_Cli_t *param)
{
	u32 rx_mode;
...
static int xgmac_cli_get_mtl_q_alg(int fd, GSW_MAC_Cli_t *param)
{
...
static int xgmac_cli_get_crc_settings(int fd, GSW_MAC_Cli_t *param)
{
	u32 cst, acs, dcrcc;
...
static int xgmac_cli_dbg_eee_status(int fd, GSW_MAC_Cli_t *param)
{
	u32 varmac_lps;
...
static int xgmac_cli_get_eee_settings(int fd, GSW_MAC_Cli_t *param)
{
...
static int xgmac_cli_get_mac_settings(int fd, GSW_MAC_Cli_t *param)
{
	u32 te, re, ra;
...
static int xgmac_cli_get_mac_rxtx_sts(int fd, GSW_MAC_Cli_t *param)
{
	u32 rwt, tjt, wd, jd;
...
static int xgmac_cli_get_mtu_settings(int fd, GSW_MAC_Cli_t *param)
{
...
static int xgmac_cli_get_checksum_offload(int fd, GSW_MAC_Cli_t *param)
{
	u32 co = 0;
...
static int xgmac_cli_get_mac_addr(int fd, GSW_MAC_Cli_t *param)
{
...
static int xgmac_cli_get_mac_rx_mode(int fd, GSW_MAC_Cli_t *param)
{
	u32 mode = 0;
...
static int xgmac_cli_get_rx_vlan_filtering_mode(int fd, GSW_MAC_Cli_t *param)
{
	u32 vtfe = 0;
...
static int xgmac_cli_get_mac_speed(int fd, GSW_MAC_Cli_t *param)
{
	u32 speed;
...
static int xgmac_cli_get_pause_frame_ctl(int fd, GSW_MAC_Cli_t *param)
{
...
static int xgmac_cli_get_mac_loopback_mode(int fd, GSW_MAC_Cli_t *param)
{
	u32 lm;
...
static int xgmac_cli_get_tstamp_settings(int fd, GSW_MAC_Cli_t *param)
{
	u32 mac_tscr, val;
...
static int xgmac_cli_get_txtstamp_cnt(int fd, GSW_MAC_Cli_t *param)
{
	int ret = 0;
...
static int xgmac_cli_get_txtstamp_pktid(int fd, GSW_MAC_Cli_t *param)
{
	int ret = 0;
...
static int xgmac_cli_get_tstamp_status(int fd, GSW_MAC_Cli_t *param)
{
	u32 mac_tscr, val;
	u64 time;
...
static int xgmac_cli_print_system_time(int fd, GSW_MAC_Cli_t *param)
{
	u64 nsec;
...
int gswss_reg_wr(int fd, GSW_MAC_Cli_t *param, u32 reg, u32 data)
{
...
int gswss_reg_rd(int fd, GSW_MAC_Cli_t *param, u32 reg)
{
...
static int xgmac_cli_get_txtstamp_mode(int fd, GSW_MAC_Cli_t *param)
{
...
static int xgmac_cli_get_debug_sts(int fd, GSW_MAC_Cli_t *param)
{
...
static int xgmac_cli_get_mtl_int_sts(int fd, GSW_MAC_Cli_t *param)
{
	u32 mtl_q_isr;
	u32 val;
...
static int xgmac_cli_dbg_int_sts(int fd, GSW_MAC_Cli_t *param)
{
	u32 mac_isr = 0, val;
...
static int xgmac_cli_get_mtl_underflow_pkt_cnt(int fd, GSW_MAC_Cli_t *param)
{
	u32 mtl_q;
	u32 val;
...
static int xgmac_cli_get_mtl_missed_pkt_cnt(int fd, GSW_MAC_Cli_t *param)
{
	u32 mtl_q;
	u32 val;
...
static int xgmac_cli_get_fup_fep_setting(int fd, GSW_MAC_Cli_t *param)
{
	u32 fup, fef;
...
static int xgmac_cli_get_ipg(int fd, GSW_MAC_Cli_t *param)
{
	u32 ipg, ifp, speed;
...
static int xgmac_cli_get_extcfg(int fd, GSW_MAC_Cli_t *param)
{
	u32 mac_extcfg, val;
...
static int xgmac_cli_dbg_pmt(int fd, GSW_MAC_Cli_t *param)
{
...
static int xgmac_cli_get_rmon(int fd, GSW_MAC_Cli_t *param)
{
	u32 i = 0;
...
static int xgmac_cli_print_hw_cap(int fd, GSW_MAC_Cli_t *param)
{
...
int xgmac_cli_get_pch_crc_cnt(int fd, GSW_MAC_Cli_t *param)
{
	u32 crc_cnt;
...
static int xgmac_cli_get_all_hw_settings(int fd, GSW_MAC_Cli_t *param)
{
...
void xgmac_menu(void)
{
	...
	for (i = 0; i < num_of_elem; i++) {
		if (xgmac_cfg_table[i].data1 || xgmac_cfg_table[i].data2 ||
			...
			printf("switch_cli xgmac    <0/1/2/* MacIdx>        %15s \t %s \n",
	...
	for (i = 0; i < num_of_elem; i++) {
		if (xgmac_cfg_table[i].get_func)
			printf("switch_cli xgmac    <0/1/2/ MacIdx>   get   %15s\n",
			       xgmac_cfg_table[i].name);
	}
...
int xgmac_main(u32 argc, char *argv[], int fd)
{
	u32 i = 0, j = 0, found = 0;
	u32 start_arg = 0;
	int idx = 0;
	...
	if (!strcmp(argv[start_arg], "*")) {
		...
		if ((idx < 0) || (idx >= (max_mac))) {
			printf("Give valid mac index 0/1/2/...\n");
			return -1;
		}
