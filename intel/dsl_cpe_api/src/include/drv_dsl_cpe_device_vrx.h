...
#define DSL_MIN_FW_VERSION_NMS                 8,   0, 0xA,  -1,  -1
#define DSL_MIN_FW_VERSION_FE_DELT             8,   1,  -1,  -1,  -1
#define DSL_MIN_FW_VERSION_R9_RELEASE          9,  -1,  -1,  -1,  -1
#define DSL_MIN_FW_VERSION_R7_RELEASE          7,  -1,  -1,  -1,  -1
...
#elif defined (DSL_VRX_DEVICE_VR11)
   #define DSL_CHIPSET_TYPE_STRING "Lantiq-VRX500"
#else
   #error Please defined a valid VRX device (VR9|VR10|VR10_320|VR11)!!!
#endif
...
/** Defines the Maximum possible Data Rate for ADSL in bit/s (DS/US) */
#define DSL_DEV_MAX_DATARATE_DS_ADSL    32768000
#define DSL_DEV_MAX_DATARATE_US_ADSL    2048000
