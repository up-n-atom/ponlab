   ...
   CMV_MESSAGE_ALL_T *pCmvMsg)
{
   ...
   else
   {
      ...
      cpe_control_memcpy_s(pCmvMsg, CMV_MESSAGE_SIZE, 
         &CmvMsg_Ack, sizeof(&CmvMsg_Ack));
   }
  ...
  CMV_MESSAGE_ALL_T *pCmvMsg)
{
   ...
   */
   if ((remainCnt_byte > 0) && (remainCnt_byte < 4) )
   {
      ...
      pTmp = ((DSL_char_t *)&tmpData);
      pTmpSrc = ((DSL_char_t *)&tmpSrc);
      cpe_control_memcpy_s(pTmpSrc, remainCnt_byte, 
         pSrc, sizeof(pSrc));
      ...
      cpe_control_memcpy_s(pTmp, remainCnt_byte, 
         pTmpSrc, sizeof(pTmpSrc));
   ...
   CMV_MESSAGE_ALL_T   *pCmvMsg)
{
   ...
   switch (CMV_MSGHDR_BIT_SIZE_GET(pCmvMsg->cmv))
   {
      ...
      case CMV_MSG_BIT_SIZE_16BIT:
         ...
         break;
      case CMV_MSG_BIT_SIZE_32BIT:
         H2N_SWAP_CMV_PAYL_DWORD(pCmvMsg, CMV_HEADER_32BIT_SIZE, (CMVSizeByte >> 2)-CMV_HEADER_32BIT_SIZE);
         break;
      default:
         DSL_CCA_DEBUG (DSL_CCA_DBG_ERR, (DSL_CPE_PREFIX
   ...
   while (pTcpDebugInfo->pEndReceive >= pPackage + CMV_HEADER_8BIT_SIZE)
   {
      ...
      switch (CMV_MSGHDR_BIT_SIZE_GET(pRecvCmvMsg->cmv))
      {
         ...
         case CMV_MSG_BIT_SIZE_16BIT:
            ...
            break;
         case CMV_MSG_BIT_SIZE_32BIT:
            N2H_SWAP_CMV_PAYL_DWORD(pRecvCmvMsg, CMV_HEADER_32BIT_SIZE, (PayloadSize >> 1));
            break;
         default:
            DSL_CCA_DEBUG (DSL_CCA_DBG_ERR, (DSL_CPE_PREFIX
