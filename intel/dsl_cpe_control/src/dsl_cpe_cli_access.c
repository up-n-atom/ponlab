   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d", &intDbgModule);
   nDbgModule = intDbgModule;
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d %x", &intDbgModule, &nDbgLvl);
   nDbgModule = intDbgModule;
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%u", &nDbgModule);

   pData.data.nDbgModule = nDbgModule;
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%u %x", &nDbgModule, &nDbgLevel);

   pData.data.nDbgModule = nDbgModule;
   pData.data.nDbgLevel = nDbgLevel;
...
#ifndef DSL_CPE_DEBUG_DISABLE
static const DSL_char_t g_sCcaDbgmdg[] =
   "Long Form: %s" DSL_CPE_CRLF
   "Short Form: %s" DSL_CPE_CRLF
   DSL_CPE_CRLF
   "Input Parameter" DSL_CPE_CRLF
   ...
   "- DSL_Error_t nReturn" DSL_CPE_CRLF
   "%s"
   "- DSL_CCA_debugDestinations_t nDbgDestination" DSL_CPE_CRLF
   "   DSL_CCA_DBG_DST_CONSOLE = 0" DSL_CPE_CRLF
   "   DSL_CCA_DBG_DST_LOGGER  = 1" DSL_CPE_CRLF
   DSL_CPE_CRLF "";

DSL_CLI_LOCAL DSL_int_t DSL_CPE_CLI_CCA_DBG_ModuleDestinationGet(
   DSL_int_t fd,
   DSL_char_t *pCommands,
   DSL_CPE_File_t *out)
{
   DSL_int_t ret = 0;
   DSL_CCA_debugDestinations_t nDbgDestination = DSL_CCA_DBG_DST_CONSOLE;
   ...
   nDbgDestination = DSL_CCA_g_dbgDestination;

   DSL_CPE_FPrintf (out, DSL_CPE_RET "nDbgDestination=%x" DSL_CPE_CRLF, DSL_CPE_RET_VAL(ret), nDbgDestination);
...
#ifndef DSL_CPE_DEBUG_DISABLE
static const DSL_char_t g_sCcaDbgmds[] =
   "Long Form: %s" DSL_CPE_CRLF
   "Short Form: %s" DSL_CPE_CRLF
   DSL_CPE_CRLF
   "Input Parameter" DSL_CPE_CRLF
...
DSL_CLI_LOCAL DSL_int_t DSL_CPE_CLI_CCA_DBG_ModuleDestinationSet(
   DSL_int_t fd,
   DSL_char_t *pCommands,
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d", &dbgDestination);
   nDbgDestination = dbgDestination;

   DSL_CCA_g_dbgDestination = nDbgDestination;

   DSL_CPE_FPrintf (out, DSL_CPE_RET"nDbgDestination=%d" DSL_CPE_CRLF, DSL_CPE_RET_VAL(ret), nDbgDestination);

   return 0;
}
#endif

static const DSL_char_t g_sDBGmdg[] =
#ifndef DSL_CPE_DEBUG_DISABLE
   "Long Form: %s" DSL_CPE_CRLF
   "Short Form: %s" DSL_CPE_CRLF
   DSL_CPE_CRLF
   ...
   "- DSL_Error_t nReturn" DSL_CPE_CRLF
   "%s"
   "- DSL_debugDestinations_t nDbgDestination" DSL_CPE_CRLF
   "   DSL_DBG_DST_CONSOLE = 0" DSL_CPE_CRLF
   "   DSL_DBG_DST_LOGGER  = 1" DSL_CPE_CRLF
   DSL_CPE_CRLF "";
#else
   "";
#endif

DSL_CLI_LOCAL DSL_int_t DSL_CPE_CLI_DBG_ModuleDestinationGet(
   DSL_int_t fd,
   DSL_char_t *pCommands,
   DSL_CPE_File_t *out)
{
   DSL_int_t ret = 0;
   DSL_DBG_ModuleDestination_t pData;
   ...
   memset(&pData, 0x0, sizeof(DSL_DBG_ModuleDestination_t));

   ret = DSL_CPE_Ioctl (fd, DSL_FIO_DBG_MODULE_DESTINATION_GET, (int) &pData);
   ...
   {
      DSL_CPE_FPrintf (out, DSL_CPE_RET"nDbgDestination=%d" DSL_CPE_CRLF,
         DSL_CPE_RET_VAL(pData.accessCtl.nReturn), pData.data.nDbgDestination);
   }

   return 0;
}

static const DSL_char_t g_sDBGmds[] =
#ifndef DSL_CPE_DEBUG_DISABLE
   "Long Form: %s" DSL_CPE_CRLF
   "Short Form: %s" DSL_CPE_CRLF
   DSL_CPE_CRLF
...
DSL_CLI_LOCAL DSL_int_t DSL_CPE_CLI_DBG_ModuleDestinationSet(
   DSL_int_t fd,
   DSL_char_t *pCommands,
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d", &dbgDestination);
   pData.data.nDbgDestination = dbgDestination;

   ret = DSL_CPE_Ioctl (fd, DSL_FIO_DBG_MODULE_DESTINATION_SET, (int) &pData);
...
#endif /* INCLUDE_DSL_CPE_DEBUG_LOGGER_SUPPORTs */
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%256s", sNotifyScript);
...
#if (INCLUDE_DSL_CPE_API_VDSL_SUPPORT == 1)
   sscanf (pCommands, "%256s %256s", sAdslScript, sVdslScript);
#else
   sscanf (pCommands, "%256s", &sAdslScript);
#endif
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%u", &nCommand);

   pData.data.nCommand = nCommand;
   ...
   DSL_CPE_File_t *out)
{
   ...
   unsigned int nAutoContinueWaitBeforeLinkActivation;
   unsigned int nAutoContinueWaitBeforeConfigWrite;
   unsigned int nAutoContinueWaitBeforeRestart;
   unsigned int nWaitBeforeLinkActivation;
   unsigned int nWaitBeforeConfigWrite;
   unsigned int nWaitBeforeRestart;
   ...
   sscanf (pCommands, "%u %u %u %u %u %u",
      &nWaitBeforeConfigWrite, &nWaitBeforeLinkActivation, &nWaitBeforeRestart,
      &nAutoContinueWaitBeforeConfigWrite, &nAutoContinueWaitBeforeLinkActivation,
      &nAutoContinueWaitBeforeRestart);


   bWaitBeforeConfigWrite = nWaitBeforeConfigWrite;
   bWaitBeforeLinkActivation = nWaitBeforeLinkActivation;
   bWaitBeforeRestart = nWaitBeforeRestart;
   bAutoContinueWaitBeforeConfigWrite = nAutoContinueWaitBeforeConfigWrite;
   bAutoContinueWaitBeforeLinkActivation = nAutoContinueWaitBeforeLinkActivation;
   bAutoContinueWaitBeforeRestart = nAutoContinueWaitBeforeRestart;
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%u", &nEventType);

   pData.data.nEventType = nEventType;
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%u %u", &nEventType, &bMask);

   pData.data.nEventType = nEventType;
   pData.data.bMask = bMask;
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%hhu %d", &pData.nChannel, &nDirection);
...
static const DSL_char_t g_sIsg[] =
   ...
   "- DSL_boolean_t bFwEventActivation" DSL_CPE_CRLF
   "   false = 0" DSL_CPE_CRLF
   "   true = 1" DSL_CPE_CRLF
   DSL_CPE_CRLF "";
#else
   ...
   DSL_CPE_File_t *out)
{
   ...
   else
   {
      DSL_CPE_FPrintf (out, DSL_CPE_RET"bEventActivation=%d nEventActivationMask=0x%x "
         "bFwEventActivation=%d"DSL_CPE_CRLF, DSL_CPE_RET_VAL(pData.accessCtl.nReturn),
         pData.data.bEventActivation, pData.data.nResourceActivationMask,
         pData.data.bFwEventActivation);
   }
   ...
   DSL_CPE_File_t *out)
{
   ...
   DSL_CPE_Control_Context_t *pCtx = DSL_NULL;
   unsigned int bEventActivation = 0;
   unsigned int nResourceActivationMask = 0;
   unsigned int bFwEventActivation = 0;
   ...
   sscanf (pCommands, "%u %x %u", &bEventActivation,
      &nResourceActivationMask, &bFwEventActivation);

   pData.data.bEventActivation = bEventActivation;
   pData.data.nResourceActivationMask = nResourceActivationMask;
   pData.data.bFwEventActivation = bFwEventActivation;
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d %d", &nDslMode, &nDirection);
   ...
   DSL_CPE_File_t *out)
{
   ...
   int nDslMode = 0;
   int nDirection = 0;
   unsigned int bTrellisEnable;
   unsigned int bBitswapEnable;
   ...
   pData.nDslMode = nDslMode;
   pData.nDirection = nDirection;
   pData.data.bTrellisEnable = bTrellisEnable;
   pData.data.bBitswapEnable = bBitswapEnable;
   ...
   {
      DSL_CPE_FPrintf (out, DSL_CPE_RET"nDslMode=%u nDirection=%u" DSL_CPE_CRLF,
         DSL_CPE_RET_VAL(pData.accessCtl.nReturn), pData.nDslMode,
         pData.nDirection);
   }
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%"_MKSTR(DSL_MAX_COMMAND_LINE_LENGTH)"s", sFileName);
   ...
   DSL_CPE_File_t *out)
{
   ...
   DSL_SystemInterfaceConfig_t pData;
   int nDslMode = 0;
   unsigned int nTcLayer = 0;
   unsigned int nEfmTcConfigUs = 0;
   unsigned int nEfmTcConfigDs = 0;
   unsigned int nSystemIf = 0;
   ...
   sscanf (pCommands, "%d %u %x %x %u", &nDslMode,
      &nTcLayer, &nEfmTcConfigUs,
      &nEfmTcConfigDs, &nSystemIf);

   pData.nDslMode = nDslMode;
   pData.data.nTcLayer = nTcLayer;
   pData.data.nEfmTcConfigUs = nEfmTcConfigUs;
   pData.data.nEfmTcConfigDs = nEfmTcConfigDs;
   pData.data.nSystemIf = nSystemIf;
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%u", &nTestMode);

   pData.data.nTestMode = nTestMode;
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d", &pData.nDirection);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%u", &pData.data.nStatusSelector);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d %d %u", &nDslMode, &nDirection,
      &nRA_MODE);

   pData.nDslMode = nDslMode;
   pData.nDirection = nDirection;
   pData.data.RA_MODE = nRA_MODE;
   ...
   DSL_CPE_File_t *out)
{
   ...
   DSL_G997_DataPathFailures_t pData;
   int nDirection = 0;
   unsigned int nDataPathFailures = 0;
   ...
   sscanf (pCommands, "%hhu %d %x", &pData.nChannel, &nDirection,
      &nDataPathFailures);

   pData.nDirection = nDirection;
   pData.data.nDataPathFailures = nDataPathFailures;
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d %x", &nDirection, &nLineFailures);

   pData.nDirection = nDirection;
   pData.data.nLineFailures = nLineFailures;
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%hhu %d %u %u", &pData.nChannel, &nDirection,
   ...
   DSL_CPE_File_t *out)
{
   ...
   {
      DSL_CPE_FPrintf (out,
         DSL_CPE_RET"nChannel=%hu nDirection=%u nNFEC=%hu nRFEC=%hu nLSYMB=%u "
   ...
   DSL_CPE_File_t *out)
{
   DSL_int_t ret = 0;
   DSL_G997_LineActivate_t pData;
   unsigned int nLDSF = 0;
   unsigned int nACSF = 0;
   unsigned int nStartupMode = 0;
   ...
   sscanf (pCommands, "%u %u %u", &nLDSF,
      &nACSF, &nStartupMode);

   pData.data.nLDSF = nLDSF;
   pData.data.nACSF = nACSF;
   pData.data.nStartupMode = nStartupMode;
   ...
   DSL_CPE_File_t *out)
{
   ...
   if (token != DSL_NULL)
   {
      for (i = 0; i < nParams; i++)
      {
         ...
         {
            nIdx = i;
            sscanf (token, "%hhx", (unsigned char *)&(pData.data.SystemVendorID[nIdx]));
         }
         else if (i < nParamList[1])
         {
            nIdx = (DSL_uint16_t)(i - nParamList[0]);
            sscanf (token, "%hhx", (unsigned char *)&(pData.data.VersionNumber[nIdx]));
         }
         else if (i < nParamList[2])
         {
            nIdx = (DSL_uint16_t)(i - nParamList[1]);
            sscanf (token, "%hhx", (unsigned char *)&(pData.data.SerialNumber[nIdx]));
         }
#if (INCLUDE_DSL_CPE_API_VDSL_SUPPORT == 1)
         else if (i < nParamList[3])
         {
            nIdx = (DSL_uint16_t)(i - nParamList[2]);
            sscanf (token, "%hhx", (unsigned char *)&(pData.data.Auxiliary.pData[nIdx]));
         }
#endif
         else
         {
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d %u", &nDirection, &nDeltDataType);

   pData.nDirection = nDirection;
   pData.nDeltDataType = nDeltDataType;
   ...
   DSL_CPE_File_t *out)
{
   ...
   unsigned int nPowerManagementState;
   ...
   sscanf (pCommands, "%u", &nPowerManagementState);

   pData.data.nPowerManagementState = nPowerManagementState;
...
static const DSL_char_t g_sG997dsnrg[] =
   ...
   "- DSL_uint8_t nGroupSize (currently unused!)" DSL_CPE_CRLF
   "- DSL_uint16_t nNumData" DSL_CPE_CRLF
   "- DSL_int_t nGroupIndex" DSL_CPE_CRLF
   ...
   DSL_CPE_File_t *out)
{
   ...
   else
   {
      ...
      DSL_CPE_FPrintf(out, "nFormat=(nGroupIndex(dec),nSnr(dec)) nData=\"");
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf ( pCommands, "%x %x %x %x %x %x %x %x",
   ...
   DSL_CPE_File_t *out)
{
   ...
   unsigned int nConfigSelector = 0;
   int nConfigValue = 0;
   ...
   sscanf (pCommands, "%u %d",
      &nConfigSelector, &nConfigValue);

   pData.data.nConfigSelector = nConfigSelector;
   pData.data.nConfigValue = nConfigValue;
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%u", &nConfigSelector);
   ...
   DSL_CPE_File_t *out)
{
   ...
   unsigned int bNePollingOff = 0;
   unsigned int bFePollingOff = 0;
   ...
   sscanf (pCommands, "%u %u %hhu %hhu %hhu", &bNePollingOff,
      &bFePollingOff, &pData.data.nBasicUpdateCycle,
      &pData.data.nFeUpdateCycleFactor, &pData.data.nFeUpdateCycleFactorL2);

   pData.data.bNePollingOff = bNePollingOff;
   pData.data.bFePollingOff = bFePollingOff;
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%u", &pData.data.bOneDayElapsed);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%u %u %u %u", &pData.data.bActivate,
   ...
   DSL_CPE_File_t *out)
{
   ...
   unsigned int nResetType = 0;
   unsigned int bUseDetailedReset = 0;
   unsigned int nResetMask = 0;
   ...
   sscanf (pCommands, "%u %u %x",
   &nResetType, &bUseDetailedReset, &nResetMask);

   pData.data.nResetType = nResetType;
   pData.data.bUseDetailedReset = bUseDetailedReset;
   pData.data.nResetMask = nResetMask;
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%u", &pData.data.nMode);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%hhu %u %u", &pData.nChannel, &direction,
      &pData.nHistoryInterval);
   pData.nDirection = direction;
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%hhu %d %u", &pData.nChannel, &nDirection,
      &pData.nHistoryInterval);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%hhu %u %u %u", &pData.nChannel, &direction,
      &pData.data.nCodeViolations, &pData.data.nFEC);
   pData.nDirection = direction;
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%hhu %u %u %u %u %u %u %u %u %u %u %u", &pData.nChannel,
      &direction, &pData.data.nHEC, &pData.data.nTotalCells,
      &pData.data.nUserTotalCells, &pData.data.nIBE,
   ...
   sscanf (pCommands, "%hhu %u %u %u %u %u %u %u", &pData.nChannel,
      &direction, &pData.data.nHEC, &pData.data.nTotalCells,
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%u %u", &direction,
      &pData.nHistoryInterval);
   pData.nDirection = direction;
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%u", &pData.nHistoryInterval);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%u %u %u %u", &pData.data.nFullInits,
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%u %u", &direction, &pData.nHistoryInterval);
   pData.nDirection = direction;
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d %u", &nDirection, &pData.nHistoryInterval);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%u %u %u %u %u %u %u", &direction, &pData.data.nES,
      &pData.data.nSES, &pData.data.nLOSS, &pData.data.nUAS, &pData.data.nLOFS,
      &pData.data.nFECS);
   pData.nDirection = direction;
   ...
   DSL_CPE_File_t *out)
{
   ...
   unsigned char nEnableTcpCli = 0;
   if (DSL_CPE_CLI_CheckParamNumber(pCommands, 3, DSL_CLI_EQUALS) == DSL_FALSE)
   {
      return -1;
   }

   sscanf ( pCommands, "%32s %hu %hhu",
                    tcpIpAddr, &tcpIpPort, &nEnableTcpCli);

   bEnableTcpCli = nEnableTcpCli;
   ...
   DSL_CPE_File_t *out)
{
   ...
   unsigned char nEnableCliAutoMsg = 0;
   unsigned char nEnableDevAutoMsg = 0;
   unsigned char nEnableSingleThrMode = 0;
   ...
   sscanf ( pCommands, "%hu %hu %32s %hu %hhu %hhu %hhu",
                    &numOfDevs, &portsPerDev, dtiIpAddr, &dtiIpPort,
                    &nEnableCliAutoMsg, &nEnableDevAutoMsg, &nEnableSingleThrMode);

   bEnableCliAutoMsg = nEnableCliAutoMsg;
   bEnableDevAutoMsg = nEnableDevAutoMsg;
   bEnableSingleThrMode = nEnableSingleThrMode;
...
static const DSL_char_t g_sRccs[] =
   ...
   "   DSL_REBOOT_CRITERIA_ESX = 0x00000010" DSL_CPE_CRLF
   "   DSL_REBOOT_CRITERIA_SESX = 0x00000020" DSL_CPE_CRLF
   ...
   DSL_CPE_File_t *out)
{
   ...
   int nDslMode = 0;
   unsigned int nRebootCriteria = 0;
   ...
   sscanf (pCommands, "%d %x", &nDslMode, &nRebootCriteria);

   pData.nDslMode = nDslMode;
   pData.data.nRebootCriteria = nRebootCriteria;
   ...
   DSL_CPE_File_t *out)
{
   ...
   {
      DSL_CPE_FPrintf (out,
         DSL_CPE_RET"nDslMode=%u nRebootCriteria=0x%08X" DSL_CPE_CRLF,
         DSL_CPE_RET_VAL(pData.accessCtl.nReturn), pData.nDslMode,
         pData.data.nRebootCriteria);
   }
...
static const DSL_char_t g_sT1413XTUOrg[] =
#ifndef DSL_CPE_DEBUG_DISABLE
   "Long Form: %s" DSL_CPE_CRLF
   "Short Form: %s" DSL_CPE_CRLF
   DSL_CPE_CRLF
   ...
   "- DSL_Error_t nReturn" DSL_CPE_CRLF
   "%s"
   "- DSL_T1413_Revision_t nRevision" DSL_CPE_CRLF
   "   DSL_T1413_REV1 = 0" DSL_CPE_CRLF
   "   DSL_T1413_REV2 = 1" DSL_CPE_CRLF
   DSL_CPE_CRLF "";
#else
   "";
#endif

DSL_CLI_LOCAL DSL_int_t DSL_CPE_CLI_T1413_XTUO_RevisionGet(
   DSL_int_t fd,
   DSL_char_t *pCommands,
   DSL_CPE_File_t *out)
{
   DSL_int_t ret = 0;
   DSL_T1413RevisionStatus_t pData;
   ...
   memset(&pData, 0x0, sizeof(DSL_T1413RevisionStatus_t));

   ret = DSL_CPE_Ioctl (fd, DSL_FIO_T1413_XTUO_REVISION_GET, (int) &pData);
   ...
   {
      DSL_CPE_FPrintf (out, DSL_CPE_RET"nRevision=%d" DSL_CPE_CRLF,
      DSL_CPE_RET_VAL(pData.accessCtl.nReturn), pData.data.nT1413RevisionNum);
   }

   return 0;
}

static const DSL_char_t g_sT1413XTURrg[] =
#ifndef DSL_CPE_DEBUG_DISABLE
   "Long Form: %s" DSL_CPE_CRLF
   "Short Form: %s" DSL_CPE_CRLF
   DSL_CPE_CRLF
...
DSL_CLI_LOCAL DSL_int_t DSL_CPE_CLI_T1413_XTUR_RevisionGet(
   DSL_int_t fd,
   DSL_char_t *pCommands,
   DSL_CPE_File_t *out)
{
   ...
   ret = DSL_CPE_Ioctl (fd, DSL_FIO_T1413_XTUR_REVISION_GET, (int) &pData);
...
static const DSL_char_t g_sT1413XTUOvrg[] =
#ifndef DSL_CPE_DEBUG_DISABLE
   "Long Form: %s" DSL_CPE_CRLF
   "Short Form: %s" DSL_CPE_CRLF
   DSL_CPE_CRLF
   ...
   "- DSL_Error_t nReturn" DSL_CPE_CRLF
   "%s"
   "- DSL_uint16_t nRevision" DSL_CPE_CRLF
   DSL_CPE_CRLF "";
#else
   "";
#endif

DSL_CLI_LOCAL DSL_int_t DSL_CPE_CLI_T1413_XTUO_VendorRevisionGet(
   DSL_int_t fd,
   DSL_char_t *pCommands,
   DSL_CPE_File_t *out)
{
   DSL_int_t ret = 0;
   DSL_T1413VendorRevisionStatus_t pData;
   ...
   memset(&pData, 0x0, sizeof(DSL_T1413VendorRevisionStatus_t));

   ret = DSL_CPE_Ioctl (fd, DSL_FIO_T1413_XTUO_VENDOR_REVISION_GET, (int) &pData);
   ...
   {
      DSL_CPE_FPrintf (out, DSL_CPE_RET"nRevision=%d" DSL_CPE_CRLF,
      DSL_CPE_RET_VAL(pData.accessCtl.nReturn), pData.data.nT1413VendorRevisionNum);
   }

   return 0;
}

static const DSL_char_t g_sT1413XTURvrg[] =
#ifndef DSL_CPE_DEBUG_DISABLE
   "Long Form: %s" DSL_CPE_CRLF
   "Short Form: %s" DSL_CPE_CRLF
   DSL_CPE_CRLF
...
DSL_CLI_LOCAL DSL_int_t DSL_CPE_CLI_T1413_XTUR_VendorRevisionGet(
   DSL_int_t fd,
   DSL_char_t *pCommands,
   DSL_CPE_File_t *out)
{
   ...
   ret = DSL_CPE_Ioctl (fd, DSL_FIO_T1413_XTUR_VENDOR_REVISION_GET, (int) &pData);
...
static const DSL_char_t g_sPccg[] =
#ifndef DSL_CPE_DEBUG_DISABLE
"Long Form: %s" DSL_CPE_CRLF
"Short Form: %s" DSL_CPE_CRLF
DSL_CPE_CRLF
...
"- DSL_IN DSL_uint16_t toneIndex"
"- DSL_IN DSL_uint16_t level"
"- ... n times previous 2 params[0 <= n <= "_MKSTR(DSL_PSD_US_MAX_CALIB_POINTS)"]"
"- DSL_Error_t nReturn" DSL_CPE_CRLF
DSL_CPE_CRLF "";
#else
"";
...
DSL_CLI_LOCAL DSL_int_t DSL_CPE_CLI_PSDCalibrationConfigGet(
   DSL_int_t fd,
   DSL_char_t *pCommands,
   DSL_CPE_File_t *out)
{
   DSL_PSDCalibration_t *pData;
   DSL_uint16_t i = 0;
   DSL_int_t ret = 0;
   int nDirection = 0;
   ...
   pData = malloc(sizeof(DSL_PSDCalibration_t));
   if (pData == DSL_NULL)
   {
      DSL_CPE_FPrintf(out, DSL_CPE_RET DSL_CPE_CRLF, DSL_CPE_RET_VAL(DSL_ERR_MEMORY));
      return 0;
   ...
   memset(pData, 0, sizeof(DSL_PSDCalibration_t));
   sscanf (pCommands, "%d ", &nDirection);

   pData->nDirection = nDirection;

   ret = DSL_CPE_Ioctl (fd, DSL_FIO_PSD_CALIBRATION_CONFIG_GET, (int) pData);
   ...
   DSL_CPE_FPrintf (out, " NumBreakPts=0x%04X nData(hex)=\"" DSL_CPE_CRLF, pData->data.NumBreakPts);
   /* Print only the number of values that are returned */
   for (i = 0; (i < pData->data.NumBreakPts); i++)
   {
      DSL_CPE_FPrintf(out, "(0x%04X 0x%04X)", (DSL_int_t)(pData->data.breakpoint[i].toneIndex), (DSL_int_t)(pData->data.breakpoint[i].level));
   }
   DSL_CPE_FPrintf(out, "\"" DSL_CPE_CRLF );
   free(pData);
   return 0;
...
static const DSL_char_t g_sPccs[] =
#ifndef DSL_CPE_DEBUG_DISABLE
"Long Form: %s" DSL_CPE_CRLF
"Short Form: %s" DSL_CPE_CRLF
DSL_CPE_CRLF
...
DSL_CLI_LOCAL DSL_int_t DSL_CPE_CLI_PSDCalibrationConfigSet(
   DSL_int_t fd,
   DSL_char_t *pCommands,
   DSL_CPE_File_t *out)
{
   ...
   DSL_PSDCalibration_t pData;
   DSL_uint32_t ntoneIndex=0;
   DSL_uint32_t nlevel=0;
   DSL_uint32_t nMaxBreakpoints=0;
   int nDirection = 0;
   ...
   memset(&pData, 0x0, sizeof(DSL_PSDCalibration_t));
   ...
   {
      nMaxBreakpoints = DSL_PSD_US_MAX_CALIB_POINTS;
   }
   if (pData.nDirection == DSL_DOWNSTREAM)
   {
      nMaxBreakpoints = DSL_PSD_DS_MAX_CALIB_POINTS;
   }
   ret = DSL_CPE_MoveCharPtr(pChar, 1, " ", &pChar);
   if (ret != DSL_SUCCESS)
   {
   ...
   for (i = 0; i < nMaxBreakpoints; i++)
   {
      ...
      ret = sscanf(pChar, "%x %x", &ntoneIndex, &nlevel);
      if ( ret != 2 )
      {
         DSL_CPE_FPrintf(out, DSL_CPE_PREFIX "invalid breakpoint data!" DSL_CPE_CRLF);
         DSL_CPE_FPrintf(out, DSL_CPE_RET DSL_CPE_CRLF, DSL_CPE_RET_VAL(DSL_ERROR));
         return 0;
      }

      pData.data.breakpoint[i].toneIndex = (DSL_uint16_t)ntoneIndex;
      pData.data.breakpoint[i].level = (DSL_uint16_t)nlevel;

      ret = DSL_CPE_MoveCharPtr(pChar, 2, " ", &pChar);
      if (ret != DSL_SUCCESS)
      {
         pChar = DSL_NULL;
      }
   ...
   if (pChar != DSL_NULL)
   {
      DSL_CPE_FPrintf(out, DSL_CPE_PREFIX "Too many brekpoints!" DSL_CPE_CRLF);
      DSL_CPE_FPrintf(out, DSL_CPE_RET DSL_CPE_CRLF, DSL_CPE_RET_VAL(DSL_ERROR));
      return 0;
   }

   /* Set current number of breakpoints */
   pData.data.NumBreakPts = (DSL_uint16_t)i;

   DSL_CPE_FPrintf (out, " NumBreakPts=0x%04X nData(int)=\"" DSL_CPE_CRLF, pData.data.NumBreakPts);
   /* Print only the number of values that are returned */
   for (i = 0; (i < pData.data.NumBreakPts); i++)
   {
      DSL_CPE_FPrintf(out, "(0x%04X 0x%04X)", (DSL_int_t)(pData.data.breakpoint[i].toneIndex), (DSL_int_t)(pData.data.breakpoint[i].level));
   ...
   ret = DSL_CPE_Ioctl (fd, DSL_FIO_PSD_CALIBRATION_CONFIG_SET, (int) &pData);
...
DSL_void_t DSL_CPE_CLI_AccessCommandsRegister(DSL_void_t)
{
...
#ifndef DSL_CPE_DEBUG_DISABLE
   DSL_CPE_CLI_CMD_ADD_DEVICE ("ccadbgmlg", "CCA_DBG_ModuleLevelGet", DSL_CPE_CLI_CCA_DBG_ModuleLevelGet, g_sCcaDbgmlg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("ccadbgmls", "CCA_DBG_ModuleLevelSet", DSL_CPE_CLI_CCA_DBG_ModuleLevelSet, g_sCcaDbgmls);
#endif
   DSL_CPE_CLI_CMD_ADD_DEVICE ("dbgmlg", "DBG_ModuleLevelGet", DSL_CPE_CLI_DBG_ModuleLevelGet, g_sDBGmlg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("dbgmls", "DBG_ModuleLevelSet", DSL_CPE_CLI_DBG_ModuleLevelSet, g_sDBGmls);

#ifdef INCLUDE_DSL_CPE_DEBUG_LOGGER_SUPPORT
   /* Debug functionalities */
#ifndef DSL_CPE_DEBUG_DISABLE
   DSL_CPE_CLI_CMD_ADD_DEVICE ("ccadbgmdg", "CCA_DBG_ModuleDestinationGet", DSL_CPE_CLI_CCA_DBG_ModuleDestinationGet, g_sCcaDbgmdg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("ccadbgmds", "CCA_DBG_ModuleDestinationSet", DSL_CPE_CLI_CCA_DBG_ModuleDestinationSet, g_sCcaDbgmds);
#endif
   DSL_CPE_CLI_CMD_ADD_DEVICE ("dbgmdg", "DBG_ModuleDestinationGet", DSL_CPE_CLI_DBG_ModuleDestinationGet, g_sDBGmdg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("dbgmds", "DBG_ModuleDestinationSet", DSL_CPE_CLI_DBG_ModuleDestinationSet, g_sDBGmds);
...
#ifdef INCLUDE_DSL_CONFIG_GET
#ifdef INCLUDE_DSL_CPE_FILESYSTEM_SUPPORT
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("asecg", "AutobootScriptExecuteConfigGet", DSL_CPE_CLI_AutobootScriptExecuteConfigGet, g_sAsecg);
#endif /* INCLUDE_DSL_CPE_FILESYSTEM_SUPPORT*/
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("acog", "AutobootConfigOptionGet", DSL_CPE_CLI_AutobootConfigOptionGet, g_sAcfgg);
#endif /* INCLUDE_DSL_CONFIG_GET*/

#ifdef INCLUDE_DSL_CPE_FILESYSTEM_SUPPORT
   DSL_CPE_CLI_CMD_ADD_DEVICE ("se", "ScriptExecute", DSL_CPE_CLI_ScriptExecute, g_sSe);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("asecs", "AutobootScriptExecuteConfigSet", DSL_CPE_CLI_AutobootScriptExecuteConfigSet, g_sAsecs);
#endif /* INCLUDE_DSL_CPE_FILESYSTEM_SUPPORT*/
   DSL_CPE_CLI_CMD_ADD_DEVICE ("acos", "AutobootConfigOptionSet", DSL_CPE_CLI_AutobootConfigOptionSet, g_sAcfgs);
#endif /* INCLUDE_DSL_CPE_CMV_SCRIPTS_SUPPORT*/
...
#endif /* INCLUDE_DSL_CONFIG_GET*/
   DSL_CPE_CLI_CMD_ADD_DEVICE ("nsecs", "NotificationScriptExecuteConfigSet", DSL_CPE_CLI_NotificationScriptExecuteConfigSet, g_sNsecs);
#endif /* INCLUDE_SCRIPT_NOTIFICATION*/

   DSL_CPE_CLI_CMD_ADD_DEVICE ("acs", "AutobootControlSet", DSL_CPE_CLI_AutobootControlSet, g_sAcs);
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("asg", "AutobootStatusGet", DSL_CPE_CLI_AutobootStatusGet, g_sAsg);
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("lsg", "LineStateGet", DSL_CPE_CLI_LineStateGet, g_sLsg);
#ifdef INCLUDE_DSL_RESOURCE_STATISTICS
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("rusg", "ResourceUsageStatisticsGet", DSL_CPE_CLI_ResourceUsageStatisticsGet, g_sRusg);
#endif /* INCLUDE_DSL_RESOURCE_STATISTICS*/
#ifdef INCLUDE_DSL_CONFIG_GET
   DSL_CPE_CLI_CMD_ADD_DEVICE ("esmcg", "EventStatusMaskConfigGet", DSL_CPE_CLI_EventStatusMaskConfigGet, g_sEsmcg);
#endif /* INCLUDE_DSL_CONFIG_GET*/
   DSL_CPE_CLI_CMD_ADD_DEVICE ("esmcs", "EventStatusMaskConfigSet", DSL_CPE_CLI_EventStatusMaskConfigSet, g_sEsmcs);
#ifdef INCLUDE_DSL_FRAMING_PARAMETERS
   DSL_CPE_CLI_CMD_ADD_DEVICE ("fpsg", "FramingParameterStatusGet", DSL_CPE_CLI_FramingParameterStatusGet, g_sFpsg);
#endif /* INCLUDE_DSL_FRAMING_PARAMETERS*/
   DSL_CPE_CLI_CMD_ADD_DEVICE ("ics", "InstanceControlSet", DSL_CPE_CLI_InstanceControlSet, g_sIcs);
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("isg", "InstanceStatusGet", DSL_CPE_CLI_InstanceStatusGet, g_sIsg);
#ifdef INCLUDE_DSL_CONFIG_GET
   DSL_CPE_CLI_CMD_ADD_DEVICE ("lfcg", "LineFeatureConfigGet", DSL_CPE_CLI_LineFeatureConfigGet, g_sLfcg);
#endif /* INCLUDE_DSL_CONFIG_GET*/
   DSL_CPE_CLI_CMD_ADD_DEVICE ("lfcs", "LineFeatureConfigSet", DSL_CPE_CLI_LineFeatureConfigSet, g_sLfcs);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("lfsg", "LineFeatureStatusGet", DSL_CPE_CLI_LineFeatureStatusGet, g_sLfsg);
#ifdef INCLUDE_DSL_SYSTEM_INTERFACE
#ifdef INCLUDE_DSL_CONFIG_GET
   DSL_CPE_CLI_CMD_ADD_DEVICE ("sicg", "SystemInterfaceConfigGet", DSL_CPE_CLI_SystemInterfaceConfigGet, g_sSicg);
#endif /* INCLUDE_DSL_CONFIG_GET*/
   DSL_CPE_CLI_CMD_ADD_DEVICE ("sics", "SystemInterfaceConfigSet", DSL_CPE_CLI_SystemInterfaceConfigSet, g_sSics);
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("sisg", "SystemInterfaceStatusGet", DSL_CPE_CLI_SystemInterfaceStatusGet, g_sSisg);
#endif /* INCLUDE_DSL_SYSTEM_INTERFACE*/
   DSL_CPE_CLI_CMD_ADD_DEVICE ("tmcs", "TestModeControlSet", DSL_CPE_CLI_TestModeControlSet, g_sTmcs);
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("tmsg", "TestModeStatusGet", DSL_CPE_CLI_TestModeStatusGet, g_sTmsg);
#ifdef INCLUDE_DSL_CPE_MISC_LINE_STATUS
   DSL_CPE_CLI_CMD_ADD_DEVICE ("bbsg", "BandBorderStatusGet", DSL_CPE_CLI_BandBorderStatusGet, g_sBbsg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("mlsg", "MiscLineStatusGet", DSL_CPE_CLI_MiscLineStatusGet, g_sMlsg);
#endif /* INCLUDE_DSL_CPE_MISC_LINE_STATUS*/
   /* G.997.1 related functionlities */
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997racs", "G997_RateAdaptationConfigSet", DSL_CPE_CLI_G997_RateAdaptationConfigSet, g_sRaCs);
#ifdef INCLUDE_DSL_CONFIG_GET
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997racg", "G997_RateAdaptationConfigGet", DSL_CPE_CLI_G997_RateAdaptationConfigGet, g_sRaCg);
#endif /* INCLUDE_DSL_CONFIG_GET*/
#ifdef INCLUDE_DSL_G997_ALARM
#ifdef INCLUDE_DSL_CONFIG_GET
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997amdpfcg", "G997_AlarmMaskDataPathFailuresConfigGet", DSL_CPE_CLI_G997_AlarmMaskDataPathFailuresConfigGet, g_sG997amdpfcg);
#endif /* INCLUDE_DSL_CONFIG_GET*/
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997amdpfcs", "G997_AlarmMaskDataPathFailuresConfigSet", DSL_CPE_CLI_G997_AlarmMaskDataPathFailuresConfigSet, g_sG997amdpfcs);
#ifdef INCLUDE_DSL_CONFIG_GET
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997amlfcg", "G997_AlarmMaskLineFailuresConfigGet", DSL_CPE_CLI_G997_AlarmMaskLineFailuresConfigGet, g_sG997amlfcg);
#endif /* INCLUDE_DSL_CONFIG_GET*/
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997amlfcs", "G997_AlarmMaskLineFailuresConfigSet", DSL_CPE_CLI_G997_AlarmMaskLineFailuresConfigSet, g_sG997amlfcs);
#endif /* INCLUDE_DSL_G997_ALARM*/
#ifdef INCLUDE_DSL_G997_PER_TONE
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997bang", "G997_BitAllocationNscGet", DSL_CPE_CLI_G997_BitAllocationNscGet, g_sG997bang);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997bansg", "G997_BitAllocationNscShortGet", DSL_CPE_CLI_G997_BitAllocationNscShortGet, g_sG997bansg);
#endif /* INCLUDE_DSL_G997_PER_TONE*/
#ifdef INCLUDE_DSL_G997_ALARM
#ifdef INCLUDE_DSL_CONFIG_GET
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997cdrtcg", "G997_ChannelDataRateThresholdConfigGet", DSL_CPE_CLI_G997_ChannelDataRateThresholdConfigGet, g_sG997cdrtcg);
#endif /* INCLUDE_DSL_CONFIG_GET*/
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997cdrtcs", "G997_ChannelDataRateThresholdConfigSet", DSL_CPE_CLI_G997_ChannelDataRateThresholdConfigSet, g_sG997cdrtcs);
#endif /* INCLUDE_DSL_G997_ALARM*/
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997csg", "G997_ChannelStatusGet", DSL_CPE_CLI_G997_ChannelStatusGet, g_sG997csg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997dpfsg", "G997_DataPathFailuresStatusGet", DSL_CPE_CLI_G997_DataPathFailuresStatusGet, g_sG997dpfsg);
#ifdef INCLUDE_DSL_G997_FRAMING_PARAMETERS
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997fpsg", "G997_FramingParameterStatusGet", DSL_CPE_CLI_G997_FramingParameterStatusGet, g_sG997fpsg);
#endif /* INCLUDE_DSL_G997_FRAMING_PARAMETERS*/
#ifdef INCLUDE_DSL_G997_PER_TONE
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997gang", "G997_GainAllocationNscGet", DSL_CPE_CLI_G997_GainAllocationNscGet, g_sG997gang);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997gansg", "G997_GainAllocationNscShortGet", DSL_CPE_CLI_G997_GainAllocationNscShortGet, g_sG997gansg);
#endif /* INCLUDE_DSL_G997_PER_TONE*/
#ifdef INCLUDE_DSL_CONFIG_GET
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("g997lacg", "G997_LineActivateConfigGet", DSL_CPE_CLI_G997_LineActivateConfigGet, g_sG997lacg);
#endif /*  INCLUDE_DSL_CONFIG_GET*/
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997lacs", "G997_LineActivateConfigSet", DSL_CPE_CLI_G997_LineActivateConfigSet, g_sG997lacs);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997lfsg", "G997_LineFailureStatusGet", DSL_CPE_CLI_G997_LineFailureStatusGet, g_sG997lfsg);
#ifdef INCLUDE_DSL_G997_LINE_INVENTORY
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997lig", "G997_LineInventoryGet", DSL_CPE_CLI_G997_LineInventoryGet, g_sG997lig);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997lis", "G997_LineInventorySet", DSL_CPE_CLI_G997_LineInventorySet, g_sG997lis);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997listrg", "G997_LineInventorySTRingGet", DSL_CPE_CLI_G997_LineInventoryStringGet, g_sG997listrg);
#endif /* INCLUDE_DSL_G997_LINE_INVENTORY*/
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997lsg", "G997_LineStatusGet", DSL_CPE_CLI_G997_LineStatusGet, g_sG997lsg);
#ifdef INCLUDE_DSL_G997_STATUS
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("g997ltsg", "G997_LineTransmissionStatusGet", DSL_CPE_CLI_G997_LineTransmissionStatusGet, g_sG997ltsg);
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("g997lisg", "G997_LineInitStatusGet", DSL_CPE_CLI_G997_LineInitStatusGet, g_sG997lisg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997lstg", "G997_LastStateTransmittedGet", DSL_CPE_CLI_G997_LastStateTransmittedGet, g_sG997lstg);
#endif /* INCLUDE_DSL_G997_STATUS*/
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997pmsft", "G997_PowerManagementStateForcedTrigger", DSL_CPE_CLI_G997_PowerManagementStateForcedTrigger, g_sG997pmsft);
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("g997pmsg", "G997_PowerManagementStatusGet", DSL_CPE_CLI_G997_PowerManagementStatusGet, g_sG997pmsg);
#ifdef INCLUDE_DSL_CEOC
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997sms", "G997_SnmpMessageSend", DSL_CPE_CLI_G997_SnmpMessageSend, g_sG997sms);
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("g997smr", "G997_SnmpMessageReceive", DSL_CPE_CLI_G997_SnmpMessageReceive, g_sG997smr);
#endif /* INCLUDE_DSL_CEOC */
#ifdef INCLUDE_DSL_G997_PER_TONE
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997sang", "G997_SnrAllocationNscGet", DSL_CPE_CLI_G997_SnrAllocationNscGet, g_sG997sang);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997sansg", "G997_SnrAllocationNscShortGet", DSL_CPE_CLI_G997_SnrAllocationNscShortGet, g_sG997sansg);
#endif /* INCLUDE_DSL_G997_PER_TONE*/
#ifdef INCLUDE_DSL_DELT
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("g997dfr", "G997_DeltFreeResources", DSL_CPE_CLI_G997_DeltFreeResources, g_sg997dfr);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997dhling", "G997_DeltHLINGet", DSL_CPE_CLI_G997_DeltHLINGet, g_sG997dhling);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997dhlinsg", "G997_DeltHLINScaleGet", DSL_CPE_CLI_G997_DeltHLINScaleGet, g_sG997dhlinsg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997dhlogg", "G997_DeltHLOGGet", DSL_CPE_CLI_G997_DeltHLOGGet,g_sG997dhlogg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997dqlng", "G997_DeltQLNGet", DSL_CPE_CLI_G997_DeltQLNGet,g_sG997dqlng);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("g997dsnrg", "G997_DeltSNRGet", DSL_CPE_CLI_G997_DeltSNRGet,g_sG997dsnrg);
#endif /* INCLUDE_DSL_DELT*/
#ifdef INCLUDE_DSL_CONFIG_GET
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("g997xtusecg", "G997_XTUSystemEnablingConfigGet", DSL_CPE_CLI_G997_XTUSystemEnablingConfigGet, g_sG997xtusecg);
#endif /* INCLUDE_DSL_CONFIG_GET*/
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("g997xtusecs", "G997_XTUSystemEnablingConfigSet", DSL_CPE_CLI_G997_XTUSystemEnablingConfigSet, g_sG997xtusecs);
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("g997xtusesg", "G997_XTUSystemEnablingStatusGet", DSL_CPE_CLI_G997_XTUSystemEnablingStatusGet, g_sG997xtusesg);

   DSL_CPE_CLI_CMD_ADD_DEVICE ("locs", "LineOptionsConfigSet", DSL_CPE_CLI_LineOptionsConfigSet, g_sLocs);
#ifdef INCLUDE_DSL_CONFIG_GET
   DSL_CPE_CLI_CMD_ADD_DEVICE ("locg", "LineOptionsConfigGet", DSL_CPE_CLI_LineOptionsConfigGet, g_sLocg);
#endif /* INCLUDE_DSL_CONFIG_GET*/

#ifdef INCLUDE_DSL_PM
#ifdef INCLUDE_DSL_CPE_PM_CONFIG
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmcs", "PM_ConfigSet", DSL_CPE_CLI_PM_ConfigSet, g_sPMcs);
#ifdef INCLUDE_DSL_CONFIG_GET
...
#ifdef INCLUDE_DSL_CPE_PM_OPTIONAL_PARAMETERS
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pm15meet", "PM_15MinElapsedExtTrigger", DSL_CPE_CLI_PM_15MinElapsedExtTrigger, g_sPM15meet);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmbms", "PM_BurninModeSet", DSL_CPE_CLI_PM_BurninModeSet, g_sPMbms);
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("pmetr", "PM_ElapsedTimeReset", DSL_CPE_CLI_PM_ElapsedTimeReset, g_sPMetr);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmsms", "PM_SyncModeSet", DSL_CPE_CLI_PM_SyncModeSet, g_sPMsms);
#ifdef INCLUDE_DSL_CONFIG_GET
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmsmg", "PM_SyncModeGet", DSL_CPE_CLI_PM_SyncModeGet, g_sPMsmg);
#endif /* #ifdef INCLUDE_DSL_CONFIG_GET*/
#endif /* #ifdef INCLUDE_DSL_CPE_PM_OPTIONAL_PARAMETERS*/
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmr", "PM_Reset", DSL_CPE_CLI_PM_Reset, g_sPMr);

#ifdef INCLUDE_DSL_CPE_PM_CHANNEL_COUNTERS
   /* Channel related counters */
#ifdef INCLUDE_DSL_CPE_PM_HISTORY
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmcc15mg", "PM_ChannelCounters15MinGet", DSL_CPE_CLI_PM_ChannelCounters15MinGet, g_sPMcc15mg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmcc1dg", "PM_ChannelCounters1DayGet", DSL_CPE_CLI_PM_ChannelCounters1DayGet, g_sPMcc1dg);
#ifdef INCLUDE_DSL_CPE_PM_OPTIONAL_PARAMETERS
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmchs15mg", "PM_ChannelHistoryStats15MinGet", DSL_CPE_CLI_PM_ChannelHistoryStats15MinGet, g_sPMchs15mg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmchs1dg", "PM_ChannelHistoryStats1DayGet", DSL_CPE_CLI_PM_ChannelHistoryStats1DayGet, g_sPMchs1dg);
#endif /* #ifdef INCLUDE_DSL_CPE_PM_OPTIONAL_PARAMETERS*/
#endif /* #ifdef INCLUDE_DSL_CPE_PM_HISTORY */
#ifdef INCLUDE_DSL_CPE_PM_TOTAL_COUNTERS
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmcctg", "PM_ChannelCountersTotalGet", DSL_CPE_CLI_PM_ChannelCountersTotalGet, g_sPMcctg);
#endif /* #ifdef INCLUDE_DSL_CPE_PM_TOTAL_COUNTERS */
#ifdef INCLUDE_DSL_CPE_PM_SHOWTIME_COUNTERS
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmccsg", "PM_ChannelCountersShowtimeGet", DSL_CPE_CLI_PM_ChannelCountersShowtimeGet, g_sPMccsg);
#endif /* #ifdef INCLUDE_DSL_CPE_PM_SHOWTIME_COUNTERS */
#ifdef INCLUDE_DSL_CPE_PM_CHANNEL_THRESHOLDS
#ifdef INCLUDE_DSL_CPE_PM_OPTIONAL_PARAMETERS
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmct15mg", "PM_ChannelThresholds15MinGet", DSL_CPE_CLI_PM_ChannelThresholds15MinGet, g_sPMct15mg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmct15ms", "PM_ChannelThresholds15MinSet", DSL_CPE_CLI_PM_ChannelThresholds15MinSet, g_sPMct15ms);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmct1dg", "PM_ChannelThresholds1DayGet", DSL_CPE_CLI_PM_ChannelThresholds1DayGet, g_sPMct1dg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmct1ds", "PM_ChannelThresholds1DaySet", DSL_CPE_CLI_PM_ChannelThresholds1DaySet, g_sPMct1ds);
#endif /* #ifdef INCLUDE_DSL_CPE_PM_OPTIONAL_PARAMETERS*/
#endif /* #ifdef INCLUDE_DSL_CPE_PM_CHANNEL_THRESHOLDS */
#endif /* #ifdef INCLUDE_DSL_CPE_PM_CHANNEL_COUNTERS */
...
#ifdef INCLUDE_DSL_CPE_PM_HISTORY
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmdpc15mg", "PM_DataPathCounters15MinGet", DSL_CPE_CLI_PM_DataPathCounters15MinGet, g_sPMdpc15mg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmdpc1dg", "PM_DataPathCounters1DayGet", DSL_CPE_CLI_PM_DataPathCounters1DayGet, g_sPMdpc1dg);
#ifdef INCLUDE_DSL_CPE_PM_OPTIONAL_PARAMETERS
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmdphs15mg", "PM_DataPathHistoryStats15MinGet", DSL_CPE_CLI_PM_DataPathHistoryStats15MinGet, g_sPMdphs15mg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmdphs1dg", "PM_DataPathHistoryStats1DayGet", DSL_CPE_CLI_PM_DataPathHistoryStats1DayGet, g_sPMdphs1dg);
#endif /* #ifdef INCLUDE_DSL_CPE_PM_OPTIONAL_PARAMETERS*/
#endif /* #ifdef INCLUDE_DSL_CPE_PM_HISTORY */
#ifdef INCLUDE_DSL_CPE_PM_TOTAL_COUNTERS
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmdpctg", "PM_DataPathCountersTotalGet", DSL_CPE_CLI_PM_DataPathCountersTotalGet, g_sPMdpctg);
#endif /* #ifdef INCLUDE_DSL_CPE_PM_TOTAL_COUNTERS */
#ifdef INCLUDE_DSL_CPE_PM_SHOWTIME_COUNTERS
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmdpcsg", "PM_DataPathCountersShowtimeGet", DSL_CPE_CLI_PM_DataPathCountersShowtimeGet, g_sPMdpcsg);
#endif /* #ifdef INCLUDE_DSL_CPE_PM_SHOWTIME_COUNTERS */
#ifdef INCLUDE_DSL_CPE_PM_DATA_PATH_THRESHOLDS
#ifdef INCLUDE_DSL_CPE_PM_OPTIONAL_PARAMETERS
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmdpt15mg", "PM_DataPathThresholds15MinGet", DSL_CPE_CLI_PM_DataPathThresholds15MinGet, g_sPMdpt15mg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmdpt15ms", "PM_DataPathThresholds15MinSet", DSL_CPE_CLI_PM_DataPathThresholds15MinSet, g_sPMdpt15ms);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmdpt1dg", "PM_DataPathThresholds1DayGet", DSL_CPE_CLI_PM_DataPathThresholds1DayGet, g_sPMdpt1dg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmdpt1ds", "PM_DataPathThresholds1DaySet", DSL_CPE_CLI_PM_DataPathThresholds1DaySet, g_sPMdpt1ds);
#endif /* #ifdef INCLUDE_DSL_CPE_PM_OPTIONAL_PARAMETERS*/
#endif /* #ifdef INCLUDE_DSL_CPE_PM_DATA_PATH_THRESHOLDS */
#endif /* #ifdef INCLUDE_DSL_CPE_PM_DATA_PATH_COUNTERS */
...
#ifdef INCLUDE_DSL_CPE_PM_HISTORY
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmrtc15mg", "PM_ReTxCounters15MinGet", DSL_CPE_CLI_PM_ReTxCounters15MinGet, g_sPMrtc15mg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmrtc1dg", "PM_ReTxCounters1DayGet", DSL_CPE_CLI_PM_ReTxCounters1DayGet, g_sPMrtc1dg);
#ifdef INCLUDE_DSL_CPE_PM_OPTIONAL_PARAMETERS
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmrths15mg", "PM_ReTxHistoryStats15MinGet", DSL_CPE_CLI_PM_ReTxHistoryStats15MinGet, g_sPMrths15mg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmrths1dg", "PM_ReTxHistoryStats1DayGet", DSL_CPE_CLI_PM_ReTxHistoryStats1DayGet, g_sPMrths1dg);
#endif /* #ifdef INCLUDE_DSL_CPE_PM_OPTIONAL_PARAMETERS*/
#endif /* #ifdef INCLUDE_DSL_CPE_PM_HISTORY */
#ifdef INCLUDE_DSL_CPE_PM_TOTAL_COUNTERS
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmrtctg", "PM_ReTxCountersTotalGet", DSL_CPE_CLI_PM_ReTxCountersTotalGet, g_sPMrtctg);
#endif /* #ifdef INCLUDE_DSL_CPE_PM_TOTAL_COUNTERS */
#ifdef INCLUDE_DSL_CPE_PM_SHOWTIME_COUNTERS
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmrtcsg", "PM_ReTxCountersShowtimeGet", DSL_CPE_CLI_PM_ReTxCountersShowtimeGet, g_sPMrtcsg);
#endif /* #ifdef INCLUDE_DSL_CPE_PM_SHOWTIME_COUNTERS */
#ifdef INCLUDE_DSL_CPE_PM_RETX_THRESHOLDS
#ifdef INCLUDE_DSL_CPE_PM_OPTIONAL_PARAMETERS
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmrtt15mg", "PM_ReTxThresholds15MinGet", DSL_CPE_CLI_PM_ReTxThresholds15MinGet, g_sPMrtt15mg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmrtt15ms", "PM_ReTxThresholds15MinSet", DSL_CPE_CLI_PM_ReTxThresholds15MinSet, g_sPMrtt15ms);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmrtt1dg", "PM_ReTxThresholds1DayGet", DSL_CPE_CLI_PM_ReTxThresholds1DayGet, g_sPMrtt1dg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmrtt1ds", "PM_ReTxThresholds1DaySet", DSL_CPE_CLI_PM_ReTxThresholds1DaySet, g_sPMrtt1ds);
#endif /* #ifdef INCLUDE_DSL_CPE_PM_OPTIONAL_PARAMETERS*/
#endif /* #ifdef INCLUDE_DSL_CPE_PM_RETX_THRESHOLDS */
#endif /* #ifdef INCLUDE_DSL_CPE_PM_RETX_COUNTERS */
   ...
   /* Data path related counters */
#ifdef INCLUDE_DSL_CPE_PM_HISTORY
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmdpfc15mg", "PM_DataPathFailureCounters15MinGet", DSL_CPE_CLI_PM_DataPathFailureCounters15MinGet, g_sPMdpfc15mg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmdpfc1dg", "PM_DataPathFailureCounters1DayGet", DSL_CPE_CLI_PM_DataPathFailureCounters1DayGet, g_sPMdpfc1dg);
#ifdef INCLUDE_DSL_CPE_PM_OPTIONAL_PARAMETERS
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmdpfhs15mg", "PM_DataPathFailureHistoryStats15MinGet", DSL_CPE_CLI_PM_DataPathFailureHistoryStats15MinGet, g_sPMdpfhs15mg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmdpfhs1dg", "PM_DataPathFailureHistoryStats1DayGet", DSL_CPE_CLI_PM_DataPathFailureHistoryStats1DayGet, g_sPMdpfhs1dg);
#endif /* INCLUDE_DSL_CPE_PM_OPTIONAL_PARAMETERS*/
#endif /* INCLUDE_DSL_CPE_PM_HISTORY */
#ifdef INCLUDE_DSL_CPE_PM_TOTAL_COUNTERS
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmdpfctg", "PM_DataPathFailureCountersTotalGet", DSL_CPE_CLI_PM_DataPathFailureCountersTotalGet, g_sPMdpfctg);
#endif /* INCLUDE_DSL_CPE_PM_TOTAL_COUNTERS */
#ifdef INCLUDE_DSL_CPE_PM_SHOWTIME_COUNTERS
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmdpfcsg", "PM_DataPathFailureCountersShowtimeGet", DSL_CPE_CLI_PM_DataPathFailureCountersShowtimeGet, g_sPMdpfcsg);
#endif /* INCLUDE_DSL_CPE_PM_SHOWTIME_COUNTERS */
#endif /* INCLUDE_DSL_CPE_PM_DATA_PATH_FAILURE_COUNTERS */
   ...
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmlesc1dg", "PM_LineEventShowtimeCounters1DayGet", DSL_CPE_CLI_PM_LineEventShowtimeCounters1DayGet, g_sPMlesc1dg);
#ifdef INCLUDE_DSL_CPE_PM_OPTIONAL_PARAMETERS
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmleshs15mg", "PM_LineEventShowtimeHistoryStats15MinGet", DSL_CPE_CLI_PM_LineEventShowtimeHistoryStats15MinGet, g_sPMleshs15mg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmleshs1dg", "PM_LineEventShowtimeHistoryStats1DayGet", DSL_CPE_CLI_PM_LineEventShowtimeHistoryStats1DayGet, g_sPMleshs1dg);
#endif /* INCLUDE_DSL_CPE_PM_OPTIONAL_PARAMETERS*/
#endif /* INCLUDE_DSL_CPE_PM_HISTORY */
#ifdef INCLUDE_DSL_CPE_PM_TOTAL_COUNTERS
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmlesctg", "PM_LineEventShowtimeCountersTotalGet", DSL_CPE_CLI_PM_LineEventShowtimeCountersTotalGet, g_sPMlesctg);
#endif /* INCLUDE_DSL_CPE_PM_TOTAL_COUNTERS */
#ifdef INCLUDE_DSL_CPE_PM_SHOWTIME_COUNTERS
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmlescsg", "PM_LineEventShowtimeCountersShowtimeGet", DSL_CPE_CLI_PM_LineEventShowtimeCountersShowtimeGet, g_sPMlescsg);
#endif /* INCLUDE_DSL_CPE_PM_SHOWTIME_COUNTERS */
#endif /* INCLUDE_DSL_CPE_PM_LINE_EVENT_SHOWTIME_COUNTERS */
...
#ifdef INCLUDE_DSL_CPE_PM_HISTORY
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmlic15mg", "PM_LineInitCounters15MinGet", DSL_CPE_CLI_PM_LineInitCounters15MinGet, g_sPMlic15mg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmlic1dg", "PM_LineInitCounters1DayGet", DSL_CPE_CLI_PM_LineInitCounters1DayGet, g_sPMlic1dg);
#ifdef INCLUDE_DSL_CPE_PM_OPTIONAL_PARAMETERS
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("pmlihs15mg", "PM_LineInitHistoryStats15MinGet", DSL_CPE_CLI_PM_LineInitHistoryStats15MinGet, g_sPMlihs15mg);
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("pmlihs1dg", "PM_LineInitHistoryStats1DayGet", DSL_CPE_CLI_PM_LineInitHistoryStats1DayGet, g_sPMlihs1dg);
#endif /* #ifdef INCLUDE_DSL_CPE_PM_OPTIONAL_PARAMETERS*/
#endif /* #ifdef INCLUDE_DSL_CPE_PM_HISTORY */
#ifdef INCLUDE_DSL_CPE_PM_TOTAL_COUNTERS
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("pmlictg", "PM_LineInitCountersTotalGet", DSL_CPE_CLI_PM_LineInitCountersTotalGet, g_sPMlictg);
#endif /* #ifdef INCLUDE_DSL_CPE_PM_TOTAL_COUNTERS */
#ifdef INCLUDE_DSL_CPE_PM_SHOWTIME_COUNTERS
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmlicsg", "PM_LineInitCountersShowtimeGet", DSL_CPE_CLI_PM_LineInitCountersShowtimeGet, g_sPMlicsg);
#endif /* #ifdef INCLUDE_DSL_CPE_PM_SHOWTIME_COUNTERS */
#ifdef INCLUDE_DSL_CPE_PM_LINE_THRESHOLDS
#ifdef INCLUDE_DSL_CPE_PM_OPTIONAL_PARAMETERS
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("pmlit15mg", "PM_LineInitThresholds15MinGet", DSL_CPE_CLI_PM_LineInitThresholds15MinGet, g_sPMlit15mg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmlit15ms", "PM_LineInitThresholds15MinSet", DSL_CPE_CLI_PM_LineInitThresholds15MinSet, g_sPMlit15ms);
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("pmlit1dg", "PM_LineInitThresholds1DayGet", DSL_CPE_CLI_PM_LineInitThresholds1DayGet, g_sPMlit1dg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmlit1ds", "PM_LineInitThresholds1DaySet", DSL_CPE_CLI_PM_LineInitThresholds1DaySet, g_sPMlit1ds);
#endif /* #ifdef INCLUDE_DSL_CPE_PM_OPTIONAL_PARAMETERS*/
#endif /* #ifdef INCLUDE_DSL_CPE_PM_LINE_THRESHOLDS */

   /* Line seconds related counters */
#ifdef INCLUDE_DSL_CPE_PM_HISTORY
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmlsc15mg", "PM_LineSecCounters15MinGet", DSL_CPE_CLI_PM_LineSecCounters15MinGet, g_sPMlsc15mg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmlsc1dg", "PM_LineSecCounters1DayGet", DSL_CPE_CLI_PM_LineSecCounters1DayGet, g_sPMlsc1dg);
#ifdef INCLUDE_DSL_CPE_PM_OPTIONAL_PARAMETERS
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmlshs15mg", "PM_LineSecHistoryStats15MinGet", DSL_CPE_CLI_PM_LineSecHistoryStats15MinGet, g_sPMlshs15mg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmlshs1dg", "PM_LineSecHistoryStats1DayGet", DSL_CPE_CLI_PM_LineSecHistoryStats1DayGet, g_sPMlshs1dg);
#endif /* #ifdef INCLUDE_DSL_CPE_PM_OPTIONAL_PARAMETERS*/
#endif /* #ifdef INCLUDE_DSL_CPE_PM_HISTORY */
#ifdef INCLUDE_DSL_CPE_PM_TOTAL_COUNTERS
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmlsctg", "PM_LineSecCountersTotalGet", DSL_CPE_CLI_PM_LineSecCountersTotalGet, g_sPMlsctg);
#endif /* #ifdef INCLUDE_DSL_CPE_PM_TOTAL_COUNTERS */
#ifdef INCLUDE_DSL_CPE_PM_SHOWTIME_COUNTERS
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmlscsg", "PM_LineSecCountersShowtimeGet", DSL_CPE_CLI_PM_LineSecCountersShowtimeGet, g_sPMlscsg);
#endif /* #ifdef INCLUDE_DSL_CPE_PM_SHOWTIME_COUNTERS */
#ifdef INCLUDE_DSL_CPE_PM_LINE_THRESHOLDS
#ifdef INCLUDE_DSL_CPE_PM_OPTIONAL_PARAMETERS
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmlst15mg", "PM_LineSecThresholds15MinGet", DSL_CPE_CLI_PM_LineSecThresholds15MinGet, g_sPMlst15mg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmlst15ms", "PM_LineSecThresholds15MinSet", DSL_CPE_CLI_PM_LineSecThresholds15MinSet, g_sPMlst15ms);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmlst1dg", "PM_LineSecThresholds1DayGet", DSL_CPE_CLI_PM_LineSecThresholds1DayGet, g_sPMlst1dg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("pmlst1ds", "PM_LineSecThresholds1DaySet", DSL_CPE_CLI_PM_LineSecThresholds1DaySet, g_sPMlst1ds);
#endif /* #ifdef INCLUDE_DSL_CPE_PM_OPTIONAL_PARAMETERS*/
#endif /* #ifdef INCLUDE_DSL_CPE_PM_LINE_THRESHOLDS */
#endif /* #ifdef INCLUDE_DSL_CPE_PM_LINE_COUNTERS */
...
#ifdef DSL_DEBUG_TOOL_INTERFACE
   DSL_CPE_CLI_CMD_ADD_DEVICE ("tcpmistart", "TCPMessageInterfaceSTART", DSL_CPE_CLI_TCPMessageInterfaceSTART, g_sTcpStart);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("tcpmistop", "TCPMessageInterfaceSTOP", DSL_CPE_CLI_TCPMessageInterfaceSTOP, g_sTcpStop);
#endif /* DSL_DEBUG_TOOL_INTERFACE*/

#if defined(INCLUDE_DSL_CPE_DTI_SUPPORT)
   DSL_CPE_CLI_CMD_ADD_DEVICE ("dtistart", "DebugTraceInterfaceSTART", DSL_CPE_CLI_DebugTraceInterfaceSTART, g_sDtiStart);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("dtistop", "DebugTraceInterfaceSTOP", DSL_CPE_CLI_DebugTraceInterfaceSTOP, g_sDtiStop);
#endif /* #if defined(INCLUDE_DSL_CPE_DTI_SUPPORT)*/

#ifdef INCLUDE_PILOT_TONES_STATUS
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("ptsg", "PilotTonesStatusGet", DSL_CPE_CLI_PilotTonesStatusGet, g_sPtsg);
#endif /* #ifdef INCLUDE_PILOT_TONES_STATUS*/

   DSL_CPE_CLI_CMD_ADD_DEVICE ("rccs", "RebootCriteriaConfigSet", DSL_CPE_CLI_RebootCriteriaConfigSet, g_sRccs);
#ifdef INCLUDE_DSL_CONFIG_GET
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("rccg", "RebootCriteriaConfigGet", DSL_CPE_CLI_RebootCriteriaConfigGet, g_sRccg);
#endif /* INCLUDE_DSL_CONFIG_GET*/

#ifdef INCLUDE_DEVICE_EXCEPTION_CODES
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("lecg", "LastExceptionCodesGet", DSL_CPE_CLI_LastExceptionCodesGet, g_sLecg);
#endif /* #ifdef INCLUDE_DEVICE_EXCEPTION_CODES*/

#ifdef INCLUDE_REAL_TIME_TRACE
   DSL_CPE_CLI_CMD_ADD_DEVICE ("rtti", "RTT_Init", DSL_CPE_CLI_RTT_Init, g_sRtti);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("rttcs", "RTT_ConfigSet", DSL_CPE_CLI_RTT_ConfigSet, g_sRttcs);
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("rttcg", "RTT_ConfigGet", DSL_CPE_CLI_RTT_ConfigGet, g_sRttcg);
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("rttsg", "RTT_StatusGet", DSL_CPE_CLI_RTT_StatusGet, g_sRttsg);
   DSL_CPE_CLI_CMD_ADD_DEVICE ("rttctrls", "RTT_ConTRoLSet", DSL_CPE_CLI_RTT_ControlSet, g_sRttctrls);
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("rttstatg", "RTT_STATisticsGet", DSL_CPE_CLI_RTT_StatisticsGet, g_sRttstatg);
#endif /*#ifdef INCLUDE_REAL_TIME_TRACE*/

   DSL_CPE_CLI_CMD_ADD_DEVICE ("osg", "OlrStatisticsGet", DSL_CPE_CLI_OlrStatisticsGet, g_sOsg);

   DSL_CPE_CLI_CMD_ADD_DEVICE ("llsg", "LoopLengthStatusGet", DSL_CPE_CLI_LoopLengthStatusGet, g_sLlsg);
...
#ifdef INCLUDE_DSL_CPE_PM_RETX_COUNTERS
#ifdef INCLUDE_DSL_CPE_PM_RETX_THRESHOLDS
   DSL_CPE_CLI_CMD_ADD_DEVICE ("rtsg", "ReTxStatisticsGet", DSL_CPE_CLI_ReTxStatisticsGet, g_sRtsg);
#endif /* INCLUDE_DSL_CPE_PM_RETX_THRESHOLDS */
#endif /* INCLUDE_DSL_CPE_PM_RETX_COUNTERS */

   DSL_CPE_CLI_CMD_ADD_DEVICE ("dsnrg", "DeltSNRGet", DSL_CPE_CLI_DeltSNRGet,g_sDsnrg);
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("fdsg", "FirmwareDownloadStatusGet", DSL_CPE_CLI_FirmwareDownloadStatusGet, g_sFdsg);

   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("t1413xtuorg", "T1413_XTUO_RevisionGet", DSL_CPE_CLI_T1413_XTUO_RevisionGet, g_sT1413XTUOrg);
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("t1413xturrg", "T1413_XTUR_RevisionGet", DSL_CPE_CLI_T1413_XTUR_RevisionGet, g_sT1413XTURrg);
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("t1413xtuovrg", "T1413_XTUO_VendorRevisionGet", DSL_CPE_CLI_T1413_XTUO_VendorRevisionGet, g_sT1413XTUOvrg);
   DSL_CPE_CLI_CMD_ADD_DEVICE_1ARG ("t1413xturvrg", "T1413_XTUR_VendorRevisionGet", DSL_CPE_CLI_T1413_XTUR_VendorRevisionGet, g_sT1413XTURvrg);
