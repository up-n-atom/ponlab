...
#define	__US_QOSQ_DES_LIST_PERQ_NUM			255	/*Number of descriptors per QOSQ*/
...
/* Support 4 ring model: RX_IN PD list is a separate list from RX_OUT */
#define	__RX_IN_PD_DES_LIST_BASE				0xB570	/* 0xB570-0xB76F	256x2=512*/
#define	__RX_IN_PD_DES_LIST_SIZE				510
#define	__RX_IN_PD_DES_LIST_NUM					255
#define	__RX_IN_PD_DES_LIST_GUARD				254
...
#define	__DS_BOND_GIF_LL_SIZE					3072
#define	__DS_BOND_GIF_LL_NUM					1536
...
#define	__ACA_FOUR_RING_MODEL				0x36CA

/* Configuration to remove ethernet FCS from data length */
#define	__ETH_FCS_DATA_LEN_RMV				0x36CB

/* GRX750-VRX518 Test Code                 */
#define	__VRX518_BOND_CORE_FW_DISABLE		0x36d0
#define	__GRX750_TEST_ENABLE				0x36d3

#define	__GRX750_READ_ENABLE				0x36d4
#define	__GRX750_SRC_ADDR					0x36d5
#define	__VRX518_DST_ADDR					0x36d6

#define	__GRX750_WRITE_ENABLE				0x36d8
#define	__GRX750_DST_ADDR					0x36d9
#define	__VRX518_SRC_VAL					0x36dA

#define __PMAC_HDR_INSERT					0x2517
/*GRX750 PP Shadow Counters in VRX518 SB */
#define	__PP_TX_IN_SHADOW_CNT				0x2520
#define	__PP_TX_OUT_SHADOW_CNT				0x2521
#define	__PP_RX_OUT_SHADOW_CNT				0x2522
#define	__PP_RX_IN_SHADOW_CNT				0x2523

#define	__PP_TX_IN_PREV_CNT					0x2524
#define	__PP_TX_OUT_PREV_CNT				0x2525
#define	__PP_RX_OUT_PREV_CNT				0x2526
#define	__PP_RX_IN_PREV_CNT					0x2527

/*GRX750 PP Counters Physical Addresses Configured by PPE driver*/
#define	__PP_TX_IN_ADDR						0x2528
#define	__PP_TX_OUT_ADDR					0x2529
#define	__PP_RX_OUT_ADDR					0x252A
#define	__PP_RX_IN_ADDR						0x252B

/*Debug information for RX_IN_OUT data_pointer */
#define	__RX_IN_PREV_DATA_PTR				0x2C00
#define	__RX_OUT_PREV_DATA_PTR				0x2C01
