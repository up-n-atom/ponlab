...
extern ssize_t proc_write_ptm_wanmib(struct file *, const char __user *,
				size_t, loff_t *);
extern int proc_read_ptm_qosmib(struct seq_file *, void *);
extern ssize_t proc_write_ptm_qosmib(struct file *, const char __user *,
				size_t, loff_t *);
extern int ptm_power_saving(struct ptm_ep_priv *, int, int);
extern int ptm_qos_drop(struct ptm_ep_priv *, int, int);
...
extern int proc_ptm_read_soc_fw(struct seq_file *, void *);
extern ssize_t proc_ptm_write_soc_fw(struct file *, const char __user *,
				size_t, loff_t *);
#endif
