...
if test -n "$STAGING_DIR"; then
	...
	: ${EGREP="/local/angele/ugw/ugw81x/ugw_sw/openwrt/staging_dir/host/bin/grep -E"}
	: ${FGREP="/local/angele/ugw/ugw81x/ugw_sw/openwrt/staging_dir/host/bin/grep -F"}
	: ${GREP="/local/angele/ugw/ugw81x/ugw_sw/openwrt/staging_dir/host/bin/grep"}
	: ${SED="/local/angele/ugw/ugw81x/ugw_sw/openwrt/staging_dir/host/bin/sed"}
fi
